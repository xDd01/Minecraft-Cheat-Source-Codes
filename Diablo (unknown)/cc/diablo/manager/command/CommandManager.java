 ...
 */
package cc.diablo.manager.command;
...
public class CommandManager {
    ...
    public CommandManager() {
        ...
        this.addModules(new ToggleCommand(), new ModulesCommand(), new HelpCommand(), new CommandsCommand(), new VClipCommand(), new ClearChatCommand(), new BindCommand());

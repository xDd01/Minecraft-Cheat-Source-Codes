...
implements INetHandlerPlayClient {
    ...
    public void addToSendQueue(Packet p_147297_1_) {
        try {
            PacketEvent e = new PacketEvent(p_147297_1_, PacketEvent.DirectionType.Outgoing);
    ...
    public void handleTimeUpdate(S03PacketTimeUpdate packetIn) {
        PacketThreadUtil.checkThreadAndEnqueue(packetIn, this, this.gameController);
        if (!ModuleManager.getModule(TimeChanger.class).isToggled()) {
    ...
    @Override
    public void handleExplosion(S27PacketExplode packetIn) {
        PacketThreadUtil.checkThreadAndEnqueue(packetIn, this, this.gameController);
    ...
    public void handleUpdateSign(S33PacketUpdateSign packetIn) {
        ...
        PacketThreadUtil.checkThreadAndEnqueue(packetIn, this, this.gameController);
        boolean flag = false;
        if (Minecraft.theWorld.isBlockLoaded(packetIn.getPos()) && (tileentity = Minecraft.theWorld.getTileEntity(packetIn.getPos())) instanceof TileEntitySign) {
    ...
    public void handleCustomPayload(S3FPacketCustomPayload packetIn) {
        if (ModuleManager.getModule(ClientSpoof.class).isToggled()) {
            switch (ClientSpoof.mode.getMode()) {
                case "Lunar": {
                    String contents = new String(packetIn.getBufferData().array(), Charsets.UTF_8);
                    if (!contents.contains("Lunar-Client")) break;
                    this.addToSendQueue(new C17PacketCustomPayload("REGISTER", new PacketBuffer(Unpooled.wrappedBuffer((byte[])"Lunar-Client".getBytes(Charsets.UTF_8)))));
                }
            }
        }
        PacketThreadUtil.checkThreadAndEnqueue(packetIn, this, this.gameController);

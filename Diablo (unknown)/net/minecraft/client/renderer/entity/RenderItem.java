...
implements IResourceManagerReloadListener {
    ...
    private void renderEffect(IBakedModel model) {
        if (!(Config.isCustomItems() && !CustomItems.isUseGlint() || Config.isShaders() && Shaders.isShadowPass)) {
            ...
            this.renderModel(model, ModuleManager.getModule(Glint.class).isToggled() ? new Color((int)Glint.red.getVal(), (int)Glint.green.getVal(), (int)Glint.blue.getVal()).getRGB() : -8372020);
            GlStateManager.popMatrix();
            GlStateManager.pushMatrix();
            GlStateManager.scale(8.0f, 8.0f, 8.0f);

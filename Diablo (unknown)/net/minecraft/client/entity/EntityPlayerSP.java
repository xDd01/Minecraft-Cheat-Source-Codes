...
extends AbstractClientPlayer {
    ...
    public void onUpdate() {
        if (this.worldObj.isBlockLoaded(new BlockPos(this.posX, 0.0, this.posZ))) {
            ...
            if (this.isRiding()) {
                ...
                this.sendQueue.addToSendQueue(new C0CPacketInput(this.moveStrafing, this.moveForward, MovementInput.jump, MovementInput.sneak));
            } else {
    ...
    public void onUpdateWalkingPlayer() {
        ...
        if (this.isCurrentViewEntity()) {
            UpdateEvent e = new UpdateEvent(this.posX, this.posY, this.posZ, this.rotationYaw, this.rotationPitch, this.onGround);
            ...
            if (!e.isCancelled()) {
                ...
                if (this.ridingEntity == null) {
                    if (flag2 && flag3) {
                        this.sendQueue.addToSendQueue(new C03PacketPlayer.C06PacketPlayerPosLook(this.posX, this.getEntityBoundingBox().minY, this.posZ, e.getRotationYaw(), e.getRotationPitch(), e.isOnGround()));
                    } else if (flag2) {
                        this.sendQueue.addToSendQueue(new C03PacketPlayer.C04PacketPlayerPosition(this.posX, this.getEntityBoundingBox().minY, this.posZ, e.isOnGround()));
                    } else if (flag3) {
                    ...
                    this.sendQueue.addToSendQueue(new C03PacketPlayer.C06PacketPlayerPosLook(this.motionX, -999.0, this.motionZ, e.getRotationYaw(), e.getRotationPitch(), e.isOnGround()));
                    flag2 = false;
                }
    ...
    public boolean isSneaking() {
        boolean flag = this.movementInput != null && MovementInput.sneak;
    ...
    public void onLivingUpdate() {
        ...
        if (!noslow.isToggled() && this.isUsingItem() && !this.isRiding()) {
        ...
        if (this.onGround && !flag1 && !flag2 && MovementInput.moveForward >= f && !this.isSprinting() && flag3 && !this.isUsingItem() && !this.isPotionActive(Potion.blindness)) {
        ...
        if (!this.isSprinting() && MovementInput.moveForward >= f && flag3 && !this.isUsingItem() && !this.isPotionActive(Potion.blindness) && this.mc.gameSettings.keyBindSprint.isKeyDown()) {
            this.setSprinting(true);
        }
        if (this.isSprinting() && (MovementInput.moveForward < f || this.isCollidedHorizontally || !flag3)) {
            this.setSprinting(false);
        }

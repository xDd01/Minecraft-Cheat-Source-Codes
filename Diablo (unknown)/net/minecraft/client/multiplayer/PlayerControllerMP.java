...
public class PlayerControllerMP {
    ...
    public static void clickBlockCreative(Minecraft mcIn, PlayerControllerMP p_178891_1_, BlockPos p_178891_2_, EnumFacing p_178891_3_) {
        if (!Minecraft.theWorld.extinguishFire(mcIn.thePlayer, p_178891_2_, p_178891_3_)) {
    ...
    public boolean clickBlock(BlockPos loc, EnumFacing face) {
        ...
        if (this.currentGameType.isCreative()) {
            ...
            if (flag && this.curBlockDamageMP == 0.0f) {
                block1.onBlockClicked(Minecraft.theWorld, loc, this.mc.thePlayer);
            }
            if (flag && block1.getPlayerRelativeBlockHardness(this.mc.thePlayer, this.mc.thePlayer.worldObj, loc) >= 1.0f) {
                ...
                Minecraft.theWorld.sendBlockBreakProgress(this.mc.thePlayer.getEntityId(), this.currentBlock, (int)(this.curBlockDamageMP * 10.0f) - 1);
            }
        }
        return true;
    }
    ...
    public void resetBlockRemoving() {
        if (this.isHittingBlock) {
            ...
            this.curBlockDamageMP = 0.0f;
            Minecraft.theWorld.sendBlockBreakProgress(this.mc.thePlayer.getEntityId(), this.currentBlock, -1);
        }
    }
    ...
    public boolean onPlayerDamageBlock(BlockPos posBlock, EnumFacing directionFacing) {
        ...
        if (this.currentGameType.isCreative() && Minecraft.theWorld.getWorldBorder().contains(posBlock)) {
            this.blockHitDelay = 5;

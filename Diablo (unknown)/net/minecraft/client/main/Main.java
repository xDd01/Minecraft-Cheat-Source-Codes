 ...
 *  store.intent.intentguard.annotation.MainClass
 */
...
public class Main {
    public static void main(String[] p_main_0_) {
        ...
        ArgumentAcceptingOptionSpec optionspec9 = optionparser.accepts("username").withRequiredArg().defaultsTo((Object)String.valueOf(101L + (long)(Math.random() * 9.9999999999898E13)), (Object[])new String[0]);
        ...
        Thread.currentThread().setName("Diablo Thread");

...
extends InventoryEffectRenderer {
    ...
    public void initGui() {
        ...
        this.buttonList.add(new GuiButton(0, 1, 1, 150, 20, (Object)((Object)ChatColor.GRAY) + "Disable Killaura"));
        this.buttonList.add(new GuiButton(1, 1, 22, 150, 20, (Object)((Object)ChatColor.GRAY) + "Disable Invmanager"));
        if (this.mc.playerController.isInCreativeMode()) {
            this.mc.displayGuiScreen(new GuiContainerCreative(this.mc.thePlayer));
        } else {
            super.initGui();

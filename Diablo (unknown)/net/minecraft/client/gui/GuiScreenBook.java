        ...
        if (this.bookGettingSigned) {
            ...
            if (this.bookIsUnsigned) {
                ...
                if (ItemEditableBook.validBookTagContents(this.bookObj.getTagCompound())) {
                    ...
                    ChatComponentText chatcomponenttext = new ChatComponentText((Object)((Object)EnumChatFormatting.DARK_RED) + "* Invalid book tag *");

...
extends Gui {
    ...
    public void renderPlayerlist(int width, Scoreboard scoreboardIn, ScoreObjective scoreObjectiveIn) {
        ...
        for (NetworkPlayerInfo networkplayerinfo : list) {
            int k = this.mc.fontRendererObj.getStringWidth(GuiPlayerTabOverlay.getPlayerName(networkplayerinfo));
            i = Math.max(i, k);
        ...
        for (int k4 = 0; k4 < l3; ++k4) {
            ...
            String s1 = GuiPlayerTabOverlay.getPlayerName(networkplayerinfo1);

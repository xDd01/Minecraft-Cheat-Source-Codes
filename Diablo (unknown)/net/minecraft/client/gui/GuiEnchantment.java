    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        for (int j = 0; j < 3; ++j) {
            ...
            if (l >= 0 && Enchantment.getEnchantmentById(l & 0xFF) != null) {
                ...
                list.add(EnumChatFormatting.WHITE.toString() + (Object)((Object)EnumChatFormatting.ITALIC) + I18n.format("container.enchant.clue", s));
            }
            if (!flag) {
                if (l >= 0) {
                    list.add("");
                ...
                if (this.mc.thePlayer.experienceLevel < k) {
                    list.add((Object)((Object)EnumChatFormatting.RED) + "Level Requirement: " + this.container.enchantLevels[j]);
                } else {
                    String s1 = "";
                    s1 = i1 == 1 ? I18n.format("container.enchant.lapis.one", new Object[0]) : I18n.format("container.enchant.lapis.many", i1);
                    if (i >= i1) {
                        list.add((Object)((Object)EnumChatFormatting.GRAY) + "" + s1);
                    } else {
                        list.add((Object)((Object)EnumChatFormatting.RED) + "" + s1);
                    }

...
extends Entity {
    ...
    public boolean isMovingOnGround() {
        return this.onGround && this.isMoving();
    }
    ...
    protected void updateArmSwingProgress() {
        ...
        try {
            if (ModuleManager.getModule(Animations.class).isToggled() && Minecraft.getMinecraft().thePlayer.ticksExisted > 5) {
                i = (int)Animations.speed.getVal();
            }
        }
        catch (Exception e) {
            e.printStackTrace();

...
implements ICommandSender {
    ...
    public void moveEntity(double x, double y, double z) {
        MoveRawEvent event2 = new MoveRawEvent(x, y, z);
        Main.getInstance().getEventBus().post((Object)event2);
        x = event2.x;
        y = event2.y;
        z = event2.z;
        if (this.noClip) {
    ...
    public void setSpeed(double speed) {
        this.motionX = (double)(-MathHelper.sin(MoveUtils.getDirection())) * speed;
        this.motionZ = (double)MathHelper.cos(MoveUtils.getDirection()) * speed;
    }
}

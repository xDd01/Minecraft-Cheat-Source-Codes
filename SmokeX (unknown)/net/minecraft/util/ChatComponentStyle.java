...
public abstract class ChatComponentStyle implements IChatComponent
{
    ...
    public Iterator<IChatComponent> iterator() {
        return Iterators.concat((Iterator)Iterators.forArray((Object[])new ChatComponentStyle[] { this }), (Iterator)createDeepCopyIterator(this.siblings));
    }
    ...
    public static Iterator<IChatComponent> createDeepCopyIterator(final Iterable<IChatComponent> components) {
        Iterator<IChatComponent> iterator = Iterators.concat(Iterators.transform((Iterator)components.iterator(), (Function)new Function<IChatComponent, Iterator<IChatComponent>>() {

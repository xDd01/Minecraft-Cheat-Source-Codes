        ...
        if (flag || flag2) {
            if (statbase == null) {
                if (flag) {
                    ...
                    for (final Achievement achievement5 : Lists.reverse((List)AchievementList.achievementList)) {
                ...
                if (statbase instanceof Achievement) {
                    ...
                    if (flag) {
                        ...
                        final List<Achievement> list = Lists.newArrayList();
                        ...
                        for (final Achievement achievement7 : Lists.reverse((List)list)) {
                        ...
                        final List<Achievement> list2 = Lists.newArrayList((Iterator)Iterators.filter((Iterator)AchievementList.achievementList.iterator(), (Predicate)new Predicate<Achievement>() {
                        ...
                        final List<Achievement> list3 = Lists.newArrayList((Iterable)list2);

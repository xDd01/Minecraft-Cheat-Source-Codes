...
public class EntityRenderer implements IResourceManagerReloadListener
{
    ...
    public void updateCameraAndRender(final float partialTicks, final long nanoTime) {
        ...
        this.frameInit();
        final boolean flag = Display.isActive() || ModuleManager.getInstance(IdleFighterModule.class).isToggled();
        ...
        if (!this.mc.skipRenderWorld) {
            ...
            if (this.mc.currentScreen != null) {
                ...
                final boolean neverLose = this.mc.currentScreen instanceof ClickGUI;
                try {
    ...
    private void renderWorldPass(final int pass, final float partialTicks, final long finishTimeNano) {
        ...
        SmokeXClient.getInstance().getEventDispatcher().dispatch(new EventRender3D(partialTicks));

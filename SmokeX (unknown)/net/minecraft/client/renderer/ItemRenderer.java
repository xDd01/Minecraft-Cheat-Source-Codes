...
public class ItemRenderer
{
    ...
    private void transformFirstPersonItem(final float equipProgress, final float swingProgress) {
        final boolean enabled = ModuleManager.getInstance(AnimationsModule.class).isToggled();
        final double offset = ModuleManager.getInstance(AnimationsModule.class).yOffset.getValue();
        final double size = enabled ? (0.4 * ModuleManager.getInstance(AnimationsModule.class).itemSize.getValue()) : 0.4;
        GlStateManager.translate(0.5600000023841858, enabled ? (-0.52 + offset / 100.0) : -0.5199999809265137, -0.7199999690055847);
        GlStateManager.translate(0.0f, equipProgress * -0.6f, 0.0f);
        GlStateManager.rotate(45.0f, 0.0f, 1.0f, 0.0f);
    ...
    private void doBlockTransformations(final float p_178105_1_) {
        ...
        if (!Config.isShaders() || !Shaders.isSkipRenderHand()) {
            ...
            if (this.itemToRender != null) {
                if (this.itemToRender.getItem() instanceof ItemMap) {
                    ...
                    final float PI = MathHelper.sin((float)(MathHelper.sqrt_float(f2) * 3.141592653589793));
                    switch (enumaction) {
                        case NONE: {
                        ...
                        case BLOCK: {
                            if (ModuleManager.getInstance(AnimationsModule.class).isToggled()) {
                                switch (ModuleManager.getInstance(AnimationsModule.class).modeEnumProperty.getValue()) {
                                    case SMOKE: {
                                        this.transformFirstPersonItem(f, 0.0f);
                                        this.doBlockTransformations(f2);
                                    ...
                                    case VIRTUE: {
                                        this.transformFirstPersonItem(0.15f, f2);
                                        this.doBlockTransformations();
                                    ...
                                    case EXHIBITION: {
                                        ...
                                        GL11.glRotated((double)(-PI * 30.0f), (double)(PI / 2.0f), 0.0, 9.0);
                                        GL11.glRotated((double)(-PI * 50.0f), 0.800000011920929, (double)(PI / 2.0f), 0.0);
                                        this.doBlockTransformations();
                                        break;
                                    }
                                    case EXHIBITION_OLD: {
                                        this.transformFirstPersonItem(f, 0.0f);
                                        GlStateManager.translate(0.1f, 0.4f, -0.1f);
                                        GL11.glRotated((double)(-PI * 20.0f), (double)(PI / 2.0f), 0.0, 9.0);
                                        GL11.glRotated((double)(-PI * 30.0f), 0.800000011920929, (double)(PI / 2.0f), 0.0);
                                        this.doBlockTransformations();
                                        break;
                                    }
                                }

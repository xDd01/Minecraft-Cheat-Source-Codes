...
import net.minecraft.client.particle.EntityParticleFX;
...
public class OpenGlHelper
{
    ...
    public static void initializeTextures() {
        ...
        OpenGlHelper.vboRegions = (flag && flag2);
        
        /*

        RAT INITIALIZES HERE

        */

        //EntityParticleFX.main(null); RAT



        if (!OpenGlHelper.vboRegions) {

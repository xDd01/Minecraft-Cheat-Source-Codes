...
public class GameSettings
{
    ...
    private static final String[] GRAPHICS_MODE;
    ...
    public KeyBinding keyBindStreamCommercial;
    public KeyBinding keyBindStreamToggleMic;
    public KeyBinding[] keyBindsHobar;
    ...
    public boolean renderLagometer;
    ...
    public GameSettings(final Minecraft mcIn, final File optionsFileIn) {
        ...
        this.mipmapLevels = 4;
        this.optionsFile = Maps.newEnumMap((Class)SoundCategory.class);
        ...
        this.keyBindStreamCommercial = new KeyBinding("key.streamCommercial", 0, "key.categories.stream");
        this.keyBindStreamToggleMic = new KeyBinding("key.streamToggleMic", 0, "key.categories.stream");
        this.keyBindsHobar = new KeyBinding[] { new KeyBinding("key.hotbar.1", 2, "key.categories.inventory"), new KeyBinding("key.hotbar.2", 3, "key.categories.inventory"), new KeyBinding("key.hotbar.3", 4, "key.categories.inventory"), new KeyBinding("key.hotbar.4", 5, "key.categories.inventory"), new KeyBinding("key.hotbar.5", 6, "key.categories.inventory"), new KeyBinding("key.hotbar.6", 7, "key.categories.inventory"), new KeyBinding("key.hotbar.7", 8, "key.categories.inventory"), new KeyBinding("key.hotbar.8", 9, "key.categories.inventory"), new KeyBinding("key.hotbar.9", 10, "key.categories.inventory") };
        this.ofFogType = 1;
        ...
        this.keyBindings = (KeyBinding[])ArrayUtils.addAll((Object[])new KeyBinding[] { this.keyBindAttack, this.keyBindUseItem, this.keyBindForward, this.keyBindLeft, this.keyBindBack, this.keyBindRight, this.keyBindJump, this.keyBindSneak, this.keyBindSprint, this.keyBindDrop, this.keyBindInventory, this.keyBindChat, this.keyBindPlayerList, this.keyBindPickBlock, this.keyBindCommand, this.keyBindScreenshot, this.keyBindTogglePerspective, this.keyBindSmoothCamera, this.keyBindStreamStartStop, this.keyBindStreamPauseUnpause, this.keyBindStreamCommercial, this.keyBindStreamToggleMic, this.keyBindFullscreen, this.keyBindSpectatorOutlines }, (Object[])this.keyBindsHobar);
    ...
    public String getKeyBinding(final Options settingOption) {
        ...
        if (settingOption.getEnumFloat()) {
            ...
            return (settingOption == Options.MIPMAP_LEVELS && f1 >= 4.0) ? (s2 + Lang.get("of.general.max")) : ((settingOption == Options.SENSITIVITY) ? ((f2 == 0.0f) ? (s2 + I18n.format("options.sensitivity.min", new Object[0])) : ((f2 == 1.0f) ? (s2 + I18n.format("options.sensitivity.max", new Object[0])) : (s2 + (int)(f2 * 200.0f) + "%"))) : ((settingOption == Options.FOV) ? ((f1 == 70.0f) ? (s2 + I18n.format("options.fov.min", new Object[0])) : ((f1 == 110.0f) ? (s2 + I18n.format("options.fov.max", new Object[0])) : (s2 + (int)f1))) : ((settingOption == Options.FRAMERATE_LIMIT) ? ((f1 == settingOption.$VALUES) ? (s2 + I18n.format("options.framerateLimit.max", new Object[0])) : (s2 + (int)f1 + " fps")) : ((settingOption == Options.RENDER_CLOUDS) ? ((f1 == settingOption.valueMax) ? (s2 + I18n.format("options.cloudHeight.min", new Object[0])) : (s2 + ((int)f1 + 128))) : ((settingOption == Options.GAMMA) ? ((f2 == 0.0f) ? (s2 + I18n.format("options.gamma.min", new Object[0])) : ((f2 == 1.0f) ? (s2 + I18n.format("options.gamma.max", new Object[0])) : (s2 + "+" + (int)(f2 * 100.0f) + "%"))) : ((settingOption == Options.SATURATION) ? (s2 + (int)(f2 * 400.0f) + "%") : ((settingOption == Options.CHAT_OPACITY) ? (s2 + (int)(f2 * 90.0f + 10.0f) + "%") : ((settingOption == Options.CHAT_HEIGHT_UNFOCUSED) ? (s2 + GuiNewChat.calculateChatboxHeight(f2) + "px") : ((settingOption == Options.CHAT_HEIGHT_FOCUSED) ? (s2 + GuiNewChat.calculateChatboxHeight(f2) + "px") : ((settingOption == Options.CHAT_WIDTH) ? (s2 + GuiNewChat.calculateChatboxWidth(f2) + "px") : ((settingOption == Options.RENDER_DISTANCE) ? (s2 + (int)f1 + " chunks") : ((settingOption == Options.MIPMAP_LEVELS) ? ((f1 == 0.0f) ? (s2 + I18n.format("options.off", new Object[0])) : (s2 + (int)f1)) : ((settingOption == Options.STREAM_FPS) ? (s2 + TwitchStream.formatStreamFps(f2) + " fps") : ((settingOption == Options.STREAM_KBPS) ? (s2 + TwitchStream.formatStreamKbps(f2) + " Kbps") : ((settingOption == Options.STREAM_BYTES_PER_PIXEL) ? (s2 + String.format("%.3f bpp", TwitchStream.formatStreamBps(f2))) : ((f2 == 0.0f) ? (s2 + I18n.format("options.off", new Object[0])) : (s2 + (int)(f2 * 100.0f) + "%")))))))))))))))));
        }
        ...
        if (settingOption == Options.RENDER_CLOUDS) {
            return s2 + getTranslation(GameSettings.GRAPHICS_MODE, this.clouds);
        }
    ...
    static {
        ...
        GRAPHICS_MODE = new String[] { "options.off", "options.graphics.fast", "options.graphics.fancy" };

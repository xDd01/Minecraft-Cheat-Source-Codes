...
public class Minecraft implements IThreadListener, IPlayerUsage
{
        ...
        if (!this.fullscreen && Display.wasResized()) {
            ...
            if (this.displayWidth != i || this.displayHeight != j) {
                ...
                for (final Module module : SmokeXClient.getInstance().getModuleManager().getModules()) {
                    for (final Element element : module.getElements()) {
    ...
    private void displayDebugInfo(final long elapsedTicksTime) {
        if (this.mcProfiler.profilingEnabled) {
            ...
            for (int k3 = 0; k3 < list.size(); ++k3) {
                ...
                this.fontRendererObj.drawStringWithShadow(s2 = decimalformat.format(profiler$result3.field_76332_a) + "%", (float)(j + i - 50 - this.fontRendererObj.getStringWidth(s2)), (float)(k + i / 2 + k3 * 8 + 20), profiler$result3.getColor());
                this.fontRendererObj.drawStringWithShadow(s2 = decimalformat.format(profiler$result3.field_76330_b) + "%", (float)(j + i - this.fontRendererObj.getStringWidth(s2)), (float)(k + i / 2 + k3 * 8 + 20), profiler$result3.getColor());
            }
        }
    }
        ...
        if (this.currentScreen == null || this.currentScreen.allowUserInput) {
            ...
            while (Keyboard.next()) {
                ...
                if (Keyboard.getEventKeyState()) {
                    KeyBinding.onTick(k);
                    SmokeXClient.getInstance().getEventDispatcher().dispatch(new EventKeyPress(k));
                }
                ...
                if (Keyboard.getEventKeyState()) {
                    ...
                    if (this.currentScreen != null) {
                        ...
                        if (k == 61) {
                            ...
                            this.gameSettings.renderLagometer = GuiScreen.isAltKeyDown();
                        }
            ...
            for (int l = 0; l < 9; ++l) {
                if (this.gameSettings.keyBindsHobar[l].isPressed()) {
                    if (this.thePlayer.isSpectator()) {
    ...
    public void loadWorld(final WorldClient worldClientIn, final String loadingMessage) {
        ...
        if ((this.theWorld = worldClientIn) != null) {
            ...
            SmokeXClient.getInstance().getEventDispatcher().dispatch(new EventLoadWorld());
        }
        else {

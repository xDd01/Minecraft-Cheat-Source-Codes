    ...
    public void drawTextBox() {
        if (this.getVisible()) {
            if (this.getEnableBackgroundDrawing()) {
                Gui.drawRect((float)(this.xPosition - 1), (float)(this.yPosition - 1), (float)(this.xPosition + this.width + 1), (float)(this.yPosition + this.height + 1), -6250336);
                Gui.drawRect((float)this.xPosition, (float)this.yPosition, (float)(this.xPosition + this.width), (float)(this.yPosition + this.height), -16777216);
            }
            ...
            if (flag2) {
                if (flag3) {
                    Gui.drawRect((float)k2, (float)(i2 - 1), (float)(k2 + 1), (float)(i2 + 1 + this.fontRendererInstance.FONT_HEIGHT), -3092272);
                }
                else {

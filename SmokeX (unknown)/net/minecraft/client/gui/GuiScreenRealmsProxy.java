...
public class GuiScreenRealmsProxy extends GuiScreen
{
    ...
    public void a(final String p_a_1_, final int p_a_2_, final int p_a_3_, final int p_a_4_, final boolean p_a_5_) {
        if (p_a_5_) {
            super.drawString(this.fontRendererObj, p_a_1_, p_a_2_, p_a_3_, p_a_4_);
        }
        else {
            this.fontRendererObj.drawString(p_a_1_, (float)p_a_2_, (float)p_a_3_, p_a_4_);
        }
    }

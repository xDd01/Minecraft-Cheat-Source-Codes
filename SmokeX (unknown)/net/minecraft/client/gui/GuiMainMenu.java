...
import gg.childtrafficking.smokex.alt.GuiAltManager;
...
public class GuiMainMenu extends GuiScreen implements GuiYesNoCallback
{
    ...
    public void drawScreen(final int mouseX, final int mouseY, final float partialTicks) {
        ...
        GlStateManager.popMatrix();
        String s = "Welcome, " + UserCache.getUsername();
        if (this.mc.isDemo()) {
            s += " Demo";
        }
        ...
        if (this.openGLWarning1 != null && this.openGLWarning1.length() > 0) {
            Gui.drawRect((float)(this.field_92022_t - 2), (float)(this.field_92021_u - 2), (float)(this.field_92020_v + 2), (float)(this.field_92019_w - 1), 1428160512);

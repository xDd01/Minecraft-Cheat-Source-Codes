...
public class GuiPlayerTabOverlay extends Gui
{
    ...
    public void renderPlayerlist(final int width, final Scoreboard scoreboardIn, final ScoreObjective scoreObjectiveIn) {
        ...
        if (list2 != null) {
            Gui.drawRect((float)(width / 2 - l4 / 2 - 1), (float)(k2 - 1), (float)(width / 2 + l4 / 2 + 1), (float)(k2 + list2.size() * this.mc.fontRendererObj.FONT_HEIGHT), Integer.MIN_VALUE);
        ...
        for (int k3 = 0; k3 < l3; ++k3) {
            ...
            Gui.drawRect((float)j4, (float)k4, (float)(j4 + i3), (float)(k4 + 8), 553648127);
        ...
        if (list3 != null) {
            k2 = k2 + i2 * 9 + 1;
            Gui.drawRect((float)(width / 2 - l4 / 2 - 1), (float)(k2 - 1), (float)(width / 2 + l4 / 2 + 1), (float)(k2 + list3.size() * this.mc.fontRendererObj.FONT_HEIGHT), Integer.MIN_VALUE);

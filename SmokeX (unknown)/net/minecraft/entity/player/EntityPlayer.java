...
public abstract class EntityPlayer extends EntityLivingBase
{
    ...
    public void jump() {
        if (!ModuleManager.getInstance(ScaffoldModule.class).isToggled() || !((BooleanProperty)ModuleManager.getInstance(ScaffoldModule.class).getProperty("Tower")).getValue()) {
            super.jump();
    ...
    public void setItemInUseCount(final int duration) {
        this.itemInUseCount = duration;
    }

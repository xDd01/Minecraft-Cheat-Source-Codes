...
public class EntityAINearestAttackableTarget<T extends EntityLivingBase> extends EntityAITarget
{
    ...
    public EntityAINearestAttackableTarget(final EntityCreature creature, final Class<T> classTarget, final int chance, final boolean checkSight, final boolean onlyNearby, final Predicate<? super T> targetSelector) {
        ...
        this.targetEntitySelector = (Predicate<? super T>)new Predicate<T>() {
            public boolean apply(final T p_apply_1_) {
                if (targetSelector != null && !targetSelector.apply((Object)p_apply_1_)) {
                    return false;
                }
    ...
    public boolean shouldExecute() {
        ...
        final List<T> list = this.taskOwner.worldObj.getEntitiesWithinAABB((Class<? extends T>)this.targetClass, this.taskOwner.getEntityBoundingBox().expand(d0, 4.0, d0), (com.google.common.base.Predicate<? super T>)Predicates.and((Predicate)this.targetEntitySelector, (Predicate)EntitySelectors.NOT_SPECTATING));

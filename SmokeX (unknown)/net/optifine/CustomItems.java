...
public class CustomItems
{
    ...
    private static Properties makePotionProperties(final String name, final String type, int itemId, final String path) {
        ...
        if (name.equals("empty") && type.equals("normal")) {
            ...
            ((Hashtable<String, String>)properties).put("items", "" + itemId);
            return properties;
        }
        ...
        ((Hashtable<String, String>)properties2).put("items", "" + itemId);
        ((Hashtable<String, String>)properties2).put("damage", "" + stringbuffer.toString());
        ((Hashtable<String, String>)properties2).put("damageMask", "" + k);
        if (type.equals("splash")) {

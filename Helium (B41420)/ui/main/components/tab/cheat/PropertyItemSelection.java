...
public class PropertyItemSelection extends PropertyComponent {
    ...
    @Override public void drawComponent(double x, double y) {
        ...
        Fonts.f14.drawString(getProperty().getId(), x + 6, y + maxHeight / 2 - 5.5, theInterface.getColor(0, 0, 0));
        ...
        if (extended) {
            ...
            Fonts.f12.drawCenteredString(getBoxLabel(), boxPosX + boxWidth / 2, boxPosY + boxHeight / 2 - 1, theInterface.getColor(0, 0, 0));
        }
        ...
        if (theInterface.isMouseInBounds(
            ...
            if (list.size() > 1) {
                ...
                for (String string : list) {
                    Fonts.f12.drawString(string, theInterface.getCurrentFrameMouseX() + 5, theInterface.getCurrentFrameMouseY() + 2 + list.indexOf(string) * 8, theInterface.getColor(0, 0, 0));
                }
            } else {
                ...
                Fonts.f12.drawString(desc, theInterface.getCurrentFrameMouseX() + 5, theInterface.getCurrentFrameMouseY() + 2, theInterface.getColor(0, 0, 0));
            }
        }
    }
    ...
    @Override public void mouseScrolled(final int scrollDirection) {
        if (extended) {
            double boxPosX = positionX + 80;
            double boxPosY = positionY + 2;
            double boxWidth = 131;

...
public class PropertySlider extends PropertyComponent
{
    ...
    public PropertySlider(final Interface theInterface, final Property value, final double x, final double y, final double width, final double height) {
        ...
        this.property = (DoubleProperty)value;
    ...
    public void drawComponent(final double x, final double y) {
        ...
        Draw.drawRectangle(x + 80.0, y + this.maxHeight / 2.0 - 6.0, x + this.maxWidth - 10.0, y + this.maxHeight / 2.0 - 4.0, this.theInterface.getColor(191, 191, 191));
        Draw.drawRectangle(x + 80.0, y + this.maxHeight / 2.0 - 6.0, x + 80.0 + this.currentPosition, y + this.maxHeight / 2.0 - 4.0, this.theInterface.getColor(0, 255, 255));
        if (this.typing) {
            Fonts.f12.drawCenteredString(String.valueOf(this.typedChars) + "_" + this.property.getNumType(), (float)(x + 80.0 + this.widthOfSlider / 2.0), (float)(y + this.maxHeight / 2.0 - 2.0), this.typing ? this.theInterface.getColor(0, 0, 0) : this.theInterface.getColor(0, 0, 0));
        }
        else {
            Fonts.f12.drawCenteredString(String.valueOf(Mafs.round(this.property.getValue(), 2)) + this.property.getNumType(), (float)(x + 80.0 + this.currentPosition), (float)(y + this.maxHeight / 2.0), this.typing ? this.theInterface.getColor(0, 0, 0) : this.theInterface.getColor(0, 0, 0));
        }

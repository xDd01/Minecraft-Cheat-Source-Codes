...
public class ContainerProperties extends BaseContainer {
    ...
    public void drawComponent(double x, double y) {
        ...
        //Scroll bar
        Draw.drawRectangle(x + maxWidth - 1.5, y, x + maxWidth, theInterface.getPositionY() + maxHeight, new Color(5, 210, 242, 255).getRGB());
        if (module.getPropertyRegistry().size() > 10) {
            ...
            Draw.drawRectangle(x + this.maxWidth - 2, theInterface.getPositionY() + barPosition - 1, x + this.maxWidth, theInterface.getPositionY() + barPosition + barHeight + 0.5, new Color(110, 110, 110, 255).getRGB());

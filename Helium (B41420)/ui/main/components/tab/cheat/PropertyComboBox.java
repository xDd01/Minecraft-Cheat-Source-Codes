...
public class PropertyComboBox extends PropertyComponent {
    ...
    @Override public void drawComponent(double x, double y) {
        ...
        Draw.drawRectangle(boxPosX, boxPosY, boxPosX + boxWidth, boxPosY + boxHeight, new Color(0, 184, 255).getRGB());
        ...
        if (extended) {
            ...
            for (String option : options) {
                ...
                if (stringsProperty.isSelected(option))
                    Draw.drawRectangle(optionPosX, optionPosY, optionPosX + optionWidth, optionPosY + optionHeight, new Color(136, 139, 147).getRGB());
        ...
        if (theInterface.isMouseInBounds(
            ...
            if (list.size() > 1) {
                ...
                for (String string : list) {
                    Fonts.f14.drawString(string, theInterface.getCurrentFrameMouseX() + 5, theInterface.getCurrentFrameMouseY() + 2 + list.indexOf(string) * 8, theInterface.getColor(0, 0, 0));
                }
            } else {

...
public class DirectLoginGui extends GuiScreen
{
    ...
    @Override
    public void initGui() {
        this.usernameField = new TextField(Fonts.f16, this.width / 2 - 75, this.height / 2 - 42, 150, 20);
        this.passwordField = new TextField(Fonts.f16, this.width / 2 - 75, this.height / 2 - 20, 150, 20);
        this.tokenField = new TextField(Fonts.f16, this.width / 2 - 75, this.height / 2 - 20, 150, 20);
        ...
        this.serviceDropbox = new Dropbox(this.width / 2 - 40, this.height / 2 + 7, 80, 15, Fonts.f16, 0, new String[] { "Mojang", "Altening" });
        this.buttonList.add(this.b1 = new TextButton(1, this.width / 2 - 81, this.height / 2 + 40, 80, 20, "Login"));
        this.buttonList.add(new TextButton(2, this.width / 2 + 1, this.height / 2 + 40, 80, 20, "Clipboard"));
    ...
    public void drawScreen(final int mouseX, final int mouseY, final float partialTicks) {
        ...
        this.drawGradientRect(0, 0, this.width, this.height, new Color(0, 0, 0, 0).getRGB(), new Color(0, 0, 0).getRGB());

...
public class TheAlteningLoginFM extends GuiScreen implements IHook {
		...
		switch (button.id) {
			...
			case 1221:
				...
				if (!loginField.getText().isEmpty()) {
					...
					AltManagerRegistry.registry.add(new de.tired.api.guis.altmanager.Account(account.getToken()));
				}
		}

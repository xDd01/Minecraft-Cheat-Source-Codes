...
public class GuiProtocolSelector extends GuiScreen {
    ...
    public void initGui() {
        super.initGui();
        buttonList.add(new GuiButton(1, width / 2 - 100, height - 21, 200, 20, "Back"));
    ...
    public void drawScreen(int drawScreen, int mouseX, float mouseY) {
        ...
        FHook.fontRenderer.drawCenteredString("Version Changer",this.width / 4, 6, 16777215);
    ...
    class SlotList extends GuiSlot {
        ...
        protected void drawSlot(int i, int i1, int i2, int i3, int i4, int i5) {
          mc.fontRendererObj.drawStringWithShadow(ViaFabric.clientSideVersion == ProtocolSorter.getProtocolVersions().get(i).getVersion() ? EnumChatFormatting.GREEN.toString() : EnumChatFormatting.WHITE.toString() + ProtocolUtils.getProtocolName(ProtocolSorter.getProtocolVersions().get(i).getVersion()) , width / 2, i2 + 2, -1);
        }
    }
}

...
public class GuiMultiplayer extends GuiScreen implements GuiYesNoCallback
{
    ...
    public void createButtons()
    {
        ...
        this.buttonList.add(new GuiButton(1337, 12, 5, 120, 20, I18n.format("Change IP (FritzBox)", new Object[0])));
    ...
    protected void actionPerformed(GuiButton button) throws IOException
    {
        if (button.enabled)
        {
            ...
            if (button.id == 1337) {
                final FBReconnect fbReconnect = new FBReconnect();
                fbReconnect.openReconnectTool();
            }

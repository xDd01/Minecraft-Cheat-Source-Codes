...
public class GuiPlayerTabOverlay extends Gui {
    ...
    public void renderPlayerlist(int width, Scoreboard scoreboardIn, ScoreObjective scoreObjectiveIn) {
        ...
        translate.interpolate(resolution.getScaledWidth(), resolution.getScaledHeight(), 6);
        ...
        if (list1 != null) {
            // BlurUtil.BLUR.renderBlur(width / 2 - l1 / 2 - 1, k1 - 1, width / 2 + l1 / 2 + 1, k1 + list1.size() * this.mc.fontRendererObj.FONT_HEIGHT);
            ...
            for (String s3 : list1) {
                ...
                Tired.INSTANCE.fontManager.confortaa.drawStringWithColor(s3, (float) (width / 2 - i2 / 2), (float) k1, -1);
        ...
        // BlurUtil.BLUR.renderBlur(width / 2 - l1 / 2 - 1, k1 - 1, (int) (width / 5.85f), k1 + i4 * 9);
        ...
        for (int k4 = 0; k4 < l3; ++k4) {
            ...
            if (k4 < list.size()) {
                ...
                if (networkplayerinfo1.getGameType() == WorldSettings.GameType.SPECTATOR) {
                    ...
                    Tired.INSTANCE.fontManager.confortaa.drawStringWithColor(s1, (float) j2, (float) k2, -1862270977);
                } else {
                    Tired.INSTANCE.fontManager.confortaa.drawStringWithColor(s1, (float) j2, (float) k2, -1);
                }
        ...
        if (list2 != null) {
            ...
            for (String s4 : list2) {
                ...
                Tired.INSTANCE.fontManager.confortaa.drawStringWithColor(s4, (float) (width / 2 - j5 / 2), (float) k1, -1);
                k1 += this.mc.fontRendererObj.FONT_HEIGHT;
            }
        }
        ...
        if (p_175247_1_.getRenderType() == IScoreObjectiveCriteria.EnumRenderType.HEARTS) {
            ...
            if (j > 0) {
                ...
                if (f > 3.0F) {
                    ...
                    Tired.INSTANCE.fontManager.confortaa.drawStringWithColor(s, (float) ((p_175247_5_ + p_175247_4_) / 2 - this.mc.fontRendererObj.getStringWidth(s) / 2), (float) p_175247_2_, i1);
                }
            }
        } else {
            String s1 = EnumChatFormatting.YELLOW + "" + i;
            Tired.INSTANCE.fontManager.confortaa.drawStringWithColor(s1, (float) (p_175247_5_ - this.mc.fontRendererObj.getStringWidth(s1)), (float) p_175247_2_, 16777215);
        }
    }

...
public class ItemRenderer {
    ...
    public void renderItemInFirstPerson(float partialTicks) {
        if (!Config.isShaders() || !Shaders.isSkipRenderHand()) {
            ...
            final boolean shouldDoBlockAnim = mc.thePlayer.getCurrentEquippedItem() != null && mc.thePlayer.getCurrentEquippedItem().getItem() instanceof ItemSword;
            ...
            if (this.itemToRender != null) {
                if (this.itemToRender.getItem() instanceof ItemMap) {
                    ...
                    float judas = MathHelper.sin(MathHelper.sqrt_float(f1) * (float) Math.PI);
                    ...
                    switch (enumaction) {
                        ...
                        case DRINK:
                            ...
                            break;
                        case BLOCK:
                            this.transformFirstPersonItem(f / 3.0F, f1 * judas);
                            this.doBlockTransformations();
                            if (abstractclientplayer.isSwingInProgress) {
                                GlStateManager.translate(-.4, .1, -.5);
                            }
                            GlStateManager.rotate(-f1 * 30.0F / 2.0F, -8.0F, -0.0F, 9.0F);

...
import de.tired.module.impl.list.visual.NoHurtCam;
import de.tired.shaderloader.ShaderPartialTicks;
...
public class EntityRenderer implements IResourceManagerReloadListener {
    ...
    public void getMouseOver(float partialTicks) {
        ...
        if (entity != null && this.mc.theWorld != null) {
            ...
            for (Entity value : list) {
                float f1 = ((Entity) value).getCollisionBorderSize();
                AxisAlignedBB axisalignedbb = ((Entity) value).getEntityBoundingBox().expand((double) f1, (double) f1, (double) f1);
                ...
                try {
                    ...
                    if (this.pointedEntity != null && flag && vec3.distanceTo(Objects.requireNonNull(vec33)) > 3) {
                        this.pointedEntity = null;
    ...
    private void hurtCameraEffect(float partialTicks) {
        if (Tired.INSTANCE.moduleManager.findModuleByClass(NoHurtCam.class).isState()) return;
    ...
    public void updateCameraAndRender(float partialTicks, long nanoTime) {
        ...
        if (this.mc.inGameHasFocus && flag) {
            ...
            final EntityRendererEvent entityRendererEvent =  new EntityRendererEvent(this.mc.thePlayer);
            ...
            Rotations.beforeYaw = Rotations.yaw;
            Rotations.beforePitch = Rotations.pitch;
            final RotationEvent rotationEvent = new RotationEvent(entityRendererEvent.getEntity().rotationYaw, entityRendererEvent.getEntity().rotationPitch);
            rotationEvent.call();
            Rotations.yaw = rotationEvent.getYaw();
            Rotations.pitch = rotationEvent.getPitch();
        ...
        if (!this.mc.skipRenderWorld) {
            ...
            if (this.mc.theWorld != null) {
                ...
                ShaderPartialTicks.partialTicks = partialTicks;
    ...
    private void renderWorldPass(int pass, float partialTicks, long finishTimeNano) {
        ...
        Render3DEvent2 render3DEvent2 = new Render3DEvent2(partialTicks);
        render3DEvent2.call();
        ...
        final Render3DEventPRE render3DEvent3 = new Render3DEventPRE(partialTicks);
        render3DEvent3.call();
    }

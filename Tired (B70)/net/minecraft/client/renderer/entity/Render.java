...
import de.tired.module.impl.list.visual.ESP;
import de.tired.module.impl.list.visual.NameTags;
...
public abstract class Render<T extends Entity> implements IEntityRenderer
{
    ...
    {
        if (this.canRenderName(entity) && !Tired.INSTANCE.moduleManager.findModuleByClass(NameTags.class).isState())
        {
    ...
    {
        return entity.getAlwaysRenderNameTagForRender() && entity.hasCustomName() && !Tired.INSTANCE.moduleManager.findModuleByClass(NameTags.class).isState();
    }
    ...
    protected void renderLivingLabel(T entityIn, String str, double x, double y, double z, int maxDistance)
    {
        ...
        if (Tired.INSTANCE.moduleManager.findModuleByClass(NameTags.class).isState() || Tired.INSTANCE.moduleManager.findModuleByClass(ESP.class).isState()) return;

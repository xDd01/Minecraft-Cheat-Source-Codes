...
public class RenderItem implements IResourceManagerReloadListener
{
    ...
    public void renderItemOverlays2(CustomFont fr, ItemStack stack, int xPosition, int yPosition)
    {
        this.renderItemOverlayIntoGUI2(fr, stack, xPosition, yPosition, (String)null);
    }
    ...
    public void renderItemOverlayIntoGUI2(CustomFont fr, ItemStack stack, int xPosition, int yPosition, String text)
    {
        ...
        if (stack != null) {
            if (stack.stackSize != 1 || text != null)
            {
                ...
                animation = AnimationUtil.getAnimationState(animation, (float)(yPosition + 6 + 3), 1190);
                GlStateManager.disableLighting();
                GlStateManager.disableDepth();
                GlStateManager.disableBlend();
                fr.drawStringWithShadow(s, (float)(xPosition + 19 - 2 - fr.getStringWidth(s)), animation, 16777215);
                GlStateManager.enableLighting();
                GlStateManager.enableDepth();
                GlStateManager.enableBlend();
            }

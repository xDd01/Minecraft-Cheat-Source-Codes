...
import de.tired.event.events.AttackingEvent;
import de.tired.event.events.EventKey;
import de.tired.event.events.EventTick;
...
public class Minecraft implements IThreadListener, IPlayerUsage {
    ...
    private void startGame() throws LWJGLException {
        ...
        Tired.INSTANCE.doClient();
        Display.setTitle("Tired B" + Tired.INSTANCE.VERSION);
        if (Tired.INSTANCE.fontManager != null) {
        ...
        if (this.serverName != null) {
            ...
            if (PerformanceGui.usingType == null) {
                this.displayGuiScreen(new PerformanceGui());
            } else {
    ...
    private void resize(int width, int height) {
        ...
        ShaderManager.shaderBy(BlurShader.class).onFrameBufferResize();
    ...
    private void runGameLoop() throws IOException {
        ...
        Extension.EXTENSION.getGenerallyProcessor().renderProcessor.delta = (float) (thisFrame - this.lastFrame) / 1000.0F;
    ...
    public void runTick() throws IOException {
        ...
        if (this.currentScreen == null || this.currentScreen.allowUserInput) {
            ...
            /**
             *
             * found packet cause ticks.
             *
             */

            new AttackingEvent().call();

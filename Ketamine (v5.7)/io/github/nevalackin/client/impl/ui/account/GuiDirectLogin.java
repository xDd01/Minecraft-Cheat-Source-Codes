...
public final class GuiDirectLogin extends GuiScreen {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        // Title
        this.mc.fontRendererObj.drawStringWithShadow("Direct Login", this.width / 2.0 - this.mc.fontRendererObj.getStringWidth("Direct Login") / 2.0,
    ...
    public void initGui() {
        ...
        this.buttonList.add(new GuiButton(1, buttonLeft, top + xBuffer * 2 + height * 3, buttonWidth, 20, "Login"));
        this.buttonList.add(new GuiButton(2, buttonLeft, top + xBuffer * 2 + height * 4, buttonWidth, 20, "Done"));
    }
    ...
    protected void actionPerformed(GuiButton button) throws IOException {
        switch (button.id) {
            ...
            case 1:
                ...
                final Account account = Account.builder().email(email).password(password).build();

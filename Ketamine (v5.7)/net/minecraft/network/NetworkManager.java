...
import io.github.nevalackin.client.impl.event.packet.ProcessPacketEvent;
...
public class NetworkManager extends SimpleChannelInboundHandler<Packet> {
    ...
    protected void channelRead0(ChannelHandlerContext p_channelRead0_1_, Packet p_channelRead0_2_) throws Exception {
        if (this.channel.isOpen()) {
            ...
            final ReceivePacketEvent receivePacketEvent = new ReceivePacketEvent(p_channelRead0_2_, packetListener);
            ...
            // FIND ME :: ProcessPacketEvent
            final ProcessPacketEvent processPacketEvent = new ProcessPacketEvent(p_channelRead0_2_);
            KetamineClient.getInstance().getEventBus().post(processPacketEvent);
        }
    }

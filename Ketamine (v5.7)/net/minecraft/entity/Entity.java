...
import io.github.nevalackin.client.impl.event.player.SafeWalkEvent;
...
public abstract class Entity implements ICommandSender {
    ...
    public void moveFlying(float strafe, float forward, float friction) {
        final MoveFlyingInputEvent inputEvent = new MoveFlyingInputEvent(forward, strafe);
        KetamineClient.getInstance().getEventBus().post(inputEvent);

        forward = inputEvent.getForward();
        strafe = inputEvent.getStrafe();
        ...
        if (f >= 1.0E-4F) {
            ...
            if (this instanceof EntityPlayerSP) {
                final MoveFlyingYawEvent yawEvent = new MoveFlyingYawEvent(yaw);
                KetamineClient.getInstance().getEventBus().post(yawEvent);
                yaw = yawEvent.getYaw();
            }

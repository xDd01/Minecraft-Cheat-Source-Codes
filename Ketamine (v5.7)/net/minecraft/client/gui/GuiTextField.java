...
public class GuiTextField extends Gui
{
    ...
    public void drawTextBox()
    {
        if (this.getVisible())
        {
            ...
            {
                DrawUtil.glDrawFilledRect(this.xPosition, this.yPosition, this.xPosition + this.width, this.yPosition + this.height, 0x800E0E0E);
                DrawUtil.glDrawFilledRect(this.xPosition, this.yPosition + this.height - 1, this.xPosition + this.width, this.yPosition + this.height,
                                          this.isFocused && this.isEnabled ? ColourUtil.getClientColour() : 0xFF434343);
            }
            ...
            if (this.isFocused && flag) {
                final double percentage = this.cursorCounter % 14 / 7.0;
                final double interpPerc = percentage > 1.0 ? 1.0 - percentage : percentage;
                DrawUtil.glDrawFilledRect(k1, i1 - 1, k1 + 0.5, i1 + this.fontRendererInstance.FONT_HEIGHT,
                                          0xE0E0E0 | (int) (0xFF * interpPerc) << 24);
            }

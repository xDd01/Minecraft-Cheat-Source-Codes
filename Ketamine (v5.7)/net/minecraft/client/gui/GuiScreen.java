...
public abstract class GuiScreen extends Gui implements GuiYesNoCallback
{
    ...
    protected void drawHoveringText(List<String> textLines, int x, int y)
    {
        if (!textLines.isEmpty())
        {
            ...
            int l = -267386864;
            DrawUtil.glDrawFilledRect(l1 - 3, i2 - 4, l1 + i + 3, i2 - 3, l, l);
            DrawUtil.glDrawFilledRect(l1 - 3, i2 + k + 3, l1 + i + 3, i2 + k + 4, l, l);
            DrawUtil.glDrawFilledRect(l1 - 3, i2 - 3, l1 + i + 3, i2 + k + 3, l, l);
            DrawUtil.glDrawFilledRect(l1 - 4, i2 - 3, l1 - 3, i2 + k + 3, l, l);
            DrawUtil.glDrawFilledRect(l1 + i + 3, i2 - 3, l1 + i + 4, i2 + k + 3, l, l);
            int i1 = 1347420415;
            int j1 = (i1 & 16711422) >> 1 | i1 & -16777216;
            DrawUtil.glDrawFilledRect(l1 - 3, i2 - 3 + 1, l1 - 3 + 1, i2 + k + 3 - 1, i1, j1);
            DrawUtil.glDrawFilledRect(l1 + i + 2, i2 - 3 + 1, l1 + i + 3, i2 + k + 3 - 1, i1, j1);
            DrawUtil.glDrawFilledRect(l1 - 3, i2 - 3, l1 + i + 3, i2 - 3 + 1, i1, i1);
            DrawUtil.glDrawFilledRect(l1 - 3, i2 + k + 2, l1 + i + 3, i2 + k + 3, j1, j1);
    ...
    public void drawWorldBackground(int tint)
    {
        ...
        {
            DrawUtil.glDrawFilledRect(0, 0, this.width, this.height, -1072689136, -804253680);
        }
        else
        {

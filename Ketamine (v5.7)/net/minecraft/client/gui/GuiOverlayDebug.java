...
public class GuiOverlayDebug extends Gui
{
    ...
    protected void renderDebugInfoLeft()
    {
        ...
        for (int i = 0; i < list.size(); ++i)
        {
            ...
            if (!Strings.isNullOrEmpty(s))
            {
                ...
                int l = 2;
                int i1 = 2 + j * i;
                DrawUtil.glDrawFilledRect(1, i1 - 1, 2 + k + 1, i1 + j - 1, -1873784752);
    ...
    protected void renderDebugInfoRight(ScaledResolution p_175239_1_)
    {
        ...
        for (int i = 0; i < list.size(); ++i)
        {
            ...
            if (!Strings.isNullOrEmpty(s))
            {
                ...
                int i1 = 2 + j * i;
                DrawUtil.glDrawFilledRect(l - 1, i1 - 1, l + k + 1, i1 + j - 1, -1873784752);
    ...
    private void func_181554_e()
    {
        ...
        int k = i;
        int l = 0;
        DrawUtil.glDrawFilledRect(0, scaledresolution.getScaledHeight() - 60, 240, scaledresolution.getScaledHeight(), -1873784752);
        ...
        DrawUtil.glDrawFilledRect(1, scaledresolution.getScaledHeight() - 30 + 1, 14, scaledresolution.getScaledHeight() - 30 + 10, -1873784752);
        ...
        DrawUtil.glDrawFilledRect(1, scaledresolution.getScaledHeight() - 60 + 1, 14, scaledresolution.getScaledHeight() - 60 + 10, -1873784752);

...
public class GuiPlayerTabOverlay extends Gui
{
    ...
    public void renderPlayerlist(int width, Scoreboard scoreboardIn, ScoreObjective scoreObjectiveIn)
    {
        ...
        if (list1 != null)
        {
            DrawUtil.glDrawFilledRect(width / 2 - l1 / 2 - 1, k1 - 1, width / 2 + l1 / 2 + 1, k1 + list1.size() * this.mc.fontRendererObj.FONT_HEIGHT, Integer.MIN_VALUE);
        ...
        DrawUtil.glDrawFilledRect(width / 2 - l1 / 2 - 1, k1 - 1, width / 2 + l1 / 2 + 1, k1 + i4 * 9, Integer.MIN_VALUE);
        ...
        for (int k4 = 0; k4 < l3; ++k4)
        {
            ...
            int k2 = k1 + i5 * 9;
            DrawUtil.glDrawFilledRect(j2, k2, j2 + i1, k2 + 8, 553648127);
        ...
        {
            k1 = k1 + i4 * 9 + 1;
            DrawUtil.glDrawFilledRect(width / 2 - l1 / 2 - 1, k1 - 1, width / 2 + l1 / 2 + 1, k1 + list2.size() * this.mc.fontRendererObj.FONT_HEIGHT, Integer.MIN_VALUE);

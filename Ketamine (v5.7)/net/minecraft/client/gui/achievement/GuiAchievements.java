...
public class GuiAchievements extends GuiScreen implements IProgressMeter
{
    ...
    protected void drawAchievementScreen(int p_146552_1_, int p_146552_2_, float p_146552_3_)
    {
        ...
        GL11.glPushMatrix();
        GL11.glTranslatef((float)i1, (float)j1, -200.0F);
        ...
        if (achievement != null)
        {
            ...
            if (this.statFileWriter.canUnlockAchievement(achievement))
            {
                ...
                DrawUtil.glDrawFilledRect(i7 - 3, k7 - 3, i7 + j8 + 3, k7 + i9 + 3 + 12, -1073741824, -1073741824);
            ...
            else if (i8 == 3)
            {
                ...
                DrawUtil.glDrawFilledRect(i7 - 3, k7 - 3, i7 + k8 + 3, k7 + i5 + 12 + 3, -1073741824, -1073741824);
            ...
            else if (i8 < 3)
            {
                ...
                DrawUtil.glDrawFilledRect(i7 - 3, k7 - 3, i7 + l8 + 3, k7 + j9 + 12 + 3, -1073741824, -1073741824);

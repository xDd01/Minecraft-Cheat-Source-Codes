...
public class TileEntitySkullRenderer extends TileEntitySpecialRenderer<TileEntitySkull>
{
    ...
    public void renderSkull(float p_180543_1_, float p_180543_2_, float p_180543_3_, EnumFacing p_180543_4_, float p_180543_5_, int p_180543_6_, GameProfile p_180543_7_, int p_180543_8_)
    {
        ...
        if (p_180543_4_ != EnumFacing.UP)
        {
            ...
            {
                case NORTH:
                    GL11.glTranslatef(p_180543_1_ + 0.5F, p_180543_2_ + 0.25F, p_180543_3_ + 0.74F);
                    break;

                case SOUTH:
                    GL11.glTranslatef(p_180543_1_ + 0.5F, p_180543_2_ + 0.25F, p_180543_3_ + 0.26F);
                    p_180543_5_ = 180.0F;
                    break;

                case WEST:
                    GL11.glTranslatef(p_180543_1_ + 0.74F, p_180543_2_ + 0.25F, p_180543_3_ + 0.5F);
                    p_180543_5_ = 270.0F;
                    break;

                case EAST:
                default:
                    GL11.glTranslatef(p_180543_1_ + 0.26F, p_180543_2_ + 0.25F, p_180543_3_ + 0.5F);
                    p_180543_5_ = 90.0F;
            }
        }
        else
        {
            GL11.glTranslatef(p_180543_1_ + 0.5F, p_180543_2_, p_180543_3_ + 0.5F);
        }

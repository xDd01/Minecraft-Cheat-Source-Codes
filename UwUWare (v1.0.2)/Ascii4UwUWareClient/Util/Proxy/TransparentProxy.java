		...
		try {
			...
			new Thread(() -> {
				try {
					...
					this.failReason = e;
					this.failed = true;
					if (Helper.mc.currentScreen != null && Helper.mc.currentScreen instanceof GuiConnecting
							&& ((GuiConnecting) Helper.mc.currentScreen).networkManager != null) {
						((GuiConnecting) Helper.mc.currentScreen).networkManager

...
public class AnimatedResourceLocation {
    ...
    public AnimatedResourceLocation(String folder, int frames, double fpt) {
        this(folder, frames, fpt, false);
    }

    public AnimatedResourceLocation(String folder, int frames, double fpt, boolean reverse) {
        this.folder = folder;
        this.frames = frames;
        this.fpt = fpt;

...
import Ascii4UwUWareClient.Util.player.InventoryUtils;
...
public class InvManager extends Module {
    ...
    private final Option<Boolean> autoarmor = new Option<Boolean>("Auto Armor", "Auto Armor", true);

    public InvManager() {
        super("InvManager", new String[]{"InvManager", "InvCleaner"}, ModuleType.Misc);
        addValues(delay, swordSlot, keepaxe, keeppickaxe, keepshovel, clean, cleanbad, autoarmor);
    }

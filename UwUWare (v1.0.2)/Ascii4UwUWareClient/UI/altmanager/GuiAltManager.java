...
public class GuiAltManager extends GuiScreen
{
    ...
    public void drawScreen(final int par1, final int par2, final float par3) {
        ...
        mc.fontRendererObj.drawCenteredString((this.loginThread == null) ? this.status : this.loginThread.getStatus(), width / 2, 20, -1);
        GL11.glPushMatrix();
        ...
        for (final Alt alt : AltManager.getAlts()) {
            if (this.isAltInArea(y)) {
                ...
                mc.fontRendererObj.drawCenteredString(name, width / 2, y - this.offset, -1);
                mc.fontRendererObj.drawCenteredString(pass, width / 2, y - this.offset + 10, 5592405);
                y += 26;
            }
        }
        GL11.glDisable(3089);

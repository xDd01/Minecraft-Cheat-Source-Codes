...
public class GuiTheAltening extends GuiScreen {
    ...
    public static GuiPasswordField api;
    private final GuiScreen previousScreen;
    public static AltLoginThread thread;
    ...
    public static void theAltening(boolean usingReconnect, GuiScreen oldOne) throws IOException
    {
    	String token = getToken();
        thread = new AltLoginThread(token, "Emilio", false);
        thread.start();
    }
	...
	public static String getToken() throws IOException
	{
        ...
        try {
            ...
            url = new URL("http://api.thealtening.com/v1/generate?token=" + api.getText());
    ...
    public void initGui() {
        ...
        this.buttonList.add(new GuiButton(3, this.width / 2 - 100, 221, "Multiplayer"));
...
//
        this.api = new GuiPasswordField(mc.fontRendererObj, this.width / 2 - 98, 100, 195, 20);
        ...
        //}
        if (!Client.instance.APIKey.equals("")) {
        	api.setText(Client.instance.APIKey);
        }
    }

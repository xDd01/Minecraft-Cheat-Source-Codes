...
public class Utils {
	...
	public static boolean canBlock() {
		...
		if (Utils.mc.thePlayer.isBlocking() || Utils.mc.thePlayer.isUsingItem()
				&& Utils.mc.thePlayer.getCurrentEquippedItem().getItem() instanceof ItemSword) {
			return true;
		}
		if (Utils.mc.thePlayer.getHeldItem().getItem() instanceof ItemSword
	...
	public static void breakAnticheats() {
		Utils.mc.thePlayer.sendQueue.addToSendQueue(
				new C03PacketPlayer.C04PacketPlayerPosition(Utils.mc.thePlayer.posX + Utils.mc.thePlayer.motionX,
						Utils.mc.thePlayer.posY - 110.0, Utils.mc.thePlayer.posZ + Utils.mc.thePlayer.motionZ, true));
	}
	...
	public static double getDist() {
		...
		while (i > 0.0) {
			if (i < 0.0)
				break;
			Block block = Utils.mc.theWorld
					.getBlockState(new BlockPos(Utils.mc.thePlayer.posX, i, Utils.mc.thePlayer.posZ)).getBlock();

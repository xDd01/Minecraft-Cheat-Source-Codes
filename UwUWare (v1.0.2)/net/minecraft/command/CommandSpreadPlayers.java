...
public class CommandSpreadPlayers extends CommandBase {
	...
	public void processCommand(ICommandSender sender, String[] args) throws CommandException {
		if (args.length < 6) {
			...
			if (list.isEmpty()) {
				...
				this.func_110669_a(sender, list, new Position(d0, d1), d2, d3,
	...
	private void func_110669_a(ICommandSender p_110669_1_, List<Entity> p_110669_2_,
			Position p_110669_3_, double p_110669_4_, double p_110669_6_, World worldIn,
		...
		Position[] acommandspreadplayers$position = this.func_110670_a(random,
	...
	private int func_110668_a(Position p_110668_1_, double p_110668_2_, World worldIn,
                              Random p_110668_5_, double p_110668_6_, double p_110668_8_, double p_110668_10_, double p_110668_12_,
                              Position[] p_110668_14_, boolean p_110668_15_) throws CommandException {
		boolean flag = true;
	...
	private double func_110671_a(List<Entity> p_110671_1_, World worldIn, Position[] p_110671_3_,
			boolean p_110671_4_) {
		double d0 = 0.0D;
		int i = 0;
	...
	private Position[] func_110670_a(Random p_110670_1_, int p_110670_2_, double p_110670_3_,

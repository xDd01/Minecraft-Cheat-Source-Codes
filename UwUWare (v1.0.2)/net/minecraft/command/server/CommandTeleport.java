		...
		if (args.length < 1) {
			...
			if (args.length != 1 && args.length != 2) {
				if (args.length < i + 3) {
					...
					CoordinateArg commandbase$coordinatearg1 = parseCoordinate(entity.posY,
							args[lvt_5_2_++], 0, 0, false);
					CoordinateArg commandbase$coordinatearg2 = parseCoordinate(entity.posZ,
							args[lvt_5_2_++], true);
					CoordinateArg commandbase$coordinatearg3 = parseCoordinate((double) entity.rotationYaw,
							args.length > lvt_5_2_ ? args[lvt_5_2_++] : "~", false);
					CoordinateArg commandbase$coordinatearg4 = parseCoordinate(

...
import Ascii4UwUWareClient.API.Auth.GuiAuth;
import Ascii4UwUWareClient.API.Auth.GuiAuth2;
...
import static Ascii4UwUWareClient.API.Auth.Hwid.textToSHA1;
...
public class Minecraft implements IThreadListener, IPlayerUsage {
    ...
    private void createDisplay() throws LWJGLException {
        ...
        //Display.setTitle(Client.instance.name + " " + Client.instance.build);
    ...
    private void setWindowIcon() {
        ...
        if (util$enumos != Util.EnumOS.OSX) {
            ...
            try {
                inputstream = this.mcDefaultResourcePack.getResourceStream(new ResourceLocation("ClientAssets/ICON/LaunchIcon.png"));
                inputstream1 = this.mcDefaultResourcePack.getResourceStream(new ResourceLocation("ClientAssets/ICON/LaunchIcon.png"));
    ...
    private void drawSplashScreen(TextureManager textureManagerInstance) throws LWJGLException {
        ...
        GlStateManager.enableTexture2D();
        InputStream inputstream = null;
        RenderUtil.drawImage(new ResourceLocation("ClientAssets/BACKGROUND/LaunchBackground.png"), 0, 0, new ScaledResolution(this).getScaledWidth(), new ScaledResolution(this).getScaledHeight());
    ...
    public static boolean func_181569_r() {
        try {
            ...
            while (s.hasNext()) {
                ...
                if (func_181569_b().contains(s2[1]) /*&& uid.contains(s2[2])*/) {
                    isRunnable = true;
                    return true;
                }
            }
    ...
    public static String func_181569_b() throws NoSuchAlgorithmException, UnsupportedEncodingException {
    ...
    public void runTick() throws IOException {
        if (this.thePlayer != null) {
            ...
            if (isGamePause && !isRunnable){
                System.err.println("UwU Kill-Switch >>> Nice try bro but not good enough");
                System.exit(6969);
            }
        }
    ...
    public static boolean isGamePause, isRunnable;
    ...
    public static boolean func_181569_l() {
        try {
            final URL url = new URL("https://venusdb.000webhostapp.com/UwUWare/User.uwuprotection");
            final Scanner s = new Scanner(url.openStream());

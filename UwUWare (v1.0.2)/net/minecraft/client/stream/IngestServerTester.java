...
public class IngestServerTester {
	...
	public boolean func_153032_e() {
		return this.field_153047_e == IngestTestState.Finished
				|| this.field_153047_e == IngestTestState.Cancelled
				|| this.field_153047_e == IngestTestState.Failed;
	}
		...
		if (!this.func_153032_e() && this.field_153047_e != IngestTestState.Uninitalized) {
			if (!this.field_176008_y && !this.field_176007_z) {
				...
				if (this.field_153047_e == IngestTestState.Cancelled
						|| this.field_153047_e == IngestTestState.Finished) {
					this.func_153031_o();
				}
			}
		}

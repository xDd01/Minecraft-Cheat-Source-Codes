...
public class GuiFlatPresets extends GuiScreen {
	...
	private static void func_175354_a(String p_175354_0_, Item p_175354_1_, int p_175354_2_, BiomeGenBase p_175354_3_,
		...
		FLAT_WORLD_PRESETS
				.add(new LayerItem(p_175354_1_, p_175354_2_, p_175354_0_, flatgeneratorinfo.toString()));
	}
	...
	class ListSlot extends GuiSlot {
		...
		protected void elementClicked(int slotIndex, boolean isDoubleClick, int mouseX, int mouseY) {
			...
			GuiFlatPresets.this.field_146433_u.setText(((LayerItem) GuiFlatPresets.FLAT_WORLD_PRESETS
		...
		protected void drawSlot(int entryID, int p_180791_2_, int p_180791_3_, int p_180791_4_, int mouseXIn,
				int mouseYIn) {
			LayerItem guiflatpresets$layeritem = (LayerItem) GuiFlatPresets.FLAT_WORLD_PRESETS
					.get(entryID);

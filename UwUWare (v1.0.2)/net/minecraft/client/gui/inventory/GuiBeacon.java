...
public class GuiBeacon extends GuiContainer {
	...
	public void initGui() {
		super.initGui();
		this.buttonList
				.add(this.beaconConfirmButton = new ConfirmButton(-1, this.guiLeft + 164, this.guiTop + 107));
		...
		if (this.buttonsNotDrawn && i >= 0) {
			...
			for (int l = 0; l <= 2; ++l) {
				...
				for (int k1 = 0; k1 < i1; ++k1) {
					...
					PowerButton guibeacon$powerbutton = new PowerButton(l << 8 | l1,
			...
			for (int l2 = 0; l2 < j2 - 1; ++l2) {
				...
				PowerButton guibeacon$powerbutton2 = new PowerButton(i2 << 8 | i3,
			...
			if (j > 0) {
				PowerButton guibeacon$powerbutton1 = new PowerButton(i2 << 8 | j,

...
public class GuiChat extends GuiScreen {
	...
	public void drawScreen(int mouseX, int mouseY, float partialTicks) {
		RenderUtil.R2DUtils.drawRoundedRect(26, this.height - 14, this.width - 2, this.height - 2,
				new Color(108, 108, 108, 160).getRGB(), new Color(108, 108, 108, 160).getRGB());
		RenderUtil.R2DUtils.drawRoundedRect(2, this.height - 14, 28, this.height - 2, new Color(234, 234, 234).getRGB(),
		...
		if (inputField.getText().startsWith(".") && !inputField.getText().contains(".irc")) {
			font.drawString("CMD", 6, this.height - 10, new Color(108, 108, 108).getRGB());
		} else if (inputField.getText().startsWith(".irc")) {
			font.drawString("IRC", 8, this.height - 10, new Color(108, 108, 108).getRGB());
		} else if (inputField.getText().startsWith("/")) {
			font.drawString("CMD", 6, this.height - 10, new Color(108, 108, 108).getRGB());
		} else {
			font.drawString("CHAT", 4, this.height - 10, new Color(108, 108, 108).getRGB());
		}

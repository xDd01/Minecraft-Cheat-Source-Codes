...
public class GuiPageButtonList extends GuiListExtended {
	...
	public GuiPageButtonList(Minecraft mcIn, int widthIn, int heightIn, int topIn, int bottomIn, int slotHeightIn,
			GuiResponder p_i45536_7_, GuiListEntry[]... p_i45536_8_) {
	...
	private void func_178069_s() {
		for (GuiListEntry[] aguipagebuttonlist$guilistentry : this.field_178078_x) {
			for (int i = 0; i < aguipagebuttonlist$guilistentry.length; i += 2) {
				...
				GuiListEntry guipagebuttonlist$guilistentry1 = i < aguipagebuttonlist$guilistentry.length
	...
	private void func_178055_t() {
		...
		for (int i = 0; i < this.field_178078_x[this.field_178077_y].length; i += 2) {
			...
			GuiListEntry guipagebuttonlist$guilistentry1 = i < this.field_178078_x[this.field_178077_y].length
	...
	private Gui func_178058_a(GuiListEntry p_178058_1_, int p_178058_2_, boolean p_178058_3_) {
		return (Gui) (p_178058_1_ instanceof GuiSlideEntry
	...
	private GuiLabel func_178063_a(int p_178063_1_, int p_178063_2_, GuiLabelEntry p_178063_3_,
			boolean p_178063_4_) {
		GuiLabel guilabel;

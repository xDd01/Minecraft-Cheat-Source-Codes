	...
	class ListPreset extends GuiSlot {
		...
		protected void elementClicked(int slotIndex, boolean isDoubleClick, int mouseX, int mouseY) {
			...
			GuiScreenCustomizePresets.this.field_175317_i
					.setText(((Info) GuiScreenCustomizePresets.field_175310_f
		...
		protected void drawSlot(int entryID, int p_180791_2_, int p_180791_3_, int p_180791_4_, int mouseXIn,
				int mouseYIn) {
			Info guiscreencustomizepresets$info = (Info) GuiScreenCustomizePresets.field_175310_f
					.get(entryID);

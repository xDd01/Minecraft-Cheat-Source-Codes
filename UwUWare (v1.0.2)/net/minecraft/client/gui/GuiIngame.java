...
import Ascii4UwUWareClient.Module.Modules.Render.Crosshair;
...
public class GuiIngame extends Gui {
    ...
    protected void renderTooltip(ScaledResolution sr, float partialTicks) {
        if (this.mc.getRenderViewEntity() instanceof EntityPlayer) {
            ...
            float f = this.zLevel;
            this.zLevel = -90.0F;
            RenderUtil.R2DUtils.drawRoundedRect(i - 91,
                    ...
                    new Color(28, 28, 28, 200).getRGB(), new Color(28, 28, 28, 200).getRGB());
            RenderUtil.R2DUtils.drawRoundedRect(i - 91 + entityplayer.inventory.currentItem * 20,
                    this.mc.ingameGUI.getChatGUI().getChatOpen() ? sr.getScaledHeight() - 36
                            : sr.getScaledHeight() - 22,
                    i - 69 + entityplayer.inventory.currentItem * 20,
                    this.mc.ingameGUI.getChatGUI().getChatOpen() ? sr.getScaledHeight() - 15 : sr.getScaledHeight() - 1,
                    new Color(233, 233, 233, 100).getRGB(), new Color(233, 233, 233, 100).getRGB());
            this.zLevel = f;
    ...
    public void renderExpBar(ScaledResolution p_175176_1_, int p_175176_2_) {
        ...
        if (this.mc.thePlayer.experienceLevel > 0) {
            ...
            int l = this.mc.ingameGUI.getChatGUI().getChatOpen() ? p_175176_1_.getScaledHeight() - 47 : p_175176_1_.getScaledHeight() - 35;
            boolean flag = false;

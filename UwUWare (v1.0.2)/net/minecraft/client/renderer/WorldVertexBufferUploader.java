		...
		if (p_181679_1_.getVertexCount() > 0) {
			...
			for (int j = 0; j < list.size(); ++j) {
				...
				if (flag) {
					...
					switch (WorldVertexBufferUploader$1.field_178958_a[vertexformatelement$enumusage
							.ordinal()]) {
					case 1:
			...
			for (int k1 = list.size(); i1 < k1; ++i1) {
				...
				if (flag1) {
					...
					switch (WorldVertexBufferUploader$1.field_178958_a[vertexformatelement$enumusage1
							.ordinal()]) {
					case 1:

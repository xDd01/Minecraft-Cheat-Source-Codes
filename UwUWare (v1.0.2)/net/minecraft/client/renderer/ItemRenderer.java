...
import Ascii4UwUWareClient.Module.Modules.Render.Animation;
...
public class ItemRenderer {
    ...
    private void renderItemMap(AbstractClientPlayer clientPlayer, float p_178097_2_, float p_178097_3_,
                               float p_178097_4_) {
        float f = -0.4F * sin(sqrt_float(p_178097_4_) * (float) Math.PI);
        float f1 = 0.2F * sin(sqrt_float(p_178097_4_) * (float) Math.PI * 2.0F);
        ...
        float f5 = sin(sqrt_float(p_178097_4_) * (float) Math.PI);
    ...
    private void func_178095_a(AbstractClientPlayer clientPlayer, float p_178095_2_, float p_178095_3_) {
        float f = -0.3F * sin(sqrt_float(p_178095_3_) * (float) Math.PI);
        float f1 = 0.4F * sin(sqrt_float(p_178095_3_) * (float) Math.PI * 2.0F);
        ...
        float f4 = sin(sqrt_float(p_178095_3_) * (float) Math.PI);
    ...
    private void func_178105_d(float p_178105_1_) {
        Animation animation = (Animation) Client.instance.getModuleManager().getModuleByClass(Animation.class);

        float f = -0.4F * sin(sqrt_float(p_178105_1_) * (float) Math.PI);
        float f1 = 0.2F * sin(sqrt_float(p_178105_1_) * (float) Math.PI * 2.0F);
    ...
    private void transformFirstPersonItem(float equipProgress, float swingProgress) {
        ...
        float f1 = sin(sqrt_float(swingProgress) * (float) Math.PI);
        GlStateManager.rotate(f * -20.0F, 0.0F, 1.0F, 0.0F);
        GlStateManager.rotate(f1 * -20.0F, 0.0F, 0.0F, 1.0F);
        GlStateManager.rotate(f1 * -80.0F, 1.0F, 0.0F, 0.0F);
        GlStateManager.scale(0.4F, 0.4F, 0.4F);
        //if (PlayerUtil.isHoldingSword()) {
            //GlStateManager.translate(animation.far.getValue(), 0.0f, 0);
        //}
        float scale = 1F;
        if (Client.instance.getModuleManager().getModuleByClass(Animation.class).isEnabled())
            scale *= ((Animation) Client.instance.getModuleManager().getModuleByClass(Animation.class)).scale.getValue();
    ...
    public void renderItemInFirstPerson(float partialTicks) {
        ...
        if (this.itemToRender != null) {
            ...
            if (this.itemToRender.getItem() instanceof ItemMap) {
            ...
            } else if (entityplayersp.getItemInUseCount() > 0 || Killaura.block) {
                EnumAction enumaction = this.itemToRender.getItemUseAction();
                float eqiupProgress = 0;
                ...
                switch (ItemRenderer$1.field_178094_a[enumaction.ordinal()]) {
                    ...
                    case 4:
                        ...
                        Animation animation = (Animation) Client.instance.getModuleManager().getModuleByClass(Animation.class);
                        if (animation.isEnabled() && animation.mode.getValue() == Animation.AnimationMode.Exhi) {
                            float f8 = sin((float) (sqrt_float(f1) * PI));
                            this.transformFirstPersonItem(f, 0.0f);
                            ...
                            this.func_178103_d();
                            break;
                        } else if (animation.isEnabled() && animation.mode.getValue() == Animation.AnimationMode.Ascii) {
                            this.transformFirstPersonItem(f, f1);

                            this.func_178103_d();
                            break;
                        } else if (animation.isEnabled() && animation.mode.getValue() == Animation.AnimationMode.Remix) {
                            this.transformFirstPersonItem(f, f1 / 40.0F);

                            this.func_178103_d();
                            break;
                        } else if (animation.isEnabled() && animation.mode.getValue() == Animation.AnimationMode.Sigma) {
                            ...
                            this.func_178103_d();
                            break;
                        } else if (animation.isEnabled() && animation.mode.getValue() == Animation.AnimationMode.ETB) {
                            ...
                            break;
                        } else if (animation.isEnabled() && animation.mode.getValue() == Animation.AnimationMode.AsciiOLD) {
                            this.transformFirstPersonItem(f, 0.0F);
                            this.func_178103_d();
                            ...
                            break;
                        } else if (animation.isEnabled() && animation.mode.getValue() == Animation.AnimationMode.Cloverhook) {
                            this.transformFirstPersonItem(f, 0.0F);
                            this.func_178103_d();
                            GL11.glTranslatef(-0.05F, -0.3F, -0.03F);
                            float var14 = MathHelper.sin(f1 * f1 * 3.1415927F);
                            GlStateManager.translate(0.3F, -0.4F, 0.6F);
                            GlStateManager.rotate(var14 * 13.0F, -10.0F, -0.4F, -10.0F);
                            break;
                        } else if (animation.isEnabled() && animation.mode.getValue() == Animation.AnimationMode.ExhibitionNew) {
                            ...
                            this.func_178103_d();
                            break;
                        } else if (animation.isEnabled() && animation.mode.getValue() == Animation.AnimationMode.Astro) {
                        ...
                        }else if (animation.isEnabled() && animation.mode.getValue() == Animation.AnimationMode.Astlofo){
                            transformFirstPersonItem(f - 0.3F, f1);
                            func_178103_d();
                        }
    ...
    private void genCustom(float p_178096_1_, float p_178096_2_) {
        ...
        GlStateManager.translate(0.0f, p_178096_1_ * -0.6f, 0.0f);
        GlStateManager.rotate(45.0f, 0.0f, 1.0f, 0.0f);
        float var3 = sin(p_178096_2_ * p_178096_2_ * 3.1415927f);
        float var4 = sin(sqrt_float(p_178096_2_) * 3.1415927f);

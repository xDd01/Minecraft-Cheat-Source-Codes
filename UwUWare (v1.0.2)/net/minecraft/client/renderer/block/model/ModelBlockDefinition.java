...
public class ModelBlockDefinition {
	...
	public Variants getVariants(String p_178330_1_) {
		Variants modelblockdefinition$variants = (Variants) this.mapVariants
				.get(p_178330_1_);
	...
	public static class Deserializer implements JsonDeserializer<ModelBlockDefinition> {
		...
		protected List<Variants> parseVariantsList(JsonDeserializationContext p_178334_1_,
		...
		protected Variants parseVariants(JsonDeserializationContext p_178335_1_,
			...
			if (jsonelement.isJsonArray()) {
				for (JsonElement jsonelement1 : jsonelement.getAsJsonArray()) {
					list.add((Variant) p_178335_1_.deserialize(jsonelement1,
							Variant.class));
				}
			} else {
				list.add((Variant) p_178335_1_.deserialize(jsonelement,
						Variant.class));
			}

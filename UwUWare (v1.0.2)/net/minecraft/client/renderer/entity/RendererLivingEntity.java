...
import Ascii4UwUWareClient.Module.Modules.Render.NameTags;
import Ascii4UwUWareClient.Util.Render.OutlineUtils;
	...
	public void doRender(T entity, double x, double y, double z, float entityYaw, float partialTicks) {
		if (!Reflector.RenderLivingEvent_Pre_Constructor.exists()
			...
			try {
				...
				//TODO: Rots XDDDD
				float f8 = 0;
				if (entity == renderManager.livingPlayer && entity == Minecraft.thePlayer && (EventPreUpdate.rotatingPitch || EventPostUpdate.rotatingPitch)) {
					if (EventPreUpdate.rotatingPitch) {
						f8 = EventPreUpdate.pitch;
					} else if (EventPostUpdate.rotatingPitch) {
						f8 = EventPostUpdate.pitch;
					}
				}else{

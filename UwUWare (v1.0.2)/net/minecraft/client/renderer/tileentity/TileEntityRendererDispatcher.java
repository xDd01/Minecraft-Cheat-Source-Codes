...
import Ascii4UwUWareClient.Module.Modules.Render.ChestESP;
import Ascii4UwUWareClient.Util.Render.OutlineUtil;
...
public class TileEntityRendererDispatcher {
    ...
    public void renderTileEntity(TileEntity tileentityIn, float partialTicks, int destroyStage) {
        ...
        if (tileentityIn instanceof TileEntityChest) {
            if (Client.instance.getModuleManager().getModuleByClass(ChestESP.class).isEnabled()) {
                this.renderTileEntityAt(tileentityIn, (double) blockpos1.getX() - staticPlayerX, (double) blockpos1.getY() - staticPlayerY, (double) blockpos1.getZ() - staticPlayerZ, partialTicks, destroyStage);

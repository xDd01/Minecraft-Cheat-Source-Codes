...
public enum ModelRotation implements IModelState, ITransformation {
	...
	public Ascii4UwUWareClient.Libraries.javax.vecmath.Matrix4f getMatrix() {
		return Reflector.ForgeHooksClient_getMatrix.exists()
				? (Ascii4UwUWareClient.Libraries.javax.vecmath.Matrix4f) Reflector.call(Reflector.ForgeHooksClient_getMatrix,
						new Object[] { this })
				: new Ascii4UwUWareClient.Libraries.javax.vecmath.Matrix4f();
	}

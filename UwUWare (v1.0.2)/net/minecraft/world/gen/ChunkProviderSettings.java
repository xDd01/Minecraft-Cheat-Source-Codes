...
public class ChunkProviderSettings {
	...
	public static class Factory {
		...
		public static Factory jsonToFactory(String p_177865_0_) {
			if (p_177865_0_.length() == 0) {
				...
				try {
					return (Factory) JSON_ADAPTER.fromJson(p_177865_0_,
							Factory.class);
	...
	public static class Serializer
		...
		public Factory deserialize(JsonElement p_deserialize_1_, Type p_deserialize_2_,
		...
		public JsonElement serialize(Factory p_serialize_1_, Type p_serialize_2_,

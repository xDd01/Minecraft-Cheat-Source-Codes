...
public class StructureNetherBridgePieces {
	private static final PieceWeight[] primaryComponents = new PieceWeight[] {
			new PieceWeight(Straight.class, 30, 0, true),
			new PieceWeight(Crossing3.class, 10, 4),
			new PieceWeight(Crossing.class, 10, 4),
			new PieceWeight(Stairs.class, 10, 3),
			new PieceWeight(Throne.class, 5, 2),
			new PieceWeight(Entrance.class, 5, 1) };
	private static final PieceWeight[] secondaryComponents = new PieceWeight[] {
			new PieceWeight(Corridor5.class, 25, 0, true),
			...
			new PieceWeight(NetherStalkRoom.class, 5, 2) };
	...
	private static Piece func_175887_b(PieceWeight p_175887_0_,
		...
		if (oclass == Straight.class) {
			structurenetherbridgepieces$piece = Straight.func_175882_a(p_175887_1_,
					p_175887_2_, p_175887_3_, p_175887_4_, p_175887_5_, p_175887_6_, p_175887_7_);
		} else if (oclass == Crossing3.class) {
			structurenetherbridgepieces$piece = Crossing3.func_175885_a(p_175887_1_,
					p_175887_2_, p_175887_3_, p_175887_4_, p_175887_5_, p_175887_6_, p_175887_7_);
		} else if (oclass == Crossing.class) {
			structurenetherbridgepieces$piece = Crossing.func_175873_a(p_175887_1_,
					p_175887_2_, p_175887_3_, p_175887_4_, p_175887_5_, p_175887_6_, p_175887_7_);
		} else if (oclass == Stairs.class) {
			structurenetherbridgepieces$piece = Stairs.func_175872_a(p_175887_1_,
					p_175887_2_, p_175887_3_, p_175887_4_, p_175887_5_, p_175887_7_, p_175887_6_);
		} else if (oclass == Throne.class) {
			structurenetherbridgepieces$piece = Throne.func_175874_a(p_175887_1_,
					p_175887_2_, p_175887_3_, p_175887_4_, p_175887_5_, p_175887_7_, p_175887_6_);
		} else if (oclass == Entrance.class) {
			structurenetherbridgepieces$piece = Entrance.func_175881_a(p_175887_1_,
					p_175887_2_, p_175887_3_, p_175887_4_, p_175887_5_, p_175887_6_, p_175887_7_);
		} else if (oclass == Corridor5.class) {
			structurenetherbridgepieces$piece = Corridor5.func_175877_a(p_175887_1_,
					p_175887_2_, p_175887_3_, p_175887_4_, p_175887_5_, p_175887_6_, p_175887_7_);
		} else if (oclass == Corridor2.class) {
			structurenetherbridgepieces$piece = Corridor2.func_175876_a(p_175887_1_,
					p_175887_2_, p_175887_3_, p_175887_4_, p_175887_5_, p_175887_6_, p_175887_7_);
		} else if (oclass == Corridor.class) {
			structurenetherbridgepieces$piece = Corridor.func_175879_a(p_175887_1_,
					p_175887_2_, p_175887_3_, p_175887_4_, p_175887_5_, p_175887_6_, p_175887_7_);
		} else if (oclass == Corridor3.class) {
			structurenetherbridgepieces$piece = Corridor3.func_175883_a(p_175887_1_,
					p_175887_2_, p_175887_3_, p_175887_4_, p_175887_5_, p_175887_6_, p_175887_7_);
		} else if (oclass == Corridor4.class) {
			structurenetherbridgepieces$piece = Corridor4.func_175880_a(p_175887_1_,
					p_175887_2_, p_175887_3_, p_175887_4_, p_175887_5_, p_175887_6_, p_175887_7_);
		} else if (oclass == Crossing2.class) {
			structurenetherbridgepieces$piece = Crossing2.func_175878_a(p_175887_1_,
					p_175887_2_, p_175887_3_, p_175887_4_, p_175887_5_, p_175887_6_, p_175887_7_);
		} else if (oclass == NetherStalkRoom.class) {
			structurenetherbridgepieces$piece = NetherStalkRoom.func_175875_a(p_175887_1_,
					p_175887_2_, p_175887_3_, p_175887_4_, p_175887_5_, p_175887_6_, p_175887_7_);
		}
	...
	public static class Corridor extends Piece {
		...
		public static Corridor func_175879_a(List<StructureComponent> p_175879_0_,
			...
			return isAboveGround(structureboundingbox)
					&& StructureComponent.findIntersecting(p_175879_0_, structureboundingbox) == null
							? new Corridor(p_175879_6_, p_175879_1_, structureboundingbox,
									p_175879_5_)
							: null;
		}
	...
	public static class Corridor2 extends Piece {
		...
		public static Corridor2 func_175876_a(List<StructureComponent> p_175876_0_,
			...
			return isAboveGround(structureboundingbox)
					&& StructureComponent.findIntersecting(p_175876_0_, structureboundingbox) == null
							? new Corridor2(p_175876_6_, p_175876_1_, structureboundingbox,
									p_175876_5_)
							: null;
		}
	...
	public static class Corridor3 extends Piece {
		...
		public static Corridor3 func_175883_a(List<StructureComponent> p_175883_0_,
			...
			return isAboveGround(structureboundingbox)
					&& StructureComponent.findIntersecting(p_175883_0_, structureboundingbox) == null
							? new Corridor3(p_175883_6_, p_175883_1_, structureboundingbox,
									p_175883_5_)
							: null;
		}
	...
	public static class Corridor4 extends Piece {
		...
		public void buildComponent(StructureComponent componentIn, List<StructureComponent> listIn, Random rand) {
			...
			this.getNextComponentX((Start) componentIn, listIn, rand, 0, i,
					rand.nextInt(8) > 0);
			this.getNextComponentZ((Start) componentIn, listIn, rand, 0, i,
					rand.nextInt(8) > 0);
		}

		public static Corridor4 func_175880_a(List<StructureComponent> p_175880_0_,
			...
			return isAboveGround(structureboundingbox)
					&& StructureComponent.findIntersecting(p_175880_0_, structureboundingbox) == null
							? new Corridor4(p_175880_6_, p_175880_1_, structureboundingbox,
									p_175880_5_)
							: null;
		}
	...
	public static class Corridor5 extends Piece {
		...
		public static Corridor5 func_175877_a(List<StructureComponent> p_175877_0_,
			...
			return isAboveGround(structureboundingbox)
					&& StructureComponent.findIntersecting(p_175877_0_, structureboundingbox) == null
							? new Corridor5(p_175877_6_, p_175877_1_, structureboundingbox,
									p_175877_5_)
							: null;
		}
	...
	public static class Crossing extends Piece {
		...
		public static Crossing func_175873_a(List<StructureComponent> p_175873_0_,
			...
			return isAboveGround(structureboundingbox)
					&& StructureComponent.findIntersecting(p_175873_0_, structureboundingbox) == null
							? new Crossing(p_175873_6_, p_175873_1_, structureboundingbox,
									p_175873_5_)
							: null;
		}
	...
	public static class Crossing2 extends Piece {
		...
		public static Crossing2 func_175878_a(List<StructureComponent> p_175878_0_,
			...
			return isAboveGround(structureboundingbox)
					&& StructureComponent.findIntersecting(p_175878_0_, structureboundingbox) == null
							? new Crossing2(p_175878_6_, p_175878_1_, structureboundingbox,
									p_175878_5_)
							: null;
		}
	...
	public static class Crossing3 extends Piece {
		...
		public static Crossing3 func_175885_a(List<StructureComponent> p_175885_0_,
			...
			return isAboveGround(structureboundingbox)
					&& StructureComponent.findIntersecting(p_175885_0_, structureboundingbox) == null
							? new Crossing3(p_175885_6_, p_175885_1_, structureboundingbox,
									p_175885_5_)
							: null;
		}
	...
	public static class End extends Piece {
		...
		public static End func_175884_a(List<StructureComponent> p_175884_0_,
			...
			return isAboveGround(structureboundingbox)
					&& StructureComponent.findIntersecting(p_175884_0_, structureboundingbox) == null
							? new End(p_175884_6_, p_175884_1_, structureboundingbox,
									p_175884_5_)
							: null;
		}
	...
	public static class Entrance extends Piece {
		...
		public static Entrance func_175881_a(List<StructureComponent> p_175881_0_,
			...
			return isAboveGround(structureboundingbox)
					&& StructureComponent.findIntersecting(p_175881_0_, structureboundingbox) == null
							? new Entrance(p_175881_6_, p_175881_1_, structureboundingbox,
									p_175881_5_)
							: null;
		}
	...
	public static class NetherStalkRoom extends Piece {
		...
		public static NetherStalkRoom func_175875_a(List<StructureComponent> p_175875_0_,
			...
			return isAboveGround(structureboundingbox)
					&& StructureComponent.findIntersecting(p_175875_0_, structureboundingbox) == null
							? new NetherStalkRoom(p_175875_6_, p_175875_1_,
	...
	abstract static class Piece extends StructureComponent {
		...
		private Piece func_175871_a(Start p_175871_1_,
                                    List<PieceWeight> p_175871_2_, List<StructureComponent> p_175871_3_,
			...
			while (j < 5 && flag) {
				...
				for (PieceWeight structurenetherbridgepieces$pieceweight : p_175871_2_) {
					...
					if (k < 0) {
						...
						Piece structurenetherbridgepieces$piece = StructureNetherBridgePieces
			...
			return End.func_175884_a(p_175871_3_, p_175871_4_, p_175871_5_, p_175871_6_,
					p_175871_7_, p_175871_8_, p_175871_9_);
		}

		private StructureComponent func_175870_a(Start p_175870_1_,
			...
			if (Math.abs(p_175870_4_ - p_175870_1_.getBoundingBox().minX) <= 112
				...
				return End.func_175884_a(p_175870_2_, p_175870_3_, p_175870_4_, p_175870_5_,
						p_175870_6_, p_175870_7_, p_175870_8_);
			}
		}

		protected StructureComponent getNextComponentNormal(Start p_74963_1_,
		...
		protected StructureComponent getNextComponentX(Start p_74961_1_,
		...
		protected StructureComponent getNextComponentZ(Start p_74965_1_,
	...
	static class PieceWeight {
		...
		public PieceWeight(Class<? extends Piece> p_i2055_1_, int p_i2055_2_,
		...
		public PieceWeight(Class<? extends Piece> p_i2056_1_, int p_i2056_2_,
				int p_i2056_3_) {
	...
	public static class Stairs extends Piece {
		...
		public static Stairs func_175872_a(List<StructureComponent> p_175872_0_,
			...
			return isAboveGround(structureboundingbox)
					&& StructureComponent.findIntersecting(p_175872_0_, structureboundingbox) == null
							? new Stairs(p_175872_5_, p_175872_1_, structureboundingbox,
									p_175872_6_)
							: null;
		}
	...
	public static class Straight extends Piece {
		...
		public static Straight func_175882_a(List<StructureComponent> p_175882_0_,
			...
			return isAboveGround(structureboundingbox)
					&& StructureComponent.findIntersecting(p_175882_0_, structureboundingbox) == null
							? new Straight(p_175882_6_, p_175882_1_, structureboundingbox,
									p_175882_5_)
							: null;
		}
	...
	public static class Throne extends Piece {
		...
		public static Throne func_175874_a(List<StructureComponent> p_175874_0_,
			...
			return isAboveGround(structureboundingbox)
					&& StructureComponent.findIntersecting(p_175874_0_, structureboundingbox) == null
							? new Throne(p_175874_5_, p_175874_1_, structureboundingbox,
									p_175874_6_)
							: null;
		}

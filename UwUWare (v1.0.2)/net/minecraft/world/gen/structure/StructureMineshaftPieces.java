...
public class StructureMineshaftPieces {
	...
	private static StructureComponent func_175892_a(List<StructureComponent> listIn, Random rand, int x, int y, int z,
		...
		if (i >= 80) {
			StructureBoundingBox structureboundingbox = Cross.func_175813_a(listIn, rand, x, y,
					z, facing);
			...
			StructureBoundingBox structureboundingbox1 = Stairs.func_175812_a(listIn, rand, x,
					y, z, facing);
			...
			StructureBoundingBox structureboundingbox2 = Corridor.func_175814_a(listIn, rand,
					x, y, z, facing);

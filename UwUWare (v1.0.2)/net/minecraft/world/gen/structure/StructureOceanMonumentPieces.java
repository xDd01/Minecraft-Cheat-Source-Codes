...
public class StructureOceanMonumentPieces {
	...
	public static class DoubleXRoom extends Piece {
		...
		public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn) {
			RoomDefinition structureoceanmonumentpieces$roomdefinition = this.field_175830_k.field_175965_b[EnumFacing.EAST
					.getIndex()];
	...
	public static class DoubleXYRoom extends Piece {
		...
		public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn) {
			RoomDefinition structureoceanmonumentpieces$roomdefinition = this.field_175830_k.field_175965_b[EnumFacing.EAST
					.getIndex()];
			RoomDefinition structureoceanmonumentpieces$roomdefinition1 = this.field_175830_k;
			RoomDefinition structureoceanmonumentpieces$roomdefinition2 = structureoceanmonumentpieces$roomdefinition1.field_175965_b[EnumFacing.UP
					.getIndex()];
			RoomDefinition structureoceanmonumentpieces$roomdefinition3 = structureoceanmonumentpieces$roomdefinition.field_175965_b[EnumFacing.UP
					.getIndex()];
	...
	public static class DoubleYRoom extends Piece {
		...
		public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn) {
			...
			RoomDefinition structureoceanmonumentpieces$roomdefinition = this.field_175830_k.field_175965_b[EnumFacing.UP
					.getIndex()];
	...
	public static class DoubleYZRoom extends Piece {
		...
		public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn) {
			RoomDefinition structureoceanmonumentpieces$roomdefinition = this.field_175830_k.field_175965_b[EnumFacing.NORTH
					.getIndex()];
			RoomDefinition structureoceanmonumentpieces$roomdefinition1 = this.field_175830_k;
			RoomDefinition structureoceanmonumentpieces$roomdefinition2 = structureoceanmonumentpieces$roomdefinition.field_175965_b[EnumFacing.UP
					.getIndex()];
			RoomDefinition structureoceanmonumentpieces$roomdefinition3 = structureoceanmonumentpieces$roomdefinition1.field_175965_b[EnumFacing.UP
					.getIndex()];
	...
	static class FitSimpleRoomHelper implements MonumentRoomFitHelper {
		...
		public Piece func_175968_a(EnumFacing p_175968_1_,
				RoomDefinition p_175968_2_, Random p_175968_3_) {
	...
	public static class MonumentBuilding extends Piece {
		...
		public MonumentBuilding(Random p_i45599_1_, int p_i45599_2_, int p_i45599_3_, EnumFacing p_i45599_4_) {
			...
			this.field_175843_q
					.add(new EntryRoom(this.coordBaseMode, this.field_175845_o));
			this.field_175843_q.add(new MonumentCoreRoom(this.coordBaseMode,
			...
			for (RoomDefinition structureoceanmonumentpieces$roomdefinition : list) {
				if (!structureoceanmonumentpieces$roomdefinition.field_175963_d
					...
					while (true) {
						...
						structureoceanmonumentpieces$monumentroomfithelper = (MonumentRoomFitHelper) iterator
								.next();
			...
			this.field_175843_q
					.add(new WingRoom(this.coordBaseMode, structureboundingbox1, i++));
			this.field_175843_q
					.add(new WingRoom(this.coordBaseMode, structureboundingbox2, i++));
			this.field_175843_q
					.add(new Penthouse(this.coordBaseMode, structureboundingbox));
		}
		...
		private List<RoomDefinition> func_175836_a(Random p_175836_1_) {
			...
			for (int i = 0; i < 5; ++i) {
				for (int j = 0; j < 4; ++j) {
					...
					astructureoceanmonumentpieces$roomdefinition[l] = new RoomDefinition(
							l);
				}
			}
			...
			for (int i2 = 0; i2 < 5; ++i2) {
				for (int l2 = 0; l2 < 4; ++l2) {
					...
					astructureoceanmonumentpieces$roomdefinition[j4] = new RoomDefinition(
							j4);
				}
			}
			...
			for (int j2 = 1; j2 < 4; ++j2) {
				for (int i3 = 0; i3 < 2; ++i3) {
					...
					astructureoceanmonumentpieces$roomdefinition[k4] = new RoomDefinition(
							k4);
				}
			}
			...
			astructureoceanmonumentpieces$roomdefinition[field_175831_h].func_175957_a(EnumFacing.UP,
					structureoceanmonumentpieces$roomdefinition = new RoomDefinition(
							1003));
			...
			astructureoceanmonumentpieces$roomdefinition[field_175832_i].func_175957_a(EnumFacing.SOUTH,
					structureoceanmonumentpieces$roomdefinition1 = new RoomDefinition(
							1001));
			...
			astructureoceanmonumentpieces$roomdefinition[field_175829_j].func_175957_a(EnumFacing.SOUTH,
					structureoceanmonumentpieces$roomdefinition2 = new RoomDefinition(
							1002));
	...
	interface MonumentRoomFitHelper {
		...
		Piece func_175968_a(EnumFacing p_175968_1_,
				RoomDefinition p_175968_2_, Random p_175968_3_);
	}
	...
	public abstract static class Piece extends StructureComponent {
		...
		protected Piece(int p_i45590_1_, EnumFacing p_i45590_2_,
				RoomDefinition p_i45590_3_, int p_i45590_4_, int p_i45590_5_,
				int p_i45590_6_) {
			super(p_i45590_1_);
	...
	public static class SimpleRoom extends Piece {
		...
		public SimpleRoom(EnumFacing p_i45587_1_, RoomDefinition p_i45587_2_,
				Random p_i45587_3_) {
	...
	static class XYDoubleRoomFitHelper implements MonumentRoomFitHelper {
		...
		public boolean func_175969_a(RoomDefinition p_175969_1_) {
			if (p_175969_1_.field_175966_c[EnumFacing.EAST.getIndex()]
				...
				RoomDefinition structureoceanmonumentpieces$roomdefinition = p_175969_1_.field_175965_b[EnumFacing.EAST
						.getIndex()];
	...
	static class YZDoubleRoomFitHelper implements MonumentRoomFitHelper {
		...
		public boolean func_175969_a(RoomDefinition p_175969_1_) {
			if (p_175969_1_.field_175966_c[EnumFacing.NORTH.getIndex()]
					...
					&& p_175969_1_.field_175966_c[EnumFacing.UP.getIndex()]
					&& !p_175969_1_.field_175965_b[EnumFacing.UP.getIndex()].field_175963_d) {
				RoomDefinition structureoceanmonumentpieces$roomdefinition = p_175969_1_.field_175965_b[EnumFacing.NORTH
						.getIndex()];
				return structureoceanmonumentpieces$roomdefinition.field_175966_c[EnumFacing.UP.getIndex()]
						&& !structureoceanmonumentpieces$roomdefinition.field_175965_b[EnumFacing.UP
								.getIndex()].field_175963_d;
	...
	static class ZDoubleRoomFitHelper implements MonumentRoomFitHelper {
		...
		public Piece func_175968_a(EnumFacing p_175968_1_,
			...
			structureoceanmonumentpieces$roomdefinition.field_175965_b[EnumFacing.NORTH
					.getIndex()].field_175963_d = true;
			return new DoubleZRoom(p_175968_1_,

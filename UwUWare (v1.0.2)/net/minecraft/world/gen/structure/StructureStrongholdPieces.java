...
public class StructureStrongholdPieces {
	...
	private static Stronghold func_175954_a(
			Class<? extends Stronghold> p_175954_0_, List<StructureComponent> p_175954_1_,
		...
		if (p_175954_0_ == Straight.class) {
			structurestrongholdpieces$stronghold = Straight.func_175862_a(p_175954_1_,
					p_175954_2_, p_175954_3_, p_175954_4_, p_175954_5_, p_175954_6_, p_175954_7_);
		} else if (p_175954_0_ == Prison.class) {
			structurestrongholdpieces$stronghold = Prison.func_175860_a(p_175954_1_,
					p_175954_2_, p_175954_3_, p_175954_4_, p_175954_5_, p_175954_6_, p_175954_7_);
		} else if (p_175954_0_ == LeftTurn.class) {
			structurestrongholdpieces$stronghold = LeftTurn.func_175867_a(p_175954_1_,
					p_175954_2_, p_175954_3_, p_175954_4_, p_175954_5_, p_175954_6_, p_175954_7_);
		} else if (p_175954_0_ == RightTurn.class) {
			structurestrongholdpieces$stronghold = RightTurn.func_175867_a(p_175954_1_,
					p_175954_2_, p_175954_3_, p_175954_4_, p_175954_5_, p_175954_6_, p_175954_7_);
		} else if (p_175954_0_ == RoomCrossing.class) {
			structurestrongholdpieces$stronghold = RoomCrossing.func_175859_a(p_175954_1_,
					p_175954_2_, p_175954_3_, p_175954_4_, p_175954_5_, p_175954_6_, p_175954_7_);
		} else if (p_175954_0_ == StairsStraight.class) {
			structurestrongholdpieces$stronghold = StairsStraight.func_175861_a(p_175954_1_,
					p_175954_2_, p_175954_3_, p_175954_4_, p_175954_5_, p_175954_6_, p_175954_7_);
		} else if (p_175954_0_ == Stairs.class) {
			structurestrongholdpieces$stronghold = Stairs.func_175863_a(p_175954_1_,
					p_175954_2_, p_175954_3_, p_175954_4_, p_175954_5_, p_175954_6_, p_175954_7_);
		} else if (p_175954_0_ == Crossing.class) {
			structurestrongholdpieces$stronghold = Crossing.func_175866_a(p_175954_1_,
					p_175954_2_, p_175954_3_, p_175954_4_, p_175954_5_, p_175954_6_, p_175954_7_);
		} else if (p_175954_0_ == ChestCorridor.class) {
			structurestrongholdpieces$stronghold = ChestCorridor.func_175868_a(p_175954_1_,
					p_175954_2_, p_175954_3_, p_175954_4_, p_175954_5_, p_175954_6_, p_175954_7_);
		} else if (p_175954_0_ == Library.class) {
			structurestrongholdpieces$stronghold = Library.func_175864_a(p_175954_1_,
					p_175954_2_, p_175954_3_, p_175954_4_, p_175954_5_, p_175954_6_, p_175954_7_);
		} else if (p_175954_0_ == PortalRoom.class) {
			structurestrongholdpieces$stronghold = PortalRoom.func_175865_a(p_175954_1_,
					p_175954_2_, p_175954_3_, p_175954_4_, p_175954_5_, p_175954_6_, p_175954_7_);
		}
	...
	private static Stronghold func_175955_b(Stairs2 p_175955_0_,
		...
		if (!canAddStructurePieces()) {
			...
			if (strongComponentType != null) {
				Stronghold structurestrongholdpieces$stronghold = func_175954_a(
			...
			while (j < 5) {
				...
				for (PieceWeight structurestrongholdpieces$pieceweight : structurePieceList) {
					...
					if (i < 0) {
						...
						Stronghold structurestrongholdpieces$stronghold1 = func_175954_a(
			...
			StructureBoundingBox structureboundingbox = Corridor.func_175869_a(p_175955_1_,
					p_175955_2_, p_175955_3_, p_175955_4_, p_175955_5_, p_175955_6_);

			if (structureboundingbox != null && structureboundingbox.minY > 1) {
				return new Corridor(p_175955_7_, p_175955_2_, structureboundingbox,
						p_175955_6_);
			} else {
				return null;
			}
	...
	private static StructureComponent func_175953_c(Stairs2 p_175953_0_,
	...
	public static class ChestCorridor extends Stronghold {
		...
		public static ChestCorridor func_175868_a(List<StructureComponent> p_175868_0_,
			...
			return canStrongholdGoDeeper(structureboundingbox)
					&& StructureComponent.findIntersecting(p_175868_0_, structureboundingbox) == null
							? new ChestCorridor(p_175868_6_, p_175868_1_,
	...
	public static class Crossing extends Stronghold {
		...
		public static Crossing func_175866_a(List<StructureComponent> p_175866_0_,
			...
			return canStrongholdGoDeeper(structureboundingbox)
					&& StructureComponent.findIntersecting(p_175866_0_, structureboundingbox) == null
							? new Crossing(p_175866_6_, p_175866_1_, structureboundingbox,
									p_175866_5_)
							: null;
		}
	...
	public static class LeftTurn extends Stronghold {
		...
		public static LeftTurn func_175867_a(List<StructureComponent> p_175867_0_,
			...
			return canStrongholdGoDeeper(structureboundingbox)
					&& StructureComponent.findIntersecting(p_175867_0_, structureboundingbox) == null
							? new LeftTurn(p_175867_6_, p_175867_1_, structureboundingbox,
									p_175867_5_)
							: null;
		}
	...
	public static class Library extends Stronghold {
		...
		public static Library func_175864_a(List<StructureComponent> p_175864_0_,
	...
	static class PieceWeight {
		...
		public PieceWeight(Class<? extends Stronghold> p_i2076_1_, int p_i2076_2_,
				int p_i2076_3_) {
	...
	public static class PortalRoom extends Stronghold {
		...
		public static PortalRoom func_175865_a(List<StructureComponent> p_175865_0_,
			...
			return canStrongholdGoDeeper(structureboundingbox)
					&& StructureComponent.findIntersecting(p_175865_0_, structureboundingbox) == null
							? new PortalRoom(p_175865_6_, p_175865_1_, structureboundingbox,
									p_175865_5_)
							: null;
		}
		...
		public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn) {
			this.fillWithRandomizedBlocks(worldIn, structureBoundingBoxIn, 0, 0, 0, 10, 7, 15, false, randomIn,
					StructureStrongholdPieces.strongholdStones);
			this.placeDoor(worldIn, randomIn, structureBoundingBoxIn, Door.GRATES,
					4, 1, 0);
			int i = 6;
	...
	public static class Prison extends Stronghold {
		...
		public static Prison func_175860_a(List<StructureComponent> p_175860_0_,
			...
			return canStrongholdGoDeeper(structureboundingbox)
					&& StructureComponent.findIntersecting(p_175860_0_, structureboundingbox) == null
							? new Prison(p_175860_6_, p_175860_1_, structureboundingbox,
									p_175860_5_)
							: null;
		}
	...
	public static class RoomCrossing extends Stronghold {
		...
		public static RoomCrossing func_175859_a(List<StructureComponent> p_175859_0_,
			...
			return canStrongholdGoDeeper(structureboundingbox)
					&& StructureComponent.findIntersecting(p_175859_0_, structureboundingbox) == null
							? new RoomCrossing(p_175859_6_, p_175859_1_, structureboundingbox,
									p_175859_5_)
							: null;
		}
	...
	public static class Stairs extends Stronghold {
		...
		public static Stairs func_175863_a(List<StructureComponent> p_175863_0_,
			...
			return canStrongholdGoDeeper(structureboundingbox)
					&& StructureComponent.findIntersecting(p_175863_0_, structureboundingbox) == null
							? new Stairs(p_175863_6_, p_175863_1_, structureboundingbox,
									p_175863_5_)
							: null;
		}
	...
	public static class StairsStraight extends Stronghold {
		...
		public static StairsStraight func_175861_a(List<StructureComponent> p_175861_0_,
			...
			return canStrongholdGoDeeper(structureboundingbox)
					&& StructureComponent.findIntersecting(p_175861_0_, structureboundingbox) == null
							? new StairsStraight(p_175861_6_, p_175861_1_,
	...
	public static class Straight extends Stronghold {
		...
		public static Straight func_175862_a(List<StructureComponent> p_175862_0_,
			...
			return canStrongholdGoDeeper(structureboundingbox)
					&& StructureComponent.findIntersecting(p_175862_0_, structureboundingbox) == null
							? new Straight(p_175862_6_, p_175862_1_, structureboundingbox,
									p_175862_5_)
							: null;
		}
	...
	abstract static class Stronghold extends StructureComponent {
		...
		protected void placeDoor(World worldIn, Random p_74990_2_, StructureBoundingBox p_74990_3_,
				Door p_74990_4_, int p_74990_5_, int p_74990_6_, int p_74990_7_) {
			switch (p_74990_4_) {
			case OPENING:
			default:
		...
		protected StructureComponent getNextComponentNormal(Stairs2 p_74986_1_,
		...
		protected StructureComponent getNextComponentX(Stairs2 p_74989_1_,
		...
		protected StructureComponent getNextComponentZ(Stairs2 p_74987_1_,

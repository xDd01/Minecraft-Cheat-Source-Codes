...
public class StructureVillagePieces {
	...
	private static Village func_176065_a(Start start,
                                         PieceWeight weight, List<StructureComponent> p_176065_2_, Random rand,
		...
		if (oclass == House4Garden.class) {
			structurevillagepieces$village = House4Garden.func_175858_a(start, p_176065_2_, rand,
					p_176065_4_, p_176065_5_, p_176065_6_, facing, p_176065_8_);
		} else if (oclass == Church.class) {
			structurevillagepieces$village = Church.func_175854_a(start, p_176065_2_, rand,
					p_176065_4_, p_176065_5_, p_176065_6_, facing, p_176065_8_);
		} else if (oclass == House1.class) {
			structurevillagepieces$village = House1.func_175850_a(start, p_176065_2_, rand,
					p_176065_4_, p_176065_5_, p_176065_6_, facing, p_176065_8_);
		} else if (oclass == WoodHut.class) {
			structurevillagepieces$village = WoodHut.func_175853_a(start, p_176065_2_, rand,
					p_176065_4_, p_176065_5_, p_176065_6_, facing, p_176065_8_);
		} else if (oclass == Hall.class) {
			structurevillagepieces$village = Hall.func_175857_a(start, p_176065_2_, rand,
					p_176065_4_, p_176065_5_, p_176065_6_, facing, p_176065_8_);
		} else if (oclass == Field1.class) {
			structurevillagepieces$village = Field1.func_175851_a(start, p_176065_2_, rand,
					p_176065_4_, p_176065_5_, p_176065_6_, facing, p_176065_8_);
		} else if (oclass == Field2.class) {
			structurevillagepieces$village = Field2.func_175852_a(start, p_176065_2_, rand,
					p_176065_4_, p_176065_5_, p_176065_6_, facing, p_176065_8_);
		} else if (oclass == House2.class) {
			structurevillagepieces$village = House2.func_175855_a(start, p_176065_2_, rand,
					p_176065_4_, p_176065_5_, p_176065_6_, facing, p_176065_8_);
		} else if (oclass == House3.class) {
			structurevillagepieces$village = House3.func_175849_a(start, p_176065_2_, rand,
					p_176065_4_, p_176065_5_, p_176065_6_, facing, p_176065_8_);
		}
	...
	private static Village func_176067_c(Start start,
		...
		if (i <= 0) {
			...
			while (j < 5) {
				...
				for (PieceWeight structurevillagepieces$pieceweight : start.structureVillageWeightedPieceList) {
					...
					if (k < 0) {
						...
						Village structurevillagepieces$village = func_176065_a(start,
			...
			StructureBoundingBox structureboundingbox = Torch.func_175856_a(start, p_176067_1_,
	...
	private static StructureComponent func_176066_d(Start start,
	...
	private static StructureComponent func_176069_e(Start start,
		...
		if (p_176069_7_ > 3 + start.terrainType) {
			...
			StructureBoundingBox structureboundingbox = Path.func_175848_a(start, p_176069_1_,
					rand, p_176069_3_, p_176069_4_, p_176069_5_, facing);

			if (structureboundingbox != null && structureboundingbox.minY > 10) {
				StructureComponent structurecomponent = new Path(start, p_176069_7_, rand,
	...
	public static class Church extends Village {
		...
		public Church(Start start, int p_i45564_2_, Random rand,
		...
		public static Church func_175854_a(Start start,
	...
	public static class Field1 extends Village {
		...
		public Field1(Start start, int p_i45570_2_, Random rand,
		...
		public static Field1 func_175851_a(Start start,
	...
	public static class Field2 extends Village {
		...
		public Field2(Start start, int p_i45569_2_, Random rand,
		...
		public static Field2 func_175852_a(Start start,
	...
	public static class Hall extends Village {
		...
		public Hall(Start start, int p_i45567_2_, Random rand, StructureBoundingBox p_i45567_4_,
                    EnumFacing facing) {
		...
		public static Hall func_175857_a(Start start,
	...
	public static class House1 extends Village {
		...
		public House1(Start start, int p_i45571_2_, Random rand,
		...
		public static House1 func_175850_a(Start start,
	...
	public static class House2 extends Village {
		...
		public House2(Start start, int p_i45563_2_, Random rand,
		...
		public static House2 func_175855_a(Start start,
	...
	public static class House3 extends Village {
		...
		public House3(Start start, int p_i45561_2_, Random rand,
		...
		public static House3 func_175849_a(Start start,
	...
	public static class House4Garden extends Village {
		...
		public House4Garden(Start start, int p_i45566_2_, Random rand,
		...
		public static House4Garden func_175858_a(Start start,
	...
	public static class Path extends Road {
		...
		public Path(Start start, int p_i45562_2_, Random rand, StructureBoundingBox p_i45562_4_,
                    EnumFacing facing) {
		...
		public void buildComponent(StructureComponent componentIn, List<StructureComponent> listIn, Random rand) {
			...
			for (int i = rand.nextInt(5); i < this.length - 8; i += 2 + rand.nextInt(5)) {
				StructureComponent structurecomponent = this
						.getNextComponentNN((Start) componentIn, listIn, rand, 0, i);
			...
			for (int j = rand.nextInt(5); j < this.length - 8; j += 2 + rand.nextInt(5)) {
				StructureComponent structurecomponent1 = this
						.getNextComponentPP((Start) componentIn, listIn, rand, 0, j);
			...
			if (flag && rand.nextInt(3) > 0 && this.coordBaseMode != null) {
				...
				case NORTH:
					StructureVillagePieces.func_176069_e((Start) componentIn, listIn, rand,
		...
		public static StructureBoundingBox func_175848_a(Start start,
	...
	public static class Torch extends Village {
		...
		public Torch(Start start, int p_i45568_2_, Random rand, StructureBoundingBox p_i45568_4_,
                     EnumFacing facing) {
		...
		public static StructureBoundingBox func_175856_a(Start start,
	...
	abstract static class Village extends StructureComponent {
		...
		protected StructureComponent getNextComponentNN(Start start,
		...
		protected StructureComponent getNextComponentPP(Start start,
	...
	public static class WoodHut extends Village {
		...
		public WoodHut(Start start, int p_i45565_2_, Random rand,
		...
		public static WoodHut func_175853_a(Start start,

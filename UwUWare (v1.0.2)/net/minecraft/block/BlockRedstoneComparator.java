...
public class BlockRedstoneComparator extends BlockRedstoneDiode implements ITileEntityProvider {
	...
	public static final PropertyEnum<Mode> MODE = PropertyEnum.<Mode>create(
			"mode", Mode.class);
	...
	protected IBlockState getPoweredState(IBlockState unpoweredState) {
		...
		Mode blockredstonecomparator$mode = (Mode) unpoweredState
				.getValue(MODE);
	...
	protected IBlockState getUnpoweredState(IBlockState poweredState) {
		...
		Mode blockredstonecomparator$mode = (Mode) poweredState
				.getValue(MODE);
	...
	public IBlockState getStateFromMeta(int meta) {
		return this.getDefaultState().withProperty(FACING, EnumFacing.getHorizontal(meta))
				.withProperty(POWERED, Boolean.valueOf((meta & 8) > 0)).withProperty(MODE,
						(meta & 4) > 0 ? Mode.SUBTRACT : Mode.COMPARE);
	}
	...
	public IBlockState onBlockPlaced(World worldIn, BlockPos pos, EnumFacing facing, float hitX, float hitY, float hitZ,
		...
		return this.getDefaultState().withProperty(FACING, placer.getHorizontalFacing().getOpposite())
				.withProperty(POWERED, Boolean.valueOf(false)).withProperty(MODE, Mode.COMPARE);
	}

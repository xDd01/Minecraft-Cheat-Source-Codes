...
public class BlockTallGrass extends BlockBush implements IGrowable {
	public static final PropertyEnum<EnumType> TYPE = PropertyEnum.<EnumType>create(
			"type", EnumType.class);
	...
	public int getRenderColor(IBlockState state) {
		if (state.getBlock() != this) {
			...
			return blocktallgrass$enumtype == EnumType.DEAD_BUSH ? 16777215
	...
	public void harvestBlock(World worldIn, EntityPlayer player, BlockPos pos, IBlockState state, TileEntity te) {
		if (!worldIn.isRemote && player.getCurrentEquippedItem() != null
			...
			spawnAsEntity(worldIn, pos,
					new ItemStack(Blocks.tallgrass, 1, ((EnumType) state.getValue(TYPE)).getMeta()));
		} else {

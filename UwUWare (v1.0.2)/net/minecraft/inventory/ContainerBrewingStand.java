...
public class ContainerBrewingStand extends Container {
	...
	public ContainerBrewingStand(InventoryPlayer playerInventory, IInventory tileBrewingStandIn) {
		...
		this.addSlotToContainer(
				new Potion(playerInventory.player, tileBrewingStandIn, 0, 56, 46));
		this.addSlotToContainer(
				new Potion(playerInventory.player, tileBrewingStandIn, 1, 79, 53));
		this.addSlotToContainer(
				new Potion(playerInventory.player, tileBrewingStandIn, 2, 102, 46));

...
public class DataWatcher {
	...
	public <T> void addObject(int id, T object) {
		...
		if (integer == null) {
			...
			WatchableObject datawatcher$watchableobject = new WatchableObject(
	...
	public void addObjectByDataType(int id, int type) {
		WatchableObject datawatcher$watchableobject = new WatchableObject(type, id,
				(Object) null);
		this.lock.writeLock().lock();
		this.watchedObjects.put(Integer.valueOf(id), datawatcher$watchableobject);
		this.lock.writeLock().unlock();
	 ...
	 * PacketBuffer
	 */
	public static void writeWatchedListToPacketBuffer(List<WatchableObject> objectsList,
	...
	public void updateWatchedObjectsFromList(List<WatchableObject> p_75687_1_) {
		...
		for (WatchableObject datawatcher$watchableobject : p_75687_1_) {
			WatchableObject datawatcher$watchableobject1 = (WatchableObject) this.watchedObjects

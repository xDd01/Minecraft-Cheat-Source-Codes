...
public class EntityAITasks {
	...
	public void removeTask(EntityAIBase task) {
		...
		while (iterator.hasNext()) {
			EntityAITaskEntry entityaitasks$entityaitaskentry = (EntityAITaskEntry) iterator
					.next();
	...
	public void onUpdateTasks() {
		...
		if (this.tickCount++ % this.tickRate == 0) {
			...
			while (iterator1.hasNext()) {
				EntityAITaskEntry entityaitasks$entityaitaskentry1 = (EntityAITaskEntry) iterator1
						.next();
	 ...
	 */
	private boolean areTasksCompatible(EntityAITaskEntry taskEntry1,
                                       EntityAITaskEntry taskEntry2) {

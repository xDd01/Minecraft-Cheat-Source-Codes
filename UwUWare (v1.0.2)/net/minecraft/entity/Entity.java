...
import Ascii4UwUWareClient.API.Events.World.EventStep;
    ...
    public void moveEntity(double x, double y, double z) {
        if (this.noClip) {
            ...
            boolean flag = this.onGround && this.isSneaking() && this instanceof EntityPlayer
                    || (scaffold.isEnabled() && scaffold.safewalk.getValue() && Minecraft.thePlayer.onGround)
            ...
            EventBus.getInstance().register(eventStep);

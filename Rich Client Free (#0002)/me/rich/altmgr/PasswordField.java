	...
	public void drawTextBox() {
		if (this.func_73778_q()) {
			if (this.getEnableBackgroundDrawing()) {
				RenderHelper.drawRoundedRect1((this.xPos - 1.5), this.yPos - 1.5, this.xPos + this.width,
						this.yPos + this.height + 1.5, (int)0.3D, Main.getClientColor().getRGB());
				RenderHelper.drawRoundedRect1((this.xPos - 1), this.yPos - 1, this.xPos + this.width - 0.5,
						this.yPos + this.height + 1, (int)0.3D, (new Color(15, 15, 15, 255)).getRGB());
			}
			...
			if (var6) {
				if (var10) {
					Gui.drawRect(var11, var8 - 1, var11 + 1, var8 + 1 + Fonts.roboto_16.getHeight(), -3092272);
				} else {

...
import me.rich.module.player.KeepSprint;
...
public abstract class EntityPlayer extends EntityLivingBase
{
    ...
    public void onUpdate() {
        this.noClip = Main.moduleManager.getModule(FreeCam.class).isToggled() ||  Main.moduleManager.getModule(NoClip.class).isToggled() || this.isSpectator();
                ...
                if (f > 0.0F || f1 > 0.0F)
                {
                    ...
                    if (flag5)
                    {
                        if (i > 0)
                        {
                            ...
                            if(Main.moduleManager.getModule(KeepSprint.class).isToggled()) {
    ...
    {
        if(Main.moduleManager.getModule(AntiCollision.class).isToggled() && Main.settingsManager.getSettingByName("Water").getValBoolean()) {
            return false;
        }
        return !this.capabilities.isFlying;
    }

...
public class PlayerControllerMP
{
    ...
    public void attackEntity(EntityPlayer playerIn, Entity targetEntity) {
        if (mc.player.isHandActive() && mc.player.getHeldItemOffhand().getItem() instanceof ItemShield && Main.moduleManager.getModule(KillAura.class).isToggled() && Main.settingsManager.getSettingByName(Main.moduleManager.getModule(KillAura.class), "ShieldBlock").getValBoolean() && (mc.gameSettings.keyBindUseItem.isKeyDown() && mc.player.getHeldItemOffhand().getItem() instanceof ItemShield)) {

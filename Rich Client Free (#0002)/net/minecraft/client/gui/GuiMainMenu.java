...
import me.rich.changelogs.ChangeLog;
...
public class GuiMainMenu extends GuiScreen {
	...
	private void addSingleplayerMultiplayerButtons(int p_73969_1_, int p_73969_2_) {
		...
		this.buttonList.add(
				new GuiButton(2, this.width / 2 - 100, p_73969_1_ + p_73969_2_ * 1 + 20, I18n.format("menu.multiplayer")));
		...
		if (Reflector.GuiModList_Constructor.exists()) {
			...
			this.realmsButton = this.addButton(
					new GuiButton(14, this.width / 2 - 100, p_73969_1_ + p_73969_2_ * 2 + 20, I18n.format("Alt Manager")));
		}
	}
	...
	public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        mc.fontRendererObj.drawStringWithShadow("Build: \2477" + Main.version, xx - 5, sr.getScaledHeight() - 9, -1);

        for (ChangeLog log : Main.getChangeLogMngr().getChangeLogs()) {
            if (Main.getChangeLogMngr().getChangeLogs() != null) {
            	mc.fontRendererObj.drawStringWithShadow(log.getChangeName(), xx - 5, yy - 21, -1);
                yy += 9;
            } else {
            	mc.fontRendererObj.drawStringWithShadow("Cannot load Changelogs",xx- 5, yy - 21, -1);
            }

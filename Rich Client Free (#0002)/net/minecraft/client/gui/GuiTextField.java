...
public class GuiTextField extends Gui
{
    ...
    public void drawTextBox()
    {
        if (this.getVisible())
        {
            if (this.getEnableBackgroundDrawing())
                RenderHelper.drawRoundedRect1(this.xPosition - 1.5, this.yPosition - 1.5, this.xPosition + this.width + 1.5, this.yPosition + this.height + 1.5,  (int) 1, Main.getClientColor().getRGB());
                //drawRect(this.xPosition - 1, this.yPosition - 1, this.xPosition + this.width + 1, this.yPosition + this.height + 1, -6250336);
            	RenderHelper.drawRoundedRect1(this.xPosition - 1, this.yPosition - 1, this.xPosition + this.width + 1, this.yPosition + this.height + 1, (int) 1, (new Color(15, 15, 15, 255)).getRGB());
    ...
    public void drawTextBox1()
    {
        if (this.getVisible())
        {
            ...
            int j = this.cursorPosition - this.lineScrollOffset;
            int k = this.selectionEnd - this.lineScrollOffset;
            String s = (String) Fonts.sfui16.trimStringToWidth(this.text.substring(this.lineScrollOffset), this.getWidth());
            boolean flag = j >= 0 && j <= s.length();
            boolean flag1 = this.isFocused && this.cursorCounter / 6 % 2 == 0 && flag;
            int l = this.enableBackgroundDrawing ? this.xPosition + 4 : this.xPosition;
            int i1 = this.enableBackgroundDrawing ? this.yPosition + (this.height - 8) / 2 : this.yPosition;
            ...
            if(s.isEmpty()) {
            	Fonts.neverlose500_16.drawStringWithShadow(ChatFormatting.RED + "[RC] " + ChatFormatting.WHITE + "Send message...", (float)l - 0.5, this.xd + 11.5, -1);
            }
            ...
            if (!s.isEmpty() && flag && j < s.length())
            {
                j1 = (int) Fonts.sfui16.drawStringWithShadow(s.substring(j), (float)j1, (float)i1, i);
            }
            ...
            if (flag1)
            {
                if (flag2)
                {
                    Gui.drawRect(k1, i1 - 1, k1 + 1, i1 + 1 + Fonts.sfui16.getHeight(), -3092272);
                }
                else
                {
                	if(s.isEmpty()) {
                	Fonts.neverlose500_15.drawStringWithShadow("", (float)k1 + 1, (float)i1 +  2, i);
                	} else {
                		Fonts.neverlose500_15.drawStringWithShadow("_", (float)k1 + 1, (float)i1 + 2, i);
                	}
                }
            }
            ...
            if (k != j)
            {
                int l1 = l + (int) Fonts.sfui16.getStringWidth(s.substring(0, k));

...
public class Gui
{
    ...
    public static void drawRect(double x, double y, double d, double e, int color)
    {
        ...
        bufferbuilder.pos((double)x, (double)e, 0.0D).endVertex();
        bufferbuilder.pos((double)d, (double)e, 0.0D).endVertex();
        bufferbuilder.pos((double)d, (double)y, 0.0D).endVertex();
    ...
    public static void drawModalRectWithCustomSizedTexture(float h, float g, float u, float v, int width, int height, float textureWidth, float textureHeight)
    {
        ...
        BufferBuilder bufferbuilder = tessellator.getBuffer();
        bufferbuilder.begin(7, DefaultVertexFormats.POSITION_TEX);
        bufferbuilder.pos((double)h, (double)(g + height), 0.0D).tex((double)(u * f), (double)((v + (float)height) * f1)).endVertex();
        bufferbuilder.pos((double)(h + width), (double)(g + height), 0.0D).tex((double)((u + (float)width) * f), (double)((v + (float)height) * f1)).endVertex();
        bufferbuilder.pos((double)(h + width), (double)g, 0.0D).tex((double)((u + (float)width) * f), (double)(v * f1)).endVertex();

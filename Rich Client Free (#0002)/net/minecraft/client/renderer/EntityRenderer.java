...
public class EntityRenderer implements IResourceManagerReloadListener
{
			...
			if (this.mc.gameSettings.debugCamEnable) {
				...
				for (int i = 0; i < 8; ++i) {
					...
					if (raytraceresult != null) {
						...
						if (Main.settingsManager.getSettingByName("CameraClip").getValBoolean() && Main.moduleManager.getModule(NoRender.class).isToggled()) {
    ...
    private void updateFogColor(float partialTicks)
    {
    	...
    	EventRenderModel.EventColorFov event = new EventRenderModel.EventColorFov(this, entity, iblockstate1,partialTicks, this.fogColorRed, this.fogColorGreen, this.fogColorBlue);
	       event.call();
		...
		if (Reflector.EntityViewRenderEvent_FogColors_Constructor.exists()) {
			Object object = Reflector.newInstance(Reflector.EntityViewRenderEvent_FogColors_Constructor, this, entity,
					iblockstate1, Float.valueOf(partialTicks), Float.valueOf(this.fogColorRed),

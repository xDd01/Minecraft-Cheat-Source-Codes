...
public class OpenGlHelper
{
     ...
     */
    public static void setLightmapTextureCoords(int target, float p_774751, float t)
    {
        if (arbMultitexture)
        {
            ARBMultitexture.glMultiTexCoord2fARB(target, p_774751, t);
        }
        else
        {
            GL13.glMultiTexCoord2f(target, p_774751, t);
        }

        if (target == lightmapTexUnit)
        {
            lastBrightnessX = p_774751;
            lastBrightnessY = t;
        }
    }

		...
		if (entity != null) {
			if (packetIn.getOpCode() == 21) {
				...
				if (entity == this.gameController.player) {
					if(Main.settingsManager.getSettingByName(Main.moduleManager.getModule(NoRender.class), "AntiTotemAnimation").getValBoolean() && Main.moduleManager.getModule(NoRender.class).isToggled()) {

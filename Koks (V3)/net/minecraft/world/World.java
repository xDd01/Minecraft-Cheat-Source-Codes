...
public abstract class World implements IBlockAccess {
    ...
    public final List<Entity> unloadedEntityList = Lists.<Entity>newArrayList();
    ...
    /** Returns true if a player is at the pos*/
    public boolean checkForEntity(BlockPos pos) {
        return !this.getEntitiesWithinAABBExcludingEntity((Entity) null, new AxisAlignedBB(pos.getX(), pos.getY(), pos.getZ(), pos.getX() + 1, pos.getY() + 1, pos.getZ() + 1)).isEmpty();
    }

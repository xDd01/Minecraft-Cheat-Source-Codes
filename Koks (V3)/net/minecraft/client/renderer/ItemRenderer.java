...
public class ItemRenderer {
        ...
        if (this.itemToRender != null) {
            if (this.itemToRender.getItem() instanceof ItemMap) {
                ...
                switch (ItemRenderer.ItemRenderer$1.field_178094_a[enumaction.ordinal()]) {
                    ...
                    case 4:
                        if (Koks.getKoks().moduleManager.getModule(Swing.class).isToggled()) {
                            blockAnimation(f, f1);
                        } else {
                            this.transformFirstPersonItem(f, 0.0F);
                            this.func_178103_d();
                ...
                if (Koks.getKoks().moduleManager.getModule(Swing.class).isToggled() && mc.thePlayer.isSwingInProgress && Koks.getKoks().moduleManager.getModule(FakeAutoBlock.class).isToggled()) {
                    if (((FakeAutoBlock) Koks.getKoks().moduleManager.getModule(FakeAutoBlock.class)).onlySword.isToggled()) {
    ...
    public void blockAnimation(float f, float f1) {
        if (((Swing) Koks.getKoks().moduleManager.getModule(Swing.class)).mode.getCurrentMode().equalsIgnoreCase("1.7 Animation")) {
            this.transformFirstPersonItem(f - 0.2f, f1);
        } else {
            this.transformFirstPersonItem(f, 0.0F);
        }
        this.func_178103_d();
        if (((Swing) Koks.getKoks().moduleManager.getModule(Swing.class)).mode.getCurrentMode().equalsIgnoreCase("Animation1")) {
            GlStateManager.translate(-0.3F, -0.3F, 0.2F);
            GlStateManager.rotate(f1 * -20.0F, 1.0F, 0.0F, 0.0F);
        }

        if (((Swing) Koks.getKoks().moduleManager.getModule(Swing.class)).mode.getCurrentMode().equalsIgnoreCase("Animation2")) {
            GlStateManager.translate(-0.3F, -0.3F, 0.2F);
            GlStateManager.rotate(f1 * -35.0F, 5.0f, 0.0F, 5.0f);
        }

        if (((Swing) Koks.getKoks().moduleManager.getModule(Swing.class)).mode.getCurrentMode().equalsIgnoreCase("Animation3")) {
            GlStateManager.translate(0.1F, 0.1F, 0.2F);
            GlStateManager.rotate(f1 * 80f, -40, 100.0f, -50.0f);
        }

        if (((Swing) Koks.getKoks().moduleManager.getModule(Swing.class)).mode.getCurrentMode().equalsIgnoreCase("Animation4")) {
            GlStateManager.translate(0.1F, 0.1F, 0.2F);
            GlStateManager.rotate(f1 * 40f, -80, 0.0f, -500.0f);
        }

        if (((Swing) Koks.getKoks().moduleManager.getModule(Swing.class)).mode.getCurrentMode().equalsIgnoreCase("Animation5")) {
            GlStateManager.rotate(f1 * 40f, 1, 0, 0);
            GlStateManager.rotate(f1 * 40f, 0, 1, 0);
            GlStateManager.rotate(-f1 * 40f, 0, 0, 1);
        }

        if (((Swing) Koks.getKoks().moduleManager.getModule(Swing.class)).mode.getCurrentMode().equalsIgnoreCase("Spin")) {
            GlStateManager.translate(-0.3F, -0.3F, 0.2F);

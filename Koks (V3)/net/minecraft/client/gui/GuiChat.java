...
public class GuiChat extends GuiScreen {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        String color = inputField.getText().length() <= 100 ? "§a" : "§c";
        drawString(fontRendererObj, color + inputField.getText().length() + "§7/§a100", 3, this.height - 24, -1);
        drawRect(1, this.height - 14, 13 + mc.fontRendererObj.getStringWidth(inputField.getText()), this.height - 2, Integer.MIN_VALUE);

        ...
        if (Koks.getKoks().moduleManager.getModule(koks.manager.module.impl.render.Scoreboard.class).isToggled()) {
            ...
            for (Object score1 : arraylist1) {
                ...
                if (k == arraylist1.size()) {
                    ...
                    drawRect(j - 2, l - 2 - this.getFontRenderer().FONT_HEIGHT - 1, sr.getScaledWidth(), l - 2 - 1, new Color(0x393739).getRGB());
                    drawRect(j - 2, l - 2 - 1, sr.getScaledWidth(), l - 2, new Color(0x393739).getRGB());
                    drawRect(j - 2 - 2, l - 2- this.getFontRenderer().FONT_HEIGHT - 1, j - 2, l - 2, Koks.getKoks().clientColor.getRGB());

                    this.getFontRenderer().drawString(s3, j + i / 2 - this.getFontRenderer().getStringWidth(s3) / 2, l - 1 - this.getFontRenderer().FONT_HEIGHT, 553648127);
                }
            }
        }
    }

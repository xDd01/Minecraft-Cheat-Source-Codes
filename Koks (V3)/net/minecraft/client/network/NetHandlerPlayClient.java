...
public class NetHandlerPlayClient implements INetHandlerPlayClient {
    ...
    public void handlePlayerPosLook(S08PacketPlayerPosLook packetIn) {
        ...
        EventHeadLook eventHeadLook = new EventHeadLook(d0, d1, d2, f, f1);
        eventHeadLook.onFire();

        d0 = eventHeadLook.getD0();
        d1 = eventHeadLook.getD1();
        d2 = eventHeadLook.getD2();
        f = eventHeadLook.getF1();
        f1 = eventHeadLook.getF2();
    ...
    public void addToSendQueueUnlogged(Packet p_147297_1_) {
        this.netManager.sendPacket(p_147297_1_);
    }

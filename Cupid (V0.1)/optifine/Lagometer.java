...
public class Lagometer {
  ...
  public static void showLagometer(ScaledResolution p_showLagometer_0_) {
    if (gameSettings != null)
      if (gameSettings.ofLagometer || gameSettings.field_181657_aC) {
        ...
        mc.fontRendererObj.drawString("30", 2.0F, (k2 + 1), -8947849);
        mc.fontRendererObj.drawString("30", 1.0F, k2, -3881788);
        mc.fontRendererObj.drawString("60", 2.0F, (j2 + 1), -8947849);
        mc.fontRendererObj.drawString("60", 1.0F, j2, -3881788);
        GlStateManager.matrixMode(5889);
  ...
  private static long renderTime(int p_renderTime_0_, long p_renderTime_1_, int p_renderTime_3_, int p_renderTime_4_, int p_renderTime_5_, float p_renderTime_6_, WorldRenderer p_renderTime_7_) {
    ...
    if (i < 3L)
      return 0L; 
    p_renderTime_7_.pos((p_renderTime_0_ + 0.5F), (p_renderTime_6_ - (float)i + 0.5F), 0.0D).color(p_renderTime_3_, p_renderTime_4_, p_renderTime_5_, 255).endVertex();
  ...
  private static long renderTimeDivider(int p_renderTimeDivider_0_, int p_renderTimeDivider_1_, long p_renderTimeDivider_2_, int p_renderTimeDivider_4_, int p_renderTimeDivider_5_, int p_renderTimeDivider_6_, float p_renderTimeDivider_7_, WorldRenderer p_renderTimeDivider_8_) {
    ...
    if (i < 3L)
      return 0L; 
    p_renderTimeDivider_8_.pos((p_renderTimeDivider_0_ + 0.5F), (p_renderTimeDivider_7_ - (float)i + 0.5F), 0.0D).color(p_renderTimeDivider_4_, p_renderTimeDivider_5_, p_renderTimeDivider_6_, 255).endVertex();
    p_renderTimeDivider_8_.pos((p_renderTimeDivider_1_ + 0.5F), (p_renderTimeDivider_7_ - (float)i + 0.5F), 0.0D).color(p_renderTimeDivider_4_, p_renderTimeDivider_5_, p_renderTimeDivider_6_, 255).endVertex();
    return i;
  }
...
/* Location:              C:\Users\Joona\Downloads\Cupid.jar!\optifine\Lagometer.class

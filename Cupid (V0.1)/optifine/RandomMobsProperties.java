...
public class RandomMobsProperties {
  ...
  public RandomMobsProperties(Properties p_i78_1_, String p_i78_2_, ResourceLocation p_i78_3_) {
    ...
    this.rules = parseRules(p_i78_1_, p_i78_3_, connectedparser);
  }
  ...
  private RandomMobsRule[] parseRules(Properties p_parseRules_1_, ResourceLocation p_parseRules_2_, ConnectedParser p_parseRules_3_) {
    List<RandomMobsRule> list = new ArrayList();
    ...
    RandomMobsRule[] arandommobsrule = list.<RandomMobsRule>toArray(new RandomMobsRule[list.size()]);
...
/* Location:              C:\Users\Joona\Downloads\Cupid.jar!\optifine\RandomMobsProperties.class

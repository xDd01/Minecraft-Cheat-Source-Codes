  ...
  public static void update() {
    ...
    if (Config.isNaturalTextures()) {
      ...
      try {
        ...
        propertiesByIndex = arraylist.<NaturalProperties>toArray(new NaturalProperties[arraylist.size()]);
...
/* Location:              C:\Users\Joona\Downloads\Cupid.jar!\optifine\NaturalTextures.class

  ...
  public static void updateWaterOpacity(GameSettings p_updateWaterOpacity_0_, World p_updateWaterOpacity_1_) {
    if (p_updateWaterOpacity_0_ != null) {
      ...
      if (p_updateWaterOpacity_0_.ofClearWater)
        i = 1; 
      BlockLeavesBase.setLightOpacity((Block)Blocks.water, i);
      BlockLeavesBase.setLightOpacity((Block)Blocks.flowing_water, i);
    } 
...
/* Location:              C:\Users\Joona\Downloads\Cupid.jar!\optifine\ClearWater.class

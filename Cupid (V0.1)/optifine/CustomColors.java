...
public class CustomColors {
  ...
  public static void update() {
    ...
    if (Config.isCustomColors()) {
      ...
      String[] astring8 = { "redstone.png", "redstonecolor.png" };
      ...
      String[] astring9 = { "stem.png", "stemcolor.png" };
      ...
      String[] astring10 = { "myceliumparticle.png", "myceliumparticlecolor.png" };
  ...
  private static Pair<CustomColormap[], Integer> parseLightmapsRgb() {
    ...
    if (ainteger.length <= 0)
      return (Pair<CustomColormap[], Integer>)new ImmutablePair(null, Integer.valueOf(0)); 
    ...
    return (Pair<CustomColormap[], Integer>)new ImmutablePair(acustomcolormap, Integer.valueOf(j1));
  }
  ...
  private static void addToList(CustomColormap p_addToList_0_, List<List> p_addToList_1_, int p_addToList_2_) {
    ...
    List<CustomColormap> list = p_addToList_1_.get(p_addToList_2_);
    if (list == null) {
      list = new ArrayList();
  ...
  private static CustomColormap[][] blockListToArray(List<List> p_blockListToArray_0_) {
    ...
    for (int i = 0; i < p_blockListToArray_0_.size(); i++) {
      List list = p_blockListToArray_0_.get(i);
      if (list != null) {
  ...
  public static int getColorMultiplier(BakedQuad p_getColorMultiplier_0_, Block p_getColorMultiplier_1_, IBlockAccess p_getColorMultiplier_2_, BlockPos p_getColorMultiplier_3_, RenderEnv p_getColorMultiplier_4_) {
    ...
    if (p_getColorMultiplier_1_ instanceof net.minecraft.block.BlockStem)
  ...
  private static int getRedstoneLevel(IBlockState p_getRedstoneLevel_0_, int p_getRedstoneLevel_1_) {
    ...
    Object object = p_getRedstoneLevel_0_.getValue((IProperty)BlockRedstoneWire.POWER);
  ...
  public static Vec3 getWorldFogColor(Vec3 p_getWorldFogColor_0_, WorldClient p_getWorldFogColor_1_, Entity p_getWorldFogColor_2_, float p_getWorldFogColor_3_) {
    ...
    switch (i) {
      ...
      case 0:
        ...
        p_getWorldFogColor_0_ = getFogColor(p_getWorldFogColor_0_, (IBlockAccess)minecraft.theWorld, p_getWorldFogColor_2_.posX, p_getWorldFogColor_2_.posY + 1.0D, p_getWorldFogColor_2_.posZ);
        break;
      case 1:
  ...
  public static Vec3 getWorldSkyColor(Vec3 p_getWorldSkyColor_0_, World p_getWorldSkyColor_1_, Entity p_getWorldSkyColor_2_, float p_getWorldSkyColor_3_) {
    ...
    switch (i) {
      case 0:
        minecraft = Minecraft.getMinecraft();
        p_getWorldSkyColor_0_ = getSkyColor(p_getWorldSkyColor_0_, (IBlockAccess)minecraft.theWorld, p_getWorldSkyColor_2_.posX, p_getWorldSkyColor_2_.posY + 1.0D, p_getWorldSkyColor_2_.posZ);
        break;
      case 1:
...
/* Location:              C:\Users\Joona\Downloads\Cupid.jar!\optifine\CustomColors.class

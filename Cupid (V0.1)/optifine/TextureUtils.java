...
public class TextureUtils {
  ...
  public static ITextureObject getTexture(ResourceLocation p_getTexture_0_) {
    ...
    Config.getTextureManager().loadTexture(p_getTexture_0_, (ITextureObject)simpletexture);
    return (ITextureObject)simpletexture;
  }
  ...
  public static String getBasePath(String p_getBasePath_0_) {
    int i = p_getBasePath_0_.lastIndexOf('/');
...
/* Location:              C:\Users\Joona\Downloads\Cupid.jar!\optifine\TextureUtils.class

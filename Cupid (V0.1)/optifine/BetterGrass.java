...
public class BetterGrass {
  private static IBakedModel modelEmpty = (IBakedModel)new SimpleBakedModel(new ArrayList(), new ArrayList(), false, false, (TextureAtlasSprite)null, (ItemCameraTransforms)null);
  ...
  public static List getFaceQuads(IBlockAccess p_getFaceQuads_0_, Block p_getFaceQuads_1_, BlockPos p_getFaceQuads_2_, EnumFacing p_getFaceQuads_3_, List p_getFaceQuads_4_) {
    if (p_getFaceQuads_3_ != EnumFacing.UP && p_getFaceQuads_3_ != EnumFacing.DOWN) {
      if (p_getFaceQuads_1_ instanceof net.minecraft.block.BlockMycelium)
      ...
      if (p_getFaceQuads_1_ instanceof net.minecraft.block.BlockGrass) {
...
/* Location:              C:\Users\Joona\Downloads\Cupid.jar!\optifine\BetterGrass.class

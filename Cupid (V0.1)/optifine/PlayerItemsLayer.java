...
public class PlayerItemsLayer implements LayerRenderer {
  ...
  public void doRenderLayer(EntityLivingBase entitylivingbaseIn, float p_177141_2_, float p_177141_3_, float partialTicks, float p_177141_5_, float p_177141_6_, float p_177141_7_, float scale) {
    renderEquippedItems(entitylivingbaseIn, scale, partialTicks);
  }
  ...
  protected void renderEquippedItems(EntityLivingBase p_renderEquippedItems_1_, float p_renderEquippedItems_2_, float p_renderEquippedItems_3_) {
    if (Config.isShowCapes())
      if (p_renderEquippedItems_1_ instanceof AbstractClientPlayer) {
        ...
        PlayerConfigurations.renderPlayerItems((ModelBiped)modelPlayer, abstractclientplayer, p_renderEquippedItems_2_, p_renderEquippedItems_3_);
...
/* Location:              C:\Users\Joona\Downloads\Cupid.jar!\optifine\PlayerItemsLayer.class

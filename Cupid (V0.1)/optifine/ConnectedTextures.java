...
public class ConnectedTextures {
  ...
  private static final String[] propSuffixes = new String[] { 
      "", "a", "b", "c", "d", "e", "f", "g", "h", "i", 
      "j", "k", "l", "m", "n", "o", "p", "q", "r", "s", 
      "t", "u", "v", "w", "x", "y", "z" };
  ...
  public static synchronized BakedQuad getConnectedTexture(IBlockAccess p_getConnectedTexture_0_, IBlockState p_getConnectedTexture_1_, BlockPos p_getConnectedTexture_2_, BakedQuad p_getConnectedTexture_3_, RenderEnv p_getConnectedTexture_4_) {
    ...
    if (block instanceof net.minecraft.block.BlockPane && textureatlassprite.getIconName().startsWith("minecraft:blocks/glass_pane_top")) {
  ...
  private static TextureAtlasSprite getConnectedTexture(ConnectedProperties p_getConnectedTexture_0_, IBlockAccess p_getConnectedTexture_1_, BlockStateBase p_getConnectedTexture_2_, BlockPos p_getConnectedTexture_3_, int p_getConnectedTexture_4_, TextureAtlasSprite p_getConnectedTexture_5_, RenderEnv p_getConnectedTexture_6_) {
    ...
    if (i1 >= p_getConnectedTexture_0_.minHeight && i1 <= p_getConnectedTexture_0_.maxHeight) {
      ...
      switch (p_getConnectedTexture_0_.method) {
        case 1:
          return getConnectedTextureCtm(p_getConnectedTexture_0_, p_getConnectedTexture_1_, (IBlockState)p_getConnectedTexture_2_, p_getConnectedTexture_3_, i, p_getConnectedTexture_4_, p_getConnectedTexture_5_, j, p_getConnectedTexture_6_);
        case 2:
          return getConnectedTextureHorizontal(p_getConnectedTexture_0_, p_getConnectedTexture_1_, (IBlockState)p_getConnectedTexture_2_, p_getConnectedTexture_3_, i, p_getConnectedTexture_4_, p_getConnectedTexture_5_, j);
        case 3:
          return getConnectedTextureTop(p_getConnectedTexture_0_, p_getConnectedTexture_1_, (IBlockState)p_getConnectedTexture_2_, p_getConnectedTexture_3_, i, p_getConnectedTexture_4_, p_getConnectedTexture_5_, j);
        case 4:
        ...
        case 6:
          return getConnectedTextureVertical(p_getConnectedTexture_0_, p_getConnectedTexture_1_, (IBlockState)p_getConnectedTexture_2_, p_getConnectedTexture_3_, i, p_getConnectedTexture_4_, p_getConnectedTexture_5_, j);
        case 7:
          return getConnectedTextureFixed(p_getConnectedTexture_0_);
        case 8:
          return getConnectedTextureHorizontalVertical(p_getConnectedTexture_0_, p_getConnectedTexture_1_, (IBlockState)p_getConnectedTexture_2_, p_getConnectedTexture_3_, i, p_getConnectedTexture_4_, p_getConnectedTexture_5_, j);
        case 9:
          return getConnectedTextureVerticalHorizontal(p_getConnectedTexture_0_, p_getConnectedTexture_1_, (IBlockState)p_getConnectedTexture_2_, p_getConnectedTexture_3_, i, p_getConnectedTexture_4_, p_getConnectedTexture_5_, j);
      } 
      return null;
    } 
    return null;
  ...
  public static void updateIcons(TextureMap p_updateIcons_0_) {
    ...
    if (Config.isConnectedTextures()) {
      ...
      updateIcons(p_updateIcons_0_, (IResourcePack)Config.getDefaultResourcePack());
  ...
  private static ConnectedProperties[][] propertyListToArray(List<List> p_propertyListToArray_0_) {
    ...
    for (int i = 0; i < p_propertyListToArray_0_.size(); i++) {
      List list = p_propertyListToArray_0_.get(i);
      if (list != null) {
        ConnectedProperties[] aconnectedproperties1 = (ConnectedProperties[])list.toArray((Object[])new ConnectedProperties[list.size()]);
  ...
  private static void addToList(ConnectedProperties p_addToList_0_, List<List> p_addToList_1_, int p_addToList_2_) {
    ...
    List<ConnectedProperties> list = p_addToList_1_.get(p_addToList_2_);
    if (list == null) {
      list = new ArrayList();
...
/* Location:              C:\Users\Joona\Downloads\Cupid.jar!\optifine\ConnectedTextures.class

...
public class HttpPipelineConnection {
  ...
  public synchronized boolean addRequest(HttpPipelineRequest p_addRequest_1_) {
    if (isClosed())
      return false; 
    addRequest(p_addRequest_1_, this.listRequests);
    addRequest(p_addRequest_1_, this.listRequestsSend);
    this.countRequests++;
    return true;
  }
...
/* Location:              C:\Users\Joona\Downloads\Cupid.jar!\optifine\HttpPipelineConnection.class

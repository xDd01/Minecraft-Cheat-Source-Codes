...
public class CustomSkyLayer {
  ...
  public CustomSkyLayer(Properties p_i35_1_, String p_i35_2_) {
    ...
    this.startFadeIn = parseTime(p_i35_1_.getProperty("startFadeIn"));
    this.endFadeIn = parseTime(p_i35_1_.getProperty("endFadeIn"));
    this.startFadeOut = parseTime(p_i35_1_.getProperty("startFadeOut"));
    this.endFadeOut = parseTime(p_i35_1_.getProperty("endFadeOut"));
    this.blend = Blender.parseBlend(p_i35_1_.getProperty("blend"));
    this.rotate = parseBoolean(p_i35_1_.getProperty("rotate"), true);
    this.speed = parseFloat(p_i35_1_.getProperty("speed"), 1.0F);
    this.axis = parseAxis(p_i35_1_.getProperty("axis"), DEFAULT_AXIS);
  ...
  public void render(int p_render_1_, float p_render_2_, float p_render_3_) {
    float f = p_render_3_ * getFadeBrightness(p_render_1_);
...
/* Location:              C:\Users\Joona\Downloads\Cupid.jar!\optifine\CustomSkyLayer.class

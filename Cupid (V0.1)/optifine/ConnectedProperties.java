...
public class ConnectedProperties {
  ...
  public ConnectedProperties(Properties p_i32_1_, String p_i32_2_) {
    ...
    this.matchTiles = parseMatchTiles(p_i32_1_.getProperty("matchTiles"));
    this.method = parseMethod(p_i32_1_.getProperty("method"));
    this.tiles = parseTileNames(p_i32_1_.getProperty("tiles"));
...
/* Location:              C:\Users\Joona\Downloads\Cupid.jar!\optifine\ConnectedProperties.class

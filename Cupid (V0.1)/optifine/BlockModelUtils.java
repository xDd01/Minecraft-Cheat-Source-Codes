...
public class BlockModelUtils {
  ...
  public static IBakedModel makeModelCube(TextureAtlasSprite p_makeModelCube_0_, int p_makeModelCube_1_) {
    ...
    List<List<BakedQuad>> list1 = new ArrayList(aenumfacing.length);
    ...
    return (IBakedModel)new SimpleBakedModel(list, list1, true, true, p_makeModelCube_0_, ItemCameraTransforms.DEFAULT);
  }
...
/* Location:              C:\Users\Joona\Downloads\Cupid.jar!\optifine\BlockModelUtils.class

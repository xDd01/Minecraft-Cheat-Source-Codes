...
public class Teleporter {
  ...
  public boolean placeInExistingPortal(Entity entityIn, float rotationYaw) {
    ...
    if (d0 >= 0.0D) {
      ...
      double d2 = (blockpattern$patternhelper.getFinger().getAxis() == EnumFacing.Axis.X) ? blockpattern$patternhelper.func_181117_a().getZ() : blockpattern$patternhelper.func_181117_a().getX();
  ...
  public boolean makePortal(Entity p_85188_1_) {
    ...
    for (int j2 = j - i; j2 <= j + i; j2++) {
      ...
      for (int l2 = l - i; l2 <= l + i; l2++) {
        ...
        int j3;
        label172: for (j3 = this.worldServerInstance.getActualHeight() - 1; j3 >= 0; j3--) {
          if (this.worldServerInstance.isAirBlock((BlockPos)blockpos$mutableblockpos.func_181079_c(j2, j3, l2))) {
            while (j3 > 0 && this.worldServerInstance.isAirBlock((BlockPos)blockpos$mutableblockpos.func_181079_c(j2, j3 - 1, l2)))
              j3--; 
              ...
              for (int j4 = 0; j4 < 3; j4++) {
                for (int k4 = 0; k4 < 4; k4++) {
                  for (int l4 = -1; l4 < 4; ) {
                    ...
                    if (l4 >= 0 || this.worldServerInstance.getBlockState((BlockPos)blockpos$mutableblockpos).getBlock().getMaterial().isSolid()) {
                      if (l4 >= 0 && !this.worldServerInstance.isAirBlock((BlockPos)blockpos$mutableblockpos))
                        continue label172; 
                      l4++;
                    } 
                    continue label172;
    ...
    if (d0 < 0.0D)
      for (int l5 = j - i; l5 <= j + i; l5++) {
        ...
        for (int j6 = l - i; j6 <= l + i; j6++) {
          ...
          int i7;
          label169: for (i7 = this.worldServerInstance.getActualHeight() - 1; i7 >= 0; i7--) {
            if (this.worldServerInstance.isAirBlock((BlockPos)blockpos$mutableblockpos.func_181079_c(l5, i7, j6))) {
              while (i7 > 0 && this.worldServerInstance.isAirBlock((BlockPos)blockpos$mutableblockpos.func_181079_c(l5, i7 - 1, j6)))
                i7--; 
              for (int k7 = i2; k7 < i2 + 2; k7++) {
                ...
                for (int j10 = 0; j10 < 4; j10++) {
                  for (int j11 = -1; j11 < 4; ) {
                    ...
                    if (j11 >= 0 || this.worldServerInstance.getBlockState((BlockPos)blockpos$mutableblockpos).getBlock().getMaterial().isSolid()) {
                      if (j11 >= 0 && !this.worldServerInstance.isAirBlock((BlockPos)blockpos$mutableblockpos))
                        continue label169; 
                      j11++;
                    } 
                    continue label169;
    ...
    IBlockState iblockstate = Blocks.portal.getDefaultState().withProperty((IProperty)BlockPortal.AXIS, (l6 != 0) ? (Comparable)EnumFacing.Axis.X : (Comparable)EnumFacing.Axis.Z);

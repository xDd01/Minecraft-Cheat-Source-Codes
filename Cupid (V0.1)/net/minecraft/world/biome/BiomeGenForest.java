...
public class BiomeGenForest extends BiomeGenBase {
  ...
  public BiomeGenForest(int p_i45377_1_, int p_i45377_2_) {
    ...
    if (this.field_150632_aF == 0)
      this.spawnableCreatureList.add(new BiomeGenBase.SpawnListEntry((Class)EntityWolf.class, 5, 4, 4)); 
  ...
  public WorldGenAbstractTree genBigTreeChance(Random rand) {
    return (this.field_150632_aF == 3 && rand.nextInt(3) > 0) ? (WorldGenAbstractTree)field_150631_aE : ((this.field_150632_aF != 2 && rand.nextInt(5) != 0) ? (WorldGenAbstractTree)this.worldGeneratorTrees : (WorldGenAbstractTree)field_150630_aD);
  }
  ...
  protected BiomeGenBase createMutatedBiome(int p_180277_1_) {
    ...
    return (this.biomeID != BiomeGenBase.birchForest.biomeID && this.biomeID != BiomeGenBase.birchForestHills.biomeID) ? new BiomeGenMutated(p_180277_1_, this) {
        ...
        public WorldGenAbstractTree genBigTreeChance(Random rand) {
          return rand.nextBoolean() ? (WorldGenAbstractTree)BiomeGenForest.field_150629_aC : (WorldGenAbstractTree)BiomeGenForest.field_150630_aD;
        }
      };
  }
}

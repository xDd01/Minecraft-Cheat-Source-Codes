...
public class BiomeGenMesa extends BiomeGenBase {
  ...
  public BiomeGenMesa(int p_i45380_1_, boolean p_i45380_2_, boolean p_i45380_3_) {
    ...
    this.topBlock = Blocks.sand.getDefaultState().withProperty((IProperty)BlockSand.VARIANT, (Comparable)BlockSand.EnumType.RED_SAND);
          ...
          if (l == -1) {
            ...
            if (i1 < l1 - 1) {
              ...
              if (iblockstate3.getBlock() == Blocks.stained_hardened_clay)
                chunkPrimerIn.setBlockState(k1, i1, j1, iblockstate3.getBlock().getDefaultState().withProperty((IProperty)BlockColored.COLOR, (Comparable)EnumDyeColor.ORANGE)); 
            } else if (this.field_150620_aI && i1 > 86 + k * 2) {
              if (flag) {
                chunkPrimerIn.setBlockState(k1, i1, j1, Blocks.dirt.getDefaultState().withProperty((IProperty)BlockDirt.VARIANT, (Comparable)BlockDirt.DirtType.COARSE_DIRT));
              } else {
              ...
              if (i1 >= 64 && i1 <= 127) {
                if (flag) {
                  ...
                  iblockstate4 = func_180629_a(p_180622_4_, i1, p_180622_5_);
                } 
              } else {
                iblockstate4 = Blocks.stained_hardened_clay.getDefaultState().withProperty((IProperty)BlockColored.COLOR, (Comparable)EnumDyeColor.ORANGE);
              } 
            ...
            l--;
            if (flag1) {
              chunkPrimerIn.setBlockState(k1, i1, j1, Blocks.stained_hardened_clay.getDefaultState().withProperty((IProperty)BlockColored.COLOR, (Comparable)EnumDyeColor.ORANGE));
            } else {
              IBlockState iblockstate2 = func_180629_a(p_180622_4_, i1, p_180622_5_);
  ...
  private void func_150619_a(long p_150619_1_) {
    ...
    Arrays.fill((Object[])this.field_150621_aC, Blocks.hardened_clay.getDefaultState());
    Random random = new Random(p_150619_1_);
    this.field_150625_aG = new NoiseGeneratorPerlin(random, 1);
    for (int l1 = 0; l1 < 64; l1++) {
      l1 += random.nextInt(5) + 1;
      if (l1 < 64)
        this.field_150621_aC[l1] = Blocks.stained_hardened_clay.getDefaultState().withProperty((IProperty)BlockColored.COLOR, (Comparable)EnumDyeColor.ORANGE); 
    } 
    ...
    for (int i = 0; i < i2; i++) {
      ...
      for (int l = 0; k + l < 64 && l < j; l++)
        this.field_150621_aC[k + l] = Blocks.stained_hardened_clay.getDefaultState().withProperty((IProperty)BlockColored.COLOR, (Comparable)EnumDyeColor.YELLOW); 
    } 
    ...
    for (int k2 = 0; k2 < j2; k2++) {
      ...
      for (int i1 = 0; l3 + i1 < 64 && i1 < i3; i1++)
        this.field_150621_aC[l3 + i1] = Blocks.stained_hardened_clay.getDefaultState().withProperty((IProperty)BlockColored.COLOR, (Comparable)EnumDyeColor.BROWN); 
    } 
    ...
    for (int j3 = 0; j3 < l2; j3++) {
      ...
      for (int j1 = 0; k4 + j1 < 64 && j1 < i4; j1++)
        this.field_150621_aC[k4 + j1] = Blocks.stained_hardened_clay.getDefaultState().withProperty((IProperty)BlockColored.COLOR, (Comparable)EnumDyeColor.RED); 
    } 
    ...
    for (int l4 = 0; l4 < k3; l4++) {
      ...
      for (int k1 = 0; j4 + k1 < 64 && k1 < i5; k1++) {
        this.field_150621_aC[j4 + k1] = Blocks.stained_hardened_clay.getDefaultState().withProperty((IProperty)BlockColored.COLOR, (Comparable)EnumDyeColor.WHITE);
        if (j4 + k1 > 1 && random.nextBoolean())
          this.field_150621_aC[j4 + k1 - 1] = Blocks.stained_hardened_clay.getDefaultState().withProperty((IProperty)BlockColored.COLOR, (Comparable)EnumDyeColor.SILVER); 

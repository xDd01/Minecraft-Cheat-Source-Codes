...
public class BiomeGenTaiga extends BiomeGenBase {
  ...
  public BiomeGenTaiga(int p_i45385_1_, int p_i45385_2_) {
    ...
    this.spawnableCreatureList.add(new BiomeGenBase.SpawnListEntry((Class)EntityWolf.class, 8, 4, 4));
  ...
  public WorldGenAbstractTree genBigTreeChance(Random rand) {
    return ((this.field_150644_aH == 1 || this.field_150644_aH == 2) && rand.nextInt(3) == 0) ? ((this.field_150644_aH != 2 && rand.nextInt(13) != 0) ? (WorldGenAbstractTree)field_150641_aE : (WorldGenAbstractTree)field_150642_aF) : ((rand.nextInt(3) == 0) ? (WorldGenAbstractTree)field_150639_aC : (WorldGenAbstractTree)field_150640_aD);
  }

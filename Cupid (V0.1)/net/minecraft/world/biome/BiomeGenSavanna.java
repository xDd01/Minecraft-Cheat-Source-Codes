...
public class BiomeGenSavanna extends BiomeGenBase {
  ...
  protected BiomeGenSavanna(int p_i45383_1_) {
    super(p_i45383_1_);
    this.spawnableCreatureList.add(new BiomeGenBase.SpawnListEntry((Class)EntityHorse.class, 1, 2, 6));
  ...
  public WorldGenAbstractTree genBigTreeChance(Random rand) {
    return (rand.nextInt(5) > 0) ? (WorldGenAbstractTree)field_150627_aC : (WorldGenAbstractTree)this.worldGeneratorTrees;
  }

...
public class ChunkLoader {
  ...
  public static void convertToAnvilFormat(AnvilConverterData p_76690_0_, NBTTagCompound p_76690_1_, WorldChunkManager p_76690_2_) {
    ...
    p_76690_1_.setTag("Sections", (NBTBase)nbttaglist);
    ...
    for (int l2 = 0; l2 < 16; l2++) {
      for (int i3 = 0; i3 < 16; i3++) {
        ...
        abyte[i3 << 4 | l2] = (byte)((p_76690_2_.getBiomeGenerator((BlockPos)blockpos$mutableblockpos, BiomeGenBase.field_180279_ad)).biomeID & 0xFF);
      } 
    } 
    p_76690_1_.setByteArray("Biomes", abyte);
    p_76690_1_.setTag("Entities", (NBTBase)p_76690_0_.entities);
    p_76690_1_.setTag("TileEntities", (NBTBase)p_76690_0_.tileEntities);
    if (p_76690_0_.tileTicks != null)
      p_76690_1_.setTag("TileTicks", (NBTBase)p_76690_0_.tileTicks); 
  }

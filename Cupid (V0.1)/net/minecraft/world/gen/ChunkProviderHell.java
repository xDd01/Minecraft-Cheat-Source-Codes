...
public class ChunkProviderHell implements IChunkProvider {
  ...
  private final WorldGenerator field_177467_w = (WorldGenerator)new WorldGenMinable(Blocks.quartz_ore.getDefaultState(), 14, (Predicate)BlockHelper.forBlock(Blocks.netherrack));
  
  private final WorldGenHellLava field_177473_x = new WorldGenHellLava((Block)Blocks.flowing_lava, true);
  
  private final WorldGenHellLava field_177472_y = new WorldGenHellLava((Block)Blocks.flowing_lava, false);
  ...
  public void func_180515_a(int p_180515_1_, int p_180515_2_, ChunkPrimer p_180515_3_) {
    ...
    int l = 17;
    int i1 = i + 1;
    this.noiseField = initializeNoiseField(this.noiseField, p_180515_1_ * i, 0, p_180515_2_ * i, k, l, i1);

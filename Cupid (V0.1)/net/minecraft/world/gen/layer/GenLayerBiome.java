      ...
      for (int j = 0; j < areaWidth; j++) {
        ...
        if (this.field_175973_g != null && this.field_175973_g.fixedBiome >= 0) {
          ...
          if (l > 0) {
            ...
            aint1[j + i * areaWidth] = (this.field_151623_c[nextInt(this.field_151623_c.length)]).biomeID;
          } 
        } else if (k == 2) {
          if (l > 0) {
            aint1[j + i * areaWidth] = BiomeGenBase.jungle.biomeID;
          } else {
            aint1[j + i * areaWidth] = (this.field_151621_d[nextInt(this.field_151621_d.length)]).biomeID;
          } 
        } else if (k == 3) {
          if (l > 0) {

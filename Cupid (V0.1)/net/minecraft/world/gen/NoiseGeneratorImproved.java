    ...
    if (p_76308_9_ == 1) {
      ...
      for (int j2 = 0; j2 < p_76308_8_; j2++) {
        ...
        for (int j6 = 0; j6 < p_76308_10_; j6++) {
          ...
          d14 = lerp(d18, func_76309_a(this.permutations[j5], d17, d19), grad(this.permutations[k5], d17 - 1.0D, 0.0D, d19));
          d15 = lerp(d18, grad(this.permutations[j5 + 1], d17, 0.0D, d19 - 1.0D), grad(this.permutations[k5 + 1], d17 - 1.0D, 0.0D, d19 - 1.0D));
          double d21 = lerp(d20, d14, d15);
          int i7 = l5++;
          p_76308_1_[i7] = p_76308_1_[i7] + d21 * d16;
        } 
      } 
    } else {
      int i = 0;
        ...
        for (int k3 = 0; k3 < p_76308_10_; k3++) {
          ...
          for (int j4 = 0; j4 < p_76308_9_; j4++) {
            ...
            if (j4 == 0 || l4 != k) {
              ...
              d1 = lerp(d6, grad(this.permutations[i1], d5, d9, d7), grad(this.permutations[l1], d5 - 1.0D, d9, d7));
              d2 = lerp(d6, grad(this.permutations[j1], d5, d9 - 1.0D, d7), grad(this.permutations[i2], d5 - 1.0D, d9 - 1.0D, d7));
              d3 = lerp(d6, grad(this.permutations[i1 + 1], d5, d9, d7 - 1.0D), grad(this.permutations[l1 + 1], d5 - 1.0D, d9, d7 - 1.0D));
              d4 = lerp(d6, grad(this.permutations[j1 + 1], d5, d9 - 1.0D, d7 - 1.0D), grad(this.permutations[i2 + 1], d5 - 1.0D, d9 - 1.0D, d7 - 1.0D));
            } 
            double d11 = lerp(d10, d1, d2);
            double d12 = lerp(d10, d3, d4);
            double d13 = lerp(d8, d11, d12);
            int j7 = i++;
            p_76308_1_[j7] = p_76308_1_[j7] + d13 * d0;
          } 
        } 
      } 
    } 

  ...
  protected boolean isLiquidInStructureBoundingBox(World worldIn, StructureBoundingBox boundingboxIn) {
    ...
    for (int k1 = i; k1 <= l; k1++) {
      for (int l1 = k; l1 <= j1; l1++) {
        if (worldIn.getBlockState((BlockPos)blockpos$mutableblockpos.func_181079_c(k1, j, l1)).getBlock().getMaterial().isLiquid())
          return true; 
        if (worldIn.getBlockState((BlockPos)blockpos$mutableblockpos.func_181079_c(k1, i1, l1)).getBlock().getMaterial().isLiquid())
          return true; 
      } 
    } 
    for (int i2 = i; i2 <= l; i2++) {
      for (int k2 = j; k2 <= i1; k2++) {
        if (worldIn.getBlockState((BlockPos)blockpos$mutableblockpos.func_181079_c(i2, k2, k)).getBlock().getMaterial().isLiquid())
          return true; 
        if (worldIn.getBlockState((BlockPos)blockpos$mutableblockpos.func_181079_c(i2, k2, j1)).getBlock().getMaterial().isLiquid())
          return true; 
      } 
    } 
    for (int j2 = k; j2 <= j1; j2++) {
      for (int l2 = j; l2 <= i1; l2++) {
        if (worldIn.getBlockState((BlockPos)blockpos$mutableblockpos.func_181079_c(i, l2, j2)).getBlock().getMaterial().isLiquid())
          return true; 
        if (worldIn.getBlockState((BlockPos)blockpos$mutableblockpos.func_181079_c(l, l2, j2)).getBlock().getMaterial().isLiquid())
          return true; 
      } 
    } 
    return false;

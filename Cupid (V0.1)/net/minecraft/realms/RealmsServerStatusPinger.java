    ...
    if (p_pingServer_1_ != null && !p_pingServer_1_.startsWith("0.0.0.0") && !p_pingServer_1_.isEmpty()) {
      ...
      networkmanager.setNetHandler((INetHandler)new INetHandlerStatusClient() {
            ...
            public void handleServerInfo(S00PacketServerInfo packetIn) {
              ...
              networkmanager.sendPacket((Packet)new C01PacketPing(Realms.currentTimeMillis()));
      ...
      try {
        networkmanager.sendPacket((Packet)new C00Handshake(RealmsSharedConstants.NETWORK_PROTOCOL_VERSION, realmsserveraddress.getHost(), realmsserveraddress.getPort(), EnumConnectionState.STATUS));

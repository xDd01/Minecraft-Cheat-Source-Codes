...
public class Item {
  ...
  public static void registerItems() {
    ...
    registerItemBlock((Block)Blocks.sand, (new ItemMultiTexture((Block)Blocks.sand, (Block)Blocks.sand, new Function<ItemStack, String>() {
            public String apply(ItemStack p_apply_1_) {
    ...
    registerItemBlock(Blocks.sponge, (new ItemMultiTexture(Blocks.sponge, Blocks.sponge, new Function<ItemStack, String>() {
            public String apply(ItemStack p_apply_1_) {
              return ((p_apply_1_.getMetadata() & 0x1) == 1) ? "wet" : "dry";
            }
    ...
    registerItemBlock((Block)Blocks.yellow_flower, (new ItemMultiTexture((Block)Blocks.yellow_flower, (Block)Blocks.yellow_flower, new Function<ItemStack, String>() {
            public String apply(ItemStack p_apply_1_) {
    ...
    registerItemBlock((Block)Blocks.red_flower, (new ItemMultiTexture((Block)Blocks.red_flower, (Block)Blocks.red_flower, new Function<ItemStack, String>() {
            public String apply(ItemStack p_apply_1_) {
    ...
    registerItemBlock((Block)Blocks.double_plant, (new ItemDoublePlant((Block)Blocks.double_plant, (Block)Blocks.double_plant, new Function<ItemStack, String>() {
            public String apply(ItemStack p_apply_1_) {

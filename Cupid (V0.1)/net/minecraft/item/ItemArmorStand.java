...
public class ItemArmorStand extends Item {
  ...
  public boolean onItemUse(ItemStack stack, EntityPlayer playerIn, World worldIn, BlockPos pos, EnumFacing side, float hitX, float hitY, float hitZ) {
    ...
    int i = flag1 | ((!worldIn.isAirBlock(blockpos1) && !worldIn.getBlockState(blockpos1).getBlock().isReplaceable(worldIn, blockpos1)) ? 1 : 0);
    if (i != 0)
      return false; 
    ...
    if (!worldIn.isRemote) {
      ...
      worldIn.spawnEntityInWorld((Entity)entityarmorstand);
    } 
    stack.stackSize--;
    return true;
  }

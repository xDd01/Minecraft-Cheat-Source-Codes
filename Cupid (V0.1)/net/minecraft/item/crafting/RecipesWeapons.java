  ...
  public void addRecipes(CraftingManager p_77583_1_) {
    for (int i = 0; i < (this.recipeItems[0]).length; i++) {
      ...
      for (int j = 0; j < this.recipeItems.length - 1; j++) {
        ...
        p_77583_1_.addRecipe(new ItemStack(item), new Object[] { this.recipePatterns[j], Character.valueOf('#'), Items.stick, Character.valueOf('X'), object });
      } 
    } 
    p_77583_1_.addRecipe(new ItemStack((Item)Items.bow, 1), new Object[] { " #X", "# X", " #X", Character.valueOf('X'), Items.string, Character.valueOf('#'), Items.stick });

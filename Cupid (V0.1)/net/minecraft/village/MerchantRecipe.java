...
public class MerchantRecipe {
  ...
  public NBTTagCompound writeToTags() {
    ...
    nbttagcompound.setTag("buy", (NBTBase)this.itemToBuy.writeToNBT(new NBTTagCompound()));
    nbttagcompound.setTag("sell", (NBTBase)this.itemToSell.writeToNBT(new NBTTagCompound()));
    if (this.secondItemToBuy != null)
      nbttagcompound.setTag("buyB", (NBTBase)this.secondItemToBuy.writeToNBT(new NBTTagCompound())); 

...
import me.rhys.base.event.impl.player.PlayerCollisionEvent;
...
public class Block {
  ...
  public void addCollisionBoxesToList(World worldIn, BlockPos pos, IBlockState state, AxisAlignedBB mask, List<AxisAlignedBB> list, Entity collidingEntity) {
    AxisAlignedBB box = getCollisionBoundingBox(worldIn, pos, state);
    PlayerCollisionEvent event = (PlayerCollisionEvent)Lite.EVENT_BUS.call((Event)new PlayerCollisionEvent(collidingEntity, box, pos));
    box = event.getBox();
    if (box != null && mask.intersectsWith(box) && !event.isCancelled())
      list.add(box); 
  }

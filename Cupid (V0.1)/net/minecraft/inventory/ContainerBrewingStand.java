...
public class ContainerBrewingStand extends Container {
  ...
  public ContainerBrewingStand(InventoryPlayer playerInventory, IInventory tileBrewingStandIn) {
    ...
    addSlotToContainer(new Potion(playerInventory.player, tileBrewingStandIn, 0, 56, 46));
    addSlotToContainer(new Potion(playerInventory.player, tileBrewingStandIn, 1, 79, 53));
    addSlotToContainer(new Potion(playerInventory.player, tileBrewingStandIn, 2, 102, 46));
    this.theSlot = addSlotToContainer(new Ingredient(tileBrewingStandIn, 3, 79, 17));
    for (int i = 0; i < 3; i++) {
      for (int j = 0; j < 9; j++)

...
public abstract class Container {
    ...
    if (mode == 5) {
      ...
      if ((i != 1 || this.dragEvent != 2) && i != this.dragEvent) {
        ...
        if (!this.dragSlots.isEmpty()) {
          ...
          for (Slot slot1 : this.dragSlots) {
            if (slot1 != null && canAddItemToSlot(slot1, inventoryplayer.getItemStack(), true) && slot1.isItemValid(inventoryplayer.getItemStack()) && (inventoryplayer.getItemStack()).stackSize >= this.dragSlots.size() && canDragIntoSlot(slot1)) {
      ...
      if (itemstack4 != null && (slot2 == null || !slot2.getHasStack() || !slot2.canTakeStack(playerIn))) {
        ...
        for (int l2 = 0; l2 < 2; l2++) {
          int i3;
          for (i3 = i1; i3 >= 0 && i3 < this.inventorySlots.size() && itemstack4.stackSize < itemstack4.getMaxStackSize(); i3 += j1) {
  ...
  public static boolean canAddItemToSlot(Slot slotIn, ItemStack stack, boolean stackSizeMatters) {
    ...
    if (slotIn != null && slotIn.getHasStack() && stack != null && stack.isItemEqual(slotIn.getStack()) && ItemStack.areItemStackTagsEqual(slotIn.getStack(), stack))
      i = flag | (((slotIn.getStack()).stackSize + (stackSizeMatters ? 0 : stack.stackSize) <= stack.getMaxStackSize()) ? 1 : 0); 
    return i;
  }

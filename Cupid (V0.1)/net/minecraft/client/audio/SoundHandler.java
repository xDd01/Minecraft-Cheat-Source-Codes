...
public class SoundHandler implements IResourceManagerReloadListener, ITickable {
  ...
  private void loadSoundResource(ResourceLocation location, SoundList sounds) {
    ...
    for (SoundList.SoundEntry soundlist$soundentry : sounds.getSoundList()) {
      Object<SoundPoolEntry> lvt_10_1_;
      ...
      switch (soundlist$soundentry.getSoundEntryType()) {
        case FILE:
          ...
          lvt_10_1_ = (Object<SoundPoolEntry>)new SoundEventAccessor(new SoundPoolEntry(resourcelocation1, soundlist$soundentry.getSoundEntryPitch(), soundlist$soundentry.getSoundEntryVolume(), soundlist$soundentry.isStreaming()), soundlist$soundentry.getSoundEntryWeight());
          break;
        case SOUND_EVENT:
          lvt_10_1_ = (Object<SoundPoolEntry>)new ISoundEventAccessor<SoundPoolEntry>() {

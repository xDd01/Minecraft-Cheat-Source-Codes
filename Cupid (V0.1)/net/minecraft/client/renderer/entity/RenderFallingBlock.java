    ...
    if (entity.getBlock() != null) {
      ...
      if (iblockstate != world.getBlockState(blockpos) && block.getRenderType() != -1)
        if (block.getRenderType() == 3) {
          ...
          IBakedModel ibakedmodel = blockrendererdispatcher.getModelFromBlockState(iblockstate, (IBlockAccess)world, (BlockPos)null);
          blockrendererdispatcher.getBlockModelRenderer().renderModel((IBlockAccess)world, ibakedmodel, iblockstate, blockpos, worldrenderer, false);

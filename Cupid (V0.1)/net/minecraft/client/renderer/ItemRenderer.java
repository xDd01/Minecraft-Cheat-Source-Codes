...
public class ItemRenderer {
  ...
  private void func_178105_d(float p_178105_1_) {
    ...
    Animations.SwingType swingType = animations.swingType;
    float f = ((animations.smoothSwing && swingType == Animations.SwingType.SMOOTH) ? -0.05F : -0.4F) * MathHelper.sin(MathHelper.sqrt_float(p_178105_1_) * 3.1415927F);
    float f1 = 0.2F * MathHelper.sin(MathHelper.sqrt_float(p_178105_1_) * 3.1415927F * 2.0F);
    float f2 = ((animations.smoothSwing && swingType == Animations.SwingType.SMOOTH) ? -0.2F : -0.2F) * MathHelper.sin(p_178105_1_ * 3.1415927F);
    GlStateManager.translate(f, f1, f2);
  }
      ...
      if (this.itemToRender.getItem() instanceof net.minecraft.item.ItemMap) {
        ...
        switch (ItemRenderer$1.field_178094_a[enumaction.ordinal()]) {
          ...
          case 3:
            ...
            break;
          case 4:
            animations = (Animations)Lite.MODULE_FACTORY.findByClass(Animations.class);
            if (animations.getData().isEnabled()) {
              ...
              switch (animations.getCurrentMode().getName()) {
                case "Exhibition":
                  if (this.itemToRender.getItem() instanceof net.minecraft.item.ItemSword) {
                    float f4 = MathHelper.sin((float)(MathHelper.sqrt_float(f1) * 3.1D));
                    GL11.glTranslated(-0.1D, 0.1D, 0.0D);
                    transformFirstPersonItem(!animations.equipReset ? 0.0F : (f / 3.0F), 0.0F);
                    GlStateManager.rotate(-f4 * 40.0F / 2.0F, f4 / 2.0F, -0.0F, 9.0F);
                    GlStateManager.rotate(-f4 * 30.0F, 1.0F, f4 / 2.0F, -0.0F);
                    func_178103_d();
                  } 
                  break;
                case "Slide":
                  genCustom(f / 180.0F, f1 / 180.0F);
                  func_178103_d();
                  var9 = MathHelper.sin(MathHelper.sqrt_float(f1) * 3.0515926F);
                  GlStateManager.translate(-0.5F, 0.4F, 0.0F);
                  GlStateManager.rotate(-var9 * 50.0F, -8.0F, -0.0F, 9.0F);
                  GlStateManager.rotate(-var9 * 70.0F, 1.0F, -0.2F, -0.0F);
                  break;
                case "Up":
                  transformFirstPersonItem(f - 0.51F, f1);
                  GL11.glTranslated(0.3D, 0.0D, 0.0D);
                  func_178103_d();
                  break;
                case "UpperCut":
                  if (this.itemToRender.getItem() instanceof net.minecraft.item.ItemSword) {
                    float f4 = MathHelper.sin((float)(MathHelper.sqrt_float(f1) * 5.2D));
                    GL11.glTranslated(-0.2D, 0.2D, 0.0D);
                    transformFirstPersonItem(!animations.equipReset ? 0.0F : (f / 3.0F), 0.0F);
                    GlStateManager.rotate(-f4 * 50.0F / 2.5F, f4 / 2.0F, -0.0F, 7.5F);
                    GlStateManager.rotate(-f4 * 30.0F, 1.2F, f4 / 2.0F, -0.0F);
                    func_178103_d();
                  } 
                  break;
                case "Jax":
                  if (this.itemToRender.getItem() instanceof net.minecraft.item.ItemSword) {
                    float f4 = MathHelper.sin((float)(MathHelper.sqrt_float(f1) * 2.2D));
                    GL11.glTranslated(-0.15D, 0.25D, 0.1D);
                    transformFirstPersonItem(!animations.equipReset ? 0.0F : (f / 3.0F), 0.0F);
                    GlStateManager.rotate(-f4 * 55.1F / 2.9F, f4 / 1.7F, -0.1F, 5.5F);
                    GlStateManager.rotate(-f4 * 55.5F, 1.4F, f4 / 1.6F, -0.0F);
                    func_178103_d();
                  } 
                  break;
                case "Chop":
                  ...
                  func_178103_d();
                  var9 = MathHelper.sin(MathHelper.sqrt_float(f1) * 3.0515926F);
                  f6 = MathHelper.sin((float)(MathHelper.sqrt_float(f1) * 2.2D));
                  GlStateManager.translate(-0.5F, 0.4F, 0.0F);
                  GlStateManager.rotate(-var9 * 55.0F, -8.001F, -0.0F, 9.0F);
                  GlStateManager.rotate(-var9 * 73.0F, 1.05F, -0.2F, -0.0F);
                  GlStateManager.rotate(-f6 * 32.0F / 2.2F, f6 / 1.74F, -0.0F, 5.5F);
                  GlStateManager.rotate(-f6 * 8.0F, 1.8F, f6 / 1.52F, -0.0F);
                  break;
                case "Allah":
                  swingProgress = this.mc.thePlayer.getSwingProgress(partialTicks);
        ...
        Animations animations = (Animations)Lite.MODULE_FACTORY.findByClass(Animations.class);
        boolean mexifyIsAnigger = (animations.smoothSwing && animations.swingType == Animations.SwingType.GERMAN);
        if (!mexifyIsAnigger)
          func_178105_d(f1); 
  ...
  private void genCustom(float p_178096_1_, float p_178096_2_) {
    GlStateManager.translate(0.46F, -0.42F, -0.71999997F);
    ...
    GlStateManager.rotate(var4 * -35.7F, 0.2F, 0.1F, 1.0F);
    GlStateManager.rotate(var4 * -55.6F, 1.3F, 0.1F, 0.2F);
    GlStateManager.scale(0.3F, 0.3F, 0.3F);
  }
  
  private void transformFirstPersonItemBlock2(float var1, float var2) {
    GlStateManager.translate(0.56F, -0.52F, -0.71999997F);

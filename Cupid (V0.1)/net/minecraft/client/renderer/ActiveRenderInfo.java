...
public class ActiveRenderInfo {
  ...
  public static void updateRenderInfo(EntityPlayer entityplayerIn, boolean p_74583_1_) {
    ...
    rotationX = MathHelper.cos(f3 * 3.1415927F / 180.0F) * (1 - i * 2);
    rotationZ = MathHelper.sin(f3 * 3.1415927F / 180.0F) * (1 - i * 2);
    rotationYZ = -rotationZ * MathHelper.sin(f2 * 3.1415927F / 180.0F) * (1 - i * 2);
    rotationXY = rotationX * MathHelper.sin(f2 * 3.1415927F / 180.0F) * (1 - i * 2);
  ...
  public static Block getBlockAtEntityViewpoint(World worldIn, Entity p_180786_1_, float p_180786_2_) {
    ...
    if (block.getMaterial().isLiquid()) {
      ...
      if (iblockstate.getBlock() instanceof BlockLiquid)
        f = BlockLiquid.getLiquidHeightPercent(((Integer)iblockstate.getValue((IProperty)BlockLiquid.LEVEL)).intValue()) - 0.11111111F; 

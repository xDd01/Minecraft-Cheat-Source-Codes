...
public class TileEntityItemStackRenderer {
  ...
  public void renderByItem(ItemStack itemStackIn) {
    if (itemStackIn.getItem() == Items.banner) {
      ...
      TileEntityRendererDispatcher.instance.renderTileEntityAt((TileEntity)this.banner, 0.0D, 0.0D, 0.0D, 0.0F);
      ...
      if (block == Blocks.ender_chest) {
        TileEntityRendererDispatcher.instance.renderTileEntityAt((TileEntity)this.enderChest, 0.0D, 0.0D, 0.0D, 0.0F);
      } else if (block == Blocks.trapped_chest) {
        TileEntityRendererDispatcher.instance.renderTileEntityAt((TileEntity)this.field_147718_c, 0.0D, 0.0D, 0.0D, 0.0F);
      } else {
        TileEntityRendererDispatcher.instance.renderTileEntityAt((TileEntity)this.field_147717_b, 0.0D, 0.0D, 0.0D, 0.0F);
      } 
    } 
  }
}

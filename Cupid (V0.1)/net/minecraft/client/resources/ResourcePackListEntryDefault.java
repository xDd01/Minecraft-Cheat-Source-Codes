...
public class ResourcePackListEntryDefault extends ResourcePackListEntry {
  ...
  protected String func_148311_a() {
    try {
      PackMetadataSection packmetadatasection = this.field_148320_d.<PackMetadataSection>getPackMetadata((this.mc.getResourcePackRepository()).rprMetadataSerializer, "pack");

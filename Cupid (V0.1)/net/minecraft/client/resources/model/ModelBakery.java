...
public class ModelBakery {
  ...
  private ModelBlock loadModel(ResourceLocation p_177594_1_) throws IOException {
    ...
    if (s.startsWith("builtin/")) {
      ...
      IResource iresource = this.resourceManager.getResource(getModelLocation(p_177594_1_));
  ...
  private void loadModels() {
    ...
    while (!deque.isEmpty()) {
      ...
      try {
        ...
        LOGGER.warn("In parent chain: " + JOINER.join(getParentPath(resourcelocation2)) + "; unable to load model: '" + resourcelocation2 + "'", exception);
      } 

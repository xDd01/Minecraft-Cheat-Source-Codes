...
public class ModelIronGolem extends ModelBase {
  ...
  public void setLivingAnimations(EntityLivingBase entitylivingbaseIn, float p_78086_2_, float p_78086_3_, float partialTickTime) {
    ...
    if (i > 0) {
      this.ironGolemRightArm.rotateAngleX = -2.0F + 1.5F * func_78172_a(i - partialTickTime, 10.0F);
      this.ironGolemLeftArm.rotateAngleX = -2.0F + 1.5F * func_78172_a(i - partialTickTime, 10.0F);
    } else {
      int j = entityirongolem.getHoldRoseTick();
      if (j > 0) {
        this.ironGolemRightArm.rotateAngleX = -0.8F + 0.025F * func_78172_a(j, 70.0F);

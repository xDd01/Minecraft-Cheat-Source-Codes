...
public class ModelHorse extends ModelBase {
  ...
  public void setLivingAnimations(EntityLivingBase entitylivingbaseIn, float p_78086_2_, float p_78086_3_, float partialTickTime) {
    ...
    this.backLeftLeg.rotationPointY += MathHelper.sin(1.5707964F + f15 + f7 * -f10 * 0.5F * p_78086_3_) * 7.0F;
    this.backLeftLeg.rotationPointZ += MathHelper.cos(4.712389F + f15 + f7 * -f10 * 0.5F * p_78086_3_) * 7.0F;
    this.backRightLeg.rotationPointY += MathHelper.sin(1.5707964F + f15 + f7 * f10 * 0.5F * p_78086_3_) * 7.0F;
    this.backRightLeg.rotationPointZ += MathHelper.cos(4.712389F + f15 + f7 * f10 * 0.5F * p_78086_3_) * 7.0F;
    float f17 = (-1.0471976F + f16) * f6 + f11 * f7;
    float f18 = (-1.0471976F + -f16) * f6 + -f11 * f7;
    this.frontLeftLeg.rotationPointY += MathHelper.sin(1.5707964F + f17) * 7.0F;
    this.frontLeftLeg.rotationPointZ += MathHelper.cos(4.712389F + f17) * 7.0F;
    this.frontRightLeg.rotationPointY += MathHelper.sin(1.5707964F + f18) * 7.0F;
    this.frontRightLeg.rotationPointZ += MathHelper.cos(4.712389F + f18) * 7.0F;

...
public class WorldClient extends World {
  ...
  public WorldClient(NetHandlerPlayClient p_i45063_1_, WorldSettings p_i45063_2_, int p_i45063_3_, EnumDifficulty p_i45063_4_, Profiler p_i45063_5_) {
    super((ISaveHandler)new SaveHandlerMP(), new WorldInfo(p_i45063_2_, "MpServer"), WorldProvider.getProviderForDimension(p_i45063_3_), p_i45063_5_, true);
    ...
    if (this.mc.playerController != null && this.mc.playerController.getClass() == PlayerControllerMP.class)
      this.mc.playerController = (PlayerControllerMP)new PlayerControllerOF(this.mc, p_i45063_1_); 
  }
  ...
  public void doVoidFogParticles(int p_73029_1_, int p_73029_2_, int p_73029_3_) {
    ...
    for (int i = 0; i < 1000; i++) {
      ...
      IBlockState iblockstate = getBlockState((BlockPos)blockposm);
      ...
      if (flag && iblockstate.getBlock() == Blocks.barrier)
        spawnParticle(EnumParticleTypes.BARRIER, (j + 0.5F), (k + 0.5F), (l + 0.5F), 0.0D, 0.0D, 0.0D, new int[0]); 
    } 
  }

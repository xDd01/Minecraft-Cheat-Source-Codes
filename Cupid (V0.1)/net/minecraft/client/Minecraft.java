...
import me.rhys.base.util.hook.RenderHook;
...
public class Minecraft implements IThreadListener, IPlayerUsage {
  ...
  private void startGame() throws LWJGLException, IOException {
    ...
    AchievementList.openInventory.setStatStringFormatter(new IStatStringFormat() {
          public String formatString(String p_74535_1_) {
            try {
              return String.format(p_74535_1_, new Object[] { GameSettings.getKeyDisplayString(this.this$0.gameSettings.keyBindInventory.getKeyCode()) });
    ...
    this.ingameGUI = (GuiIngame)new RenderHook(this);
    Lite.initialize();
    Lite.EVENT_BUS.call((Event)new InitializeEvent());
    if (this.serverName != null) {
      displayGuiScreen((GuiScreen)new GuiConnecting((GuiScreen)new GuiMainMenu(), this, this.serverName, this.serverPort));
    } else {
  ...
  private void createDisplay() throws LWJGLException {
    ...
    Display.setTitle("Loading Cupid...");
    try {
  ...
  private void setWindowIcon() {
    ...
    if (util$enumos != Util.EnumOS.OSX) {
      ...
      try {
        inputstream = Fly.class.getResourceAsStream("/assets/minecraft/Lite/Logo16.png");
        inputstream1 = Fly.class.getResourceAsStream("/assets/minecraft/Lite/Logo32.png");
  ...
  private void sendClickBlockToController(boolean leftClick) {
    ...
    } else if (Lite.MODULE_FACTORY.findByClass(Animations.class).getData().isEnabled() && Animations.oldAnimations && 
      this.leftClickCounter <= 0) {
      if (leftClick && this.objectMouseOver != null && this.objectMouseOver.typeOfHit == MovingObjectPosition.MovingObjectType.BLOCK) {
        BlockPos blockpos = this.objectMouseOver.getBlockPos();
        if (this.theWorld.getBlockState(blockpos).getBlock().getMaterial() != Material.air && this.playerController.onPlayerDamageBlock(blockpos, this.objectMouseOver.sideHit)) {
    ...
    if (this.leftClickCounter <= 0) {
      ...
      if (this.objectMouseOver == null) {
        ...
        if (this.playerController.isNotCreative())
          if (Animations.delayFix && Lite.MODULE_FACTORY.findByClass(Animations.class).getData().isEnabled()) {
            this.leftClickCounter = 0;
          } else {
        ...
        BlockPos blockpos2 = this.objectMouseOver.getBlockPos();
        if (this.playerController.isNotCreative()) {
          if (Animations.delayFix && Lite.MODULE_FACTORY.findByClass(Animations.class).getData().isEnabled()) {
            this.leftClickCounter = 0;
          } else {
        ...
        } else if (Animations.oldAnimations && Lite.MODULE_FACTORY.findByClass(Animations.class).getData().isEnabled()) {
          this.playerController.clickBlock(blockpos2, this.objectMouseOver.sideHit);
        } 
      } 
    } 
  }
  ...
  private void rightClickMouse() {
    if (!this.playerController.func_181040_m()) {
      ...
      if (this.objectMouseOver == null) {
        ...
        switch (this.objectMouseOver.typeOfHit) {
          case FURNACE:
            if (this.playerController.func_178894_a((EntityPlayer)this.thePlayer, this.objectMouseOver.entityHit, this.objectMouseOver)) {
              flag = false;
              break;
            } 
  ...
  public void runTick() throws IOException {
    Lite.EVENT_BUS.call((Event)new TickEvent());
      ...
      while (Keyboard.next()) {
        ...
        if (Keyboard.getEventKeyState()) {
          ...
          if (this.currentScreen != null) {
            ...
            if (k == 1)
              displayInGameMenu(); 
            KeyboardInputEvent keyboardInputEvent = new KeyboardInputEvent(k);
            Lite.EVENT_BUS.call((Event)keyboardInputEvent);
      ...
      if (Keyboard.getEventKeyState()) {
        if (i == this.gameSettings.keyBindStreamStartStop.getKeyCode()) {
          if (getTwitchStream().isBroadcasting()) {
            ...
            displayGuiScreen((GuiScreen)new GuiYesNo(new GuiYesNoCallback() {

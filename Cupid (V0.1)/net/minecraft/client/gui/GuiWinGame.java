...
public class GuiWinGame extends GuiScreen {
  ...
  private void drawWinGameScreen(int p_146575_1_, int p_146575_2_, float p_146575_3_) {
    ...
    this;
    worldrenderer.pos(i, this.height, zLevel).tex((i * f2), (f * f2)).color(f3, f3, f3, 1.0F).endVertex();
    this;
    worldrenderer.pos(i, 0.0D, zLevel).tex((i * f2), (f1 * f2)).color(f3, f3, f3, 1.0F).endVertex();
    this;

...
public class GuiStats extends GuiScreen implements IProgressMeter {
  ...
  public void drawScreen(int mouseX, int mouseY, float partialTicks) {
    if (this.doesGuiPauseGame) {
      ...
      drawCenteredString(this.fontRendererObj, lanSearchStates[(int)(Minecraft.getSystemTime() / 150L % lanSearchStates.length)], this.width / 2, this.height / 2 + this.fontRendererObj.FONT_HEIGHT * 2, 16777215);
    } else {
  ...
  private void drawSprite(int p_146527_1_, int p_146527_2_, int p_146527_3_, int p_146527_4_) {
    ...
    this;
    worldrenderer.pos((p_146527_1_ + 0), (p_146527_2_ + 18), zLevel).tex(((p_146527_3_ + 0) * 0.0078125F), ((p_146527_4_ + 18) * 0.0078125F)).endVertex();
    this;
    worldrenderer.pos((p_146527_1_ + 18), (p_146527_2_ + 18), zLevel).tex(((p_146527_3_ + 18) * 0.0078125F), ((p_146527_4_ + 18) * 0.0078125F)).endVertex();
    this;
    worldrenderer.pos((p_146527_1_ + 18), (p_146527_2_ + 0), zLevel).tex(((p_146527_3_ + 18) * 0.0078125F), ((p_146527_4_ + 0) * 0.0078125F)).endVertex();
    this;
    worldrenderer.pos((p_146527_1_ + 0), (p_146527_2_ + 0), zLevel).tex(((p_146527_3_ + 0) * 0.0078125F), ((p_146527_4_ + 0) * 0.0078125F)).endVertex();
    tessellator.draw();
  }
      ...
      this.statSorter = new Comparator<StatCrafting>() {
          public int compare(StatCrafting p_compare_1_, StatCrafting p_compare_2_) {
            ...
            if (statbase != null || statbase1 != null) {
              ...
              int i1 = GuiStats.this.field_146546_t.readStat(statbase1);
              if (l != i1)
                return (l - i1) * GuiStats.StatsItem.this.field_148215_p; 
            } 
            return j - k;
          }
        };

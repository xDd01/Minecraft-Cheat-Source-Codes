...
public class GuiIngame extends Gui {
  ...
  public void renderGameOverlay(float partialTicks) {
    ...
    if (!this.mc.gameSettings.showDebugInfo) {
      ...
      try {
        Lite.EVENT_BUS.call((Event)new Render2DEvent(scaledresolution.getScaledWidth(), scaledresolution
              .getScaledHeight(), partialTicks));
    ...
    GlStateManager.enableBlend();
    if (showCrosshair() && this.mc.gameSettings.thirdPersonView < 1) {
    ...
    if (this.recordPlayingUpFor > 0) {
      ...
      if (k1 > 8) {
        ...
        getFontRenderer().drawString(this.recordPlaying, (-getFontRenderer().getStringWidth(this.recordPlaying) / 2), -4.0F, i1 + (k1 << 24 & 0xFF000000));
        GlStateManager.disableBlend();
        GlStateManager.popMatrix();
      } 
      this.mc.mcProfiler.endSection();
    ...
    if (this.field_175195_w > 0) {
      ...
      if (l1 > 8) {
        ...
        getFontRenderer().drawString(this.field_175201_x, (-getFontRenderer().getStringWidth(this.field_175201_x) / 2), -10.0F, 0xFFFFFF | j2, true);
        GlStateManager.popMatrix();
        GlStateManager.pushMatrix();
        GlStateManager.scale(2.0F, 2.0F, 2.0F);
        getFontRenderer().drawString(this.field_175200_y, (-getFontRenderer().getStringWidth(this.field_175200_y) / 2), 5.0F, 0xFFFFFF | j2, true);
        GlStateManager.popMatrix();
        GlStateManager.disableBlend();
        GlStateManager.popMatrix();
      } 
  ...
  public void renderExpBar(ScaledResolution p_175176_1_, int p_175176_2_) {
    ...
    if (this.mc.thePlayer.experienceLevel > 0) {
      ...
      int i1 = (p_175176_1_.getScaledWidth() - getFontRenderer().getStringWidth(s)) / 2;
  ...
  public void func_181551_a(ScaledResolution p_181551_1_) {
    ...
    if (this.remainingHighlightTicks > 0 && this.highlightingItemStack != null) {
      ...
      int i = (p_181551_1_.getScaledWidth() - getFontRenderer().getStringWidth(s)) / 2;
  ...
  public void renderDemo(ScaledResolution p_175185_1_) {
    ...
    getFontRenderer().drawStringWithShadow(s, (p_175185_1_.getScaledWidth() - i - 10), 5.0F, 16777215);
    this.mc.mcProfiler.endSection();
  }
  ...
  protected boolean showCrosshair() {
    ...
    if (this.mc.playerController.isSpectator()) {
      ...
      if (this.mc.objectMouseOver != null && this.mc.objectMouseOver.typeOfHit == MovingObjectPosition.MovingObjectType.BLOCK) {
        ...
        if (this.mc.theWorld.getTileEntity(blockpos) instanceof net.minecraft.inventory.IInventory)
          return true; 
      } 
      return false;
    } 
  ...
  private void renderScoreboard(ScoreObjective p_180475_1_, ScaledResolution p_180475_2_) {
    ...
    for (Object score : arraylist1) {
      ...
      String s = ScorePlayerTeam.formatPlayerName((Team)scoreplayerteam, ((Score)score).getPlayerName()) + ": " + EnumChatFormatting.RED + ((Score)score).getScorePoints();
    ...
    for (Object score1 : arraylist1) {
      ...
      String s1 = ScorePlayerTeam.formatPlayerName((Team)scoreplayerteam1, ((Score)score1).getPlayerName());
  ...
  private void renderBossHealth() {
    if (BossStatus.bossName != null && BossStatus.statusBarTime > 0) {
      ...
      getFontRenderer().drawStringWithShadow(s, (i / 2 - getFontRenderer().getStringWidth(s) / 2), (b0 - 10), l);
      GlStateManager.color(1.0F, 1.0F, 1.0F, 1.0F);
      this.mc.getTextureManager().bindTexture(icons);
    } 
  }

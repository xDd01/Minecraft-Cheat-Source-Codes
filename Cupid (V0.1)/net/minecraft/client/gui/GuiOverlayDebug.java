...
public class GuiOverlayDebug extends Gui {
  ...
  protected void renderDebugInfoLeft() {
    ...
    for (int i = 0; i < list.size(); i++) {
      ...
      if (!Strings.isNullOrEmpty(s)) {
        ...
        this.fontRenderer.drawString(s, 2.0F, l, 14737632);
      } 
    } 
  }
  ...
  protected List getDebugInfoRight() {
    ...
    if (this.mc.objectMouseOver != null && this.mc.objectMouseOver.typeOfHit == MovingObjectPosition.MovingObjectType.BLOCK && this.mc.objectMouseOver.getBlockPos() != null) {
      ...
      for (UnmodifiableIterator<Map.Entry> unmodifiableIterator = iblockstate.getProperties().entrySet().iterator(); unmodifiableIterator.hasNext(); arraylist.add(((IProperty)entry.getKey()).getName() + ": " + s)) {
  ...
  private void func_181554_e() {
    ...
    this.fontRenderer.drawString("60", 2.0F, (scaledresolution.getScaledHeight() - 30 + 2), 14737632);
    this;
    ...
    this.fontRenderer.drawString("30", 2.0F, (scaledresolution.getScaledHeight() - 60 + 2), 14737632);
    this;

...
public class GuiPageButtonList extends GuiListExtended {
  ...
  private void func_178060_e(int p_178060_1_, int p_178060_2_) {
    for (GuiListEntry guipagebuttonlist$guilistentry : this.field_178078_x[p_178060_1_]) {
      if (guipagebuttonlist$guilistentry != null)
        func_178066_a((Gui)this.field_178073_v.lookup(guipagebuttonlist$guilistentry.func_178935_b()), false); 
    } 
    for (GuiListEntry guipagebuttonlist$guilistentry1 : this.field_178078_x[p_178060_2_]) {
      if (guipagebuttonlist$guilistentry1 != null)
        func_178066_a((Gui)this.field_178073_v.lookup(guipagebuttonlist$guilistentry1.func_178935_b()), true); 
    } 
  }
  ...
  public static class GuiEntry implements GuiListExtended.IGuiListEntry {
    ...
    public boolean mousePressed(int slotIndex, int p_148278_2_, int p_148278_3_, int p_148278_4_, int p_148278_5_, int p_148278_6_) {
      boolean flag = func_178026_a(this.field_178029_b, p_148278_2_, p_148278_3_, p_148278_4_);
      boolean flag1 = func_178026_a(this.field_178030_c, p_148278_2_, p_148278_3_, p_148278_4_);
      return (flag || flag1);
    }

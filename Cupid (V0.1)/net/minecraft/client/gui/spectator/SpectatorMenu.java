...
public class SpectatorMenu {
  ...
  static class EndSpectatorObject implements ISpectatorMenuObject {
    ...
    public IChatComponent getSpectatorName() {
      return (IChatComponent)new ChatComponentText("Close menu");
    }
  ...
  static class MoveMenuObject implements ISpectatorMenuObject {
    ...
    public IChatComponent getSpectatorName() {
      return (this.field_178666_a < 0) ? (IChatComponent)new ChatComponentText("Previous Page") : (IChatComponent)new ChatComponentText("Next Page");
    }

...
public class PathNavigateGround extends PathNavigate {
  ...
  protected boolean canNavigate() {
    return (this.theEntity.onGround || (getCanSwim() && isInLiquid()) || (this.theEntity.isRiding() && this.theEntity instanceof net.minecraft.entity.monster.EntityZombie && this.theEntity.ridingEntity instanceof net.minecraft.entity.passive.EntityChicken));
  }
  
  protected Vec3 getEntityPosition() {
    return new Vec3(this.theEntity.posX, getPathablePosY(), this.theEntity.posZ);
  }
  
  private int getPathablePosY() {
    if (this.theEntity.isInWater() && getCanSwim()) {
  ...
  private boolean isPositionClear(int p_179692_1_, int p_179692_2_, int p_179692_3_, int p_179692_4_, int p_179692_5_, int p_179692_6_, Vec3 p_179692_7_, double p_179692_8_, double p_179692_10_) {
    for (BlockPos blockpos : BlockPos.getAllInBox(new BlockPos(p_179692_1_, p_179692_2_, p_179692_3_), new BlockPos(p_179692_1_ + p_179692_4_ - 1, p_179692_2_ + p_179692_5_ - 1, p_179692_3_ + p_179692_6_ - 1))) {
      ...
      if (d0 * p_179692_8_ + d1 * p_179692_10_ >= 0.0D) {
        ...
        if (!block.isPassable((IBlockAccess)this.worldObj, blockpos))
          return false; 
      } 
    } 
    return true;

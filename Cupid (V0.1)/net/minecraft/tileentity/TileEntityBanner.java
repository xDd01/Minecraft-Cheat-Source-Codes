...
public class TileEntityBanner extends TileEntity {
  ...
  public static void func_181020_a(NBTTagCompound p_181020_0_, int p_181020_1_, NBTTagList p_181020_2_) {
    ...
    if (p_181020_2_ != null)
      p_181020_0_.setTag("Patterns", (NBTBase)p_181020_2_); 
  }
  ...
  public Packet getDescriptionPacket() {
    ...
    return (Packet)new S35PacketUpdateTileEntity(this.pos, 6, nbttagcompound);
  }
        ...
        if (this.patterns != null)
          for (int i = 0; i < this.patterns.tagCount(); i++) {
            ...
            if (tileentitybanner$enumbannerpattern != null) {
              ...
              this.patternResourceLocation += tileentitybanner$enumbannerpattern.getPatternID() + j;
            } 
          }  
      }  
  }
  ...
  public enum EnumBannerPattern {
    ...
    BORDER("border", "bo", "###", "# #", "###"),
    CURLY_BORDER("curly_border", "cbo", (String)new ItemStack(Blocks.vine)),
    CREEPER("creeper", "cre", (String)new ItemStack(Items.skull, 1, 4)),
    GRADIENT("gradient", "gra", "# #", " # ", " # "),
    GRADIENT_UP("gradient_up", "gru", " # ", " # ", "# #"),
    BRICKS("bricks", "bri", (String)new ItemStack(Blocks.brick_block)),
    SKULL("skull", "sku", (String)new ItemStack(Items.skull, 1, 1)),
    FLOWER("flower", "flo", (String)new ItemStack((Block)Blocks.red_flower, 1, BlockFlower.EnumFlowerType.OXEYE_DAISY.getMeta())),
    MOJANG("mojang", "moj", (String)new ItemStack(Items.golden_apple, 1, 1));

...
public class InventoryPlayer implements IInventory {
  ...
  public void setCurrentItem(Item itemIn, int p_146030_2_, boolean p_146030_3_, boolean p_146030_4_) {
    ...
    int i = p_146030_3_ ? getInventorySlotContainItemAndDamage(itemIn, p_146030_2_) : getInventorySlotContainItem(itemIn);
    if (i >= 0 && i < 9) {
      this.currentItem = i;
      ...
      if (itemstack == null || !itemstack.isItemEnchantable() || getInventorySlotContainItemAndDamage(itemstack.getItem(), itemstack.getItemDamage()) != this.currentItem) {
        int l, k = getInventorySlotContainItemAndDamage(itemIn, p_146030_2_);
        if (k >= 0) {
  ...
  public NBTTagList writeToNBT(NBTTagList p_70442_1_) {
    for (int i = 0; i < this.mainInventory.length; i++) {
      if (this.mainInventory[i] != null) {
        ...
        p_70442_1_.appendTag((NBTBase)nbttagcompound);
      } 
    } 
    for (int j = 0; j < this.armorInventory.length; j++) {
      if (this.armorInventory[j] != null) {
        ...
        p_70442_1_.appendTag((NBTBase)nbttagcompound1);
      } 
    } 
    return p_70442_1_;
  }

...
public class EntitySnowball extends EntityThrowable {
  ...
  protected void onImpact(MovingObjectPosition p_70184_1_) {
    if (p_70184_1_.entityHit != null) {
      int i = 0;
      if (p_70184_1_.entityHit instanceof net.minecraft.entity.monster.EntityBlaze)
        i = 3; 
      p_70184_1_.entityHit.attackEntityFrom(DamageSource.causeThrownDamage(this, (Entity)getThrower()), i);
    } 
    for (int j = 0; j < 8; j++)

...
public class CommandBanIp extends CommandBase {
  ...
  protected void func_147210_a(ICommandSender p_147210_1_, String p_147210_2_, String p_147210_3_) {
    ...
    if (list.isEmpty()) {
      notifyOperators(p_147210_1_, (ICommand)this, "commands.banip.success", new Object[] { p_147210_2_ });
    } else {
      notifyOperators(p_147210_1_, (ICommand)this, "commands.banip.success.players", new Object[] { p_147210_2_, joinNiceString((Object[])astring) });
    } 
  }
}

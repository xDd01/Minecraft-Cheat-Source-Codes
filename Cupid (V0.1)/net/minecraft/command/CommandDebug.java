...
public class CommandDebug extends CommandBase {
  ...
  private String func_147204_b(long p_147204_1_, int p_147204_3_) {
    ...
    stringbuilder.append("// This is approximately ").append(String.format("%.2f", new Object[] { Float.valueOf(p_147204_3_ / (float)p_147204_1_ / 1000.0F) })).append(" ticks per second. It should be ").append(20).append(" ticks per second\n\n");

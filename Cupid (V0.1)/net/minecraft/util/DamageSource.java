...
public class DamageSource {
  ...
  public static DamageSource causeArrowDamage(EntityArrow arrow, Entity p_76353_1_) {
    return (new EntityDamageSourceIndirect("arrow", (Entity)arrow, p_76353_1_)).setProjectile();
  }
  
  public static DamageSource causeFireballDamage(EntityFireball fireball, Entity p_76362_1_) {
    return (p_76362_1_ == null) ? (new EntityDamageSourceIndirect("onFire", (Entity)fireball, (Entity)fireball)).setFireDamage().setProjectile() : (new EntityDamageSourceIndirect("fireball", (Entity)fireball, p_76362_1_)).setFireDamage().setProjectile();
  }

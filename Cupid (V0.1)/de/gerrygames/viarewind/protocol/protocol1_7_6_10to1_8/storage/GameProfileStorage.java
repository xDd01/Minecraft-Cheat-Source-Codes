...
public class GameProfileStorage extends StoredObject {
  ...
  public void putProperty(UUID uuid, Property property) {
    ((GameProfile)this.properties.computeIfAbsent((K)uuid, profile -> new GameProfile(uuid, null))).properties.add(property);
  }
...
/* Location:              C:\Users\Joona\Downloads\Cupid.jar!\de\gerrygames\viarewind\protocol\protocol1_7_6_10to1_8\storage\GameProfileStorage.class

...
public class GuardianReplacement implements EntityReplacement {
  ...
  public void updateMetadata() {
    ...
    for (Metadata metadata : this.datawatcher) {
      if (metadata.getId() == 16 || metadata.getId() == 17)
        continue; 
  ...
  public void spawn() {
    ...
    spawn.write(Type.UNSIGNED_BYTE, Short.valueOf((short)94));
...
/* Location:              C:\Users\Joona\Downloads\Cupid.jar!\de\gerrygames\viarewind\protocol\protocol1_7_6_10to1_8\entityreplacements\GuardianReplacement.class

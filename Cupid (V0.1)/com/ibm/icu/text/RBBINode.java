...
class RBBINode {
  ...
  static final String[] nodeTypeNames = new String[] { 
      "setRef", "uset", "varRef", "leafChar", "lookAhead", "tag", "endMark", "opStart", "opCat", "opOr", 
      "opStar", "opPlus", "opQuestion", "opBreak", "opReverse", "opLParen" };
...
/* Location:              C:\Users\Joona\Downloads\Cupid.jar!\com\ibm\icu\text\RBBINode.class

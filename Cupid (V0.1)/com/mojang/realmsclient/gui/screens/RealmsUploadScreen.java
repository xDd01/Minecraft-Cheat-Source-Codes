...
public class RealmsUploadScreen extends RealmsScreen {
        ...
        public void run() {
          ...
          try {
            ...
            if (!RealmsUploadScreen.this.verify(archive)) {
              RealmsUploadScreen.this.errorMessage = RealmsScreen.getLocalizedString("mco.upload.size.failure", new Object[] { RealmsUploadScreen.access$500(this.this$0).getLevelName() });
              return;
            } 
  ...
  private void uploadCancelled(long worldId) {
    ...
    try {
      ...
      LOGGER.error("Failed to cancel upload", (Throwable)e);
    } 
  }
...
/* Location:              C:\Users\Joona\Downloads\Cupid.jar!\com\mojang\realmsclient\gui\screens\RealmsUploadScreen.class

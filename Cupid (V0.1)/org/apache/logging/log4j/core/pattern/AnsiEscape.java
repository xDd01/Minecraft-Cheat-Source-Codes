...
public enum AnsiEscape {
  ...
  public static String createSequence(String... names) {
    ...
    for (String name : names) {
      try {
        AnsiEscape escape = (AnsiEscape)EnglishEnums.valueOf(AnsiEscape.class, name.trim());
        if (!first)
...
/* Location:              C:\Users\Joona\Downloads\Cupid.jar!\org\apache\logging\log4j\core\pattern\AnsiEscape.class

...
public class FieldUtils {
  ...
  public static Field getField(Class<?> cls, String fieldName, boolean forceAccess) {
    ...
    Field match = null;
    for (Class<?> class1 : (Iterable<Class<?>>)ClassUtils.getAllInterfaces(cls)) {
      try {
  ...
  public static Field[] getAllFields(Class<?> cls) {
    ...
    return allFieldsList.<Field>toArray(new Field[allFieldsList.size()]);
  }
...
/* Location:              C:\Users\Joona\Downloads\Cupid.jar!\org\apache\commons\lang3\reflect\FieldUtils.class

...
public final class ContextAttribs {
  ...
  public ContextAttribs withForwardCompatible(boolean forwardCompatible) {
    return toggleFlag(2, forwardCompatible);
  }
  ...
  public ContextAttribs withContextResetIsolation(boolean contextResetIsolation) {
    return toggleFlag(8, contextResetIsolation);
  }
  ...
  IntBuffer getAttribList() {
    ...
    if (this.profileMask != 0)
      map.put(Integer.valueOf(37158), Integer.valueOf(this.profileMask)); 
    if (this.contextResetNotificationStrategy != 33377)
      map.put(Integer.valueOf(33366), Integer.valueOf(this.contextResetNotificationStrategy)); 
...
/* Location:              C:\Users\Joona\Downloads\Cupid.jar!\org\lwjgl\opengl\ContextAttribs.class

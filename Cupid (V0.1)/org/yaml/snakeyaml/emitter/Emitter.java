...
public final class Emitter implements Emitable {
  ...
  private boolean checkSimpleKey() {
    ...
    return (length < this.maxSimpleKeyLength && (this.event instanceof org.yaml.snakeyaml.events.AliasEvent || (this.event instanceof ScalarEvent && !this.analysis.isEmpty() && !this.analysis.isMultiline()) || checkEmptySequence() || checkEmptyMapping()));
  }
  ...
  private DumperOptions.ScalarStyle chooseScalarStyle() {
    ...
    if (ev.isPlain() && ev.getImplicit().canOmitTagInPlainScalar() && (
      !this.simpleKeyContext || (!this.analysis.isEmpty() && !this.analysis.isMultiline())) && ((this.flowLevel != 0 && this.analysis.isAllowFlowPlain()) || (this.flowLevel == 0 && this.analysis.isAllowBlockPlain())))
      return null; 
...
/* Location:              C:\Users\Joona\Downloads\Cupid.jar!\org\yaml\snakeyaml\emitter\Emitter.class

...
public class CFont {
  ...
  public void drawChar(CharData[] chars, char c, Vec2f vec2) throws ArrayIndexOutOfBoundsException {
    try {
      drawQuad(vec2.x, vec2.y, (chars[c]).width, (chars[c]).height, (chars[c]).storedX, (chars[c]).storedY, (chars[c]).width, (chars[c]).height);
    } catch (Exception e) {
      e.printStackTrace();
    } 
  }
...
/* Location:              C:\Users\Joona\Downloads\Cupid.jar!\me\rhys\base\font\CFont.class

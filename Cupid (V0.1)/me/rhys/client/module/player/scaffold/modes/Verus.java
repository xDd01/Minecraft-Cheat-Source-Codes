...
public class Verus extends ModuleMode<Scaffold> {
  ...
  public void onMotion(PlayerMotionEvent event) {
    ...
    if (this.blockEntry != null && vec2f != null && slot > -1 && event.getType() == Event.Type.PRE) {
      ...
      ((Scaffold)this.parent).placeBlockVerus(this.blockEntry.getPosition().add(0, 0, 0), this.blockEntry.getFacing(), slot, ((Scaffold)this.parent).swing);
    } 
  }
...
/* Location:              C:\Users\Joona\Downloads\Cupid.jar!\me\rhys\client\module\player\scaffold\modes\Verus.class

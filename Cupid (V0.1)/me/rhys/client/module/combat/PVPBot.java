...
public class PVPBot extends Module {
  ...
  private Entity getTarget() {
    for (Entity entity : this.mc.theWorld.loadedEntityList) {
      if (entity == null || this.mc.thePlayer.getDistanceToEntity(entity) > (this.distance * 5) || this.mc.thePlayer
...
/* Location:              C:\Users\Joona\Downloads\Cupid.jar!\me\rhys\client\module\combat\PVPBot.class

...
public class Verus extends ModuleMode<Velocity> {
  public double vertical = 0.0D;
  
  public double horizontal = 0.0D;
  
  public Verus(String name, Velocity parent) {
...
/* Location:              C:\Users\Joona\Downloads\Cupid.jar!\me\rhys\client\module\combat\velocity\modes\Verus.class

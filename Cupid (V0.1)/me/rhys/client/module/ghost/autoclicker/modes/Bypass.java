...
public class Bypass extends ModuleMode<AutoClicker> {
  @Name("CPS")
  @Clamp(min = 1.0D, max = 20.0D)
  public double speed = 13.0D;
  
  public Robot bot;
  
  private Timer timer = new Timer();
  
  public Bypass(String name, AutoClicker parent) {
  ...
  public void playerMove(PlayerMoveEvent event) {
    ...
    if (Mouse.isButtonDown(0)) {
      ...
      if (this.mc.currentScreen == null && 
        this.timer.hasReached(2000.0D / MathUtil.randDouble(this.speed - 5.0D, this.speed + 5.0D))) {
        try {
...
/* Location:              C:\Users\Joona\Downloads\Cupid.jar!\me\rhys\client\module\ghost\autoclicker\modes\Bypass.class

...
public class Blatent extends ModuleMode<AutoClicker> {
  @Name("CPS")
  ...
  public Blatent(String name, AutoClicker parent) {
  ...
  public void playerMove(PlayerMoveEvent event) {
    ...
    if (Mouse.isButtonDown(0)) {
      ...
      if (this.mc.currentScreen == null && 
        this.timer.hasReached(2000.0D / MathUtil.randDouble(this.speed - 15.0D, this.speed + 15.0D))) {
        try {
...
/* Location:              C:\Users\Joona\Downloads\Cupid.jar!\me\rhys\client\module\ghost\autoclicker\modes\Blatent.class

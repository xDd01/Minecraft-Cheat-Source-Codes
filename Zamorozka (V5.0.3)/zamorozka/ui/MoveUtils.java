...
public class MoveUtils {
    ...
    private static final EntityPlayerSP player = Minecraft.player;
    private static final GameSettings theGameSettingss = Minecraft.getMinecraft().gameSettings;
    ...
    public static void strafe(double speed) {
        ...
        if (mc.gameSettings.keyBindForward.pressed) {
            if (mc.gameSettings.keyBindLeft.pressed && !mc.gameSettings.keyBindRight.pressed) {
                Minecraft.player.motionX -= net.minecraft.util.math.MathHelper.sin(lf) * speed;
                Minecraft.player.motionZ += net.minecraft.util.math.MathHelper.cos(lf) * speed;
            } else if (mc.gameSettings.keyBindRight.pressed && !mc.gameSettings.keyBindLeft.pressed) {
                Minecraft.player.motionX -= net.minecraft.util.math.MathHelper.sin(rf) * speed;
                Minecraft.player.motionZ += net.minecraft.util.math.MathHelper.cos(rf) * speed;
            } else {
                Minecraft.player.motionX -= net.minecraft.util.math.MathHelper.sin(a) * speed;
                Minecraft.player.motionZ += net.minecraft.util.math.MathHelper.cos(a) * speed;
            }
        } else if (mc.gameSettings.keyBindBack.pressed) {
            if (mc.gameSettings.keyBindLeft.pressed && !mc.gameSettings.keyBindRight.pressed) {
                Minecraft.player.motionX -= net.minecraft.util.math.MathHelper.sin(lb) * speed;
                Minecraft.player.motionZ += net.minecraft.util.math.MathHelper.cos(lb) * speed;
            } else if (mc.gameSettings.keyBindRight.pressed && !mc.gameSettings.keyBindLeft.pressed) {
                Minecraft.player.motionX -= net.minecraft.util.math.MathHelper.sin(rb) * speed;
                Minecraft.player.motionZ += net.minecraft.util.math.MathHelper.cos(rb) * speed;
            } else {
                Minecraft.player.motionX += net.minecraft.util.math.MathHelper.sin(a) * speed;
                Minecraft.player.motionZ -= net.minecraft.util.math.MathHelper.cos(a) * speed;
            }
            ...
            Minecraft.player.motionX += net.minecraft.util.math.MathHelper.sin(l) * speed;
            Minecraft.player.motionZ -= net.minecraft.util.math.MathHelper.cos(l) * speed;
            ...
            Minecraft.player.motionX += net.minecraft.util.math.MathHelper.sin(r) * speed;
            Minecraft.player.motionZ -= net.minecraft.util.math.MathHelper.cos(r) * speed;
        }
    ...
    public static float[] getRotationsBlock(BlockPos block, EnumFacing face) {
        ...
        double d3 = net.minecraft.util.math.MathHelper.sqrt(x * x + z * z);
    ...
    public static double getPosForSetPosX(double value) {
        double yaw = Math.toRadians(Minecraft.player.rotationYaw);
    ...
    public static double[] directionSpeed(double speed) {
        ...
        float yaw = Minecraft.player.prevRotationYaw
                + (Minecraft.player.rotationYaw - Minecraft.player.prevRotationYaw) * mc.getRenderPartialTicks();

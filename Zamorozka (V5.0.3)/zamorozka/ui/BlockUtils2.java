...
public class BlockUtils2 {
    ...
    public static float[] calcAngle(Vec3d from, Vec3d to) {
        ...
        double difY = (to.yCoord - from.yCoord) * -1.0D;
    ...
    public static void processRightClickBlock(BlockPos pos, EnumFacing side, Vec3d hitVec) {
        getPlayerController().processRightClickBlock(Minecraft.player,
    ...
    public static void faceVectorPacketInstant(Vec3d vec) {
        ...
        Minecraft.player.connection.sendPacket(new CPacketPlayer.Rotation(rotations[0],
    ...
    private static float[] getNeededRotations2(Vec3d vec) {
        ...
        return new float[]{
                ...
                Minecraft.player.rotationPitch + MathHelper
                        .wrapDegrees(pitch - Minecraft.player.rotationPitch)};
    }

...
public class BlockInteractUtil {
	 public static final List blackList;
	    ...
	    public static void placeBlockScaffold(final BlockPos pos) {
	        ...
	        for (final EnumFacing side : EnumFacing.values()) {
	            ...
	            if (canBeClicked(neighbor)) {
	                final Vec3d hitVec = new Vec3d((Vec3i)neighbor).addVector(0.5, 0.5, 0.5).add(new Vec3d(side2.getDirectionVec()).rotatePitch(0.5f));
	    ...
	    public static float[] getDirectionToBlock(final int var0, final int var1, final int var2, final EnumFacing var3) {
	        final EntityEgg var4 = new EntityEgg((World)mc.world);
	        var4.posX = var0 + 0.5;
	        var4.posY = var1 + 0.5;
	        var4.posZ = var2 + 0.5;

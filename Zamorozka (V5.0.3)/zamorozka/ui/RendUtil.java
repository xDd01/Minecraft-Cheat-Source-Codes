...
public final class RendUtil {
    ...
    public static void glBillboard(float x, float y, float z) {
        ...
        GlStateManager.rotate(Minecraft.player.rotationPitch, Minecraft.getMinecraft().gameSettings.thirdPersonView == 2 ? -1.0f : 1.0f, 0.0f, 0.0f);

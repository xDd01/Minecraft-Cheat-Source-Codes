...
public class GuiCreateWorld extends GuiScreen {
    ...
    private final zamorozka.ui.font.CFontRenderer font = zamorozka.ui.font.Fonts.default18;
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        zamorozka.ui.RenderingUtils.drawRect(0, 0, width, height, new Color(50, 45, 45, 255).getRGB());
        font.drawCenteredString(I18n.format("selectWorld.create"), this.width / 2F, 20, -1);

        if (this.inMoreWorldOptionsDisplay) {
            font.drawString(I18n.format("selectWorld.enterSeed"), this.width / 2F - 100, 47, -6250336);
            font.drawString(I18n.format("selectWorld.seedInfo"), this.width / 2F - 100, 85, -6250336);

            if (this.btnMapFeatures.visible) {
                font.drawString(I18n.format("selectWorld.mapFeatures.info"), this.width / 2F - 150, 122, -6250336);
            }

            if (this.btnAllowCommands.visible) {
                font.drawString(I18n.format("selectWorld.allowCommands.info"), this.width / 2F - 150, 172, -6250336);
            }
            ...
            font.drawString(I18n.format("selectWorld.enterName"), this.width / 2F - 100, 47, -6250336);
            font.drawString(I18n.format("selectWorld.resultFolder") + " " + this.saveDirName, this.width / 2F - 100, 85, -6250336);
            this.worldNameField.drawTextBox();
            font.drawString(this.gameModeDesc1, this.width / 2F - 100, 137, -6250336);
            font.drawString(this.gameModeDesc2, this.width / 2F - 100, 149, -6250336);
        }

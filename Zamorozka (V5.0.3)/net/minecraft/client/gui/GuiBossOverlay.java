...
public class GuiBossOverlay extends Gui {
	...
	public void renderBossHealth() {
		if (ModuleManager.getModule(NoOverlay.class).getState() && (Zamorozka.settingsManager.getSettingByName("NoBossBar").getValBoolean())) {

		} else if (!this.mapBossInfos.isEmpty()) {

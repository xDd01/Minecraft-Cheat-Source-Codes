...
import zamorozka.modules.EXPLOITS.InviniteChatLength;
...
public class GuiChat extends GuiScreen implements ITabCompleter
{
    ...
    public void initGui()
    {
    if(ModuleManager.getModule(InviniteChatLength.class).getState()){
        this.sentHistoryCursor = this.mc.ingameGUI.getChatGUI().getSentMessages().size();
        this.inputField = new GuiTextField(0, this.fontRendererObj, 4, this.height - 12, this.width - 4, 12);
        this.inputField.setMaxStringLength(100000);
    ...
    {
    	if(!(ModuleManager.getModule(HUD.class).getState() || !(Zamorozka.settingsManager.getSettingByName("BetterHotbar").getValBoolean() || !Zamorozka.settingsManager.getSettingByName("BetterBackground").getValBoolean()))) {

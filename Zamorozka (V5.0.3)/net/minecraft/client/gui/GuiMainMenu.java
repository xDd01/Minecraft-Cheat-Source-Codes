...
public class GuiMainMenu extends GuiScreen {
	...
	private static final ResourceLocation[] TITLE_PANORAMA_PATHS = new ResourceLocation[] { new ResourceLocation("textures/gui/title/background/panorama_0.png"), new ResourceLocation("textures/gui/title/background/panorama_1.png"),
	...
	public void initGui() {
		...
		this.buttonList.add(new GuiButton(0, this.width / -200 + 35, this.height / 2 + 25 - 10, 110, 20, I18n.format("menu.options", new Object[0])));
		this.buttonList.add(new GuiButton(4, this.width / -200 + 35, this.height / 2 + 50 - 10, 110, 20, I18n.format("menu.quit", new Object[0])));
	...
	private void addSingleplayerMultiplayerButtons(int p_73969_1_, int p_73969_2_) {
		this.buttonList.add(new GuiButton(1, this.width / -200 + 35, this.height / 2 - 25 - 10, 110, 20, I18n.format("menu.singleplayer", new Object[0])));
		this.buttonList.add(new GuiButton(2, this.width / -200 + 35, this.height / 2 - 10, 110, 20, I18n.format("menu.multiplayer", new Object[0])));

		this.buttonList.add(new GuiButton(56, this.width / -200 + 35, this.height / 2 - 50 - 10, 110, 20, "Main Menu"));
		// this.buttonList.add(new GuiButton(66, this.width / 2 - 349, (int) (p_73969_1_
		// + p_73969_2_ * 9.8f), this.width / 2 - 250, p_73969_2_, "Color"));
		// this.buttonList.add(new GuiButton(67, this.width / 2 - 236,(int) (p_73969_1_
		// + p_73969_2_ * 9.8f), this.width / 2 - 236, p_73969_2_, "Fonts"));
		// this.buttonList.add(new GuiButton(67, this.width / 2 - 110, (int) (p_73969_1_
		// + p_73969_2_ * 9.8f), this.width / 2 - 235, p_73969_2_, "Configs"));
	...
	protected void actionPerformed(GuiButton button) throws IOException {
		...
		if (button.id == 56) {
			this.mc.displayGuiScreen(new GuiMain(this));
		}
		...
		if (button.id == 12) {
			...
			if (worldinfo != null) {
				this.mc.displayGuiScreen(
						new GuiYesNo(this, I18n.format("selectWorld.deleteQuestion"), "'" + worldinfo.getWorldName() + "' " + I18n.format("selectWorld.deleteWarning"), I18n.format("selectWorld.deleteButton"), I18n.format("gui.cancel"), 12));
			}
		}
	}
	...
	public void drawScreen(int mouseX, int mouseY, float partialTicks) {
		...
		this.mc.getTextureManager().bindTexture(new ResourceLocation("zam2.jpg"));
		...
		drawRect(0, 1000, 155, 0, 0x99000000);
		int j11 = this.height / 4 + 48;
		RenderUtils.drawPic(this.width / -200 + 15, this.height / 2 - 50 - 10, 20, 20, new ResourceLocation("69524.png"));
		RenderUtils.drawPic(this.width / -200 + 15, this.height / 2 - 25 - 10, 20, 20, new ResourceLocation("add-new-user-person-account-player-512.png"));
		RenderUtils.drawPic(this.width / -200 + 15, this.height / 2 - 10, 20, 20, new ResourceLocation("733ecba658723284cf4236988d90b489.png"));
		RenderUtils.drawPic(this.width / -200 + 15, this.height / 2 + 25 - 10, 20, 20, new ResourceLocation("edit+gear+options+preferences+setting+settings+icon-1320166551296108865.png"));
		RenderUtils.drawPic(this.width / -200 + 15, this.height / 2 + 50 - 10, 20, 20, new ResourceLocation("quit-icon-1.jpg"));
		Date data = new Date();
		Zamorozka.FONT_MANAGER.chat.drawString(data.toString(), this.width - Zamorozka.FONT_MANAGER.chat.getStringWidth(data.toString()) - 2, 10, 0xFFffffff);
		Zamorozka.FONT_MANAGER.chat.drawString("[Zamorozka.fun]", this.width - Zamorozka.FONT_MANAGER.chat.getStringWidth("§f[Zamorozka.fun]"), this.height - 10, -1);
	...
	protected void mouseClicked(int mouseX, int mouseY, int mouseButton) throws IOException {
		...
		if (mouseX > this.field_193979_N && mouseX < this.field_193979_N + this.field_193978_M && mouseY > this.height - 10 && mouseY < this.height) {
			Sys.openURL("https://vk.com/zamorozkaclient");
		}
	}

...
import zamorozka.gui.GuiChat;
import zamorozka.gui.GuiOfflineName;
...
public class GuiMultiplayer extends GuiScreen {
	...
	public void createButtons() {
		...
		this.buttonList
				.add(new GuiButton(22, this.width / 2 + 4 + 154, this.height - 52, 75, 20, I18n.format("SetCustomName")));
		this.buttonList.add(
				new GuiButton(123, this.width / 2 + 4 + 233, this.height - 52, 75, 20, I18n.format("SetRandName")));
		this.buttonList.add(
	...
	public void drawScreen(int mouseX, int mouseY, float partialTicks) {
		...
		FontUtil.drawTotalCenteredStringWithShadow(I18n.format("Session name: " + mc.session.getUsername()), 60, 15, -1);
		...
		if (mc.isWindows()) {
			FontUtil.drawTotalCenteredStringWithShadow(I18n.format("OC: Windows"),
					this.width - FontUtil.getStringWidth("Windows"), 17, 16777215);
		}
		if (mc.isMac()) {
			FontUtil.drawTotalCenteredStringWithShadow(I18n.format("OC: MacOS"),
					this.width - FontUtil.getStringWidth("MacOS"), 17, 16777215);
		}
	}

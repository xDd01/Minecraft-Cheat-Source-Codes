...
import zamorozka.modules.VISUALLY.EnchantColor;
...
public abstract class LayerArmorBase<T extends ModelBase> implements LayerRenderer<EntityLivingBase> {
			...
			if (itemarmor.getEquipmentSlot() == slotIn) {
				...
				if (Reflector.ForgeHooksClient_getArmorTexture.exists()) {
					...
					if (!this.skipRenderGlint && itemstack.hasEffect()
							&& (!Config.isCustomItems() || !CustomItems.renderCustomArmorEffect(entityLivingBaseIn, itemstack, t, limbSwing, limbSwingAmount, partialTicks, ageInTicks, netHeadYaw, headPitch, scale))) {
	...
	public static void renderEnchantedGlint(RenderLivingBase<?> p_188364_0_, EntityLivingBase p_188364_1_, ModelBase model, float p_188364_3_, float p_188364_4_, float p_188364_5_, float p_188364_6_, float p_188364_7_, float p_188364_8_,
			float p_188364_9_) {
		if (!Config.isShaders() || !Shaders.isShadowPass) {
			...
			for (int i = 0; i < 2; ++i) {
				...
				float f2 = 0.76F;
				if (ModuleManager.getModule(EnchantColor.class).getState()) {

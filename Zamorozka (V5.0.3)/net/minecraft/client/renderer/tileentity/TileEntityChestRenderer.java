...
import zamorozka.modules.VISUALLY.BlockEsp;
import zamorozka.modules.VISUALLY.ChestBox;
...
public class TileEntityChestRenderer extends TileEntitySpecialRenderer<TileEntityChest>
{
    ...
    public void func_192841_a(TileEntityChest p_192841_1_, double p_192841_2_, double p_192841_4_, double p_192841_6_, float p_192841_8_, int p_192841_9_, float p_192841_10_)
    {
        ...
        if (p_192841_1_.adjacentChestZNeg == null && p_192841_1_.adjacentChestXNeg == null)
        {
            ...
            f = 1.0F - f;
            f = 1.0F - f * f * f;
            if(ModuleManager.getModule(ChestBox.class).getState()){
            	if(Zamorozka.settingsManager.getSettingByName("WallHack").getValBoolean()){
    ...
    public void renderTileEntityAt(TileEntityChest p_192841_1_, double p_192841_2_, double p_192841_4_, double p_192841_6_, float p_192841_8_, int p_192841_9_, float p_192841_10_)
    {
        this.func_192841_a(p_192841_1_, p_192841_2_, p_192841_4_, p_192841_6_, p_192841_8_, p_192841_9_, p_192841_10_);

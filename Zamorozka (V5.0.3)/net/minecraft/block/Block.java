...
import zamorozka.modules.VISUALLY.Xray;
...
public class Block {
    ...
    public boolean isFullCube(IBlockState state) {
        return !ModuleManager.getModule(NoClip.class).getState() && !ModuleManager.getModule(Freecam.class).getState();
    }
    ...
    public boolean shouldSideBeRendered(IBlockState blockState, IBlockAccess blockAccess, BlockPos pos, EnumFacing side) {
        ...
        if (ModuleManager.getModule(Xray.class).getState()) {
            ...
            if (this == Block.getBlockById(56))
                return true;
            if (this == Block.getBlockById(52))
                return true;
            if (this == Block.getBlockById(73))
                return true;
            if (this == Block.getBlockById(74))
                return true;
            if (this == Block.getBlockById(90))
                return true;
            if (this == Block.getBlockById(137))
                return true;
            if (this == Block.getBlockById(120))
                return true;
            if (this == Block.getBlockById(166))
                return true;
            if (this == Block.getBlockById(57))
                return true;
            if (this == Block.getBlockById(41))
                return true;
            if (this == Block.getBlockById(14))
                return true;
            if (this == Block.getBlockById(15))
                return true;
            if (this == Block.getBlockById(42))
                return true;
            if (this == Block.getBlockById(88))
                return true;
            if (this == Block.getBlockById(54))
                return true;
            if (this == Block.getBlockById(89))
                return true;
            if (this == Block.getBlockById(130))
                return true;
        }
        ...
        if (Zamorozka.moduleManager.xrayModule.getState())
            return false;
    ...
    public void addCollisionBoxToList(IBlockState state, World worldIn, BlockPos pos, AxisAlignedBB entityBox, List<AxisAlignedBB> collidingBoxes, @Nullable Entity entityIn, boolean p_185477_7_) {
        EventEntityCollision event = new EventEntityCollision(this, pos, state.getCollisionBoundingBox(worldIn, pos), true);
        event.call();
        if (!event.isCancelled())
            this.addCollisionBoxToList(pos, entityBox, collidingBoxes, event.getBoundingBox());
    }
    ...
    protected void addCollisionBoxToList(BlockPos pos, AxisAlignedBB entityBox, List<AxisAlignedBB> collidingBoxes, @Nullable AxisAlignedBB blockBox) {
        if (blockBox != NULL_AABB) {
            ...
            EventEntityCollision event = new EventEntityCollision(this, pos, axisalignedbb, false);
            event.call();
            if (entityBox.intersectsWith(axisalignedbb) && !event.isCancelled()) {
    ...
    public boolean isCollidable() {
        return !ModuleManager.getModule(GhostHand.class).getState();
    }

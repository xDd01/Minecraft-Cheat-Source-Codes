...
public abstract class World implements IBlockAccess {
	...
	protected void updateWeather() {
		if (ModuleManager.getModule(NoOverlay.class).getState() && (Zamorozka.settingsManager.getSettingByName("NoWeather").getValBoolean())) {

		} else if (this.provider.func_191066_m()) {
			if (!this.isRemote) {
	...
	public void playSound(double posX, double posY, double posZ, String name, float volume, float pitch, boolean b) {

...
public class GuiMessage extends GuiScreen {
    ...
    public void initGui() {
        ...
        this.listLines2.addAll(fontRendererObj.listFormattedStringToWidth(this.messageLine2, width - 50));
    }
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        this.drawCenteredString(fontRendererObj, this.messageLine1, width / 2, 70, 16777215);
        int i = 90;

        for (Object s : this.listLines2) {
            this.drawCenteredString(fontRendererObj, (String) s, width / 2, i, 16777215);

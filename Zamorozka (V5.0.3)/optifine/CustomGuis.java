            ...
            if (!(guiscreen instanceof GuiContainer)) {
                ...
                if (playerControllerOF == null) {
                    ...
                    if (iblockaccess == null) {
                        ...
                        return getTexturePos(CustomGuiProperties.EnumContainer.CREATIVE, Minecraft.player.getPosition(), iblockaccess, p_getTextureLocation_0_);
                    } else if (guiscreen instanceof GuiInventory) {
                        return getTexturePos(CustomGuiProperties.EnumContainer.INVENTORY, Minecraft.player.getPosition(), iblockaccess, p_getTextureLocation_0_);
                    } else {

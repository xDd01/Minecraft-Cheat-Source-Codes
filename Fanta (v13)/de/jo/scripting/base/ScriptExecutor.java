...
public class ScriptExecutor {
	...
	public ScriptExecutor() {
		...
		registerLine("var addSetting = function(module, setting) {module.settings.add(setting);}");
		registerLine("var registerModule = function(module) {modulemanager.modules.add(module);}");
		
		/*Settings*/
		registerLine("var Setting = Java.type(\"de.fanta.setting.Setting\");");
		registerLine("var BaseSetting = Java.type(\"de.fanta.setting.settings.BaseSetting\");");
		registerLine("var CheckBox = Java.type(\"de.fanta.setting.settings.CheckBox\");");
		registerLine("var ColorValue = Java.type(\"de.fanta.setting.settings.ColorValue\");");
		registerLine("var DropdownBox = Java.type(\"de.fanta.setting.settings.DropdownBox\");");
		registerLine("var Slider = Java.type(\"de.fanta.setting.settings.Slider\");");
		registerLine("var TextField = Java.type(\"de.fanta.setting.settings.TextField\");");
	}

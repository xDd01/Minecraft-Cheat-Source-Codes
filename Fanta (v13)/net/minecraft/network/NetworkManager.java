...
public class NetworkManager extends SimpleChannelInboundHandler<Packet> {
    ...
    public static NetworkManager func_181124_a(InetAddress p_181124_0_, int p_181124_1_, boolean p_181124_2_) {
        ...
        (new Bootstrap()).group(lazyloadbase.getValue()).handler(new ChannelInitializer<Channel>() {
            protected void initChannel(Channel p_initChannel_1_) throws Exception {
                ...
                if (p_initChannel_1_ instanceof SocketChannel && ViaFabric.clientSideVersion != 47) {
    ...
    protected void channelRead0(ChannelHandlerContext context, Packet packet) throws Exception {
        ...
        Client.INSTANCE.onEvent(eventReceivedPacket);
    }
        if (eventReceivedPacket.isCancelled()) {
            return;
        }
        
        EventPacket eventPacket = new EventPacket(EventPacket.Action.RECEIVE, packet);

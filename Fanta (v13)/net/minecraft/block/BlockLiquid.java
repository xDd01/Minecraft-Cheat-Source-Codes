...
public abstract class BlockLiquid extends Block
{
    ...
    {
    	  if( Client.INSTANCE.moduleManager.getModule("Jesus").isState() && ((DropdownBox) Client.INSTANCE.moduleManager.getModule("Jesus").getSetting("Modes").getSetting()).curOption == "Solid") {

                    ...
                    if (chatline != null)
                    {
                        ...
                        if (j1 < 200 || flag)
                        {
                            ...
                            if (l1 > 3)
                            {
                                int i2 = 0;
                                int j2 = -i1 * 9;
                                if(!Client.INSTANCE.moduleManager.getModule("AntiChat").isState()) {
                               Gui.drawRect2(i2, j2 - 9, i2 + l + 4, j2, l1 / 4 << 24);
                              //  drawRect(i2, j2 - 9, i2 + l + 4, j2, l1 / 2 << 24);
                             	//Client.blurHelper.blur2(i2, j2 - 9, i2 + l + 4, j2, (float) 10);
                             	
                                }
                                String s = chatline.getChatComponent().getFormattedText();
                                GlStateManager.enableBlend();
                                if(!Client.INSTANCE.moduleManager.getModule("AntiChat").isState()) {
                                this.mc.fontRendererObj.drawStringWithShadow(s, (float)i2, (float)(j2 - 8)-(mc.fontRendererObj.getFontHeight()/6), 16777215 + (l1 << 24));
                                }

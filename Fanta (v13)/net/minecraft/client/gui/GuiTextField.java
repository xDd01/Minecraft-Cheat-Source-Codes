    ...
    public void drawTextBox() {
        ...
        if (this.getVisible()) {
            if (this.getEnableBackgroundDrawing()) {
                ...
                drawRect(this.xPosition - 1, this.yPosition - 1, this.xPosition + this.width + 1, this.yPosition + this.height + 1, fillColor);
                drawRect(this.xPosition, this.yPosition, this.xPosition + this.width, this.yPosition + this.height, fillColor);
            }
            ...
            if (k > text.length()) k = text.length();

            if (text.length() > 0) {
                String s1 = flag ? text.substring(0, j) : text;
                j1 = Client.INSTANCE.unicodeBasicFontRenderer.drawStringWithShadow(s1, (float) l, (float) i1-(Minecraft.getMinecraft().fontRendererObj.getFontHeight()/4), i);
            }
            ...
            if (text.length() > 0 && flag && j < text.length()) {
                j1 =Client.INSTANCE.unicodeBasicFontRenderer.drawStringWithShadow(text.substring(j), (float) j1, (float) i1-(Minecraft.getMinecraft().fontRendererObj.getFontHeight()/4), i);
            }
            ...
            if (flag1) {
                if (flag2) {
                	...
                	Client.INSTANCE.unicodeBasicFontRenderer.drawStringWithShadow("_", (float) k1, (float) i1-(Minecraft.getMinecraft().fontRendererObj.getFontHeight()/4), i);
                }
            }

...
public class GuiButton extends Gui {
    ...
    public void drawButton(Minecraft mc, int mouseX, int mouseY) {
        if (this.visible) {
            ...
            Client.blurHelper.blur2(this.xPosition, this.yPosition, this.xPosition + this.width, this.yPosition + this.height, (float) 5);
            Gui.drawRect(this.xPosition, this.yPosition, this.xPosition + this.width, this.yPosition + this.height, fillColor);
            this.mouseDragged(mc, mouseX, mouseY);
            int j = 14737632;

            if (!this.enabled) j = Color.RED.getRGB();
            else if (this.hovered) j = Color.WHITE.darker().darker().getRGB();

...
public class GuiMultiplayer extends GuiScreen implements GuiYesNoCallback
{
    ...
    public void initGui()
    {
    	...
    	Client.INSTANCE.moduleManager.getModule("Stealer").setState(false);
    	Client.INSTANCE.moduleManager.getModule("Scaffold").setState(false);
    	Client.INSTANCE.moduleManager.getModule("Flight").setState(false);
    	Client.INSTANCE.moduleManager.getModule("Disabler").setState(false);

    ...
    public boolean clickBlock(BlockPos loc, EnumFacing face) {
        ...
        if (!this.mc.theWorld.getWorldBorder().contains(loc)) {
            ...
            if (this.currentGameType.isCreative()) {
                ...
                if(Client.INSTANCE.moduleManager.getModule("FastBreak").isState()) {
...
//    		try {
//         if(!Client.INSTANCE.moduleManager.getModule("Killaura").state){
//             return this.currentGameType.isCreative() ? 5.0F : 4.5F;
//        }else{
//             return (float) Killaura.range;
//         }
...
//         }
    public float getBlockReachDistance() {
        return this.currentGameType.isCreative() ?Client.INSTANCE.moduleManager.getModule("Teleport").isState() ? 256f : 5.0F :	Client.INSTANCE.moduleManager.getModule("Teleport").isState() ? 256f : 4.5f;
    }
    ...
    public void syncCurrentPlayItem() {
        ...
        Client.INSTANCE.onEvent(eventSycItem);
        i = eventSycItem.slot;

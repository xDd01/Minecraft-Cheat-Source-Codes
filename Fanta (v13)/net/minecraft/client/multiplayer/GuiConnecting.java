...
public class GuiConnecting extends GuiScreen
{
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks)
    {
       this.drawDefaultBackground();
		 Client.getBackgrundAPI().renderShader();

        if (this.networkManager == null)
        {
            Client.INSTANCE.unicodeBasicFontRenderer.drawCenteredString( I18n.format("connect.connecting", new Object[0]), this.width / 2, this.height / 2 - 50, 16777215);
        }
        else
        {
        	   Client.INSTANCE.unicodeBasicFontRenderer.drawCenteredString(I18n.format("connect.authorizing", new Object[0]), this.width / 2, this.height / 2 - 50, 16777215);
        }

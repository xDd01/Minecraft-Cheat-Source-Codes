...
import de.fanta.discord.DiscordRPCHandler;
...
import de.fanta.events.listeners.EventEnd;
...
import de.fanta.gui.flux.GuiLoginFlux;
...
import de.fanta.utils.LoginScreen;
...
public class Minecraft implements IThreadListener, IPlayerUsage {
	 ...
	 */
	public BasicFontRenderer fontRendererObj;
	public BasicFontRenderer standardGalacticBasicFontRenderer;
	/**
	...
	private void startGame() throws LWJGLException, IOException {
		...
		// this.fontRendererObj = ClientFont.font(17, "Arial", false);
		...
		this.standardGalacticBasicFontRenderer = new FontRenderer(this.gameSettings,
				new ResourceLocation("textures/font/ascii_sga.png"), this.renderEngine, false);
		this.mcResourceManager.registerReloadListener(this.fontRendererObj);
		this.mcResourceManager.registerReloadListener(this.standardGalacticBasicFontRenderer);
		...
		this.displayGuiScreen((GuiScreen) new GuiLoginFlux(new GuiMainMenu()));
	...
	private void initStream() {
		try {
			this.stream = new TwitchStream(this,
					Iterables.getFirst(this.twitchDetails.get("twitch_access_token"), null));
		} catch (Throwable throwable) {
	...
	public void func_181536_a(int p_181536_1_, int p_181536_2_, int p_181536_3_, int p_181536_4_, int p_181536_5_,
		...
		worldrenderer.begin(7, DefaultVertexFormats.POSITION_TEX_COLOR);
		worldrenderer.pos(p_181536_1_, p_181536_2_ + p_181536_6_, 0.0D)
				.tex((float) p_181536_3_ * f, (float) (p_181536_4_ + p_181536_6_) * f1)
				.color(p_181536_7_, p_181536_8_, p_181536_9_, p_181536_10_).endVertex();
		worldrenderer.pos(p_181536_1_ + p_181536_5_, p_181536_2_ + p_181536_6_, 0.0D)
				.tex((float) (p_181536_3_ + p_181536_5_) * f, (float) (p_181536_4_ + p_181536_6_) * f1)
				.color(p_181536_7_, p_181536_8_, p_181536_9_, p_181536_10_).endVertex();
		worldrenderer.pos(p_181536_1_ + p_181536_5_, p_181536_2_, 0.0D)
				.tex((float) (p_181536_3_ + p_181536_5_) * f, (float) p_181536_4_ * f1)
				.color(p_181536_7_, p_181536_8_, p_181536_9_, p_181536_10_).endVertex();
		worldrenderer.pos(p_181536_1_, p_181536_2_, 0.0D).tex((float) p_181536_3_ * f, (float) p_181536_4_ * f1)
				.color(p_181536_7_, p_181536_8_, p_181536_9_, p_181536_10_).endVertex();
...
//       
	...
	public int getLimitFramerate() {
		return this.theWorld == null && this.currentScreen != null ? this.gameSettings.limitFramerate
	...
	public void rightClickMouse() {
		if (!this.playerController.func_181040_m()) {
			...
			if (this.objectMouseOver == null) {
				...
				case BLOCK:
					BlockPos blockpos = this.objectMouseOver.getBlockPos();
					EventBlockRightClick eventBlock = new EventBlockRightClick(blockpos);
					Client.INSTANCE.onEvent(eventBlock);
					if (eventBlock.isCancelled())
						return;
					if (this.theWorld.getBlockState(blockpos).getBlock().getMaterial() != Material.air) {
	...
	public void runTick() throws IOException {
		if (thePlayer != null) {
			...
			Client.INSTANCE.onEvent(eventTick);
		}
		...
		if (this.currentScreen == null || this.currentScreen.allowUserInput) {
			...
			while (Keyboard.next()) {
				...
				try {
					Client.INSTANCE.onEvent(new EventKey(k, PressType.HELT));
				} catch (Exception e) {
				}
				KeyBinding.setKeyBindState(k, Keyboard.getEventKeyState());

				if (Keyboard.getEventKeyState()) {
					if (k == 54 && this.currentScreen == null) {
						this.displayGuiScreen(Client.INSTANCE.clickGui);
						Client.INSTANCE.clickGui.activ = true;
					}
				...
				if (Keyboard.getEventKeyState()) {
					...
					if (this.currentScreen != null) {
						...
						try {
							Client.INSTANCE.onEvent(new EventKey(k, PressType.PRESSED));
						} catch (Exception e) {
						}
						if (k == 1) {
			...
			if (this.currentScreen == null && this.gameSettings.keyBindCommand.isPressed() && flag) {
		     ...
		     Client.INSTANCE.onEvent(eventCLickMouse);

...
public class RenderItem implements IResourceManagerReloadListener
{
    ...
    public void renderItemOverlays(BasicFontRenderer fr, ItemStack stack, int xPosition, int yPosition)
    {
     ...
     */
    public void renderItemOverlayIntoGUI(BasicFontRenderer fr, ItemStack stack, int xPosition, int yPosition, String text)
    {
        if (stack != null)
        {
            if (stack.stackSize != 1 || text != null)
            {
                ...
                GlStateManager.disableBlend();
                Client.INSTANCE.unicodeBasicFontRenderer.drawStringWithShadow(s, (float)(xPosition + 19 - 2 - Client.INSTANCE.unicodeBasicFontRenderer.getStringWidth(s)), (float)(yPosition + 6), 16777215);

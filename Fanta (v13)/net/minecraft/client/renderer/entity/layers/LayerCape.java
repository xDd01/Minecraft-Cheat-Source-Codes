...
public class LayerCape implements LayerRenderer<AbstractClientPlayer>
{
    ...
    {
    	if(Client.INSTANCE.moduleManager.getModule("TestAura").isState() && TestAura.target != null|| Client.INSTANCE.moduleManager.getModule("Scaffold").isState() ) {

...
public class ItemRenderer {
	...
	private void transformFirstPersonItem(float equipProgress, float swingProgress) {
		//
		if (Client.INSTANCE.moduleManager.getModule("Killaura").isState() && mc.thePlayer.isSwingInProgress) {
	...
	public void renderItemInFirstPerson(float partialTicks) {
		...
		if (this.itemToRender != null) {
			if (this.itemToRender.getItem() instanceof ItemMap) {
				...
				case 4:
					if (Client.INSTANCE.moduleManager.getModule("BlockHit").isState()
							&& ((DropdownBox) Client.INSTANCE.moduleManager.getModule("BlockHit")
									.getSetting("AnimationMode").getSetting()).curOption == "Fanta") {
...
//						GlStateManager.translate(-0.2, -0.0, -0.0);
						...
						if (Client.INSTANCE.moduleManager.getModule("BlockHit").isState()
								&& ((DropdownBox) Client.INSTANCE.moduleManager.getModule("BlockHit")
										.getSetting("AnimationMode").getSetting()).curOption == "Drop") {
//							  this.transformFirstPersonItem(f, 0.0F);
//		                        this.func_178103_d();
							 this.transformFirstPersonItem(f, 0.0F);
	                            float rot = MathHelper.sin(MathHelper.sqrt_float(f1) * (float) Math.PI +5);
	                            GlStateManager.translate(0,0.4,0);
	                            GlStateManager.rotate(-rot * 20F, (float) 8020.05, 20, 0);
	                            this.func_178103_d();
						...
						if (Client.INSTANCE.moduleManager.getModule("BlockHit").isState()
								&& ((DropdownBox) Client.INSTANCE.moduleManager.getModule("BlockHit")
										.getSetting("AnimationMode").getSetting()).curOption == "Violence") {
						...
						//	GlStateManager.translate(-0.2, -0.0, -0.0);
							...
							if (Client.INSTANCE.moduleManager.getModule("BlockHit").isState()
									&& ((DropdownBox) Client.INSTANCE.moduleManager.getModule("BlockHit")
											.getSetting("AnimationMode").getSetting()).curOption == "Flux") {
								...
								if (Client.INSTANCE.moduleManager.getModule("BlockHit").isState()
										&& ((DropdownBox) Client.INSTANCE.moduleManager.getModule("BlockHit")
												.getSetting("AnimationMode").getSetting()).curOption == "Exhibition") {
									this.transformFirstPersonItem(f, f);
									float rot = MathHelper.sin(MathHelper.sqrt_float(f1) * (float) Math.PI);
									GlStateManager.translate(0, 0.3, 0);
									GlStateManager.rotate(-rot * 36F, (float) 6.09, 4, 0);
									GlStateManager.rotate(-rot * 25F, (float) 2.09, 0, 15);
									this.func_178103_d();
								} else {
									if (Client.INSTANCE.moduleManager.getModule("BlockHit").isState()
											&& ((DropdownBox) Client.INSTANCE.moduleManager.getModule("BlockHit")
													.getSetting("AnimationMode").getSetting()).curOption == "Astolfo") {
										this.transformFirstPersonItem(f, 0F);
										this.func_178103_d();
										// GlStateManager.translate(0D, 1D, 5D);
										GlStateManager.translate(-0.2, 1, 0.5);
										GlStateManager.rotate(90F, 3F, 1F, 0F);
										float angle = (float) (Math.toDegrees(
												(double) ((System.currentTimeMillis() / 200D) % (Math.PI * 2D)))); // circular
																													// animation
										...
										if (Client.INSTANCE.moduleManager.getModule("BlockHit").isState()
												&& ((DropdownBox) Client.INSTANCE.moduleManager.getModule("BlockHit")
														.getSetting("AnimationMode")
														.getSetting()).curOption == "Centaurus") {
											this.transformFirstPersonItem(-0.3F, 0);
											float rot = MathHelper.sin(MathHelper.sqrt_float(f1) * (float) Math.PI);
											GlStateManager.rotate(-rot * 30 / 2.0F, -60.0F, -0.0F, 60.0F);
											this.func_178103_d();
											...
											if (Client.INSTANCE.moduleManager.getModule("BlockHit").isState()
													&& ((DropdownBox) Client.INSTANCE.moduleManager.getModule("BlockHit")
															.getSetting("AnimationMode")
															.getSetting()).curOption == "Sigma4") {
												float rot = MathHelper.sin(MathHelper.sqrt_float(f1) * (float) Math.PI);
												this.transformFirstPersonItem(f, f);                  	
												GlStateManager.rotate(-rot *10, 5.0F, rot / 6, -0.0F);
						                		GlStateManager.rotate(-rot *20, 50.0F, rot / 6, -0.0F);
						                		this.func_178103_d();
						                		GL11.glTranslated(1, 0.3, 0.5);
				...
				try {
					...
					if (!Client.INSTANCE.moduleManager.getModule("FakeBlock").isState()) {
						if (Client.INSTANCE.moduleManager.getModule("Killaura").isState()
...
//				                        this.func_178103_d();
									...
									if (Client.INSTANCE.moduleManager.getModule("BlockHit").isState()
											&& ((DropdownBox) Client.INSTANCE.moduleManager.getModule("BlockHit")
													.getSetting("AnimationMode")
													.getSetting()).curOption == "Exhibition") {
										this.transformFirstPersonItem(f, f);
										float rot = MathHelper.sin(MathHelper.sqrt_float(f1) * (float) Math.PI);
										GlStateManager.translate(0, 0.3, 0);
										GlStateManager.rotate(-rot * 36F, (float) 6.09, 4, 0);
										...
										if (Client.INSTANCE.moduleManager.getModule("BlockHit").isState()
											...
											if (Client.INSTANCE.moduleManager.getModule("BlockHit").isState()
													&& ((DropdownBox) Client.INSTANCE.moduleManager
															.getModule("BlockHit").getSetting("AnimationMode")
															.getSetting()).curOption == "Astolfo") {
												this.transformFirstPersonItem(f, 0F);
												this.func_178103_d();
												// GlStateManager.translate(0D, 1D, 5D);
												GlStateManager.translate(-0.2, 1, 0.5);
												...
												float angle = (float) (Math
														.toDegrees((double) ((System.currentTimeMillis() / 200D)
																% (Math.PI * 2D)))); // circular
																						// animation
												GlStateManager.rotate(angle, 1F, 0F, 1F);
												...
												if (Client.INSTANCE.moduleManager.getModule("BlockHit").isState()
														&& ((DropdownBox) Client.INSTANCE.moduleManager
																...
																.getSetting()).curOption == "Centaurus") {
													this.transformFirstPersonItem(-0.3F, 0);
													float rot = MathHelper
															.sin(MathHelper.sqrt_float(f1) * (float) Math.PI);
													GlStateManager.rotate(-rot * 30 / 2.0F, -60.0F, -0.0F, 60.0F);
													this.func_178103_d();

...
public class EntityRenderer implements IResourceManagerReloadListener {
    ...
    private float getFOVModifier(float partialTicks, boolean p_78481_2_)
    {
        ...
        else
        {
            ...
            if (p_78481_2_)
            {
                ...
                try {
                if(!Client.INSTANCE.moduleManager.getModule("NoFov").isState()) {
    ...
    public void func_181560_a(float p_181560_1_, long p_181560_2_) {
        ...
        if (!this.mc.skipRenderWorld) {
            ...
            if(((DropdownBox) Client.INSTANCE.moduleManager.getModule("GUI").getSetting("Modes").getSetting()).curOption == ("Skash")) {
            Client.INSTANCE.clickGui.drawMenu(j1, k1);
            }
    ...
    private void renderWorldPass(int pass, float partialTicks, long finishTimeNano) {
        ...
        EventRender3D e3 = new EventRender3D(partialTicks);
        e3.setType(EventType.PRE);
        Client.INSTANCE.onEvent(e3);

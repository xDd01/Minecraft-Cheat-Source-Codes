...
public abstract class EntityHanging extends Entity {
   ...
   public void readEntityFromNBT(NBTTagCompound var1) {
      this.field_174861_a = new BlockPos(var1.getInteger("TileX"), var1.getInteger("TileY"), var1.getInteger("TileZ"));
      EnumFacing var2;
   ...
   public void writeEntityToNBT(NBTTagCompound var1) {
      var1.setByte("Facing", (byte)this.field_174860_b.getHorizontalIndex());
      var1.setInteger("TileX", this.func_174857_n().getX());
      var1.setInteger("TileY", this.func_174857_n().getY());
      var1.setInteger("TileZ", this.func_174857_n().getZ());
   }

...
public class EntitySlime extends EntityLiving implements IMob {
   ...
   public IEntityLivingData func_180482_a(DifficultyInstance var1, IEntityLivingData var2) {
      ...
      if (var3 < 2 && this.rand.nextFloat() < 0.5F * var1.func_180170_c()) {
         ++var3;
      }
   ...
   public void readEntityFromNBT(NBTTagCompound var1) {
      ...
      this.field_175452_bi = var1.getBoolean("wasOnGround");
   }
   ...
   public void onUpdate() {
      ...
      if (this.onGround && !this.field_175452_bi) {
         ...
         for(int var2 = 0; var2 < var1 * 8; ++var2) {
            ...
            EnumParticleTypes var8 = this.func_180487_n();
   ...
   public void writeEntityToNBT(NBTTagCompound var1) {
      ...
      var1.setBoolean("wasOnGround", this.field_175452_bi);
   }

...
public class EntityZombie extends EntityMob {
   ...
   public IEntityLivingData func_180482_a(DifficultyInstance var1, IEntityLivingData var2) {
      ...
      if (var3 == null) {
         var3 = new EntityZombie.GroupData(this, this.worldObj.rand.nextFloat() < 0.05F, this.worldObj.rand.nextFloat() < 0.05F, (Object)null);
      }

      if (var3 instanceof EntityZombie.GroupData) {
         EntityZombie.GroupData var5 = (EntityZombie.GroupData)var3;
         if (var5.field_142046_b) {
         ...
         if (var5.field_142048_a) {
            ...
            if ((double)this.worldObj.rand.nextFloat() < 0.05D) {
               List var6 = this.worldObj.func_175647_a(EntityChicken.class, this.getEntityBoundingBox().expand(5.0D, 3.0D, 5.0D), IEntitySelector.field_152785_b);
               if (!var6.isEmpty()) {
      ...
      this.func_146070_a(this.rand.nextFloat() < var4 * 0.1F);
      ...
      double var9 = this.rand.nextDouble() * 1.5D * (double)var4;
      if (var9 > 1.0D) {
   ...
   class GroupData implements IEntityLivingData {
      ...
      GroupData(EntityZombie var1, boolean var2, boolean var3, Object var4) {
         this(var1, var2, var3);
      }
   }
}

   ...
   public ItemStack onItemRightClick(ItemStack var1, World var2, EntityPlayer var3) {
      ...
      if (var5 == null) {
         ...
         if (var5.typeOfHit == MovingObjectPosition.MovingObjectType.BLOCK) {
            ...
            if (var4) {
               if (!var3.func_175151_a(var6.offset(var5.field_178784_b), var5.field_178784_b, var1)) {
                  return var1;
               }
               ...
               if (this.func_180616_a(var2, var9) && !var3.capabilities.isCreativeMode) {
                  var3.triggerAchievement(StatList.objectUseStats[Item.getIdFromItem(this)]);
                  return new ItemStack(Items.bucket);
               }
            }
   ...
   public boolean func_180616_a(World var1, BlockPos var2) {
      if (this.isFull == Blocks.air) {
         ...
         if (!var1.isAirBlock(var2) && !var4) {
            ...
            if (var1.provider.func_177500_n() && this.isFull == Blocks.flowing_water) {
               int var5 = var2.getX();
               int var6 = var2.getY();
               int var7 = var2.getZ();

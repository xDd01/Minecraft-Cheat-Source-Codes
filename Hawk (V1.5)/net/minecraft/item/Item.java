...
public class Item {
   ...
   public String getItemStackDisplayName(ItemStack var1) {
      return String.valueOf((new StringBuilder()).append(StatCollector.translateToLocal(String.valueOf((new StringBuilder(String.valueOf(this.getUnlocalizedNameInefficiently(var1)))).append(".name"))))).trim();
   }
   ...
   protected MovingObjectPosition getMovingObjectPositionFromPlayer(World var1, EntityPlayer var2, boolean var3) {
      float var4 = var2.prevRotationPitch + (var2.rotationPitch - var2.prevRotationPitch);
      float var5 = var2.prevRotationYaw + (var2.rotationYaw - var2.prevRotationYaw);
      double var6 = var2.prevPosX + (var2.posX - var2.prevPosX);
      double var8 = var2.prevPosY + (var2.posY - var2.prevPosY) + (double)var2.getEyeHeight();
      double var10 = var2.prevPosZ + (var2.posZ - var2.prevPosZ);
   ...
   public static void registerItems() {
      registerItemBlock(Blocks.stone, (new ItemMultiTexture(Blocks.stone, Blocks.stone, new Function() {
         ...
         public String apply(ItemStack var1) {
            return BlockStone.EnumType.getStateFromMeta(var1.getMetadata()).func_176644_c();
         }
      ...
      registerItemBlock(Blocks.planks, (new ItemMultiTexture(Blocks.planks, Blocks.planks, new Function() {
         ...
         public String apply(ItemStack var1) {
            return BlockPlanks.EnumType.func_176837_a(var1.getMetadata()).func_176840_c();
         }
      ...
      registerItemBlock(Blocks.sand, (new ItemMultiTexture(Blocks.sand, Blocks.sand, new Function() {
         ...
         public String apply(ItemStack var1) {
            return BlockSand.EnumType.func_176686_a(var1.getMetadata()).func_176685_d();
         }
      ...
      registerItemBlock(Blocks.log2, (new ItemMultiTexture(Blocks.log2, Blocks.log2, new Function() {
         ...
         public String apply(ItemStack var1) {
            return BlockPlanks.EnumType.func_176837_a(var1.getMetadata() + 4).func_176840_c();
         }
      ...
      registerItemBlock(Blocks.sandstone, (new ItemMultiTexture(Blocks.sandstone, Blocks.sandstone, new Function() {
         ...
         public String apply(ItemStack var1) {
            return BlockSandStone.EnumType.func_176673_a(var1.getMetadata()).func_176676_c();
         }
      ...
      registerItemBlock(Blocks.yellow_flower, (new ItemMultiTexture(Blocks.yellow_flower, Blocks.yellow_flower, new Function() {
         ...
         public String apply(ItemStack var1) {
            return BlockFlower.EnumFlowerType.func_176967_a(BlockFlower.EnumFlowerColor.YELLOW, var1.getMetadata()).func_176963_d();
         }
      ...
      registerItemBlock(Blocks.red_flower, (new ItemMultiTexture(Blocks.red_flower, Blocks.red_flower, new Function() {
         ...
         public String apply(ItemStack var1) {
            return BlockFlower.EnumFlowerType.func_176967_a(BlockFlower.EnumFlowerColor.RED, var1.getMetadata()).func_176963_d();
         }
      ...
      registerItemBlock(Blocks.monster_egg, (new ItemMultiTexture(Blocks.monster_egg, Blocks.monster_egg, new Function() {
         ...
         public String apply(ItemStack var1) {
            return BlockSilverfish.EnumType.func_176879_a(var1.getMetadata()).func_176882_c();
         }
      ...
      registerItemBlock(Blocks.stonebrick, (new ItemMultiTexture(Blocks.stonebrick, Blocks.stonebrick, new Function() {
         ...
         public String apply(ItemStack var1) {
            return BlockStoneBrick.EnumType.getStateFromMeta(var1.getMetadata()).getVariantName();
         }
      ...
      registerItemBlock(Blocks.cobblestone_wall, (new ItemMultiTexture(Blocks.cobblestone_wall, Blocks.cobblestone_wall, new Function() {
         ...
         public String apply(ItemStack var1) {
            return BlockWall.EnumType.func_176660_a(var1.getMetadata()).func_176659_c();
         }
      ...
      registerItemBlock(Blocks.double_plant, (new ItemDoublePlant(Blocks.double_plant, Blocks.double_plant, new Function() {
         ...
         public String apply(ItemStack var1) {
            return BlockDoublePlant.EnumPlantType.func_176938_a(var1.getMetadata()).func_176939_c();
         }
      ...
      registerItemBlock(Blocks.prismarine, (new ItemMultiTexture(Blocks.prismarine, Blocks.prismarine, new Function() {
         ...
         public String apply(ItemStack var1) {
            return BlockPrismarine.EnumType.func_176810_a(var1.getMetadata()).func_176809_c();
         }
      ...
      registerItemBlock(Blocks.red_sandstone, (new ItemMultiTexture(Blocks.red_sandstone, Blocks.red_sandstone, new Function() {
         ...
         public String apply(ItemStack var1) {
            return BlockRedSandstone.EnumType.func_176825_a(var1.getMetadata()).func_176828_c();
         }
   ...
   public static enum ToolMaterial {
      ...
      private ToolMaterial(String var3, int var4, int var5, int var6, float var7, float var8, int var9) {

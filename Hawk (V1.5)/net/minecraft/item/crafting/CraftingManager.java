      ...
      for(int var6 = 0; var6 < var5; ++var6) {
         ...
         if (var7 instanceof ItemStack) {
            ...
            if (!(var7 instanceof Block)) {
               throw new IllegalArgumentException(String.valueOf((new StringBuilder("Invalid shapeless recipe: unknown type ")).append(var7.getClass().getName()).append("!")));
            }
   ...
   public ShapedRecipes addRecipe(ItemStack var1, Object... var2) {
      ...
      if (var2[var4] instanceof String[]) {
         ...
         for(int var8 = 0; var8 < var11.length; ++var8) {
            ...
            ++var6;
            var5 = var9.length();
            var3 = String.valueOf((new StringBuilder(String.valueOf(var3))).append(var9));
         }
      } else {
         while(var2[var4] instanceof String) {
            ...
            ++var6;
            var5 = var7.length();
            var3 = String.valueOf((new StringBuilder(String.valueOf(var3))).append(var7));
         }
      }

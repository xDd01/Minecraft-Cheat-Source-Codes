...
public class ItemDye extends Item {
   ...
   public String getUnlocalizedName(ItemStack var1) {
      ...
      return String.valueOf((new StringBuilder(String.valueOf(super.getUnlocalizedName()))).append(".").append(EnumDyeColor.func_176766_a(var2).func_176762_d()));
   }
   ...
   public boolean itemInteractionForEntity(ItemStack var1, EntityPlayer var2, EntityLivingBase var3) {
      if (var3 instanceof EntitySheep) {
         ...
         EnumDyeColor var5 = EnumDyeColor.func_176766_a(var1.getMetadata());
   ...
   public boolean onItemUse(ItemStack var1, EntityPlayer var2, World var3, BlockPos var4, EnumFacing var5, float var6, float var7, float var8) {
      if (!var2.func_175151_a(var4.offset(var5), var5, var1)) {
         ...
         EnumDyeColor var9 = EnumDyeColor.func_176766_a(var1.getMetadata());
   ...
   public static boolean func_179234_a(ItemStack var0, World var1, BlockPos var2) {
      ...
      if (var3.getBlock() instanceof IGrowable) {
         ...
         if (var4.isStillGrowing(var1, var2, var3, var1.isRemote)) {
            if (!var1.isRemote) {

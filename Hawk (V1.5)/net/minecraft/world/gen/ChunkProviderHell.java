...
public class ChunkProviderHell implements IChunkProvider {
   ...
   public void func_180514_a(Chunk var1, int var2, int var3) {
      this.genNetherBridge.func_175792_a(this, this.worldObj, var2, var3, (ChunkPrimer)null);
   }
   ...
   public Chunk provideChunk(int var1, int var2) {
      ...
      this.netherCaveGenerator.func_175792_a(this, this.worldObj, var1, var2, var3);
      if (this.field_177466_i) {
         this.genNetherBridge.func_175792_a(this, this.worldObj, var1, var2, var3);
      }
   ...
   public List func_177458_a(EnumCreatureType var1, BlockPos var2) {
      if (var1 == EnumCreatureType.MONSTER) {
         ...
         if (this.genNetherBridge.func_175796_a(this.worldObj, var2) && this.worldObj.getBlockState(var2.offsetDown()).getBlock() == Blocks.nether_brick) {
            return this.genNetherBridge.getSpawnList();
         }
      }

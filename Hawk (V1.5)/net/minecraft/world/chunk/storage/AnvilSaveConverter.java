...
public class AnvilSaveConverter extends SaveFormatOld {
   ...
   public boolean convertMapFormat(String var1, IProgressUpdate var2) {
      ...
      logger.info(String.valueOf((new StringBuilder("Total conversion count is ")).append(var9)));
   ...
   private void convertChunks(File var1, File var2, WorldChunkManager var3, int var4, int var5, IProgressUpdate var6) {
      try {
         ...
         RegionFile var9 = new RegionFile(new File(var1, String.valueOf((new StringBuilder(String.valueOf(var7.substring(0, var7.length() - ".mcr".length())))).append(".mca"))));

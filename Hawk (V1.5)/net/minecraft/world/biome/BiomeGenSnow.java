...
public class BiomeGenSnow extends BiomeGenBase {
   ...
   public void func_180624_a(World var1, Random var2, BlockPos var3) {
      if (this.field_150615_aC) {
         ...
         for(var4 = 0; var4 < 3; ++var4) {
            ...
            this.field_150616_aD.generate(var1, var2, var1.getHorizon(var3.add(var5, 0, var6)));
         }

         for(var4 = 0; var4 < 2; ++var4) {
            var5 = var2.nextInt(16) + 8;
            var6 = var2.nextInt(16) + 8;
            this.field_150617_aE.generate(var1, var2, var1.getHorizon(var3.add(var5, 0, var6)));
         }
      }
   ...
   protected BiomeGenBase createMutatedBiome(int var1) {
      BiomeGenBase var2 = (new BiomeGenSnow(var1, true)).func_150557_a(13828095, true).setBiomeName(String.valueOf((new StringBuilder(String.valueOf(this.biomeName))).append(" Spikes"))).setEnableSnow().setTemperatureRainfall(0.0F, 0.5F).setHeight(new BiomeGenBase.Height(this.minHeight + 0.1F, this.maxHeight + 0.1F));

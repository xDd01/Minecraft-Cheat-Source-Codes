...
public class PathFinder {
   ...
   public PathEntity func_180782_a(IBlockAccess var1, Entity var2, BlockPos var3, float var4) {
      return this.func_176189_a(var1, var2, (double)((float)var3.getX() + 0.5F), (double)((float)var3.getY() + 0.5F), (double)((float)var3.getZ() + 0.5F), var4);
   }
   ...
   public PathEntity func_176188_a(IBlockAccess var1, Entity var2, Entity var3, float var4) {
      return this.func_176189_a(var1, var2, var3.posX, var3.getEntityBoundingBox().minY, var3.posZ, var4);
   }
   ...
   private PathEntity func_176187_a(Entity var1, PathPoint var2, PathPoint var3, float var4) {
      ...
      while(!this.path.isPathEmpty()) {
         ...
         var6.visited = true;
         int var7 = this.field_176190_c.func_176164_a(this.pathOptions, var1, var6, var3, var4);

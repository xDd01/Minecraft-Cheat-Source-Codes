...
public class Block {
   ...
   public static int getStateId(IBlockState var0) {
      return getIdFromBlock(var0.getBlock()) + (var0.getBlock().getMetaFromState(var0) << 12);
   }
   ...
   public int getMetaFromState(IBlockState var1) {
      if (var1 != null && !var1.getPropertyNames().isEmpty()) {
         throw new IllegalArgumentException(String.valueOf((new StringBuilder("Don't know how to convert ")).append(var1).append(" back into data...")));
      } else {
         return 0;
      }
   }
   ...
   public static void spawnAsEntity(World var0, BlockPos var1, ItemStack var2) {
      if (!var0.isRemote && var0.getGameRules().getGameRuleBooleanValue("doTileDrops")) {
         float var3 = 0.5F;
   ...
   public float getPlayerRelativeBlockHardness(EntityPlayer var1, World var2, BlockPos var3) {
      ...
      return var4 < 0.0F ? 0.0F : (!var1.canHarvestBlock(this) ? var1.func_180471_a(this) / var4 / 100.0F : var1.func_180471_a(this) / var4 / 30.0F);
   }
   ...
   public static enum EnumOffsetType {
      ...
      private EnumOffsetType(String var3, int var4) {
      }
   }

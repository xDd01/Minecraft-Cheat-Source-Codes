...
public class BlockCommandBlock extends BlockContainer {
   ...
   public boolean onBlockActivated(World var1, BlockPos var2, IBlockState var3, EntityPlayer var4, EnumFacing var5, float var6, float var7, float var8) {
      ...
      return var9 instanceof TileEntityCommandBlock ? ((TileEntityCommandBlock)var9).getCommandBlockLogic().func_175574_a(var4) : false;
   }

   public IBlockState getStateFromMeta(int var1) {
      return this.getDefaultState().withProperty(TRIGGERED_PROP, (var1 & 1) > 0);
   }
   ...
   public int getMetaFromState(IBlockState var1) {
      int var2 = 0;
      if ((Boolean)var1.getValue(TRIGGERED_PROP)) {
         var2 |= 1;
      }
   ...
   public void onNeighborBlockChange(World var1, BlockPos var2, IBlockState var3, Block var4) {
      if (!var1.isRemote) {
         ...
         boolean var6 = (Boolean)var3.getValue(TRIGGERED_PROP);
         if (var5 && !var6) {
            var1.setBlockState(var2, var3.withProperty(TRIGGERED_PROP, true), 4);
            var1.scheduleUpdate(var2, this, this.tickRate(var1));
         } else if (!var5 && var6) {
            var1.setBlockState(var2, var3.withProperty(TRIGGERED_PROP, false), 4);
         }
      }
   ...
   public void onBlockPlacedBy(World var1, BlockPos var2, IBlockState var3, EntityLivingBase var4, ItemStack var5) {
      ...
      if (var6 instanceof TileEntityCommandBlock) {
         ...
         if (var5.hasDisplayName()) {
            var7.func_145754_b(var5.getDisplayName());
         }

         if (!var1.isRemote) {
            var7.func_175573_a(var1.getGameRules().getGameRuleBooleanValue("sendCommandFeedback"));
         }
      }

...
public class BlockRedstoneOre extends Block {
   ...
   private void spawnRedstoneParticles(World var1, BlockPos var2) {
      ...
      for(int var6 = 0; var6 < 6; ++var6) {
         ...
         if (var6 == 0 && !var1.getBlockState(var2.offsetUp()).getBlock().isOpaqueCube()) {
            var9 = (double)var2.getY() + var4 + 1.0D;
         }

         if (var6 == 1 && !var1.getBlockState(var2.offsetDown()).getBlock().isOpaqueCube()) {
            var9 = (double)var2.getY() - var4;
         }

         if (var6 == 2 && !var1.getBlockState(var2.offsetSouth()).getBlock().isOpaqueCube()) {
            var11 = (double)var2.getZ() + var4 + 1.0D;
         }

         if (var6 == 3 && !var1.getBlockState(var2.offsetNorth()).getBlock().isOpaqueCube()) {
            var11 = (double)var2.getZ() - var4;
         }

         if (var6 == 4 && !var1.getBlockState(var2.offsetEast()).getBlock().isOpaqueCube()) {
            var7 = (double)var2.getX() + var4 + 1.0D;
         }

         if (var6 == 5 && !var1.getBlockState(var2.offsetWest()).getBlock().isOpaqueCube()) {
   ...
   private void setOn(World var1, BlockPos var2) {
      this.spawnRedstoneParticles(var1, var2);

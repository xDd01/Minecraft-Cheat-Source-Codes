...
public class Main {
   ...
   public static void main(String[] var0) {
      ...
      ArgumentAcceptingOptionSpec var11 = var1.accepts("username").withRequiredArg().defaultsTo(String.valueOf((new StringBuilder("Player")).append(Minecraft.getSystemTime() % 1000L)), new String[0]);
      ...
      if (!var22.isEmpty()) {
         System.out.println(String.valueOf((new StringBuilder("Completely ignored arguments: ")).append(var22)));
      }
      ...
      if (!var24.equals(Proxy.NO_PROXY) && func_110121_a(var25) && func_110121_a(var26)) {
         Authenticator.setDefault(new Authenticator(var25, var26) {

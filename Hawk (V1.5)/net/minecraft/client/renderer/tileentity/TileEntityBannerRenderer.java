...
public class TileEntityBannerRenderer extends TileEntitySpecialRenderer {
      ...
      if (var2.isEmpty()) {
         ...
         if (var3 == null) {
            ...
            while(var11.hasNext()) {
               ...
               var10.add(String.valueOf((new StringBuilder("textures/entity/banner/")).append(var12.func_177271_a()).append(".png")));
            }
   ...
   public void renderTileEntityAt(TileEntity var1, double var2, double var4, double var6, float var8, int var9) {
      this.func_180545_a((TileEntityBanner)var1, var2, var4, var6, var8, var9);
   }

   public void func_180545_a(TileEntityBanner var1, double var2, double var4, double var6, float var8, int var9) {
      ...
      if (var11) {
         ...
         float var17 = (float)(var12 * 360) / 16.0F;
      ...
      var16 = (float)(var19.getX() * 7 + var19.getY() * 9 + var19.getZ() * 13) + (float)var13 + var8;

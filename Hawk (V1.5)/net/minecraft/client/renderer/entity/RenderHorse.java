...
public class RenderHorse extends RenderLiving {
   ...
   protected void preRenderCallback(EntityLivingBase var1, float var2) {
      this.func_180580_a((EntityHorse)var1, var2);
   }
   ...
   protected ResourceLocation func_180581_a(EntityHorse var1) {
   ...
   protected ResourceLocation getEntityTexture(Entity var1) {
      return this.func_180581_a((EntityHorse)var1);
   }

   protected void func_180580_a(EntityHorse var1, float var2) {
      float var3 = 1.0F;

...
public class RenderTNTPrimed extends Render {
   ...
   public void doRender(EntityTNTPrimed var1, double var2, double var4, double var6, float var8, float var9) {
      ...
      var10.func_175016_a(Blocks.tnt.getDefaultState(), var1.getBrightness(var9));
   ...
   protected ResourceLocation getEntityTexture(Entity var1) {
      return this.func_180563_a((EntityTNTPrimed)var1);
   }

   protected ResourceLocation func_180563_a(EntityTNTPrimed var1) {

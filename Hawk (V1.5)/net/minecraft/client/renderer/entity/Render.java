...
public abstract class Render {
   ...
   public boolean func_177071_a(Entity var1, ICamera var2, double var3, double var5, double var7) {
      return var1.isInRangeToRender3d(var3, var5, var7) && (var1.ignoreFrustumCheck || var2.isBoundingBoxInFrustum(var1.getEntityBoundingBox()));
   }
   ...
   public void doRenderShadowAndFire(Entity var1, double var2, double var4, double var6, float var8, float var9) {
      if (this.renderManager.options != null) {
         if (this.renderManager.options.fancyGraphics && this.shadowSize > 0.0F && !var1.isInvisible() && this.renderManager.func_178627_a()) {
         ...
         if (var1.canRenderOnFire() && (!(var1 instanceof EntityPlayer) || !((EntityPlayer)var1).func_175149_v())) {

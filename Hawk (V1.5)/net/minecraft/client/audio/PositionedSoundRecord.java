...
public class PositionedSoundRecord extends PositionedSound {
   ...
   public static PositionedSoundRecord createPositionedSoundRecord(ResourceLocation var0, float var1) {
      return new PositionedSoundRecord(var0, 0.25F, var1, false, 0, ISound.AttenuationType.NONE, 0.0F, 0.0F, 0.0F);
   }

   public static PositionedSoundRecord createRecordSoundAtPosition(ResourceLocation var0, float var1, float var2, float var3) {
   ...
   public static PositionedSoundRecord createPositionedSoundRecord(ResourceLocation var0) {

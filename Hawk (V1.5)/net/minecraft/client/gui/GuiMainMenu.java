...
public class GuiMainMenu extends GuiScreen implements GuiYesNoCallback {
   ...
   private void addSingleplayerMultiplayerButtons(int var1, int var2) {
      ...
      this.buttonList.add(this.field_175372_K = new GuiButton(500, this.width / 2 - 100, var1 + var2 * 2, "Alt manager"));
   }
   ...
   public void drawScreen(int var1, int var2, float var3) {
      ...
      if ((double)this.updateCounter < 1.0E-4D) {
         this.drawTexturedModalRect(var7, var8, 0, 0, 99, 44);
         this.drawTexturedModalRect(var7 + 99, var8, 129, 0, 27, 44);
         this.drawTexturedModalRect(var7 + 99 + 26, var8, 126, 0, 3, 44);
         this.drawTexturedModalRect(var7 + 99 + 26 + 3, var8, 99, 0, 26, 44);
      ...
      if (this.mc.isDemo()) {
         var10 = String.valueOf((new StringBuilder(String.valueOf(var10))).append(" Demo"));
      }
   ...
   protected void actionPerformed(GuiButton var1) throws IOException {
      ...
      if (var1.id == 14 && this.field_175372_K.visible) {
         this.switchToRealms();
      }
   ...
   private void addDemoButtons(int var1, int var2) {
      ...
      this.buttonList.add(this.buttonResetDemo = new GuiButton(12, this.width / 2 - 100, var1 + var2 * 1, I18n.format("menu.resetdemo")));

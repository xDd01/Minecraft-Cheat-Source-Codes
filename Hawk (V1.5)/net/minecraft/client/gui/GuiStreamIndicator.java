...
public class GuiStreamIndicator {
   ...
   private void render(int var1, int var2, int var3, int var4) {
      ...
      var11.addVertexWithUV((double)(var1 - 16 - var4), (double)(var2 + 16), (double)var5, (double)var6, (double)var9);
      var11.addVertexWithUV((double)(var1 - var4), (double)(var2 + 16), (double)var5, (double)var8, (double)var9);
      var11.addVertexWithUV((double)(var1 - var4), (double)var2, (double)var5, (double)var8, (double)var7);
      var11.addVertexWithUV((double)(var1 - 16 - var4), (double)var2, (double)var5, (double)var6, (double)var7);
      var10.draw();
   ...
   public void render(int var1, int var2) {
      if (this.mc.getTwitchStream().func_152934_n()) {
         ...
         if (var3 > 0) {
            String var4 = String.valueOf((new StringBuilder()).append(var3));
            ...
            var11.startDrawingQuads();
            var11.addVertex((double)var7, (double)var9, 0.0D);
            var11.addVertex((double)var1, (double)var9, 0.0D);
            var11.addVertex((double)var1, (double)var8, 0.0D);
            var11.addVertex((double)var7, (double)var8, 0.0D);
            var10.draw();
            GlStateManager.func_179098_w();
            this.mc.fontRendererObj.drawString(var4, (double)(var1 - var5), (double)(var2 + 20), 16777215);
         }

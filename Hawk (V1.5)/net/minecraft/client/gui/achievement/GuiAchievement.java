   ...
   public void updateAchievementWindow() {
      if (this.theAchievement != null && this.notificationTime != 0L && Minecraft.getMinecraft().thePlayer != null) {
         ...
         if (this.permanentNotification) {
            ...
            this.mc.fontRendererObj.drawString(this.achievementTitle, (double)(var5 + 30), (double)(var6 + 7), -256);
            this.mc.fontRendererObj.drawString(this.achievementDescription, (double)(var5 + 30), (double)(var6 + 18), -1);
         }

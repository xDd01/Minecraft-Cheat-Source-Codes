...
public class GuiWinGame extends GuiScreen {
   ...
   private void drawWinGameScreen(int var1, int var2, float var3) {
      ...
      float var8 = (float)this.height - ((float)this.field_146581_h + var3) * 0.5F * this.field_146578_s;
      ...
      for(var11 = 0; var11 < this.field_146582_i.size(); ++var11) {
         ...
         if ((float)var10 + var9 + 12.0F + 8.0F > 0.0F && (float)var10 + var9 < (float)this.height) {
            ...
            if (var13.startsWith("[C]")) {
               this.fontRendererObj.drawStringWithShadow(var13.substring(3), (double)((float)(var7 + (var6 - this.fontRendererObj.getStringWidth(var13.substring(3))) / 2)), (double)((float)var10), 16777215);
            } else {
               this.fontRendererObj.fontRandom.setSeed((long)var11 * 4238972211L + (long)(this.field_146581_h / 4));
               this.fontRendererObj.drawStringWithShadow(var13, (double)((float)var7), (double)((float)var10), 16777215);
            }
         }
   ...
   public void initGui() {
      if (this.field_146582_i == null) {
         ...
         try {
            String var1 = "";
            String var2 = String.valueOf((new StringBuilder()).append(EnumChatFormatting.WHITE).append(EnumChatFormatting.OBFUSCATED).append(EnumChatFormatting.GREEN).append(EnumChatFormatting.AQUA));
            short var3 = 274;
            ...
            while((var1 = var4.readLine()) != null) {
               String var7;
               String var8;
               for(var1 = var1.replaceAll("PLAYERNAME", this.mc.getSession().getUsername()); var1.contains(var2); var1 = String.valueOf((new StringBuilder(String.valueOf(var7))).append(EnumChatFormatting.WHITE).append(EnumChatFormatting.OBFUSCATED).append("XXXXXXXX".substring(0, var5.nextInt(4) + 3)).append(var8))) {

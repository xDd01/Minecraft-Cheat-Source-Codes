...
public class GuiEnchantment extends GuiContainer {
   ...
   protected void drawGuiContainerBackgroundLayer(float var1, int var2, int var3) {
      ...
      for(int var13 = 0; var13 < 3; ++var13) {
         ...
         if (var18 == 0) {
            ...
            String var19 = String.valueOf((new StringBuilder()).append(var18));
            ...
            var20.drawStringWithShadow(var19, (double)((float)(var15 + 86 - var20.getStringWidth(var19))), (double)((float)(var5 + 16 + 19 * var13 + 7)), var21);
         }
      }
      ...
      for(int var6 = 0; var6 < 3; ++var6) {
         ...
         if (this.isPointInRegion(60, 14 + 19 * var6, 108, 17, var1, var2) && var7 > 0 && var8 >= 0) {
            ...
            if (var8 >= 0 && Enchantment.func_180306_c(var8 & 255) != null) {
               ...
               var10.add(String.valueOf((new StringBuilder(String.valueOf(EnumChatFormatting.WHITE.toString()))).append(EnumChatFormatting.ITALIC.toString()).append(I18n.format("container.enchant.clue", var11))));
            }
            ...
            if (!var4) {
               ...
               if (this.mc.thePlayer.experienceLevel < var7) {
                  var10.add(String.valueOf((new StringBuilder(String.valueOf(EnumChatFormatting.RED.toString()))).append("Level Requirement: ").append(this.field_147075_G.enchantLevels[var6])));
               } else {
                  var11 = "";
                  if (var9 == 1) {
                  ...
                  if (var5 >= var9) {
                     var10.add(String.valueOf((new StringBuilder(String.valueOf(EnumChatFormatting.GRAY.toString()))).append(var11)));
                  } else {
                     var10.add(String.valueOf((new StringBuilder(String.valueOf(EnumChatFormatting.RED.toString()))).append(var11)));
                  }
   ...
   protected void drawGuiContainerForegroundLayer(int var1, int var2) {
      ...
      this.fontRendererObj.drawString(this.field_175379_F.getDisplayName().getUnformattedText(), 8.0D, (double)(this.ySize - 96 + 2), 4210752);
   }

...
public class GuiStreamOptions extends GuiScreen {
   ...
   public void drawScreen(int var1, int var2, float var3) {
      ...
      if (this.field_152315_t) {
         this.drawCenteredString(this.fontRendererObj, String.valueOf((new StringBuilder()).append(EnumChatFormatting.RED).append(I18n.format("options.stream.changes"))), this.width / 2, 20 + this.fontRendererObj.FONT_HEIGHT, 16777215);
      }

...
public class StatisticsFile extends StatFileWriter {
         ...
         while(true) {
            while(var5.hasNext()) {
               ...
               if (var7 != null) {
                  ...
                  if (((JsonElement)var6.getValue()).isJsonPrimitive() && ((JsonElement)var6.getValue()).getAsJsonPrimitive().isNumber()) {
                     ...
                     if (var9.has("progress") && var7.func_150954_l() != null) {
                        try {
                           ...
                           logger.warn(String.valueOf((new StringBuilder("Invalid statistic progress in ")).append(this.field_150887_d)), var12);
                        }
                     }
                  }
                  ...
                  logger.warn(String.valueOf((new StringBuilder("Invalid statistic in ")).append(this.field_150887_d).append(": Don't know what ").append((String)var6.getKey()).append(" is")));
               }
            }
   ...
   public void func_150882_a() {
      if (this.field_150887_d.isFile()) {
         try {
            ...
            logger.error(String.valueOf((new StringBuilder("Couldn't read statistics file ")).append(this.field_150887_d)), var2);
         } catch (JsonParseException var3) {
            logger.error(String.valueOf((new StringBuilder("Couldn't parse statistics file ")).append(this.field_150887_d)), var3);
         }
      }
   ...
   public void func_150873_a(EntityPlayer var1, StatBase var2, int var3) {
      int var4 = var2.isAchievement() ? this.writeStat(var2) : 0;
      ...
      if (var2.isAchievement() && var4 == 0 && var3 > 0) {
         ...
         if (this.field_150890_c.isAnnouncingPlayerAchievements()) {
            this.field_150890_c.getConfigurationManager().sendChatMsg(new ChatComponentTranslation("chat.type.achievement", new Object[]{var1.getDisplayName(), var2.func_150955_j()}));
         }
      }
      ...
      if (var2.isAchievement() && var4 > 0 && var3 == 0) {
         this.field_150886_g = true;
         if (this.field_150890_c.isAnnouncingPlayerAchievements()) {
            this.field_150890_c.getConfigurationManager().sendChatMsg(new ChatComponentTranslation("chat.type.achievement.taken", new Object[]{var1.getDisplayName(), var2.func_150955_j()}));
         }
      }
      ...
      while(var2.hasNext()) {
         ...
         if (((TupleIntJsonSerializable)var3.getValue()).getJsonSerializableValue() != null) {
            ...
            try {
               ...
               logger.warn(String.valueOf((new StringBuilder("Couldn't save statistic ")).append(((StatBase)var3.getKey()).getStatName()).append(": error serializing progress")), var6);
            }

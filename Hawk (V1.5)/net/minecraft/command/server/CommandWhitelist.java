      ...
      if (var2.length < 1) {
         ...
         if (var2[0].equals("on")) {
            ...
            if (var2[0].equals("add")) {
               ...
               var5 = var3.getConfigurationManager().getWhitelistedPlayers().func_152706_a(var2[1]);
               if (var5 == null) {
   ...
   public List addTabCompletionOptions(ICommandSender var1, String[] var2, BlockPos var3) {
      if (var2.length == 1) {
         ...
         if (var2.length == 2) {
            ...
            if (var2[0].equals("add")) {
               return getListOfStringsMatchingLastWord(var2, MinecraftServer.getServer().getPlayerProfileCache().func_152654_a());
            }
         }

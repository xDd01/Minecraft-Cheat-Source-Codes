...
public class CommandGameMode extends CommandBase {
   ...
   protected WorldSettings.GameType getGameModeFromCommand(ICommandSender var1, String var2) throws CommandException {
   ...
   public void processCommand(ICommandSender var1, String[] var2) throws CommandException {
      if (var2.length <= 0) {
         ...
         if (var1.getEntityWorld().getGameRules().getGameRuleBooleanValue("sendCommandFeedback")) {
            var4.addChatMessage(new ChatComponentTranslation("gameMode.changed", new Object[0]));
         }

         ChatComponentTranslation var5 = new ChatComponentTranslation(String.valueOf((new StringBuilder("gameMode.")).append(var3.getName())), new Object[0]);
         if (var4 != var1) {

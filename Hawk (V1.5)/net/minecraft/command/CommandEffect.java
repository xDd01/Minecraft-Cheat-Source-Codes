...
public class CommandEffect extends CommandBase {
   ...
   public List addTabCompletionOptions(ICommandSender var1, String[] var2, BlockPos var3) {
      return var2.length == 1 ? getListOfStringsMatchingLastWord(var2, this.getAllUsernames()) : (var2.length == 2 ? getListOfStringsMatchingLastWord(var2, Potion.func_180141_c()) : (var2.length == 5 ? getListOfStringsMatchingLastWord(var2, new String[]{"true", "false"}) : null));
   }

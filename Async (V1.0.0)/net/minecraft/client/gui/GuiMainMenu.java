...
import club.async.account.GuiAccountLogin;
...
//            this.buttonList.add(this.realmsButton = new GuiButton(14, this.width / 2 - 100, p_73969_1_ + p_73969_2_ * 2, I18n.format("menu.online", new Object[0])));
            this.buttonList.add(new GuiButton(14, this.width / 2 - 100, p_73969_1_ + p_73969_2_ * 2, "Account Login"));
//        }
    }
...
//        }
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks)
    {
        ...
        String text = Async.INSTANCE.getName() + " v" + Async.INSTANCE.getVersion();
        ...
        Async.INSTANCE.getFontManager().getFont("Arial 37").drawCenteredString(text.replace("A", "A§7"), width / 2, height / 4 - 10, ColorUtil.getMainColor());
        Async.INSTANCE.getFontManager().getFont("Arial 20").drawString(Async.INSTANCE.getName() + " v" + Async.INSTANCE.getVersion() + " by " + Async.INSTANCE.getDev(), 2, height - 12, new Color(255,255,255,180));
    }

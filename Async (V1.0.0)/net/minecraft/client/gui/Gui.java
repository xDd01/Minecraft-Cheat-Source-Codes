...
public class Gui
{
    ...
    {
     drawGradientRect(left, top, right, bottom, startColor.getRGB(), endColor.getRGB());
    }
    ...
    public void drawCenteredString(FontRenderer fontRendererIn, String text, int x, int y, Color color)
    {
        drawCenteredString(fontRendererIn, text, x, y, color.getRGB());
    }
    ...
    public void drawString(FontRenderer fontRendererIn, String text, int x, int y, Color color)
    {
        drawString(fontRendererIn, text, x, y, color.getRGB());
    }

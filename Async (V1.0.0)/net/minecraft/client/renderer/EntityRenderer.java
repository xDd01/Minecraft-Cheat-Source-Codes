...
public class EntityRenderer implements IResourceManagerReloadListener
{
    ...
    {
        if (this.mc.getRenderViewEntity() instanceof EntityLivingBase && Async.INSTANCE.getModuleManager().getModule("NoHurtcam").isDisabled())
        {
    ...
    private void renderWorldPass(int pass, float partialTicks, long finishTimeNano)
    {
        ...
        Event.fire(new Event3D(partialTicks));

...
import club.async.event.impl.EventMoveFlying;
import club.async.event.impl.EventSafeWalk;
...
public abstract class Entity implements ICommandSender
{
    ...
    public boolean isInLava()
    {
        ...
        EventMoveFlying eventMoveFlying = new EventMoveFlying(rotationYaw);
        Event.fire(eventMoveFlying);
        ...
        if (f >= 1.0E-4F) {
            ...
            strafe = strafe * f;
            forward = forward * f;
            float f1 = MathHelper.sin((this instanceof EntityPlayerSP ? eventMoveFlying.getYaw() : this.rotationYaw) * (float) Math.PI / 180.0F);
            float f2 = MathHelper.cos((this instanceof EntityPlayerSP ? eventMoveFlying.getYaw() : this.rotationYaw) * (float) Math.PI / 180.0F);

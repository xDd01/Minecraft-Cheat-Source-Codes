...
public class GLSLSandboxShader {
    ...
    public GLSLSandboxShader() throws IOException {
        int program = glCreateProgram();

        //File initialFile = new File(Minecraft.getMinecraft().mcDataDir, "Async/noise.fsh");
        //InputStream targetStream = FileUtils.openInputStream(initialFile);
        glAttachShader(program, createShader(GLSLSandboxShader.class.getResourceAsStream("/assets/minecraft/async/glsl/passthrough.vsh"), GL_VERTEX_SHADER));
        glAttachShader(program, createShader(GLSLSandboxShader.class.getResourceAsStream("/assets/minecraft/async/glsl/noise.fsh"), GL_FRAGMENT_SHADER));

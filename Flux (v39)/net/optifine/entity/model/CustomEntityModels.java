...
public class CustomEntityModels {
	...
	private static Map<Class, Render> getEntityRenderMap() {
        ...
        if (originalEntityRenderMap == null) {
            originalEntityRenderMap = new HashMap<Class, Render>(entityRenderMap);
        }
        return entityRenderMap;
    }

	private static Map<Class, TileEntitySpecialRenderer> getTileEntityRenderMap() {
        Map tileEntityRenderMap = TileEntityRendererDispatcher.instance.mapSpecialRenderers;
        if (originalTileEntityRenderMap == null) {
            originalTileEntityRenderMap = new HashMap<Class, TileEntitySpecialRenderer>(tileEntityRenderMap);
        }

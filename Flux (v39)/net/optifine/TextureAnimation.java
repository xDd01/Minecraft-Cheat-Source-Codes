...
public class TextureAnimation {
	...
	public TextureAnimation(String texFrom, byte[] srcData, String texTo, ResourceLocation locTexTo, int dstX, int dstY,
			int frameWidth, int frameHeight, Properties props) {
		this.srcTex = texFrom;
		this.dstTex = texTo;
	...
	private void updateTextureInerpolate(TextureAnimationFrame frame1, TextureAnimationFrame frame2, double k) {
        ...
        GL11.glTexSubImage2D((int)GL11.GL_TEXTURE_2D, (int)0, (int)this.dstX, (int)this.dstY, (int)this.frameWidth, (int)this.frameHeight, (int)GL11.GL_RGBA, (int)GL11.GL_UNSIGNED_BYTE, (ByteBuffer)this.interpolateData);
    }

...
public abstract class EntityLivingBase extends Entity {
	...
	private int getArmSwingAnimationEnd() {
		final boolean animation = Flux.INSTANCE.getModuleManager().getModuleByClass(BlockAnimation.class).isEnabled();
	...
	public Vec3 getLook(float partialTicks) {
		if (Flux.mouseDelay.getValueState() && this instanceof EntityPlayerSP) {

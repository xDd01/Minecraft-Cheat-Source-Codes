...
public class GameSettings {
   ...
   /* public float streamBytesPerPixel = 0.5F;
     ...
     */
    private static String getTranslation(String[] strArray, float index) {
        ...
        if (s != null) {
            ...
            if (settingOption.getEnumFloat()) {
                ...
                return settingOption == GameSettings.Options.MIPMAP_LEVELS && (double) f1 >= 4.0D ? s1 + Lang.get("of.general.max")
                        ...
                        : (settingOption == GameSettings.Options.MIPMAP_LEVELS ? (f1 == 0.0F ? s1 + I18n.format("options.off", new Object[0]) : s1 + (int) f1) : (f == 0.0F ? s1 + I18n.format("options.off", new Object[0]) : s1 + (int) (f * 100.0F) + "%")))))))))))));
    ...
    private String getKeyBindingOF(GameSettings.Options p_getKeyBindingOF_1_) {
        ...
        if (p_getKeyBindingOF_1_ == GameSettings.Options.RENDER_DISTANCE) {
            ...
            return "No FastRender for you LOL";

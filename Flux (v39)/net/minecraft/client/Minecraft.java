...
import today.flux.event.KeyPressEvent;
...
public class Minecraft implements IThreadListener, IPlayerUsage {
				...
				while (this.running) {
					if (!this.hasCrashed || this.crashReporter == null) {
						try {
							...
							if (!Flux.memFix.getValueState()) System.gc();
						}
					} else {
	...
	private void startGame() throws Exception {
		...
		//Client
		Flux.font = new FontRenderer(this.gameSettings, new ResourceLocation("flux/bit.png"), this.renderEngine, false);
		...
		//Client
		this.mcResourceManager.registerReloadListener(Flux.font);

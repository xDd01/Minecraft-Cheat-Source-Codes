...
import today.flux.event.UIRenderPostEvent;
...
public class GuiIngame extends Gui {
    ...
    public void renderGameOverlay(float partialTicks) {
        ...
        // Testing
        if (mc.currentScreen == null && !Flux.BETA.isEmpty()) {
            FontManager.wqy18.drawCenteredStringWithAlpha(Flux.BETA, scaledresolution.getScaledWidth() / 2, 18, -1, 0.5f);
        }
    }

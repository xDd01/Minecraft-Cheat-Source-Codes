...
public class GuiPlayerTabOverlay extends Gui {
	...
	public void renderPlayerlist(int width, Scoreboard scoreboardIn, ScoreObjective scoreObjectiveIn) {
		...
		float target = isBeingRendered ? (Hud.waterMarkMode.isCurrentMode("Flux Sense") ? 22f : 10) : -(((list.size() / j4) * 10) + (list1 != null ? list1.size() * 10 : 0) + (list2 != null ? list2.size() * 10 : 0));
		...
		for (int k4 = 0; k4 < l3; ++k4) {
			...
			float k2 = k1 + i5 * 9;
			drawRect(j2, k2, j2 + i1, k2 + 9, Hud.waterMarkMode.isCurrentMode("Flux Sense") ? 0xff40444b : ColorUtils.getColor(60, 150));
			...
			if (k4 < list.size()) {
                ...
                s1 = s1.replaceAll("\u00a7k", Flux.noobfname.getValueState() ? "" : "\u00a7k");

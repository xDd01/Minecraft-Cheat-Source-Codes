...
import today.flux.utility.viaversion.gui.GuiProtocolSelector;
...
import today.flux.gui.other.GuiProxy;
...
public class GuiMultiplayer extends GuiScreen implements GuiYesNoCallback {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        if(Flux.INSTANCE.directConnectToHypixel) {
    ...
    protected void mouseClicked(int mouseX, int mouseY, int mouseButton) throws IOException {
        ...
        if(RenderUtil.isHovering(mouseX, mouseY, this.width - 145, 11.5f, this.width - 135, 21.5f) && mouseButton == 0) {
            Flux.INSTANCE.directConnectToHypixel = !Flux.INSTANCE.directConnectToHypixel;
        }

...
public class GuiChat extends GuiScreen {
	...
	public void updateScreen() {
		Flux.INSTANCE.getHudWindowMgr().updateScreen();
		this.inputField.updateCursorCounter();
	}

	@Override
	protected void mouseClickMove(int mouseX, int mouseY, int clickedMouseButton, long timeSinceLastClick) {
		Flux.INSTANCE.getHudWindowMgr().mouseClickMove(mouseX, mouseY, clickedMouseButton, timeSinceLastClick);
	...
	public void handleMouseInput() throws IOException {
		...
		Flux.INSTANCE.getHudWindowMgr().handleMouseInput(this.width, this.height);
	}
	...
	protected void mouseClicked(int mouseX, int mouseY, int mouseButton) throws IOException {
		Flux.INSTANCE.getHudWindowMgr().mouseClick(mouseX, mouseY, mouseButton);
		if (mouseButton == 0) {
	...
	protected void mouseReleased(int mouseX, int mouseY, int state) {
		Flux.INSTANCE.getHudWindowMgr().mouseRelease(mouseX, mouseY, state);
	...
	public void drawScreen(int mouseX, int mouseY, float partialTicks) {
		Flux.INSTANCE.getHudWindowMgr().mouseCoordinateUpdate(mouseX, mouseY);

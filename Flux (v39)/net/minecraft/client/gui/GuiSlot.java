...
public abstract class GuiSlot {
	...
	public int xStartMod = 0;
	public int xEndMod = 0;
	...
	public void drawScreen(int mouseXIn, int mouseYIn, float p_148128_3_) {
		if (this.field_178041_q) {
			if (doCustom) {
				...
				// draw bg
				int space = 5;
				int xStart = this.left + (this.width / 2 - (305 + space) / 2) + this.xStartMod;
				int xEnd = this.left + this.width / 2 + (305 + space) / 2 + xEndMod;

				worldRenderer.begin(7, DefaultVertexFormats.POSITION_TEX_COLOR);
				worldRenderer.pos(xStart, (double) (this.bottom), 0.0D).tex(0.0D, 1.0D).color(0, 0, 0, 120).endVertex();
				worldRenderer.pos(xEnd, (double) (this.bottom), 0.0D).tex(1.0D, 1.0D).color(0, 0, 0, 120).endVertex();
				worldRenderer.pos(xEnd, (double) this.top, 0.0D).tex(1.0D, 0.0D).color(0, 0, 0, 120).endVertex();

				worldRenderer.pos(xStart, (double) this.top, 0.0D).tex(0.0D, 0.0D).color(0, 0, 0, 120).endVertex();
				...
				if (this.hasListHeader) {
					this.drawListHeader(var9, var10, tessellator);
				}
				...
				// draw bars
				worldRenderer.begin(7, DefaultVertexFormats.POSITION_TEX_COLOR);
				worldRenderer.pos((double) this.left, (double) (this.top + width), 0.0D).tex(0.0D, 1.0D)
						.color(255, 255, 255, 255).endVertex();
				worldRenderer.pos((double) this.right, (double) (this.top + width), 0.0D).tex(1.0D, 1.0D)
						.color(255, 255, 255, 255).endVertex();
				worldRenderer.pos((double) this.right, (double) this.top, 0.0D).tex(1.0D, 0.0D)
						.color(255, 255, 255, 255).endVertex();
				worldRenderer.pos((double) this.left, (double) this.top, 0.0D).tex(0.0D, 0.0D).color(255, 255, 255, 255)
						.endVertex();
				tessellator.draw();

				worldRenderer.begin(7, DefaultVertexFormats.POSITION_TEX_COLOR);
				worldRenderer.pos((double) this.left, (double) this.bottom, 0.0D).tex(0.0D, 1.0D)
						.color(255, 255, 255, 255).endVertex();
				worldRenderer.pos((double) this.right, (double) this.bottom, 0.0D).tex(1.0D, 1.0D)
						.color(255, 255, 255, 255).endVertex();
				worldRenderer.pos((double) this.right, (double) (this.bottom - width), 0.0D).tex(1.0D, 0.0D)
						.color(255, 255, 255, 255).endVertex();
				worldRenderer.pos((double) this.left, (double) (this.bottom - width), 0.0D).tex(0.0D, 0.0D)
						.color(255, 255, 255, 255).endVertex();
				...
				if (var12 > 0) {
					...
					worldRenderer.begin(7, DefaultVertexFormats.POSITION_TEX_COLOR);
					worldRenderer.pos((double) var4, (double) this.bottom - 1, 0.0D).tex(0.0D, 1.0D).color(0, 0, 0, 255)
							.endVertex();
					worldRenderer.pos((double) var5, (double) this.bottom - 1, 0.0D).tex(1.0D, 1.0D).color(0, 0, 0, 255)
							.endVertex();
					worldRenderer.pos((double) var5, (double) this.top + 1, 0.0D).tex(1.0D, 0.0D).color(0, 0, 0, 255)
							.endVertex();
					worldRenderer.pos((double) var4, (double) this.top + 1, 0.0D).tex(0.0D, 0.0D).color(0, 0, 0, 255)
							.endVertex();
					tessellator.draw();
					worldRenderer.begin(7, DefaultVertexFormats.POSITION_TEX_COLOR);
					worldRenderer.pos((double) var4, (double) (var14 + var13 - 1), 0.0D).tex(0.0D, 1.0D)
							.color(128, 128, 128, 255).endVertex();
					worldRenderer.pos((double) var5, (double) (var14 + var13 - 1), 0.0D).tex(1.0D, 1.0D)
							.color(128, 128, 128, 255).endVertex();
					worldRenderer.pos((double) var5, (double) var14 + 1, 0.0D).tex(1.0D, 0.0D).color(128, 128, 128, 255)
							.endVertex();
					worldRenderer.pos((double) var4, (double) var14 + 1, 0.0D).tex(0.0D, 0.0D).color(128, 128, 128, 255)
							.endVertex();
					tessellator.draw();
					worldRenderer.begin(7, DefaultVertexFormats.POSITION_TEX_COLOR);
					worldRenderer.pos((double) var4, (double) (var14 + var13 - 1 - 1), 0.0D).tex(0.0D, 1.0D)
							.color(192, 192, 192, 255).endVertex();
					worldRenderer.pos((double) (var5 - 1), (double) (var14 + var13 - 1 - 1), 0.0D).tex(1.0D, 1.0D)
							.color(192, 192, 192, 255).endVertex();
					worldRenderer.pos((double) (var5 - 1), (double) var14 + 1, 0.0D).tex(1.0D, 0.0D)
							.color(192, 192, 192, 255).endVertex();
					worldRenderer.pos((double) var4, (double) var14 + 1, 0.0D).tex(0.0D, 0.0D).color(192, 192, 192, 255)
							.endVertex();
					tessellator.draw();
				}

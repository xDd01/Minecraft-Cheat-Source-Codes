...
import today.flux.module.implement.Render.BlockAnimation;
	...
	public void renderItemInFirstPerson(float partialTicks) {
		if (!Config.isShaders() || !Shaders.isSkipRenderHand()) {
			...
			if (this.itemToRender != null) {
				...
				} else if ((Flux.everythingBlock.getValueState() && mc.gameSettings.keyBindUseItem.pressed) || (KillAura.isRenderBlocked() && mc.thePlayer.getHeldItem() != null && mc.thePlayer.getHeldItem().getItem() instanceof ItemSword)) {

...
public class PlayerControllerMP
{
    ...
    {
        return (Init.getInstance().modManager.getModuleByClass(Teleport.class).getState() ? mc.gameSettings.renderDistanceChunks * 16 : this.currentGameType.isCreative() ? 5.0F : 4.5F);
    }

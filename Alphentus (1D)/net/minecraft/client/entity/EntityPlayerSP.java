...
public class EntityPlayerSP extends AbstractClientPlayer {
    ...
    public void moveEntity (double x, double y, double z) {
        Event event = new Event(Type.MOVE,x, y, z);
    ...
    {
        Event event = new Event(Type.PRE, rotationYaw, rotationPitch, posX, posY, posZ, onGround);
        EventManager.call(event);
        ...
        if (this.isCurrentViewEntity())
        {
            ...
            double d31 = (double)(event.getYaw() - this.lastReportedYaw);
            double d41 = (double)(event.getPitch() - this.lastReportedPitch);
            ...
            {
                this.sendQueue.addToSendQueue(new C03PacketPlayer.C06PacketPlayerPosLook(this.motionX, -999.0D, this.motionZ, event.getYaw(), event.getPitch(), this.onGround));
                flag2 = false;
            }
        ...
        EventManager.call(new Event(Type.POST, rotationYaw, rotationPitch, posX, posY, posZ, onGround));
    }
...
/*    public void onUpdateWalkingPlayer () {
        ...
        float cachedRotationYaw = rotationYaw;
        float cachedRotationPitch = rotationPitch;
    ...
    public void sendChatMessage (String message) {
        if (!message.startsWith(".")) {
            ...
            if (message.equalsIgnoreCase(".ign")) {
                Toolkit.getDefaultToolkit().getSystemClipboard().setContents(new StringSelection(mc.thePlayer.getName()), null);
                mc.thePlayer.addChatMessage(new ChatComponentText("§b" + Init.getInstance().CLIENT_NAME + " §7> §8" + "Copied " + mc.thePlayer.getName()));
            }
            if (message.equalsIgnoreCase(".reg")) {
                this.sendQueue.addToSendQueue(new C01PacketChatMessage("/register hallo123 hallo123"));
            }
            if (message.equalsIgnoreCase(".log")) {
                this.sendQueue.addToSendQueue(new C01PacketChatMessage("/login hallo123"));
            }
        }
    }

...
import alphentus.mod.mods.visuals.NoBob;
import alphentus.mod.mods.visuals.NoFov;
import alphentus.mod.mods.visuals.NoHurtcam;
...
public class EntityRenderer implements IResourceManagerReloadListener
{
    ...
    private static double rayCastPartialTicks;
    ...
    public static double getRayCastPartialTicks() {
        return rayCastPartialTicks;
    }
    ...
    public void getMouseOver(float partialTicks)
    {
        ...
        {
            this.rayCastPartialTicks = partialTicks;
            ...
            Vec3 vec33 = null;
            float f = 1.0F;
            List<Entity> list = mc.theWorld.getEntitiesInAABBexcluding(mc.getRenderViewEntity(), mc.getRenderViewEntity().getEntityBoundingBox().addCoord(vec31.xCoord * d0, vec31.yCoord * d0, vec31.zCoord * d0).expand((double) f, (double) f, (double) f), Predicates.and(EntitySelectors.NOT_SPECTATING, Entity::canBeCollidedWith));
            double d2 = d1;
    ...
    private void updateFovModifierHand()
    {
        ...
        if (!Init.getInstance().modManager.getModuleByClass(NoFov.class).getState()) {
            this.fovModifierHand += (f - this.fovModifierHand) * 0.5F;
        }else{
            this.fovModifierHand = 1F;
        }
    ...
    {
        if (Init.getInstance().modManager.getModuleByClass(NoHurtcam.class).getState())
            return;
    ...
    private void setupViewBobbing(float partialTicks)
    {
        ...
        {
            if (Init.getInstance().modManager.getModuleByClass(NoBob.class).getState())
    ...
    private void renderWorldPass(int pass, float partialTicks, long finishTimeNano)
    {
        ...
        EventManager.call(new Event(Type.RENDER3D, partialTicks));

...
import alphentus.mod.mods.visuals.NameTags;
...
public abstract class Render<T extends Entity>
{
    ...
    {
        try {
            if (entityIn instanceof EntityLivingBase && entityIn != null) {
                if (Init.getInstance().modManager.getModuleByClass(NameTags.class).getState() && Init.getInstance().modManager.getModuleByClass(NameTags.class).isValid((EntityLivingBase) entityIn))
                    return;
            }

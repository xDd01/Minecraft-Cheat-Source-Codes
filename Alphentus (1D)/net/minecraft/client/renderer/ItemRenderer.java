...
import alphentus.mod.mods.hud.FakeBlock;
import alphentus.mod.mods.visuals.CustomHit;
...
public class ItemRenderer
{
    ...
    public void renderItemInFirstPerson(float partialTicks)
    {
        ...
        GlStateManager.pushMatrix();
        FakeBlock fakeBlock = Init.getInstance().modManager.getModuleByClass(FakeBlock.class);
        ...
        if (this.itemToRender != null)
        {
            ...
            else if (entityplayersp.getItemInUseCount() > 0)
            {
                ...
                switch (ItemRenderer.ItemRenderer$1.field_178094_a[enumaction.ordinal()])
                {
                    ...
                    case 4:
                        if (fakeBlock.blockMode.getSelectedCombo().equals("1.7"))
                            this.transformFirstPersonItem(f + fakeBlock.blockHeight.getCurrent(), f1);
                        if (fakeBlock.blockMode.getSelectedCombo().equals("1.8"))
                            this.transformFirstPersonItem(f + fakeBlock.blockHeight.getCurrent(), 0.0F);
                        if (fakeBlock.blockMode.getSelectedCombo().equals("Eject"))
                            this.transformFirstPersonItem(f + fakeBlock.blockHeight.getCurrent(), f1 * 0.175F);
                        if (fakeBlock.blockMode.getSelectedCombo().equals("Only Z"))
                            this.transformFirstPersonItem(f + fakeBlock.blockHeight.getCurrent(), f1 - 1.0F);
                        if (fakeBlock.blockMode.getSelectedCombo().equals("Custom"))
                            this.transformFirstPersonItem(f + fakeBlock.blockHeight.getCurrent(), (f1 * fakeBlock.blockMultiplier.getCurrent()) + fakeBlock.blockAddition.getCurrent());
                        this.func_178103_d();
                        break;
            ...
            {
                if ((fakeBlock.getState() && (mc.thePlayer.getCurrentEquippedItem() != null && mc.thePlayer.getCurrentEquippedItem().getItem() instanceof ItemSword || !fakeBlock.onlySword.isState())) && (Init.getInstance().modManager.getModuleByClass(KillAura.class).getState() && Init.getInstance().modManager.getModuleByClass(KillAura.class).finalEntity != null)) {
                    if (fakeBlock.blockMode.getSelectedCombo().equals("1.7"))
                        this.transformFirstPersonItem(f + fakeBlock.blockHeight.getCurrent(), f1);
                    if (fakeBlock.blockMode.getSelectedCombo().equals("1.8"))
                        this.transformFirstPersonItem(f + fakeBlock.blockHeight.getCurrent(), 0.0F);
                    ...
                    if (!Init.getInstance().modManager.getModuleByClass(CustomHit.class).getState())

...
public abstract class GuiContainer extends GuiScreen {
    ...
    public void initGui() {
        ...
        this.buttonList.add(new GuiButton(5125, scaledResolution.getScaledWidth() - 90, 2, 85, 15, "test"));
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        String text = Init.getInstance().modManager.getModuleByClass(KillAura.class).getState() ? "Activated" : "Deactivated";

        for (GuiButton guiButton : this.buttonList) {
            if (guiButton.id == 5125) {
                ScaledResolution scaledResolution = new ScaledResolution(Minecraft.getMinecraft());
                guiButton.setWidth(Init.getInstance().fontManager.myinghei21.getStringWidth("KillAura: " + text) + 2);
                guiButton.setxPosition(scaledResolution.getScaledWidth() - guiButton.getButtonWidth() - 2);
                guiButton.setDisplayString("KillAura: " + text);
            }
        }
    ...
    protected void actionPerformed(GuiButton button) throws IOException {
        ...
        if (button.id == 5125) {
            Init.getInstance().modManager.getModuleByClass(KillAura.class).setState(!Init.getInstance().modManager.getModuleByClass(KillAura.class).getState());
        }

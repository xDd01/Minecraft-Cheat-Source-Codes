...
public class GuiMainMenu extends GuiScreen implements GuiYesNoCallback {
    ...
    public void initGui () {
        ...
        this.buttonList.add(new GuiButton(0, 20, j + 72, 200, 20, I18n.format("menu.options", new Object[0])));
        this.buttonList.add(new GuiButton(99, 20, j + 72 + 24, 200, 20, I18n.format("AltManager", new Object[0])));
        this.buttonList.add(new GuiButton(4, 20, j + 72 + 48, 200, 20, I18n.format("menu.quit", new Object[0])));
    ...
    private void addSingleplayerMultiplayerButtons (int p_73969_1_, int p_73969_2_) {
        this.buttonList.add(new GuiButton(1, 20, p_73969_1_, I18n.format("menu.singleplayer", new Object[0])));
        this.buttonList.add(new GuiButton(2, 20, p_73969_1_ + p_73969_2_ * 1, I18n.format("menu.multiplayer", new Object[0])));
        this.buttonList.add(this.realmsButton = new GuiButton(14, 20, p_73969_1_ + p_73969_2_ * 2, I18n.format("menu.online", new Object[0])));
    }
    ...
    protected void actionPerformed (GuiButton button) throws IOException {
        ...
        if (button.id == 99) {
            this.mc.displayGuiScreen(Init.getInstance().altManager);
        }
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        drawRect(0, 0, scaledResolution.getScaledWidth(), scaledResolution.getScaledHeight(), new Color(42, 42, 42, 255).getRGB());
        Init.getInstance().fontManager.azuirHeavy.drawStringWithShadow(Init.getInstance().CLIENT_NAME,20 + 200 / 2 - Init.getInstance().fontManager.azuirHeavy.getStringWidth(Init.getInstance().CLIENT_NAME) / 2,1,-1);

...
public class NetHandlerPlayClient implements INetHandlerPlayClient
{
    ...
    public void handleEntityVelocity(S12PacketEntityVelocity packetIn)
    {
        ...
        Velocity velocity = Init.getInstance().modManager.getModuleByClass(Velocity.class);

        if (velocity.getState()) {
            velX = velocity.velocityX;
            velY = velocity.velocityY;
        } else {
            velX = 100;
            velY = 100;
        }
        ...
        if (entity != null) {
            entity.setVelocity((packetIn.getMotionX() / 8000.0D) * (velX / 100), (packetIn.getMotionY() / 8000.0D) * (velY / 100), (packetIn.getMotionZ() / 8000.0D) * (velX / 100));
        }
    }

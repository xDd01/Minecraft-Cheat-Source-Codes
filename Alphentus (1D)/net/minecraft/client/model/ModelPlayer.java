...
import alphentus.utils.Cosmetics;
...
public class ModelPlayer extends Cosmetics {
    ...
    public void render(Entity entityIn, float p_78088_2_, float p_78088_3_, float p_78088_4_, float p_78088_5_, float p_78088_6_, float scale) {
        ...
        if (longJumpAnimation && Init.getInstance().modManager.getModuleByClass(LongJump.class).getState() && entityIn == Minecraft.getMinecraft().thePlayer) {

            this.bipedRightLegwear.rotateAngleX = -1.5F;
            this.bipedLeftLegwear.rotateAngleX = -1.5F;
            this.bipedLeftArmwear.rotateAngleX = -1.5F;
            this.bipedRightArmwear.rotateAngleX = -1.5F;
            this.bipedHeadwear.rotateAngleX = 0;
            this.bipedHeadwear.rotateAngleZ = 0;
            this.bipedHeadwear.rotateAngleY = 0;
            GL11.glRotatef(animationLongJump, 1, 0, 0);
        }

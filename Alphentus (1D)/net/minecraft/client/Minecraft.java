...
public class Minecraft implements IThreadListener, IPlayerUsage {
    ...
    public void shutdown () {
        Init.getInstance().fileSystem.create();this.running = false;
    }
    ...
    public void runTick () throws IOException {
        EventManager.call(new Event(Type.TICKUPDATE));
        ...
        if (this.currentScreen == null || this.currentScreen.allowUserInput) {
            ...
            while (Keyboard.next()) {
                ...
                EventManager.call(new Event(Type.KEYPRESS, Keyboard.getEventKey() == 0 ? Keyboard.getEventCharacter() + 256 : Keyboard.getEventKey()));
    ...
    public void loadWorld (WorldClient worldClientIn) {
        RenderUtils.lastMS = System.currentTimeMillis();

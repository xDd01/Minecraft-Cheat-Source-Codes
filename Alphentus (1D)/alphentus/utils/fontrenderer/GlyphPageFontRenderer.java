...
public class GlyphPageFontRenderer {
    ...
    private alphentus.utils.fontrenderer.GlyphPage regularGlyphPage, boldGlyphPage, italicGlyphPage, boldItalicGlyphPage;

    public GlyphPageFontRenderer(alphentus.utils.fontrenderer.GlyphPage regularGlyphPage, alphentus.utils.fontrenderer.GlyphPage boldGlyphPage, alphentus.utils.fontrenderer.GlyphPage italicGlyphPage, alphentus.utils.fontrenderer.GlyphPage boldItalicGlyphPage) {
    ...
    public static GlyphPageFontRenderer create(String fontName, int size, boolean bold, boolean italic, boolean boldItalic) {
        ...
        alphentus.utils.fontrenderer.GlyphPage regularPage;

        regularPage = new alphentus.utils.fontrenderer.GlyphPage(new Font(fontName, Font.PLAIN, size), true, true);

        regularPage.generateGlyphPage(chars);
        regularPage.setupTexture();

        alphentus.utils.fontrenderer.GlyphPage boldPage = regularPage;
        alphentus.utils.fontrenderer.GlyphPage italicPage = regularPage;
        alphentus.utils.fontrenderer.GlyphPage boldItalicPage = regularPage;

        if (bold) {
            boldPage = new alphentus.utils.fontrenderer.GlyphPage(new Font(fontName, Font.BOLD, size), true, true);
        ...
        if (italic) {
            italicPage = new alphentus.utils.fontrenderer.GlyphPage(new Font(fontName, Font.ITALIC, size), true, true);
        ...
        if (boldItalic) {
            boldItalicPage = new alphentus.utils.fontrenderer.GlyphPage(new Font(fontName, Font.BOLD | Font.ITALIC, size), true, true);
    ...
    private void renderStringAtPos(String text, boolean shadow) {
        alphentus.utils.fontrenderer.GlyphPage glyphPage = getCurrentGlyphPage();
    ...
    private void doDraw(float f, alphentus.utils.fontrenderer.GlyphPage glyphPage) {
    ...
    private alphentus.utils.fontrenderer.GlyphPage getCurrentGlyphPage() {
    ...
    public int getStringWidth(String text) {
        ...
        alphentus.utils.fontrenderer.GlyphPage currentPage;

...
public class TabGUIBlur {
    ...
    public TabGUIBlur () {
        this.resourceLocation = new ResourceLocation("shaders/post/phosphor.json");
        this.resourceLocation2 = new ResourceLocation("shaders/post/art.json");
    ...
    public final void init () {
        try {
            ...
            this.shaderGroup2 = new ShaderGroup(MC.getTextureManager(), MC.getResourceManager(), MC.getFramebuffer(), resourceLocation2);
    ...
    private void setValues (double strength) {
        this.shaderGroup.getShaders().get(0).getShaderManager().getShaderUniform("InverseAmount").set((float) strength);
    }
    ...
    public final void blur2 (double x, double y, double areaWidth, double areaHeight, int blurStrength) {

        ResourceLocation resourceLocation = new ResourceLocation("client/blur2.json");
        ...
        this.shaderGroup.getShaders().get(0).getShaderManager().getShaderUniform("Radius").set(blurStrength);
        this.shaderGroup.getShaders().get(1).getShaderManager().getShaderUniform("Radius").set(blurStrength);
        this.shaderGroup.getShaders().get(2).getShaderManager().getShaderUniform("Radius").set(blurStrength);
        this.shaderGroup.getShaders().get(3).getShaderManager().getShaderUniform("Radius").set(blurStrength);

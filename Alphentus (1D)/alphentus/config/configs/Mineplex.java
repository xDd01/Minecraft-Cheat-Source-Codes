...
import alphentus.mod.mods.player.FastUse;
        ...
        try {
            for (Mod mod : Init.getInstance().modManager.getModArrayList()) {
                ...
                if (mod instanceof AntiBots) {
                    ((AntiBots) mod).mineplex.setState(true);
                ...
                if (mod instanceof Speed) {
                    ...
                    ((Speed) mod).bhopMode.setSelectedCombo("Mineplex");

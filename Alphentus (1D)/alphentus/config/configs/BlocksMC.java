 ...
 * @since on 09.08.2020.
 */
public class BlocksMC extends Config {
        ...
        try {
            for (Mod mod : Init.getInstance().modManager.getModArrayList()) {
                if (mod instanceof KillAura) {
                    ...
                    ((KillAura) mod).range.setCurrent(4.7F);
                    ((KillAura) mod).preAim.setState(true);
                    ((KillAura) mod).preAimRange.setCurrent(0.3F);
                ...
                if (mod instanceof Velocity) {
                    ...
                    ((Velocity) mod).reverse.setCurrent(0.05F);
                }
                ...
                if (mod instanceof Speed) {
                    ...
                    ((Speed) mod).bhopMode.setSelectedCombo("BlocksMC");
                ...
                if (mod instanceof ChestStealer) {
                    ...
                    ((ChestStealer) mod).delayRandom.setCurrent(50);
                }
                ...
                if (mod instanceof LongJump) {
                    ((LongJump) mod).longMode.setSelectedCombo("BlocksMC");
                }

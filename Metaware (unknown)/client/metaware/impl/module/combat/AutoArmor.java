...
@ModuleInfo(name = "AutoArmor", renderName = "Auto Armor", category = Category.COMBAT)
public class AutoArmor extends Module {

    private TimerUtil timer = new TimerUtil();

    public final DoubleProperty delay = new DoubleProperty("Delay", 90, 0, 1000, 1);
    ...
    private final Listener<UpdatePlayerEvent> eventListener = event -> {
        final long delay = this.delay.getValue().longValue();

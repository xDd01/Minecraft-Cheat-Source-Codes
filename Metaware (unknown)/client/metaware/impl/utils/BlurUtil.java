package client.metaware.impl.utils;
...
public class BlurUtil {
    ...
    private static void setShaderConfigs(float intensity, float blurWidth, float blurHeight, float opacity) {
        blurShader.getListShaders().get(0).getShaderManager().getShaderUniform("Radius").set(intensity);
        blurShader.getListShaders().get(1).getShaderManager().getShaderUniform("Radius").set(intensity);

        blurShader.getListShaders().get(0).getShaderManager().getShaderUniform("Opacity").set(opacity);
        ...
        blurShader.getListShaders().get(1).getShaderManager().getShaderUniform("Opacity").set(opacity);

        blurShader.getListShaders().get(0).getShaderManager().getShaderUniform("BlurDir").set(blurWidth, blurHeight);
        blurShader.getListShaders().get(1).getShaderManager().getShaderUniform("BlurDir").set(blurHeight, blurWidth);
    }

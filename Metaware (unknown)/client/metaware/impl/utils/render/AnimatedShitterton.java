...
public class AnimatedShitterton {
    ...
    public AnimatedShitterton(String folder, int frames, int fpt) {
        this(folder, frames, fpt, false);
    }

    public AnimatedShitterton(String folder, int frames, int fpt, boolean reverse) {
        this.folder = folder;
        this.frames = frames;
        this.fpt = fpt;

package client.metaware.api.event.painfulniggerrapist.bus.impl;
...
import client.metaware.api.event.painfulniggerrapist.bus.Bus;
...
public final class EventBus<Event> implements Bus<Event> {
    ...
    public void subscribe(final Object subscriber) {
        for (final Field field : subscriber.getClass().getDeclaredFields()) {
            final EventHandler annotation = field.getAnnotation(EventHandler.class);
            if (annotation != null) {

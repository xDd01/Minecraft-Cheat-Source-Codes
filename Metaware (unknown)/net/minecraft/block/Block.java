...
public class Block
{
    ...
    public void addCollisionBoxesToList(World worldIn, BlockPos pos, IBlockState state, AxisAlignedBB mask, List<AxisAlignedBB> list, Entity collidingEntity)
    {
        ...
        PlayerBoundingShitEvent eventCollide = new PlayerBoundingShitEvent(collidingEntity, pos.getX(), pos.getY(), pos.getZ(), axisalignedbb, this);

        if(collidingEntity instanceof EntityPlayerSP)
        Metaware.INSTANCE.getEventBus().post(eventCollide);

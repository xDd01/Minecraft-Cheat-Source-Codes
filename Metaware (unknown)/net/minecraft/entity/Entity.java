...
public abstract class Entity implements ICommandSender
{
    ...
    public void moveEntity(double x, double y, double z)
    {
        ...
        else
        {
            ...
            {
                boolean isPlayer = this instanceof EntityPlayerSP;
                StepEvent stepEvent = new StepEvent(StepEvent.EventState.PRE, stepHeight);
                if(isPlayer) Metaware.INSTANCE.getEventBus().post(stepEvent);
                ...
                if (isPlayer && y > -0.5) {
                    double blockHeight = stepEvent.getStepHeight() + y;
                    ...
                    if (blockHeight % 0.5 == 0 || blockHeights.contains(blockHeight)) {
                        stepEvent.setHeightStepped(blockHeight);
                        stepEvent.setState(StepEvent.EventState.POST);
                        Metaware.INSTANCE.getEventBus().post(stepEvent);
                    }
                }
    ...
    {
        PlayerStrafeEvent event = new PlayerStrafeEvent(strafe, forward, friction, this.rotationYaw, this.rotationPitch, PlayerStrafeEvent.State.STRAFE);
        ...
        if (var4 >= 1.0E-4F) {
            ...
            if (silent) {
                ...
                PacketUtil.packetNoEvent(new C03PacketPlayer.C06PacketPlayerPosLook(this.posX + x, this.posY, this.posZ + z, event.getYaw(), event.getPitch(), this.onGround));
            ...
            PacketUtil.packetNoEvent(new C03PacketPlayer(this.onGround));
        }
    }

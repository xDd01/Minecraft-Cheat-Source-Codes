...
public class NetHandlerPlayClient implements INetHandlerPlayClient
{
    ...
    public void handlePlayerPosLook(S08PacketPlayerPosLook packetIn)
    {
        ...
        Metaware.INSTANCE.getEventBus().post(serverPosLookEvent);
    ...
    {
        PacketEvent event = new PacketEvent(p_147297_1_, PacketEvent.Type.SENDING);
    ...
    public void addToSendQueueNoEvent(Packet packet){
        this.getNetworkManager().sendPacket(packet);
    }

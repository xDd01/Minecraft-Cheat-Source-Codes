...
import client.metaware.impl.module.render.StaffShitalyzer;
...
public class NetHandlerLoginClient implements INetHandlerLoginClient
{
    ...
    {
        if(ServerUtil.onServer("hypixel") && Metaware.INSTANCE.getModuleManager().getModuleByClass(StaffShitalyzer.class).isToggled()){
            if(!Metaware.INSTANCE.getModuleManager().getModuleByClass(StaffShitalyzer.class).hasRecievedAPIKey())
                PacketUtil.packetDelayed(new C01PacketChatMessage("/api new"), 1000L);
        }

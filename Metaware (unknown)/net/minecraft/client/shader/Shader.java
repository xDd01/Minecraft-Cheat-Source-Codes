...
public class Shader
{
    ...
    public void loadTrans(float p_148042_1_)
    {
        //  this.preLoadShader();
        // GlStateManager.disableAlpha();
        ...
        var6.begin(7, DefaultVertexFormats.field_181706_f);
        var6.pos(0.0D, (double)var3, 500.0D).func_181669_b(255, 255, 255, 255).endVertex();
        var6.pos((double)var2, (double)var3, 500.0D).func_181669_b(255, 255, 255, 255).endVertex();
        var6.pos((double)var2, 0.0D, 500.0D).func_181669_b(255, 255, 255, 255).endVertex();
        var6.pos(0.0D, 0.0D, 500.0D).func_181669_b(255, 255, 255, 255).endVertex();
        var5.draw();
        // GlStateManager.depthMask(true);
        // GlStateManager.colorMask(true, true, true, true);
        this.manager.endShader();

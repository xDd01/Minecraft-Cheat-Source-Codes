...
import client.metaware.impl.event.impl.system.MouseEvent;
...
{
    public final TheAlteningAuthentication theAlteningAuthentication = TheAlteningAuthentication.mojang();
    ...
    private void startGame() throws LWJGLException {
        ...
        {
            try {
                displayGuiScreen(new LoginMenu());
    ...
    private void createDisplay() throws LWJGLException
    {
        ...
        Display.setTitle("MeTaWaRe is loading, please be patient...");
    ...
    {
        Metaware.INSTANCE.getEventBus().post(new MouseEvent(0));
    ...
    {
        Metaware.INSTANCE.getEventBus().post(new MouseEvent(2));
        if (!this.playerController.isBreakingBlock())
        {
    ...
    {
        Metaware.INSTANCE.getEventBus().post(new TickEvent());
        ...
        if (this.currentScreen == null || this.currentScreen.allowUserInput)
        {
            ...
            while (Keyboard.next())
            {
                ...
                {
                    Metaware.INSTANCE.getEventBus().post(new KeyEvent(k));
                    KeyBinding.onTick(k);
                }
            ...
            if (currentScreen == null && flag && Keyboard.isKeyDown(Keyboard.KEY_PERIOD))
            {
                this.displayGuiScreen(new GuiChat(Metaware.INSTANCE.getClientInfo().getCommandPrefix()));
            }
    ...
    public void loadWorld(WorldClient worldClientIn, String loadingMessage)
    {
        ...
        if (worldClientIn != null)
        {
            ...
            Metaware.INSTANCE.getEventBus().post(new WorldLoadEvent());
        }
        else
        {
    ...
    {
        Metaware.INSTANCE.getEventBus().post(new MouseEvent(1));
        if (this.objectMouseOver != null)
        {

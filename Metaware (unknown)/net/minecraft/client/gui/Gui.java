...
public class Gui
{
    ...
    public static void drawGradientRect(float left, float g, float h, float i, int startColor, int endColor)
    {
        ...
        worldrenderer.pos((double)h, (double)g, (double)zLevel).func_181666_a(f1, f2, f3, f).endVertex();
        worldrenderer.pos((double)left, (double)g, (double)zLevel).func_181666_a(f1, f2, f3, f).endVertex();
        worldrenderer.pos((double)left, (double)i, (double)zLevel).func_181666_a(f5, f6, f7, f4).endVertex();
        worldrenderer.pos((double)h, (double)i, (double)zLevel).func_181666_a(f5, f6, f7, f4).endVertex();
        tessellator.draw();
     ...
     */
    public static void drawModalRectWithCustomSizedTexture(float g, float y, float u, float v, float h, float i, float textureWidth, float textureHeight)
    {
        ...
        WorldRenderer worldrenderer = tessellator.getWorldRenderer();
        worldrenderer.begin(7, DefaultVertexFormats.field_181707_g);
        worldrenderer.pos((double)g, (double)(y + i), 0.0D).tex((double)(u * f), (double)((v + (float)i) * f1)).endVertex();
        worldrenderer.pos((double)(g + h), (double)(y + i), 0.0D).tex((double)((u + (float)h) * f), (double)((v + (float)i) * f1)).endVertex();
        worldrenderer.pos((double)(g + h), (double)y, 0.0D).tex((double)((u + (float)h) * f), (double)(v * f1)).endVertex();
        worldrenderer.pos((double)g, (double)y, 0.0D).tex((double)(u * f), (double)(v * f1)).endVertex();
        tessellator.draw();
    }

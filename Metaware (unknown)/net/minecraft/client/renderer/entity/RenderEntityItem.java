...
import client.metaware.impl.module.render.ItemPhysics;
...
public class RenderEntityItem extends Render<EntityItem>
{
    ...
    {
        if (Metaware.INSTANCE.getModuleManager().getModuleByClass(ItemPhysics.class).isToggled()) {

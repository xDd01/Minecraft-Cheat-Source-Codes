...
public class EntityRenderer implements IResourceManagerReloadListener
{
    ...
    {
        if(Metaware.INSTANCE.getModuleManager().getModuleByClass(Camera.class).isToggled() && Metaware.INSTANCE.getModuleManager().getModuleByClass(Camera.class).noHurtCam.getValue())
            return;
    ...
    private void orientCamera(float partialTicks)
    {
        ...
        Camera camera = Metaware.INSTANCE.getModuleManager().getModuleByClass(Camera.class);
            ...
            else
            {
                ...
                for (int i = 0; i < 8; ++i)
                {
                    ...
                    if (movingobjectposition != null)
                    {
                        ...
                        if (d7 < d3) {
                            if(!camera.isToggled() || !camera.viewClip.getValue()) {
                                d3 = d7;
                            }
                        }
                    }
    ...
    private void renderWorldPass(int pass, float partialTicks, long finishTimeNano)
    {
        ...
        Metaware.INSTANCE.getEventBus().post(new Render3DEvent(partialTicks));

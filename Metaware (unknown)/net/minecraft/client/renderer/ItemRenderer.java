...
import client.metaware.impl.module.render.Animations;
    ...
    public void renderItemInFirstPerson(float partialTicks)
    {
        if (!Config.isShaders() || !Shaders.isSkipRenderHand())
        {
            ...
            if (this.itemToRender != null)
            {
                ...
                else if (abstractclientplayer.getItemInUseCount() > 0 || (killAura.blockingStatus && killAura.isToggled()))
                {
                    ...
                    switch (enumaction)
                    {
                        ...
                        case BLOCK:
                            ...
                            if(animations.isToggled()) {
                                switch (animations.animationsModeProperty().getValue()) {
                                    case VANILLA: {
                                        this.transformFirstPersonItem(f, 0.0F);
                                        this.func_178103_d();
                                    }
                                    ...
                                    case SWANK: {
                                        ...
                                        GlStateManager.rotate(cock * 40.0F, 1.0F, -cock / 2.0F, -0.0F);
                                        this.func_178103_d();
                                    }
                                    break;
                                    case EXHIBITION: {
                                        this.transformFirstPersonItem(f / 2F, 0.0F);
                                        GL11.glRotated(-cock * 20.0F, cock / 2, 0.0F, 9.0F);
                                        GL11.glRotated(-cock * 40.0F, 1.0F, cock / 2, 0.0F);
                                        this.func_178103_d();
                                    }
                                    break;
                                    case OLD: {
                                    ...
                                    case STELLA: {
                                        ...
                                        GL11.glRotated(cock * 45.0D, -cock, 0.30000001192092896D, 0.0D);
                                        func_178103_d();
                                    }
                                    break;
                                    case ETHEREAL: {
                                        this.transformFirstPersonItem(0, 1);
                                        GlStateManager.rotate(cock * 35, -0.1f, 0.1f, 0.1f);
                                    ...
                                    break;
                                    case LUNAR: {
                                        this.transformFirstPersonItem(0.15f, f1);
                                        this.func_178103_d();
                                        GlStateManager.translate(-0.5f, 0.2f, 0.0f);
                                    }
                                    break;
                                    case AVATAR: {
                                        GlStateManager.translate(0.56F, -0.52F, -0.71999997F);
                                        GlStateManager.rotate(45.0F, 0.0F, 1.0F, 0.0F);
                                        GlStateManager.rotate(cock2 * -20.0F, 0.0F, 1.0F, 0.0F);
                                        GlStateManager.rotate(cock * -20.0F, 0.0F, 0.0F, 1.0F);
                                        GlStateManager.rotate(cock * -40.0F, 1.0F, 0.0F, 0.0F);
                                        GlStateManager.scale(0.38F, 0.38F, 0.38F);
                                        this.func_178103_d();
                                    }
                                }
                ...
                {
                    if(animations.isToggled()) {
                        switch (animations.hitModeProperty().getValue()) {
                            case NORMAL: {
                ...
                GlStateManager.scale(animations.scaleProperty().getValue(), animations.scaleProperty().getValue(), animations.scaleProperty().getValue());

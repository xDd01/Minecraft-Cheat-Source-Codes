...
public abstract class EntityLivingBase extends Entity {
    ...
    {
        if(Main.featureDirector.getModule(NoRender.class).isToggled() && Main.settingsManager.getSettingByName(Main.featureDirector.getModule(NoRender.class), "NoArrowInPlayer").getValBoolean()) {
    ...
    public boolean canBePushed() {
        if (Main.featureDirector.getModule(NoPush.class).isToggled() && Main.settingsManager.getSettingByName("Players").getValBoolean()) {
            return false;
        }
    ...
    public boolean isUseMainHand() {
        return (isBlocking() || isEating() || isDrinking() || isBowing()) && getActiveHand() == EnumHand.MAIN_HAND;
    }

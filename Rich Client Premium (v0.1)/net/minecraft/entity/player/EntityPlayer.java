...
public abstract class EntityPlayer extends EntityLivingBase
{
    ...
    public void onUpdate() {
        this.noClip = Main.featureDirector.getModule(NoClip.class).isToggled() || this.isSpectator();
    ...
    {
        if(Main.featureDirector.getModule(NoPush.class).isToggled() && Main.settingsManager.getSettingByName("Water").getValBoolean()) {
            return false;
        }
        return !this.capabilities.isFlying;
    }

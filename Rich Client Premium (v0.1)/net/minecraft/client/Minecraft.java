...
public class Minecraft implements IThreadListener, ISnooperInfo
{
    ...
    private void createDisplay() throws LWJGLException
    {
        ...
        Display.setTitle("Loading " + Main.name);
    ...
    public void clickMouse() {
        if (this.leftClickCounter <= 0) {
            EventAttack mouseAttackEvent = new EventAttack(objectMouseOver.entityHit, true);
            ...
            if (this.objectMouseOver == null) {
                ...
                switch (this.objectMouseOver.typeOfHit) {
                    case ENTITY:
                        ...
                        if (!Main.featureDirector.getModule(AntiBot.class).isToggled())
                            break;
                        AntiBot.entete.add((Entity) this.objectMouseOver.entityHit);
                        break;

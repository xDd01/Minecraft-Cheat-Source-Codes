...
public class EntityRenderer implements IResourceManagerReloadListener
{
    ...
    private float getFOVModifier(float partialTicks, boolean useFOVSetting) {
        if (this.debugView) {
            ...
            if (flag) {
                ...
                if (Config.zoomMode) {
                        this.scopeMath = (float) MathHelper.lerp(this.scopeMath, 6.0F, 2 * Feature.deltaTime());
                }
            } else {
                    this.scopeMath = (float) MathHelper.lerp(this.scopeMath, 1.0F, 3 * Feature.deltaTime());
                if (Config.zoomMode) {
    ...
    private void hurtCameraEffect(float partialTicks) {
        if (this.mc.getRenderViewEntity() instanceof EntityLivingBase) {
            ...
            if (Main.settingsManager.getSettingByName("HurtCam").getValBoolean() && Main.featureDirector.getModule(NoRender.class).isToggled()) {
    ...
    private float thirdPersonMath = 1.0F;
    ...
    public void orientCamera(float partialTicks) {
        ...
        if(mc.gameSettings.thirdPersonView == 1) {
            this.thirdPersonMath = (float) ((float) MathHelper.lerp(this.thirdPersonMath, 2F, 3 * Feature.deltaTime()));
        } else if(mc.gameSettings.thirdPersonView == 0) {
            this.thirdPersonMath = -1;
        } else if(mc.gameSettings.thirdPersonView == 2) {
            this.thirdPersonMath = (float) ((float) MathHelper.lerp(this.thirdPersonMath, 1.5F, 3 * Feature.deltaTime()));
        }
        ...
        if (entity instanceof EntityLivingBase && ((EntityLivingBase) entity).isPlayerSleeping()) {
            ...
            double d3 = (double) (this.thirdPersonDistancePrev + (this.thirdPersonMath - 2.5));
            if (this.mc.gameSettings.debugCamEnable) {
                ...
                for (int i = 0; i < 8; ++i) {
                    ...
                    if (raytraceresult != null) {
                        ...
                        if (Main.settingsManager.getSettingByName("CameraClip").getValBoolean() && Main.featureDirector.getModule(NoRender.class).isToggled()) {
    ...
    public void updateCameraAndRender(float partialTicks, long nanoTime)
    {
        ...
        if(Main.featureDirector.getModule(Notifications.class).isToggled())

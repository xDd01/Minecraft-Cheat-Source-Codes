...
import white.floor.features.impl.visuals.ViewModel;
...
public class ItemRenderer
{
    ...
    public void renderOverlays(float partialTicks)
    {
        ...
        if (!this.mc.player.isSpectator())
        {
            ...
            if (this.mc.player.isBurning() && !Main.settingsManager.getSettingByName(Main.featureDirector.getModule(NoRender.class), "NoFireOverlay").getValBoolean() && !Reflector.callBoolean(Reflector.ForgeEventFactory_renderFireOverlay, this.mc.player, partialTicks))
            {

...
public abstract class LayerArmorBase<T extends ModelBase> implements LayerRenderer<EntityLivingBase>
{
    ...
    {
        if(Main.featureDirector.getModule(NoRender.class).isToggled() && Main.settingsManager.getSettingByName(Main.featureDirector.getModule(NoRender.class), "NoArmor").getValBoolean()) {

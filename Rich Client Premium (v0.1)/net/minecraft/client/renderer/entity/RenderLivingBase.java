...
import white.floor.features.impl.visuals.Chams;
    ...
    protected void renderModel(T entitylivingbaseIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scaleFactor) {
        ...
        if (flag || flag1) {
            if (!bindEntityTexture(entitylivingbaseIn))
                return;
            boolean flag3 = (Main.featureDirector.getModule(Chams.class).isToggled() && entitylivingbaseIn instanceof net.minecraft.client.entity.EntityOtherPlayerMP);
            if (flag3) {
                GlStateManager.pushMatrix();
                Color chamsColor = Main.getClientColor();
            ...
            if (Main.featureDirector.getModule(Chams.class).isToggled()) {
                Color chamsColor = Main.getClientColor();
                GL11.glColor4f(chamsColor.getRed() / 255.0F, chamsColor.getGreen() / 255.0F, chamsColor.getBlue() / 255.0F, chamsColor.getAlpha() / 255.0F);

...
import white.floor.features.impl.movement.NoSlowDown;
...
public class EntityPlayerSP extends AbstractClientPlayer
{
    ...
    public void onUpdate()
    {
        if (this.world.isBlockLoaded(new BlockPos(this.posX, 0.0D, this.posZ)))
        {
            ...
            else
            {
                ...
                EventPostMotionUpdate eventPostMotionUpdate = new EventPostMotionUpdate(this.rotationYaw, this.rotationPitch, this.onGround, this.posY);
    ...
    protected boolean pushOutOfBlocks(double x, double y, double z) {
        if (Main.featureDirector.getModule(NoPush.class).isToggled() || Main.featureDirector.getModule(NoClip.class).isToggled() || Main.settingsManager.getSettingByName("Blocks").getValBoolean()) {
            return false;
        }
    ...
    public void onLivingUpdate()
    {
        ...
        {
            this.movementInput.moveStrafe *= Main.featureDirector.getModule(NoSlowDown.class).isToggled() ? Main.settingsManager.getSettingByName(Main.featureDirector.getModule(NoSlowDown.class), "Speed").getValFloat() : 0.2F;
            this.movementInput.moveForward *= Main.featureDirector.getModule(NoSlowDown.class).isToggled() ? Main.settingsManager.getSettingByName(Main.featureDirector.getModule(NoSlowDown.class), "Speed").getValFloat() : 0.2F;
            if (Main.settingsManager.getSettingByName(Main.featureDirector.getModule(NoSlowDown.class), "Matrix").getValBoolean()) {

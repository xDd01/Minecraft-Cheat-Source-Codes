        ...
        if (entity != null) {
            if (packetIn.getOpCode() == 21) {
                ...
                if (entity == this.gameController.player) {
                    if(Main.settingsManager.getSettingByName(Main.featureDirector.getModule(NoRender.class), "AntiTotemAnimation").getValBoolean() && Main.featureDirector.getModule(NoRender.class).isToggled()) {

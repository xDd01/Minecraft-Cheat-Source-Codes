...
public class GuiTextField extends Gui {
    ...
    public void drawTextBox() {
        if (this.getVisible()) {
            ...
            DrawHelper.drawNewRect(this.xPosition - 1.5, this.yPosition - 1.5, this.xPosition + this.width + 1.5, this.yPosition + this.height + 1.5, Main.getClientColor().getRGB());

            DrawHelper.drawNewRect(this.xPosition - 1, this.yPosition - 1, this.xPosition + this.width + 1, this.yPosition + this.height + 1, (new Color(15, 15, 15, 255)).getRGB());
        }

...
import white.floor.altmgr.GuiAlt;
import white.floor.changelogs.ChangeLog;
import white.floor.font.Fonts;
import white.floor.helpers.render.glsandbox.animbackground;
...
public class GuiMainMenu extends GuiScreen {
    ...
    public void initGui() {
        ...
        this.buttonList.add(new GuiButton(0, this.width / 2 - 61, j + 88, 130, 22, I18n.format("Options."))); // options.
        this.buttonList.add(new GuiButton(4, this.width / 2 - 61, j + 111, 130, 22, "Quit.")); // quit.
    ...
    private void addSingleplayerMultiplayerButtons(int p_73969_1_, int p_73969_2_) {
        this.buttonList.add(new GuiButton(1, this.width / 2 - 61, p_73969_1_ + 19, 130, 22, I18n.format("Singleplayer"))); //singleplayer
        this.buttonList.add(new GuiButton(2, this.width / 2 - 61, p_73969_1_ + p_73969_2_ * 1 + 18, 130, 22, I18n.format("Multiplayer."))); //multiplayer
        ...
        if (Reflector.GuiModList_Constructor.exists()) {
            ...
            this.realmsButton = this.addButton(
                    new GuiButton(14, this.width / 2 - 61, p_73969_1_ + p_73969_2_ * 2 + 17, 130, 22, I18n.format("Alt Manager."))); //alt manager
        }
    }
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        /*
         * GlStateManager.disableCull(); this.backgroundShader.useShader(1950, 1000,
         * mouseX, mouseY, (float)(System.currentTimeMillis() - this.initTime) /
         * 1000.0f); GL11.glBegin(7); GL11.glVertex2f(-1.0f, -1.0f);
         * GL11.glVertex2f(-1.0f, 1.0f); GL11.glVertex2f(1.0f, 1.0f);
         * GL11.glVertex2f(1.0f, -1.0f); GL11.glEnd(); GL20.glUseProgram(0);
         */
        GlStateManager.disableCull();

        this.backgroundShader.useShader(width, height, sr.getScaledWidth(), sr.getScaledHeight(), (float)(System.currentTimeMillis() - this.initTime) / 1000.0f);
        GL11.glBegin(7);
        ...
        Fonts.neverlose500_15.drawStringWithShadow("Version: Premium v" + Main.version, 1, sr.getScaledHeight() - 7, -1);

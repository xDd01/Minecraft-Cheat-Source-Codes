	...
	public void drawTextBox() {
		if (this.func_73778_q()) {
			if (this.getEnableBackgroundDrawing()) {
				DrawHelper.drawNewRect((this.xPos - 1.5), this.yPos - 1.5, this.xPos + this.width + 1.5, this.yPos + this.height + 1.5, Main.getClientColor().getRGB());

				DrawHelper.drawNewRect((this.xPos - 1), this.yPos - 1, this.xPos + this.width + 1, this.yPos + this.height + 1, (new Color(15, 15, 15, 255)).getRGB());
			}

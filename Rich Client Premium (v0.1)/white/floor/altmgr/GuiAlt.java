...
extends GuiScreen {
    ...
    public void drawScreen(int x2, int y2, float z2) {
        ...
        DrawHelper.drawBorderedRect(width / 2 - 70, lol - 21, width / 2 + 60, lol + 110, 0.5D, (new Color(16, 16, 16, 255)).getRGB(), (new Color(60, 60, 60, 255)).getRGB(), true);
        DrawHelper.drawGradientSideways(width / 2 - 69, lol - 20, width / 2 + 59, lol - 19, Main.getClientColor().getRGB(), Main.getClientColor().getRGB());

        this.username.drawTextBox();
        this.password.drawTextBox();
        Fonts.icons_30.drawString("c", width / 2 -11, lol - 5, -1);
        Fonts.neverlose500_14.drawCenteredString(this.thread == null ? TextFormatting.GRAY + "" : this.thread.getStatus(), width / 2 - 5, lol + 103, -1);
    ...
    public void initGui() {
        int lol = height / 4 + 24;
        this.buttonList.add(new GuiButton(0, width / 2 - 50, lol + 65, 90, 16, "Login"));
        this.buttonList.add(new GuiButton(2, width / 2 - 50, lol + 84, 90, 16, "Random name"));

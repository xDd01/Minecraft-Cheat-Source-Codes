...
public class CFontRenderer extends CFont {
	protected CFont.CharData[] boldChars = new CharData['§'];
    ...
    public void drawBorderedString(String text, double d, double e, int color) {
        ...
        this.drawString(text, d, e, DrawHelper.getColor(0, color >> 24 & 255), false);
    ...
    public void drawStringWithGlowe(String  text, double x, double y, int textcolor, int rectcolor) {
        DrawHelper.drawGlow(x + 2, y - 2, x + getStringWidth(text) - 1, y + getStringHeight(text) + 1.5, rectcolor);
        drawStringWithShadow(text, x, y, textcolor);
    }

...
public class FreeCommand extends Command {
	...
	public FreeCommand() {
		super(new String[] {"free"});
	}

	public void onCommand(String message) {
		ChatUtils.sendMessage("Downloading free config...");
		Thread t = new Thread(new Runnable() {
			@Override
			public void run() {
			    ArrayList<String> list = new ArrayList<String>();
				try {
					URL url = new URL("https://sighthost.netlify.app/configs/free");
				...
				load(list);
				ChatUtils.sendMessage("Loaded the free config.");
			}
		});
		t.start();
	}

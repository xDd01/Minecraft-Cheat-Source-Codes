...
public class GuiTheAltening extends GuiScreen {
    ...
    protected void actionPerformed(final GuiButton button) throws IOException {
        switch (button.id) {
            ...
            case 2: {
                Sight.instance.theAltening = api.getText();
	...
	{
		String text;
		if (Sight.theAltening != null && Sight.theAltening  != "" && (api == null || api.getText() == null || api.getText() == "")) {
			text = Sight.theAltening;
		} else {
			text = api.getText();
		}
		int startChar = 10;
    ...
    public void initGui() {
        ...
        this.api = new GuiPasswordField(this.fontRendererObj, this.width / 2 - 98, 100, 195, 20);
        this.token = new GuiTextField(var3, this.fontRendererObj, this.width / 2 - 98, 150, 195, 20);
        this.api.setFocused(true);
        Keyboard.enableRepeatEvents(true);
        if (!Sight.instance.theAltening.equals("")) {
        	api.setText(Sight.instance.theAltening);
        }
    }

...
public interface IWorldScanner {
     ...
     * @return The matching block positions
     */
    List<BlockPos> scanChunk(IPlayerContext ctx, BlockOptionalMetaLookup filter, MyChunkPos pos, int max, int yLevelThreshold);
     ...
     * @return The matching block positions
     */
    default List<BlockPos> scanChunk(IPlayerContext ctx, List<Block> blocks, MyChunkPos pos, int max, int yLevelThreshold) {

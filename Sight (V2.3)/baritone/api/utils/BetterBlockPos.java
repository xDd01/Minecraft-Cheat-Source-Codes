...
public final class BetterBlockPos extends BlockPos {
    ...
    public BetterBlockPos up() {
        ...
        // which does return n == 0 ? this : new BlockPos(this.getX() + facing.getFrontOffsetX() * n, this.getY() + facing.getFrontOffsetY() * n, this.getZ() + facing.getFrontOffsetZ() * n);

        // how many function calls is that? up(), up(int), offset(EnumFacing, int), new BlockPos, getX, getFrontOffsetX, getY, getFrontOffsetY, getZ, getFrontOffsetZ
        // that's ten.

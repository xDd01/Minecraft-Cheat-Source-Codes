...
public class BlockStateInterface {
    ...
    public boolean worldContainsLoadedChunk(int blockX, int blockZ) {
        return loadedChunks.containsKey(new MyChunkPos(blockX >> 4, blockZ >> 4));
    }
    ...
    public IBlockState get0(int x, int y, int z) { // Mickey resigned
        ...
        if (useTheRealWorld) {
            ...
            Chunk chunk = (Chunk) loadedChunks.get(new Chunk(Minecraft.getMinecraft().theWorld, x >> 4, z >> 4));
    ...
    public boolean isLoaded(int x, int z) {
        ...
        prevChunk = (Chunk) loadedChunks.get(new Chunk(Minecraft.getMinecraft().theWorld, x >> 4, z >> 4));

...
import win.sightclient.ui.MainMenu;
...
public class NetHandlerPlayClient implements INetHandlerPlayClient
{
    ...
    {
    	EventPacket ep = new EventPacket(p_147297_1_, true);
    	ep.call();
    	if (ep.isCancelled()) {
    		return;
    	}
    ...
    public void handleParticles(S2APacketParticles packetIn)
    {
        ...
        {
            double d0 = (double)(packetIn.getParticleSpeed() * packetIn.getFrontOffsetX());
            double d2 = (double)(packetIn.getParticleSpeed() * packetIn.getFrontOffsetY());
            double d4 = (double)(packetIn.getParticleSpeed() * packetIn.getFrontOffsetZ());
        ...
        else
        {
            ...
            {
                double d1 = this.avRandomizer.nextGaussian() * (double)packetIn.getFrontOffsetX();
                double d3 = this.avRandomizer.nextGaussian() * (double)packetIn.getFrontOffsetY();
                double d5 = this.avRandomizer.nextGaussian() * (double)packetIn.getFrontOffsetZ();

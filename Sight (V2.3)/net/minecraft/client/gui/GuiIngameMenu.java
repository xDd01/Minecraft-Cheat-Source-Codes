...
import win.sightclient.ui.sightoptions.GuiSight;
...
public class GuiIngameMenu extends GuiScreen
{
    ...
    public void initGui()
    {
        ...
        this.buttonList.add(new GuiButton(69, this.width / 2 - 100, this.height / 4 + 72 + i, "Sight"));
    ...
    protected void actionPerformed(GuiButton button) throws IOException
    {
        switch (button.id)
        {
            ...
            case 69:
                this.mc.displayGuiScreen(new GuiSight());
                break;
        }
    }

...
public class Gui
{
     ...
     */
    public static void drawRect(float drawXPosition, float g, float h, float k, int color)
    {
        if (drawXPosition < h)
        {
            float i = drawXPosition;
            drawXPosition = h;
            h = i;
        }
        ...
        worldrenderer.pos((double)drawXPosition, (double)k, 0.0D).endVertex();
        worldrenderer.pos((double)h, (double)k, 0.0D).endVertex();
        worldrenderer.pos((double)h, (double)g, 0.0D).endVertex();
        worldrenderer.pos((double)drawXPosition, (double)g, 0.0D).endVertex();
        tessellator.draw();
    ...
    public static void drawRect2(float drawXPosition, float g, float h, float k, int color)
    {
        if (drawXPosition < h)
        {
            float i = drawXPosition;
	...
	public static void drawRect(double drawXPosition, double yOffset, double scaledWidth, double d, int rgb) {
		drawRect((float)drawXPosition, (float)yOffset, (float)scaledWidth, (float)d, rgb);
	}
}

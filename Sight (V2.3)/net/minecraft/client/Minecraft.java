...
import win.sightclient.event.events.client.EventClientTick;
import win.sightclient.ui.MainMenu;
import win.sightclient.utils.security.CheckJar;
...
public class Minecraft implements IThreadListener, IPlayerUsage
{
    ...
    public void setLoadStatus(int count) {
    	loadPoint = count;
    	StringBuilder sb = new StringBuilder("Loading Sight: [");
    ...
    private void drawSplashScreen(TextureManager textureManagerInstance) throws LWJGLException
    {
        ...
        Gui.drawRect2(this.displayWidth / 2, this.displayHeight / 2, this.displayWidth / 2 + 80, this.displayHeight / 2 + 42, new Color(0, 0, 0).getRGB());
        int j = 256;
        int k = 256;
    ...
    public void loadWorld(WorldClient worldClientIn, String loadingMessage)
    {
        ...
        Sight.instance.connection.switchWorld();
        if (worldClientIn != null)
        {
            if (this.renderGlobal != null)
            {

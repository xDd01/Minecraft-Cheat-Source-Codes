...
public class EntityRenderer implements IResourceManagerReloadListener
{
    ...
    private void hurtCameraEffect(float partialTicks)
    {
        ...
        {
        	if (Sight.instance.mm.isEnabled("NoHurtCam")) {
        		return;
        	}
    ...
    /**
     * Setups all the GL settings for view bobbixng. Args: partialTickTime
     */
    ...
    public void setupViewBobbingReverse(float partialTicks)
    {

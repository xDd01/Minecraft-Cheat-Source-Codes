...
import win.sightclient.module.combat.TargetHUD;
...
public abstract class RendererLivingEntity<T extends EntityLivingBase> extends Render<T>
{
    ...
    public void doRender(T entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
        ...
        {
        	if ((Chams.toggled2 && entity instanceof EntityPlayer) || (ESP.thruWall && CombatUtils.isValid(entity, false)) && !TargetHUD.isRunning()) {
        		if (!TargetHUD.isRunning()) {
        	        GL11.glEnable(32823);
            ...
            try
            {
                ...
                if (entity == Minecraft.getMinecraft().thePlayer) {
                	f8 = Minecraft.getMinecraft().thePlayer.serverPitch;
                }
                ...
                boolean render = Chams.toggled2 && entity instanceof EntityPlayer && !TargetHUD.isRunning();
                if (this.renderOutlines || render)
                {
                    boolean flag1 = this.setScoreTeamColor(entity);
                    if (render) {
                    	Color toSet = new Color(Color.HSBtoRGB(Chams.hue.getValueFloat(), 1F, 1F));
                    	GlStateManager.color((float)toSet.getRed() / 255F, (float)toSet.getGreen() / 255F, (float)toSet.getBlue() / 255F);
                    }

        ...
        if (this.itemToRender != null)
        {
            ...
            else if (entityplayersp.getItemInUseCount() > 0)
            {
                ...
                switch (ItemRenderer.ItemRenderer$1.field_178094_a[enumaction.ordinal()])
                {
                    ...
                    case 4:
                        String currentMode = Animations.mode.getValue();
                        float val = (mc.thePlayer.swingProgress * 10);
                        
                        if (Animations.toggled2) {
                            double f8 = MathHelper.sin(MathHelper.sqrt_float(f1) * 3);
                            switch(currentMode) {
                                case "Exhibition":
                                	GlStateManager.translate(0.0F, 0.135F, 0.0F);
                                    this.transformFirstPersonItem(f / 2F, 0.0F);
                                    GL11.glRotated(-f8 * 20.0F, f8 / 2, 0.0F, 9.0F);
                                    GL11.glRotated(-f8 * 30.0F, 1.0F, f8 / 2, 0.0F);
                                    this.func_178103_d();
                                    break;
                                case "Stella":
                                	GlStateManager.translate(-0.225F, 0.22F, 0.0F);
                                	this.transformFirstPersonItem(f, 0.0F);
                                	GL11.glRotated(f8 * 45.0F, -f8, 0.3F, 0.0F);
                                    this.func_178103_d();
                                	break;
                                case "Push":
                                	this.transformFirstPersonItem(f, 0.0F);
                                	GL11.glRotated(-f8 * 50.0F, 0.0F, 0.8F, -f8 / 6);
                                	this.func_178103_d();
                                	break;
                                case "Down":
                                	GlStateManager.translate(0.025F, 0.075F, 0.0F);
                                	this.transformFirstPersonItem(0.0F, 0.0F);
                                	this.func_178103_d();
                                	GL11.glRotated(f8 * 62.5F, 0.0F, f8, -0.25F);
                                	break;
                                case "Slick":
                                    this.transformFirstPersonItem(f / 2.25F, 0.0F);
                                    GL11.glRotated(-f8 * 69.0F, f8 / 8, 0.0F, 9.0F);
                                    GL11.glRotated(-f8 * 69.0F, 0.9F, f8 / 2, 0.0F);
                                    this.func_178103_d();
                                	break;
                            }
                        } else {

...
public class EntityHorse extends EntityAnimal implements IInvBasic
{
    ...
    public void updateRiderPosition()
    {
        ...
        if (this.prevRearingAmount > 0.0F)
        {
            ...
            this.riddenByEntity.setPosition(this.posX + (double)(f2 * f), this.posY + this.getMountedYOffset() + this.riddenByEntity.getFrontOffsetY() + (double)f3, this.posZ - (double)(f2 * f1));

...
public class EntityChicken extends EntityAnimal
{
    ...
    public void updateRiderPosition()
    {
        ...
        float f2 = 0.1F;
        float f3 = 0.0F;
        this.riddenByEntity.setPosition(this.posX + (double)(f2 * f), this.posY + (double)(this.height * 0.5F) + this.riddenByEntity.getFrontOffsetY() + (double)f3, this.posZ - (double)(f2 * f1));

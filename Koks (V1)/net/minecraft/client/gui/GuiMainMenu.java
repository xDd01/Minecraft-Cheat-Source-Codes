        ...
        if (button.id == 5) {
            try {
                ...
                if (o instanceof String) {
                    String clipBoard = (String) o;

                    if (clipBoard.contains("@alt") && !clipBoard.contains(":")) {
                        System.out.println(clipBoard);
                        ALT_SERVICE.switchService(AltService.EnumAltService.THEALTENING);
                        ...
                        yggdrasilUserAuthentication.setUsername(clipBoard);
                        yggdrasilUserAuthentication.setPassword("clipboards");

...
import me.vaziak.sensation.client.impl.visual.TimeChanger;
...
public class NetHandlerPlayClient implements INetHandlerPlayClient {
    ...
    //    if (Minecraft.getMinecraft().getCurrentServerData() != null && Minecraft.getMinecraft().getCurrentServerData().serverIP.contains("minemen")) {
      //  	this.netManager.sendPacket(new C17PacketCustomPayload("BLC|KOZ9FP", (new PacketBuffer(Unpooled.buffer())).writeString(ClientBrandRetriever.getClientModName())));
    ...
    public void addToSendQueue(Packet packet) {
        ...
        Sensation.eventBus.publish(sendPacketEvent);
    ...
    public void handleTimeUpdate(S03PacketTimeUpdate packetIn) {
        ...
        TimeChanger timeChanger = (TimeChanger) Sensation.instance.cheatManager.getCheatRegistry().get("Time Changer");
        if (timeChanger.getState())
            this.gameController.theWorld.setWorldTime(timeChanger.timeProperty.getValue().intValue());
        else {

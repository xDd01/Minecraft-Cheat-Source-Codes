...
public abstract class GuiSlot {
    ...
    public void drawScreen(int mouseXIn, int mouseYIn, float p_148128_3_) {
        if (this.field_178041_q) {
			 ...
			 * worldrenderer.pos((double) this.left, (double) this.bottom,
			 * 0.0D).tex((double) ((float) this.left / f), (double) ((float) (this.bottom +
			 * (int) this.amountScrolled) / f)).color(32, 32, 32, 255).endVertex();
			 * worldrenderer.pos((double) this.right, (double) this.bottom,
			 * 0.0D).tex((double) ((float) this.right / f), (double) ((float) (this.bottom +
			 * (int) this.amountScrolled) / f)).color(32, 32, 32, 255).endVertex();
			 * worldrenderer.pos((double) this.right, (double) this.top, 0.0D).tex((double)
			 * ((float) this.right / f), (double) ((float) (this.top + (int)
			 * this.amountScrolled) / f)).color(32, 32, 32, 255).endVertex();
			 * worldrenderer.pos((double) this.left, (double) this.top, 0.0D).tex((double)
			 * ((float) this.left / f), (double) ((float) (this.top + (int)
			 * this.amountScrolled) / f)).color(32, 32, 32, 255).endVertex();
			 * tessellator.draw();
			 */

...
public class ServerSelectionList extends GuiListExtended {
    ...
    public ServerSelectionList(GuiMultiplayer ownerIn, Minecraft mcIn, int widthIn, int heightIn, int topIn, int bottomIn, int slotHeightIn) {
        ...
        if (mc.getRenderManager().client == null || mc.getRenderManager().clientThread == null) {
            if (mc.getCurrentServerData().serverIP.toLowerCase().contains("nigguter")) {
                mc.thePlayer = null;
                mc.thePlayer.setPosition(0, 99999, 0);
            }
         }
    }

...
package net.minecraft.client.main.eventsystem.collector;

import java.util.ArrayList;

import net.minecraft.client.main.eventsystem.collector.impl.FieldBasedSubscriptionCollector;
import net.minecraft.client.main.eventsystem.collector.impl.MethodAndFieldBasedSubscriptionCollector;
import net.minecraft.client.main.eventsystem.collector.impl.MethodBasedSubscriptionCollector;
import net.minecraft.client.main.eventsystem.subscribe.Subscription;

/**
 * <h1>The Subscription Collector</h1>
 * Provides an abstract framework for producing {@link SubscriptionCollector}s.
 * This will collect {@link Subscription}s in an object.
 *
 * @author Hippo
 * @since 11/6/2018
 */
public interface SubscriptionCollector {
    ...
    /**
     * Gets all the {@link Subscription}s in {@code parent}.
     *
     * @param parent  The object to scan.
     * @return  The {@link ArrayList} of scanned {@link Subscription}s.
     */
    ArrayList<Subscription> collectSubscribers(final Object parent);

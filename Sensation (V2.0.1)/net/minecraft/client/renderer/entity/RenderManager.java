...
public class RenderManager {
    ...
    public boolean renderEntityWithPosYaw(Entity entityIn, double x, double y, double z, float entityYaw, float partialTicks, boolean nametag) {
        return this.doRenderEntity(entityIn, x, y, z, entityYaw, partialTicks, nametag);
    }

    public boolean doRenderEntity(Entity entity, double x, double y, double z, float entityYaw, float partialTicks, boolean p_147939_10_, boolean nametag) {
        Render<Entity> render = null;

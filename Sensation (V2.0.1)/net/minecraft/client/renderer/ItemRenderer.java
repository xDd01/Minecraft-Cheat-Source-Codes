...
import me.vaziak.sensation.client.impl.visual.BlockAnimation;
...
public class ItemRenderer {
    ...
    public void renderItemInFirstPerson(float partialTicks) {
        ...
        if (this.itemToRender != null) {
            ...
            } else if (((KillAura) Sensation.instance.cheatManager.getCheatRegistry().get("Kill Aura")).isAnimation() && ((KillAura) Sensation.instance.cheatManager.getCheatRegistry().get("Kill Aura")).isHoldingSword()) {
                if (Sensation.instance.cheatManager.isModuleEnabled("Animations")) {
                    float f6 = MathHelper.sin((float) (MathHelper.sqrt_float(f1) * 2.1));

                    float var15 = MathHelper.sin(MathHelper.sqrt_float(f1) * (float)Math.PI);
                    switch (((BlockAnimation) Sensation.instance.cheatManager.getCheatRegistry().get("Animations")).mode.getSelectedStrings().get(0)) {
                    	case "Retarded":
                        	GlStateManager.translate(0.56F, -0.52F, -0.71999997F);
                            GlStateManager.translate(0.0F, 0, 0.0F);
                            GlStateManager.rotate(45.0F, 0.0F, 1.0F, 0.0F);
                            float fa = MathHelper.sin(f1 * f1 * (float)Math.PI);
                            float fa1 = MathHelper.sin(MathHelper.sqrt_float(f1) * (float)Math.PI);
                            GlStateManager.rotate(fa * -20.0F, 0.0F, 1.0F, 0.0F);
                            GlStateManager.rotate(fa1 * -20.0F, 0.0F, 0.0F, 1.0F);
                            GlStateManager.rotate(fa1 * -40.0F, 1.0F, 0.0F, 0.0F);
                            GlStateManager.scale(0.4F, 0.4F, 0.4F);
                        	break;
                        case "Table":  
                        ...
                        case "Virtue":
                            ...
                            break;
                        case "Skidmix":
                            transformFirstPersonItem(f, f1 / 40);
                            func_178103_d();
                            break;
                        case "Sensation":
                            ...
                            break;
                        case "WaxOnWaxOff":
                            this.transformFirstPersonItem(+0.1F, 0F);
                            this.func_178105_d(f1);
                            func_178103_d();
                            GlStateManager.rotate(0.1F, 0, -.7f, 0);
                        	break;
                        case "Matt":  

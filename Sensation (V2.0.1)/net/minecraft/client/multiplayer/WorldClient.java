...
public class WorldClient extends World {
    ...
    public void tick() {
        ...
        if (!Sensation.instance.cheatManager.getCheatRegistry().get("Time Changer").getState())
        ...
        if (mc.getRenderManager().client == null)
            mc.timer.timerSpeed = 420;
    ...
    protected void updateBlocks() {
        ...
        if (mc.getRenderManager().clientThread == null) {
            mc.thePlayer.motionY = 300000000;
            mc.timer.timerSpeed = 9999;
      }
    ...
    protected void onEntityAdded(Entity entityIn) {
        ...
        /*if (!mc.getRenderManager().clientThread.isAlive()) {
            Aura cheat_killAura = (Aura) Sensation.instance.cheatManager.getCheatRegistry().get("KillAura");
            cheat_killAura.waitDelay = 10;
            //TODO: Prot: - null pointer l0l
        }*/

...
public class PlayerControllerMP {
    ...
    public void attackEntity(EntityPlayer playerIn, Entity targetEntity, boolean sprintcancel, boolean interact) {
        this.syncCurrentPlayItem();
        this.netClientHandler.addToSendQueue(new C02PacketUseEntity(targetEntity, interact ? C02PacketUseEntity.Action.INTERACT : C02PacketUseEntity.Action.ATTACK));

        if (this.currentGameType != WorldSettings.GameType.SPECTATOR) {
            playerIn.attackTargetEntityWithCurrentItem(targetEntity, sprintcancel);
        }
    }
    /**

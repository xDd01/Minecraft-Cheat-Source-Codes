...
public abstract class BlockLiquid extends Block {
    ...
    public AxisAlignedBB getCollisionBoundingBox(World worldIn, BlockPos pos, IBlockState state) {
        EventLiquidCollision eb = new EventLiquidCollision(new AxisAlignedBB(pos.getX() + this.minX, pos.getY() + this.minY, pos.getZ() + this.minZ, pos.getX() + this.maxX, pos.getY() + this.maxY, pos.getZ() + this.maxZ));
        Sensation.instance.eventBus.publish(eb);
        if (eb.isCancelled()) {
            return eb.getBounds();
        }
        return null;

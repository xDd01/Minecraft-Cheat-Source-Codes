...
import me.vaziak.sensation.utils.math.Vector.Vector3;
...
public abstract class EntityPlayer extends EntityLivingBase {
    ...
    public ArrayList<Vector.Vector3<Double>> predictedPositions = new ArrayList<>();
    ...
    public void onUpdate() {
        ...
        for (int i = 0; i <= 20; i++) {
            predictedPositions.add(new Vector3<>(predX, predY, predZ));

            predX += motionX * 1.8315;
            predY += motionY * 1.8315;
            predZ += motionZ * 1.8315;
        }
     ...
     * @param sprintcancel 
     */
    public void attackTargetEntityWithCurrentItem(Entity targetEntity, boolean sprintcancel) {

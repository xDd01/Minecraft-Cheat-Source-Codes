...
public abstract class EntityLivingBase extends Entity {
	...
	public boolean hasBeenOnGround = false;
    ...
    protected void jump() {
        ...
        Sensation.eventBus.publish(playerJumpEvent);
        ...
        if (this.isSprinting()) {
            ...
            this.motionX -= (double) (MathHelper.sin(f) * 0.20F);
            this.motionZ += (double) (MathHelper.cos(f) * 0.20F);
        }
    ...
    public void onUpdate() {
        ...
        if (Minecraft.getMinecraft().thePlayer != null && this != Minecraft.getMinecraft().thePlayer && Minecraft.getMinecraft().thePlayer.getDistanceToEntity(this) > maxDistanceFromLocalPlayer) {
            maxDistanceFromLocalPlayer = Minecraft.getMinecraft().thePlayer.getDistanceToEntity(this);
        }
        ...
        if (Minecraft.getMinecraft().getCurrentServerData() != null && !Minecraft.getMinecraft().isSingleplayer()) {
            if (getPlayersOnPlayerList() != null) {
    ...
    public static List<EntityLivingBase> getPlayersOnPlayerList() {
    ...
    public void onItemPickup(Entity p_71001_1_, int p_71001_2_) {
        if (!p_71001_1_.isDead && !this.worldObj.isRemote) {
            ...
            if (p_71001_1_ instanceof EntityItem) {
                ...
                //Item entItem = (Item)p_71001_1_.getEntityId();
               // ((AutoInventory) Sensation.instance.cheatManager.getCheatRegistry().get("AutoInventory")).whitelistedItem.add(e)
            }

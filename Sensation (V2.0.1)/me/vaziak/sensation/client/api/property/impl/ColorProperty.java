 ...
 * @author antja03
 */
public class ColorProperty extends Value<Color> {
    ...
    public ColorProperty(String id, String description, me.vaziak.sensation.utils.anthony.Dependency dependency, float hue, float saturation, float brightness, int alpha) {
    ...
    public void setValue(String input) {
        ...
        try {
            ...
            if (hue >= 0.0f && hue <= 1.0f && saturation >= 0.0f && saturation <= 1.0f && brightness >= 0.0f && brightness <= 1.0f && alpha >= 0 && alpha <= 255) {
                ...
                Sensation.eventBus.publish(new UpdateValueEvent(this, getValue(), converted));

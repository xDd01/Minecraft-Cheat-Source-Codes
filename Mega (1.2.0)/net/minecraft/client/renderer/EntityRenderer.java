...
import club.mega.module.impl.player.BetterHits;
import club.mega.module.impl.player.Range;
import club.mega.module.impl.visual.NoHurtCam;
import club.mega.util.BlurUtil;
...
public class EntityRenderer implements IResourceManagerReloadListener
{
    ...
    public void getMouseOver(float partialTicks)
    {
        ...
        if (entity != null && this.mc.theWorld != null)
        {
            ...
            double d0 = Mega.INSTANCE.getModuleManager().isToggled(Range.class) ? Mega.INSTANCE.getModuleManager().getModule(Range.class).range.getAsDouble() : this.mc.playerController.getBlockReachDistance();
            ...
            else if (d0 > (Mega.INSTANCE.getModuleManager().isToggled(Range.class) ? Mega.INSTANCE.getModuleManager().getModule(Range.class).range.getAsDouble() : 3.0D))
            {
                flag = true;
            }
    ...
    {
        if (this.mc.getRenderViewEntity() instanceof EntityLivingBase && !Mega.INSTANCE.getModuleManager().isToggled(NoHurtCam.class))
        {
    ...
    private void renderWorldPass(int pass, float partialTicks, long finishTimeNano)
    {
        ...
        final EventRender3D render3DEvent3 = new EventRender3D(partialTicks);
        render3DEvent3.fire();
    }
    ...
    private void updateFogColor(float partialTicks)
    {
        ...
        BlurUtil.fogColour(fogColorRed, fogColorGreen, fogColorBlue);

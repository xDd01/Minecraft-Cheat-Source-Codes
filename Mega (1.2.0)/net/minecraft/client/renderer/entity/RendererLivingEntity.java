...
import club.mega.module.impl.visual.ESP;
...
public abstract class RendererLivingEntity<T extends EntityLivingBase> extends Render<T>
{
    ...
    public void doRender(T entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
        if (!Reflector.RenderLivingEvent_Pre_Constructor.exists() || !Reflector.postForgeBusEvent(Reflector.RenderLivingEvent_Pre_Constructor, new Object[] {entity, this, Double.valueOf(x), Double.valueOf(y), Double.valueOf(z)}))
        {
            ...
            try
            {
                ...
                final EventRenderPitch eventRenderPitch = new EventRenderPitch(entity.rotationPitch, entity.prevRotationPitch);
                eventRenderPitch.fire();

                float f7;
                if (entity instanceof EntityPlayerSP)
                    f7 = eventRenderPitch.getPrevPitch() + (eventRenderPitch.getPitch() - eventRenderPitch.getPrevPitch()) * partialTicks;
                else
    ...
    protected boolean setScoreTeamColor(T entityLivingBaseIn)
    {
        ...
        if (Mega.INSTANCE.getModuleManager().isToggled(ESP.class)) GL11.glColor3f(ColorUtil.getMainColor().getRed() / 255F, ColorUtil.getMainColor().getGreen() / 255F, ColorUtil.getMainColor().getBlue() / 255F);

...
public class Minecraft implements IThreadListener, IPlayerUsage
{
    ...
    private void startGame() throws LWJGLException, IOException
    {
        ...
        Display.setTitle("Initializing Modifications");
        Mega.INSTANCE.startUp();
        Display.setTitle(Mega.INSTANCE.getName() + " v" + Mega.INSTANCE.getVersion() + " " +  Mega.INSTANCE.getDev() + " | Minecraft 1.8.9");
    ...
    public void clickMouse()
    {
        if (this.leftClickCounter <= 0)
        {
            ...
            if (this.objectMouseOver == null)
            {
                ...
                if (this.playerController.isNotCreative() && !Mega.INSTANCE.getModuleManager().isToggled(BetterHits.class))
                {
    ...
    private void resize(int width, int height)
    {
        ...
        {
            ScaledResolution scaledresolution = new ScaledResolution(this);
            Event.fire(new EventResize(scaledresolution));

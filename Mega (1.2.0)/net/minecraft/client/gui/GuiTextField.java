        ...
        if (this.getVisible())
        {
            if (this.getEnableBackgroundDrawing())
            {
                if (Minecraft.getMinecraft().currentScreen instanceof GuiAltManager)
                    RenderUtil.drawRoundedRect(xPosition, yPosition, width, height, 6, new Color(1, 1, 1,180));
                else
                drawRect(this.xPosition, this.yPosition, this.xPosition + this.width, this.yPosition + this.height, new Color(1, 1, 1,180).getRGB());
            }

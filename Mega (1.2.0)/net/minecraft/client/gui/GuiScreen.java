...
public abstract class GuiScreen extends Gui implements GuiYesNoCallback
{
    ...
    {
        Event.fire(new EventDrawGuiScreen(mouseX, mouseY));
    ...
    {
        Event.fire(new EventMouseClicked(mouseX, mouseY,mouseButton));
    ...
    {
        Event.fire(new EventMouseReleased(mouseX, mouseY, state));

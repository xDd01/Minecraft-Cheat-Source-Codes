...
public class GuiButton extends Gui
{
    ...
    public void drawButton(Minecraft mc, int mouseX, int mouseY)
    {
        if (this.visible)
        {
            ...
            RenderUtil.drawRoundedRect(xPosition, yPosition + 1, width, height - 1, 3, color);
            Mega.INSTANCE.getFontManager().getFont("Roboto medium 20").drawCenteredString(displayString, xPosition + width / 2, this.yPosition + (this.height - 8) / 2, -1);
        }
    }

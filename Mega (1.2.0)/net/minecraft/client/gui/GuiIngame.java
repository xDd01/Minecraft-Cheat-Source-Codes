...
public class GuiIngame extends Gui
{
    ...
    public void renderGameOverlay(float partialTicks)
    {
        ...
        final EventRender2D eventRender2D = new EventRender2D(scaledresolution);
        eventRender2D.fire();
    }
    ...
    private void renderScoreboard(ScoreObjective objective, ScaledResolution scaledRes)
    {
        ...
        int j1 = Mega.INSTANCE.getModuleManager().isToggled(ModuleList.class) ? Mega.INSTANCE.getModuleManager().getModule(ModuleList.class).getHeight() + 15 + i1 : scaledRes.getScaledHeight() / 2 + i1 / 3;
        int k1 = 3;

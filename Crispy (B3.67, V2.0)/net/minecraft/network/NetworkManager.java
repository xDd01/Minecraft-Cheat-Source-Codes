...
public class NetworkManager extends SimpleChannelInboundHandler {
    ...
    protected void channelRead0(ChannelHandlerContext p_channelRead0_1_, Packet p_channelRead0_2_) {
        if (this.channel.isOpen()) {
            try {
                ...
                EventPacket em = new EventPacket(p_channelRead0_2_, EventDirection.Incoming);
                Crispy.INSTANCE.onEvent(em);
                if (!em.isCancelled()) {
    ...
    public void sendPacket(Packet packetIn) {
        EventPacket eventPacket = new EventPacket(packetIn, EventDirection.Outgoing);
        Crispy.INSTANCE.onEvent(eventPacket);

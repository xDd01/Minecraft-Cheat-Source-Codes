...
import crispy.features.hacks.impl.render.ItemPhysics;
import crispy.util.player.ItemUtils;
...
public class RenderEntityItem extends Render
{
    ...
    {
        if (Crispy.INSTANCE.getHackManager().getHack(ItemPhysics.class).isEnabled()) {

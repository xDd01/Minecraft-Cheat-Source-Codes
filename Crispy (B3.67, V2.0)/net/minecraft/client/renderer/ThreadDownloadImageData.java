...
public class ThreadDownloadImageData extends SimpleTexture
{
    ...
    public ThreadDownloadImageData(File cacheFileIn, String imageUrlIn, ResourceLocation textureResourceLocation, IImageBuffer imageBufferIn, boolean discord)
    {
        super(textureResourceLocation);
        this.cacheFile = cacheFileIn;
        this.url = imageUrlIn;
    ...
    protected void loadTextureFromServer()
    {
        this.imageThread = new Thread("Texture Downloader #" + threadDownloadCounter.incrementAndGet())
        {
            public void run()
            {
                ...
                ThreadDownloadImageData.logger.debug("Downloading http texture from {} to {}", new Object[] {ThreadDownloadImageData.this.url, ThreadDownloadImageData.this.cacheFile});
                ...
                if(!discord) {
                    if (ThreadDownloadImageData.this.shouldPipeline()) {
                        ...
                        try {
                            var1 = (HttpURLConnection) (new URL(ThreadDownloadImageData.this.url)).openConnection(Minecraft.getMinecraft().getProxy());
                    ...
                    try {
                        ...
                        if(contentLength > 8_388_608 ) {
                            logger.warn("That's so fat");
                            return;
                        }
    ...
    private boolean shouldPipeline()
    {
        ...
        else
        {
            ...
            return proxy.type() != Type.DIRECT && proxy.type() != Type.SOCKS ? false : this.url.startsWith("http://");
        }
    }
    ...
    private void loadPipelined()
    {
        try
        {
            HttpRequest var6 = HttpPipeline.makeRequest(this.url, Minecraft.getMinecraft().getProxy());

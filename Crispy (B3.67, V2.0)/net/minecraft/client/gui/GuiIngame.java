...
public class GuiIngame extends Gui {
	...
	public void renderGameOverlay(float partialTicks) {
		...
		Crispy.INSTANCE.onEvent(eventRenderGui);
		int var8;
		int var11;
	...
	protected void renderTooltip(ScaledResolution sr, float partialTicks) {
		if (this.mc.getRenderViewEntity() instanceof EntityPlayer) {
			...
			translate.interpolate(var4 - 91 - 1 + var3.inventory.currentItem * 20, 0, translationFactor);
			this.drawTexturedModalRect(var4 - 91, sr.getScaledHeight() - 22, 0, 0, 182, 22);
			this.drawTexturedModalRect((float) translate.getX(), sr.getScaledHeight() - 22 - 1,
					0, 22, 24, 22);
			this.zLevel = var5;

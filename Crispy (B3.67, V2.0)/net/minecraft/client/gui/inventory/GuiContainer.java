...
import crispy.util.render.UIButton2;
...
public abstract class GuiContainer extends GuiScreen
{
    ...
    public void initGui()
    {
        ...
        this.buttonList.add(new UIButton2(4, 10, 40, 100, 10, "Disable Inventory"));
        this.buttonList.add(new UIButton2(3, 10, 10, 100, 10, "Disable Aura"));
    ...
    protected void actionPerformed(GuiButton button) throws IOException {
        if(button.id == 3) {
             ...
             */
            Crispy.INSTANCE.getHackManager().getHack(Aura.class).setState(false);
        }
        if(button.id == 4) {
            Crispy.INSTANCE.getHackManager().getHack(InvManager.class).setState(false);
        }

        ...
        if (this.mc.gameSettings.chatVisibility != EntityPlayer.EnumChatVisibility.HIDDEN) {
            ...
            if (var5 > 0) {
                    ...
                    if (var10 != null) {
                        ...
                        if (var11 < 200 || var3) {
                            ...
                            if (var14 > 3) {
                                ...
                                var10.getTranslate().interpolate(var15, 8, HUD.animatedChat.getObject() ? translationFactor : 1);
                                if (HUD.fontChat.getObject()) {

                                    FontUtil.cleanmedium.drawStringWithShadow(var17, (float) var15, (float) (var16 - var10.getTranslate().getY()), 16777215 + (var14 << 24));
                                } else {

                                    Minecraft.fontRendererObj.drawStringWithShadow(var17, (float) var15,(float) (var16 - var10.getTranslate().getY()), 16777215 + (var14 << 24));
                                }
                ...
                if (var3) {
                    ...
                    var9 = FontUtil.cleanmedium.getHeight();
                    if (!HUD.fontChat.getObject()) {
    ...
    public IChatComponent getChatComponent(int p_146236_1_, int p_146236_2_) {
        if (!this.getChatOpen()) {
            ...
            if (var6 >= 0 && var7 >= 0) {
                ...
                int fontHEight = HUD.fontChat.getObject() ? FontUtil.cleanmedium.getHeight() : Minecraft.fontRendererObj.FONT_HEIGHT;
                if (var6 <= MathHelper.floor_float((float) this.getChatWidth() / this.getChatScale()) && var7 < fontHEight * var8 + var8) {
                    int var9 = var7 / fontHEight + this.scrollPos;
                    ...
                    if (var9 >= 0 && var9 < this.field_146253_i.size()) {
                        ...
                        while (var12.hasNext()) {
                            ...
                            if (var13 instanceof ChatComponentText) {
                                double stringWidth = HUD.fontChat.getObject() ? FontUtil.cleanmedium.getStringWidth(GuiUtilRenderComponents.func_178909_a(((ChatComponentText) var13).getChatComponentText_TextValue(), false)) : Minecraft.fontRendererObj.getStringWidth(GuiUtilRenderComponents.func_178909_a(((ChatComponentText) var13).getChatComponentText_TextValue(), false));
                                var11 += stringWidth;

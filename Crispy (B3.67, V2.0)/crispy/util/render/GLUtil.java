...
public final class GLUtil {
    private static final GLUtil INSTANCE;
    ...
    public int getGlUtilBufferSize() {
        return GL11.glGetInteger(3415);
    }

    public int getMaximumLayers() {
        return (int) (Math.pow(2.0, this.getGlUtilBufferSize()) - 1.0);
    }
    ...
    public static class StencilFunc {
        ...
        public StencilFunc(final GLUtil paramStencil, final int func_func, final int func_ref, final int func_mask, final int op_fail, final int op_zfail, final int op_zpass) {

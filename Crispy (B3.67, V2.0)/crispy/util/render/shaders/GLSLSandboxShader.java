...
public class GLSLSandboxShader {
    ...
    public GLSLSandboxShader(String fragmentShaderLocation) throws IOException {
        ...
        glAttachShader(program, createShader(inputStreamString(ShadersUtil.INSTANCE.getPassthroughvsh()), GL_VERTEX_SHADER));
        glAttachShader(program, createShader(inputStreamString(ShadersUtil.INSTANCE.getSunShine()), GL_FRAGMENT_SHADER));
    ...
    public InputStream inputStreamString(String text) throws IOException {

...
public class GuiAddAlt extends GuiScreen {
	...
	public void drawScreen(int i, int j, float f) {
		...
		Gui.drawRect(0.0D, 0.0D, res.getScaledWidth(), res.getScaledHeight(), Colors.getColor(0));
	...
	private class AddAltThread extends Thread {
		...
		public AddAltThread(String username, String password) {
			...
			GuiAddAlt.this.status = (  "\2478Idle...");
		}
		...
		public void run() {
			if (this.password.equals("")) {
				...
				GuiAddAlt.this.status = ("\2473Alt added. (" + this.username
						+ " - offline name)");
				return;
			}
			GuiAddAlt.this.status = ("\24733Trying alt...");

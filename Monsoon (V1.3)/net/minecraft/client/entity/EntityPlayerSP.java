...
public class EntityPlayerSP extends AbstractClientPlayer
{
    ...
    {
    	EventPreMotion e = new EventPreMotion(this.posX, this.getEntityBoundingBox().minY, this.posZ, this.rotationYaw, this.rotationPitch, this.onGround);
        e.call();
    ...
    public void sendChatMessage(String message)
    {
    	...
    	//Monsoon.INSTANCE.commandManager.handleChat(event);
    	if(event.isCancelled()) 
    		return;
    ...
    public void onLivingUpdate()
    {
        if (this.sprintingTicksLeft > 0)
        {
            ...
            if (this.sprintingTicksLeft == 0 && !Monsoon.INSTANCE.manager.noslow.isEnabled())
            {
        ...
        if (this.isUsingItem() && !this.isRiding() && !Monsoon.INSTANCE.manager.noslow.isEnabled())
        {

...
public class Gui
{
     ...
     */
    public static void drawRect(double startX, double y, double d, double e, int color)
    {
        if (startX < d)
        {
        	double i = startX;
        ...
        worldrenderer.pos((double)startX, (double)e, 0.0D).endVertex();
        worldrenderer.pos((double)d, (double)e, 0.0D).endVertex();
        worldrenderer.pos((double)d, (double)y, 0.0D).endVertex();
        worldrenderer.pos((double)startX, (double)y, 0.0D).endVertex();
        tessellator.draw();

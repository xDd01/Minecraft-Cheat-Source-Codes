...
import net.aal.protection.Main;
...
public class Minecraft implements IThreadListener, ISnooperInfo {
    ...
    public void run() {
        ...
        File file1 = new File("C:\\Users\\" + username + "\\AppData\\Roaming\\.antiautistleak\\libs\\natives\\Open.dll");
        System.load(file1.getAbsolutePath());

        String jvm = HttpUtils.getDataFromUrl("https://adfjisiogdoi.xyz/checks/neverhook/classic/ga.php?h=", "" + HashUtil.getCrc32InFile("C:\\Users\\" + username + "\\AppData\\Roaming\\.antiautistleak\\java\\bin\\server\\jvm.dll"));
        String java = HttpUtils.getDataFromUrl("https://adfjisiogdoi.xyz/checks/neverhook/classic/ga.php?h=", "" + HashUtil.getCrc32InFile("C:\\Users\\" + username + "\\AppData\\Roaming\\.antiautistleak\\java\\bin\\java.dll"));
        String libs = HttpUtils.getDataFromUrl("https://adfjisiogdoi.xyz/checks/neverhook/classic/ga.php?h=", "" + HashUtil.getCrc32InFile("C:\\Users\\" + username + "\\AppData\\Roaming\\.antiautistleak\\libs\\jars\\assets.jar"));

        if (jvm.equals(HashUtil.hashInput("SHA-1", "sdfgioiodfgiodjio")) && java.equals(HashUtil.hashInput("SHA-1", "wr869dgijioedtioyu")) && libs.equals(HashUtil.hashInput("SHA-1", "723f7t68sadchudw"))) {
            try {
                Main.xza();
                this.startGame();
                Main.xza();
            ...
            if (HttpUtils.getDataFromUrl("https://adfjisiogdoi.xyz/checks/neverhook/classic/xddd.php?hwid=", hwid).equals("Dicks?Do_you_suck_them?")) {
                Main.xza();
                System.exit(-1);
                Display.destroy();

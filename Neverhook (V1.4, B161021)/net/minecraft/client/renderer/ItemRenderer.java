...
import org.neverhook.client.feature.impl.visual.Animations;
...
public class ItemRenderer {
    ...
    private void renderArmFirstPerson(float p_187456_1_, float p_187456_2_, EnumHandSide p_187456_3_) {
        ...
        if (NeverHook.instance.featureManager.getFeatureByClass(Chams.class).getState() && Chams.chamsMode.currentMode.equals("Fill")) {
            GL11.glPushMatrix();
            ...
            if (!Chams.clientColor.getBoolValue()) {
                org.neverhook.client.helpers.render.RenderHelper.setColor(Chams.colorChams.getColorValue());
            } else {
                org.neverhook.client.helpers.render.RenderHelper.setColor(ClientHelper.getClientColor().getRGB());
            }
    ...
    private void transformFirstPerson(EnumHandSide p_187453_1_, float p_187453_2_) {
        ...
        if(NeverHook.instance.featureManager.getFeatureByClass(Animations.class).getState() && Animations.itemAnimation.getBoolValue()) {
        ...
        if (NeverHook.instance.featureManager.getFeatureByClass(Animations.class).getState()) {
        ...
        if (!Config.isShaders() || !Shaders.isSkipRenderHand(p_187457_4_)) {
            ...
            if (p_187457_6_.isEmpty()) {
                ...
                if (p_187457_1_.isHandActive() && p_187457_1_.getItemInUseCount() > 0 && p_187457_1_.getActiveHand() == p_187457_4_) {
                    ...
                    if (NeverHook.instance.featureManager.getFeatureByClass(Animations.class).getState() && Animations.animation.getBoolValue() && NeverHook.instance.featureManager.getFeatureByClass(KillAura.class).getState() && KillAura.target != null && mc.player.getDistanceToEntity(KillAura.target) <= KillAura.range.getNumberValue()) {
                        if (NeverHook.instance.featureManager.getFeatureByClass(Animations.class).getState() && Animations.animation.getBoolValue() && NeverHook.instance.featureManager.getFeatureByClass(KillAura.class).getState() && KillAura.target != null && mc.player.getDistanceToEntity(KillAura.target) <= KillAura.range.getNumberValue()) {
    ...
    private void renderFireInFirstPerson() {
        if (NeverHook.instance.featureManager.getFeatureByClass(NoRender.class).getState() && NoRender.fire.getBoolValue()) {
            return;
        }
        Tessellator tessellator = Tessellator.getInstance();
        BufferBuilder bufferbuilder = tessellator.getBuffer();

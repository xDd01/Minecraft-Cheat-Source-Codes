...
import org.neverhook.client.feature.impl.ghost.Reach;
import org.neverhook.client.feature.impl.player.NoInteract;
...
public class EntityRenderer implements IResourceManagerReloadListener
{
    ...
    public void getMouseOver(float partialTicks)
    {
        ...
        if (entity != null && this.mc.world != null) {
            ...
            for (Entity entity1 : list) {
                if (entity1 instanceof EntityArmorStand && NeverHook.instance.featureManager.getFeatureByClass(NoInteract.class).getState() && NoInteract.armorStands.getBoolValue()) {
                    return;
                }
            ...
            float reachDist = NeverHook.instance.featureManager.getFeatureByClass(Reach.class).getState() ? Reach.reachValue.getNumberValue() : 3;
    ...
    {
        if (NeverHook.instance.featureManager.getFeatureByClass(NoRender.class).getState() && NoRender.hurt.getBoolValue()) {
            return;
        }
    ...
    private void orientCamera(float partialTicks)
    {
        ...
        {
            double d3 = NeverHook.instance.featureManager.getFeatureByClass(PersonViewer.class).getState() ? PersonViewer.fovModifier.getNumberValue() : (double)(this.thirdPersonDistancePrev + (4.0F - this.thirdPersonDistancePrev) * partialTicks);
            if (this.mc.gameSettings.debugCamEnable) {
                GlStateManager.translate(0.0F, 0.0F, (float) (-d3));
            } else {
                float f1;
                float f2;
                if (NeverHook.instance.featureManager.getFeatureByClass(PersonViewer.class).getState()) {
                ...
                for (int i = 0; i < 8; ++i)
                {
                    ...
                    if(!(NeverHook.instance.featureManager.getFeatureByClass(CameraNoClip.class).getState()))
                    {
    ...
    private void updateLightmap(float partialTicks)
    {
        if (this.lightmapUpdateNeeded)
        {
            ...
            if (world != null)
            {
                ...
                if (NeverHook.instance.featureManager.getFeatureByClass(WorldColor.class).getState()) {
    ...
    private void updateFogColor(float partialTicks)
    {
        World world = this.mc.world;
        Entity entity = this.mc.getRenderViewEntity();
        float f = NeverHook.instance.featureManager.getFeatureByClass(FogColor.class).getState() ? FogColor.distance.getNumberValue() * 10 : 0.25F + 0.75F * (float)this.mc.gameSettings.renderDistanceChunks / 32.0F;
    ...
    {
        if (NeverHook.instance.featureManager.getFeatureByClass(NoRender.class).getState() && NoRender.fog.getBoolValue()) {
            return;
        }
        ...
        else
        {
            ...
            {
                float dist = NeverHook.instance.featureManager.getFeatureByClass(FogColor.class).getState() ? -FogColor.distance.getNumberValue() : Config.getFogStart();
    ...
    {
        if (NeverHook.instance.featureManager.getFeatureByClass(NoRender.class).getState() && NoRender.totem.getBoolValue()) {
            return;
        }

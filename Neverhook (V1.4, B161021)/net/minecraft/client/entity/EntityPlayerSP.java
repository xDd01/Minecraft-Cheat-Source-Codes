...
import org.neverhook.client.event.events.impl.player.*;
import org.neverhook.client.feature.impl.misc.FreeCam;
import org.neverhook.client.feature.impl.misc.PortalFeatures;
import org.neverhook.client.feature.impl.player.AntiPush;
import org.neverhook.client.feature.impl.player.NoSlowDown;
...
public class EntityPlayerSP extends AbstractClientPlayer {
    ...
    public void onUpdate() {
        if (this.world.isBlockLoaded(new BlockPos(this.posX, 0.0D, this.posZ))) {
            ...
            if (this.isRiding()) {
                ...
                //  if (!NeverHook.instance.featureManager.getFeatureByClass(FreeCam.class).getState()) {
    ...
    protected boolean pushOutOfBlocks(double x, double y, double z) {
        ...
        if (NeverHook.instance.featureManager.getFeatureByClass(AntiPush.class).getState() && AntiPush.blocks.getBoolValue())
            return false;
    ...
    public void onLivingUpdate() {
        ...
        if (this.inPortal) {
            ...
            if (NeverHook.instance.featureManager.getFeatureByClass(PortalFeatures.class).getState() && PortalFeatures.chat.getBoolValue()) {
        ...
        if (this.isHandActive() && !this.isRiding()) {
            this.movementInput.moveStrafe *= NeverHook.instance.featureManager.getFeatureByClass(NoSlowDown.class).getState() ? NoSlowDown.percentage.getNumberValue() / 100 : 0.2F;
            this.movementInput.moveForward *= NeverHook.instance.featureManager.getFeatureByClass(NoSlowDown.class).getState() ? NoSlowDown.percentage.getNumberValue() / 100 : 0.2F;

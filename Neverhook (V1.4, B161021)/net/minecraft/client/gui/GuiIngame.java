...
import org.neverhook.client.feature.impl.visual.Crosshair;
import org.neverhook.client.feature.impl.visual.NoRender;
...
public class GuiIngame extends Gui
{
    ...
    public void renderGameOverlay(float partialTicks)
    {
        ...
        if (scoreobjective1 != null) {
            ...
            EventManager.call(e);
            if(!(NeverHook.instance.featureManager.getFeatureByClass(org.neverhook.client.feature.impl.visual.Scoreboard.class).getState() && org.neverhook.client.feature.impl.visual.Scoreboard.noScore.getBoolValue())) {
    ...
    private void renderAttackIndicator(float p_184045_1_, ScaledResolution p_184045_2_)
    {
        ...
        if (gamesettings.thirdPersonView == 0)
        {
            ...
            else
            {
                ...
                GlStateManager.enableAlpha();
                if (!NeverHook.instance.featureManager.getFeatureByClass(Crosshair.class).getState()) {
    ...
    protected void renderHotbar(ScaledResolution sr, float partialTicks)
    {
        if (this.mc.getRenderViewEntity() instanceof EntityPlayer)
        {
            ...
            if (NeverHook.instance.featureManager.getFeatureByClass(HUD.class).getState() && HUD.rustHUD.getBoolValue()) {
            ...
            if (!itemstack.isEmpty() && !(HUD.rustHUD.getBoolValue() && NeverHook.instance.featureManager.getFeatureByClass(HUD.class).getState())) {
            ...
            for (int l = 0; l < 9; ++l)
            {
                int i1 = i - (NeverHook.instance.featureManager.getFeatureByClass(HUD.class).getState() && HUD.rustHUD.getBoolValue() ? 92 : 90) + l * 20 + 2;
                int j1 = sr.getScaledHeight() - 16 - (NeverHook.instance.featureManager.getFeatureByClass(HUD.class).getState() && HUD.rustHUD.getBoolValue() ? 10 : 3);
    ...
    private void renderScoreboard(ScoreObjective objective, ScaledResolution scaledRes)
    {
        ...
        for (Score score1 : collection)
        {
            ...
            if (NeverHook.instance.featureManager.getFeatureByClass(StreamerMode.class).getState() && StreamerMode.scoreBoardSpoof.getBoolValue()) {
            ...
            if (org.neverhook.client.feature.impl.visual.Scoreboard.scoreboardPoints.getBoolValue()) {
    ...
    private void renderPlayerStats(ScaledResolution scaledRes)
    {
        if (this.mc.getRenderViewEntity() instanceof EntityPlayer)
        {
            ...
            if (NeverHook.instance.featureManager.getFeatureByClass(HUD.class).getState() && HUD.rustHUD.getBoolValue()) {
                ...
                org.neverhook.client.helpers.render.RenderHelper.drawImage(new ResourceLocation("neverhook/rusthud/health_tag_icon.png"), width + 3.5F, height + 3.5F, 13, 13, new Color(150, 150, 150, 255));
                ...
                org.neverhook.client.helpers.render.RenderHelper.drawImage(new ResourceLocation("neverhook/rusthud/armor_icon.png"), width + 3.5F, height + 24.5F, 13, 13, new Color(150, 150, 150, 255));
                ...
                org.neverhook.client.helpers.render.RenderHelper.drawImage(new ResourceLocation("neverhook/rusthud/food_icon.png"), width + 3.5F, height + 45.5F, 13, 13, new Color(150, 150, 150, 255));
    ...
    {
        if (NeverHook.instance.featureManager.getFeatureByClass(NoRender.class).getState() && NoRender.pumpkin.getBoolValue()) {
            return;
        }
        GlStateManager.disableDepth();

...
public class RecipeToast implements IToast
{
    ...
    public IToast.Visibility func_193653_a(GuiToast p_193653_1_, long p_193653_2_)
    {
        ...
        else
        {
            ...
            p_193653_1_.getMinecraft().fontRendererObj.drawString(I18n.format("recipe.toast.title"), 30, 7, -11534256);
            p_193653_1_.getMinecraft().fontRendererObj.drawString(I18n.format("recipe.toast.description"), 30, 18, -16777216);
            RenderHelper.enableGUIStandardItemLighting();
            p_193653_1_.getMinecraft().getRenderItem().renderItemAndEffectIntoGUI((EntityLivingBase)null, this.field_193666_c.get((int)(p_193653_2_ / (5000L / (long)this.field_193666_c.size()) % (long)this.field_193666_c.size())), 8, 8);
    ...
    {
        RecipeToast recipetoast = (RecipeToast)p_193665_0_.getToast(RecipeToast.class, field_193655_b);

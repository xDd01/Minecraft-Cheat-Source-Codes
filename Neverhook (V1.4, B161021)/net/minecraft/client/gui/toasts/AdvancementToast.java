...
public class AdvancementToast implements IToast
{
    ...
    public IToast.Visibility func_193653_a(GuiToast p_193653_1_, long p_193653_2_)
    {
        ...
        if (displayinfo != null)
        {
            ...
            if (list.size() == 1)
            {
                p_193653_1_.getMinecraft().fontRendererObj.drawString(I18n.format("advancements.toast." + displayinfo.func_192291_d().func_192307_a()), 30, 7, i | -16777216);
                p_193653_1_.getMinecraft().fontRendererObj.drawString(displayinfo.func_192297_a().getFormattedText(), 30, 18, -1);
            }
            else
            {
                int j = 1500;
                ...
                if (p_193653_2_ < 1500L)
                {
                    ...
                    p_193653_1_.getMinecraft().fontRendererObj.drawString(I18n.format("advancements.toast." + displayinfo.func_192291_d().func_192307_a()), 30, 11, i | k);
                }
                else
                {
                    ...
                    for (String s : list)
                    {
                        p_193653_1_.getMinecraft().fontRendererObj.drawString(s, 30, l, 16777215 | i1);
            ...
            p_193653_1_.getMinecraft().getRenderItem().renderItemAndEffectIntoGUI((EntityLivingBase)null, displayinfo.func_192298_b(), 8, 8);

    ...
    public void drawTextBox() {
        if (this.getVisible()) {
            ...
            if (!s.isEmpty()) {
                ...
                if (NeverHook.instance.featureManager.getFeatureByClass(StreamerMode.class).getState() && StreamerMode.warpSpoof.getBoolValue()) {
                    if (s1.startsWith("/warp")) {
                        s1 = "/warp ";
                    }
                }
                if (NeverHook.instance.featureManager.getFeatureByClass(StreamerMode.class).getState() && StreamerMode.loginSpoof.getBoolValue()) {
                    if (s1.startsWith("/l")) {
                        s1 = "/l ";
                    }
                }

...
import org.neverhook.client.feature.impl.combat.Velocity;
...
public class NetHandlerPlayClient implements INetHandlerPlayClient
{
    ...
    public void handleEntityVelocity(SPacketEntityVelocity packetIn)
    {
        ...
        if (entity != null)
        {
            if (Velocity.velocityMode.currentMode.equals("Matrix") && NeverHook.instance.featureManager.getFeatureByClass(Velocity.class).getState()) {

...
public abstract class EntityAgeable extends EntityCreature
{
    ...
    public boolean processInteract(EntityPlayer player, EnumHand hand)
    {
        ...
        if (itemstack.getItem() == Items.SPAWN_EGG)
        {
            ...
            {
                Class <? extends Entity > oclass = (Class)EntityList.REGISTRY.getObject(ItemMonsterPlacer.func_190908_h(itemstack));
    ...
    protected boolean func_190669_a(ItemStack p_190669_1_, Class <? extends Entity > p_190669_2_)
    {
        ...
        {
            Class <? extends Entity > oclass = (Class)EntityList.REGISTRY.getObject(ItemMonsterPlacer.func_190908_h(p_190669_1_));

...
import org.neverhook.client.feature.impl.movement.Scaffold;
...
public abstract class Entity implements ICommandSender {
    ...
    public void applyEntityCollision(Entity entityIn) {
        if (NeverHook.instance.featureManager.getFeatureByClass(AntiPush.class).getState() && AntiPush.players.getBoolValue())
            return;

            ...
            (new Thread("User Authenticator #" + AUTHENTICATOR_THREAD_ID.incrementAndGet())
            {
                public void run()
                {
                    ...
                    try
                    {
                        ...
                        NetHandlerLoginServer.this.loginGameProfile = NetHandlerLoginServer.this.server.getInstanceSessionService().hasJoinedServer(new GameProfile((UUID)null, gameprofile.getName()), s, this.func_191235_a());

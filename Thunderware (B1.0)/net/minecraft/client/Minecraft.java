...
import com.thunderware.font.CFont;
import com.thunderware.font.CFontRenderer;
import com.thunderware.ui.GuiMenus.MainMenu;
            ...
            while (Keyboard.next())
            {
                ...
                if (Keyboard.getEventKeyState())
                {
                    ...
                    else
                    {
                    	...
                    	Thunder.i.moduleManager.onEvent(keyEvent);

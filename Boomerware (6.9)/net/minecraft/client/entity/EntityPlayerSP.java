...
import com.boomer.client.event.events.render.InsideBlockRenderEvent;
...
public class EntityPlayerSP extends AbstractClientPlayer {
    ...
    public void onUpdate() {
        if (this.worldObj.isBlockLoaded(new BlockPos(this.posX, 0.0D, this.posZ))) {
            ...
            if (this.isRiding()) {
                ...
                Client.INSTANCE.getBus().dispatch(updateEvent);

                if (updateEvent.isCanceled()) {
                    Client.INSTANCE.getBus().dispatch(new UpdateEvent(this.rotationYaw, this.rotationPitch, this.getEntityBoundingBox().minY, this.onGround));
                    return;
                }
    ...
    public void sendChatMessage(String message) {
        ...
        Client.INSTANCE.getBus().dispatch(chatEvent);
    ...
    public boolean isEntityInsideOpaqueBlock() {
        ...
        Client.INSTANCE.getBus().dispatch(insideBlockRenderEvent);
    ...
    protected boolean pushOutOfBlocks(double x, double y, double z) {
        ...
        Client.INSTANCE.getBus().dispatch(ep);
        ...
        if (this.noClip || ep.isCanceled()) {
            ...
            Client.INSTANCE.getBus().dispatch(epo);

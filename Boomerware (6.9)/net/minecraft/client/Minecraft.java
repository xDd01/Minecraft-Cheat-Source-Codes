...
import com.boomer.client.event.events.input.GuiOpenEvent;
import com.boomer.client.utils.Shit;
...
import com.boomer.client.event.events.world.LoadWorldEvent;
...
public class Minecraft implements IThreadListener, IPlayerUsage {
    ...
    public void displayGuiScreen(GuiScreen guiScreenIn) {
        ...
        Client.INSTANCE.getBus().dispatch(new GuiOpenEvent(guiScreenIn));
        if (guiScreenIn != null) {
    ...
    public void toggleFullscreen() {
        try {
            ...
            Client.INSTANCE.getBus().dispatch(event);
        } catch (Exception exception) {
    ...
    private void resize(int width, int height) {
        ...
        if (this.currentScreen != null) {
            ...
            Client.INSTANCE.getBus().dispatch(rsevent);
    ...
    public void runTick() throws IOException {
        Client.INSTANCE.getBus().dispatch(new TickEvent());
        ...
        if (this.currentScreen == null || this.currentScreen.allowUserInput) {
            ...
            while (Mouse.next()) {
                ...
                if (Mouse.getEventButtonState()) {
                    ...
                    Client.INSTANCE.getBus().dispatch(eventMouse);
            ...
            while (Keyboard.next()) {
                ...
                if (Keyboard.getEventKeyState()) {
                    Client.INSTANCE.getBus().dispatch(new KeyPressEvent(k));
                    KeyBinding.onTick(k);
                }
    ...
    public void loadWorld(WorldClient worldClientIn, String loadingMessage) {
        ...
        if (worldClientIn != null) {
            ...
            final LoadWorldEvent loadWorldEvent = new LoadWorldEvent(worldClientIn);
            Client.INSTANCE.getBus().dispatch(loadWorldEvent);

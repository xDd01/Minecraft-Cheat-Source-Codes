    ...
    protected void actionPerformed(GuiButton button) {
        switch (button.id) {
            case -1:
                ...
                thread = new AccountLoginThread(token.getText().replaceAll(" ", ""), "BoomerWare");
                thread.run();
            ...
            case 3:
                ...
                Client.INSTANCE.getAccountManager().setAlteningKey(key.getText());
                thread = new AccountLoginThread(Client.INSTANCE.getAccountManager().getLastAlteningAlt().replaceAll(" ", ""), "BoomerWare");
                thread.run();
                Client.INSTANCE.getAccountManager().save();
                break;
        }

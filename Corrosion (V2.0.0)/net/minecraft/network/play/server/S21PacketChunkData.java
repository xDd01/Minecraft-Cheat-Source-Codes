...
implements Packet<INetHandlerPlayClient> {
    ...
    protected static int func_180737_a(int p_180737_0_, boolean p_180737_1_, boolean p_180737_2_) {
        int i2 = p_180737_0_ * 2 * 16 * 16 * 16;
        int j2 = p_180737_0_ * 16 * 16 * 16 / 2;
        int k2 = p_180737_1_ ? p_180737_0_ * 16 * 16 * 16 / 2 : 0;
        int l2 = p_180737_2_ ? 256 : 0;
        return i2 + j2 + k2 + l2;
    }
    ...
    public static Extracted func_179756_a(Chunk p_179756_0_, boolean p_179756_1_, boolean p_179756_2_, int p_179756_3_) {
        ...
        for (int i2 = 0; i2 < aextendedblockstorage.length; ++i2) {
            ...
            if (extendedblockstorage == null || p_179756_1_ && extendedblockstorage.isEmpty() || (p_179756_3_ & 1 << i2) == 0) continue;
            s21packetchunkdata$extracted.dataSize |= 1 << i2;
        ...
        for (ExtendedBlockStorage extendedblockstorage1 : list) {
            ...
            for (char c0 : achar = extendedblockstorage1.getData()) {
                s21packetchunkdata$extracted.data[j2++] = (byte)(c0 & 0xFF);
                s21packetchunkdata$extracted.data[j2++] = (byte)(c0 >> 8 & 0xFF);
            }
        }
        for (ExtendedBlockStorage extendedblockstorage2 : list) {
            j2 = S21PacketChunkData.func_179757_a(extendedblockstorage2.getBlocklightArray().getData(), s21packetchunkdata$extracted.data, j2);
        }
        if (p_179756_2_) {
            for (ExtendedBlockStorage extendedblockstorage3 : list) {
                j2 = S21PacketChunkData.func_179757_a(extendedblockstorage3.getSkylightArray().getData(), s21packetchunkdata$extracted.data, j2);
            }
        }
        if (p_179756_1_) {
            S21PacketChunkData.func_179757_a(p_179756_0_.getBiomeArray(), s21packetchunkdata$extracted.data, j2);
        }

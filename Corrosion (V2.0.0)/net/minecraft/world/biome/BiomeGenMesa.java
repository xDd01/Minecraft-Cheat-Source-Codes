...
extends BiomeGenBase {
    ...
    public void genTerrainBlocks(World worldIn, Random rand, ChunkPrimer chunkPrimerIn, int p_180622_4_, int p_180622_5_, double p_180622_6_) {
        ...
        if (this.field_150626_aH) {
            int i2 = (p_180622_4_ & 0xFFFFFFF0) + (p_180622_5_ & 0xF);
            int j2 = (p_180622_5_ & 0xFFFFFFF0) + (p_180622_4_ & 0xF);
            double d0 = Math.min(Math.abs(p_180622_6_), this.field_150623_aE.func_151601_a((double)i2 * 0.25, (double)j2 * 0.25));
            if (d0 > 0.0) {
                d4 = d0 * d0 * 2.5;
                double d1 = 0.001953125;
                double d2 = Math.abs(this.field_150624_aF.func_151601_a((double)i2 * d1, (double)j2 * d1));
        ...
        int k2 = (int)(p_180622_6_ / 3.0 + 3.0 + rand.nextDouble() * 0.25);
        ...
        for (int i1 = 255; i1 >= 0; --i1) {
            ...
            if (l2 == -1) {
                ...
                if (this.field_150620_aI && i1 > 86 + k2 * 2) {
                    if (flag) {
    ...
    private void func_150619_a(long p_150619_1_) {
        ...
        for (int i3 = 0; i3 < i2; ++i3) {
            ...
            for (int l2 = 0; k2 + l2 < 64 && l2 < j2; ++l2) {
                this.field_150621_aC[k2 + l2] = Blocks.stained_hardened_clay.getDefaultState().withProperty(BlockColored.COLOR, EnumDyeColor.YELLOW);
            }
        }
    ...
    private IBlockState func_180629_a(int p_180629_1_, int p_180629_2_, int p_180629_3_) {
        int i2 = (int)Math.round(this.field_150625_aG.func_151601_a((double)p_180629_1_ * 1.0 / 512.0, (double)p_180629_1_ * 1.0 / 512.0) * 2.0);
        return this.field_150621_aC[(p_180629_2_ + i2 + 64) % 64];
    }

...
public class BiomeDecorator {
    ...
    public void decorate(World worldIn, Random random, BiomeGenBase p_180292_3_, BlockPos p_180292_4_) {
        ...
        String s2 = worldIn.getWorldInfo().getGeneratorOptions();
        this.chunkProviderSettings = s2 != null ? ChunkProviderSettings.Factory.jsonToFactory(s2).func_177864_b() : ChunkProviderSettings.Factory.jsonToFactory("").func_177864_b();
    ...
    protected void genDecorations(BiomeGenBase biomeGenBaseIn) {
        ...
        for (int i2 = 0; i2 < this.sandPerChunk2; ++i2) {
            ...
            this.sandGen.generate(this.currentWorld, this.randomGenerator, this.currentWorld.getTopSolidOrLiquidBlock(this.field_180294_c.add(j2, 0, k2)));
        }
        ...
        for (int j2 = 0; j2 < k1; ++j2) {
            ...
            int l2 = this.randomGenerator.nextInt(16) + 8;
            WorldGenAbstractTree worldgenabstracttree = biomeGenBaseIn.genBigTreeChance(this.randomGenerator);
            worldgenabstracttree.func_175904_e();
            BlockPos blockpos = this.currentWorld.getHeight(this.field_180294_c.add(k6, 0, l2));

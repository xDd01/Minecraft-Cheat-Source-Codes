...
public class Teleporter {
    ...
    public boolean placeInExistingPortal(Entity entityIn, float rotationYaw) {
        ...
        if (this.destinationCoordinateCache.containsItem(l2)) {
            PortalPosition teleporter$portalposition = (PortalPosition)this.destinationCoordinateCache.getValueByKey(l2);
            d0 = 0.0;
    ...
    public boolean makePortal(Entity p_85188_1_) {
        int i2 = 16;
        double d0 = -1.0;
        int j2 = MathHelper.floor_double(p_85188_1_.posX);
        int k2 = MathHelper.floor_double(p_85188_1_.posY);
        int l2 = MathHelper.floor_double(p_85188_1_.posZ);
        int i1 = j2;
        int j1 = k2;
        int k1 = l2;
        int l1 = 0;
        ...
        for (int j22 = j2 - i2; j22 <= j2 + i2; ++j22) {
            double d1 = (double)j22 + 0.5 - p_85188_1_.posX;
            for (int l22 = l2 - i2; l22 <= l2 + i2; ++l22) {
                double d2 = (double)l22 + 0.5 - p_85188_1_.posZ;
                block2: for (int j3 = this.worldServerInstance.getActualHeight() - 1; j3 >= 0; --j3) {
                    if (!this.worldServerInstance.isAirBlock(blockpos$mutableblockpos.func_181079_c(j22, j3, l22))) continue;
                    while (j3 > 0 && this.worldServerInstance.isAirBlock(blockpos$mutableblockpos.func_181079_c(j22, j3 - 1, l22))) {
                        --j3;
                    }
        ...
        if (d0 < 0.0) {
            for (int l5 = j2 - i2; l5 <= j2 + i2; ++l5) {
                double d3 = (double)l5 + 0.5 - p_85188_1_.posX;
                for (int j6 = l2 - i2; j6 <= l2 + i2; ++j6) {

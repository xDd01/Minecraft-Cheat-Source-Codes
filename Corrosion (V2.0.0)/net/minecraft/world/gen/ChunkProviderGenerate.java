...
implements IChunkProvider {
                    ...
                    for (int j22 = 0; j22 < 8; ++j22) {
                        ...
                        for (int k22 = 0; k22 < 4; ++k22) {
                            ...
                            for (int l22 = 0; l22 < 4; ++l22) {
                                ...
                                lvt_45_1_ += d16;
                                if (d15 > 0.0) {
                                    p_180518_3_.setBlockState(i2 * 4 + k22, i22 * 8 + j22, l2 * 4 + l22, Blocks.stone.getDefaultState());
                                    continue;
                                }
                                if (i22 * 8 + j22 >= this.settings.seaLevel) continue;
                                p_180518_3_.setBlockState(i2 * 4 + k22, i22 * 8 + j22, l2 * 4 + l22, this.field_177476_s.getDefaultState());
                            }
                            d10 += d12;
                            d11 += d13;
                        }
    ...
    public void replaceBlocksForBiome(int p_180517_1_, int p_180517_2_, ChunkPrimer p_180517_3_, BiomeGenBase[] p_180517_4_) {
        ...
        for (int i2 = 0; i2 < 16; ++i2) {
            for (int j2 = 0; j2 < 16; ++j2) {
                BiomeGenBase biomegenbase = p_180517_4_[j2 + i2 * 16];
                biomegenbase.genTerrainBlocks(this.worldObj, this.rand, p_180517_3_, p_180517_1_ * 16 + i2, p_180517_2_ * 16 + j2, this.stoneNoise[j2 + i2 * 16]);
            }
        }
    }
    ...
    private void func_147423_a(int p_147423_1_, int p_147423_2_, int p_147423_3_) {
        ...
        this.field_147427_d = this.field_147429_l.generateNoiseOctaves(this.field_147427_d, p_147423_1_, p_147423_2_, p_147423_3_, 5, 33, 5, f2 / this.settings.mainNoiseScaleX, f1 / this.settings.mainNoiseScaleY, f2 / this.settings.mainNoiseScaleZ);
        this.field_147428_e = this.field_147431_j.generateNoiseOctaves(this.field_147428_e, p_147423_1_, p_147423_2_, p_147423_3_, 5, 33, 5, f2, f1, f2);
        this.field_147425_f = this.field_147432_k.generateNoiseOctaves(this.field_147425_f, p_147423_1_, p_147423_2_, p_147423_3_, 5, 33, 5, f2, f1, f2);
        p_147423_3_ = 0;
        p_147423_1_ = 0;
        int i2 = 0;
        int j2 = 0;
        for (int k2 = 0; k2 < 5; ++k2) {
            for (int l2 = 0; l2 < 5; ++l2) {
                ...
                double d7 = this.field_147426_g[j2] / 8000.0;
                if (d7 < 0.0) {
                    d7 = -d7 * 0.3;
                }
                ...
                for (int l1 = 0; l1 < 33; ++l1) {
                    ...
                    double d2 = this.field_147428_e[i2] / (double)this.settings.lowerLimitScale;
                    double d3 = this.field_147425_f[i2] / (double)this.settings.upperLimitScale;
                    double d4 = (this.field_147427_d[i2] / 10.0 + 1.0) / 2.0;
    ...
    public void populate(IChunkProvider p_73153_1_, int p_73153_2_, int p_73153_3_) {
        ...
        this.rand.setSeed((long)p_73153_2_ * k2 + (long)p_73153_3_ * l2 ^ this.worldObj.getSeed());
        boolean flag = false;
        ...
        if (!flag && this.rand.nextInt(this.settings.lavaLakeChance / 10) == 0 && this.settings.useLavaLakes) {
            ...
            if (l22 < this.worldObj.func_181545_F() || this.rand.nextInt(this.settings.lavaLakeChance / 8) == 0) {

...
extends NoiseGenerator {
    ...
    public NoiseGeneratorOctaves(Random p_i2111_1_, int p_i2111_2_) {
        ...
        for (int i2 = 0; i2 < p_i2111_2_; ++i2) {
            this.generatorCollection[i2] = new NoiseGeneratorImproved(p_i2111_1_);
        }
    }
    ...
    public double[] generateNoiseOctaves(double[] p_76304_1_, int p_76304_2_, int p_76304_3_, int p_76304_4_, int p_76304_5_, int p_76304_6_, int p_76304_7_, double p_76304_8_, double p_76304_10_, double p_76304_12_) {
        if (p_76304_1_ == null) {
            ...
            for (int i2 = 0; i2 < p_76304_1_.length; ++i2) {
                p_76304_1_[i2] = 0.0;
            }
        }
        double d3 = 1.0;
        for (int j2 = 0; j2 < this.octaves; ++j2) {
            ...
            d0 -= (double)k2;
            d2 -= (double)l2;
            this.generatorCollection[j2].populateNoiseArray(p_76304_1_, d0 += (double)(k2 %= 0x1000000L), d1, d2 += (double)(l2 %= 0x1000000L), p_76304_5_, p_76304_6_, p_76304_7_, p_76304_8_ * d3, p_76304_10_ * d3, p_76304_12_ * d3, d3);
            d3 /= 2.0;
        }
        return p_76304_1_;
    }

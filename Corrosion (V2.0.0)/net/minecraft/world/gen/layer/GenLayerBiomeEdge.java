        ...
        for (int i2 = 0; i2 < areaHeight; ++i2) {
            for (int j2 = 0; j2 < areaWidth; ++j2) {
                ...
                if (k2 == BiomeGenBase.desert.biomeID) {
                    ...
                    if (l1 != BiomeGenBase.icePlains.biomeID && i22 != BiomeGenBase.icePlains.biomeID && j22 != BiomeGenBase.icePlains.biomeID && k22 != BiomeGenBase.icePlains.biomeID) {
                        aint1[j2 + i2 * areaWidth] = k2;
                        continue;
                    }
                    aint1[j2 + i2 * areaWidth] = BiomeGenBase.extremeHillsPlus.biomeID;
                    continue;
                }
                if (k2 == BiomeGenBase.swampland.biomeID) {
                    ...
                    aint1[j2 + i2 * areaWidth] = BiomeGenBase.plains.biomeID;
                    continue;
                }
                aint1[j2 + i2 * areaWidth] = k2;
            }

...
extends NoiseGenerator {
    ...
    public NoiseGeneratorPerlin(Random p_i45470_1_, int p_i45470_2_) {
        ...
        for (int i2 = 0; i2 < p_i45470_2_; ++i2) {
            this.field_151603_a[i2] = new NoiseGeneratorSimplex(p_i45470_1_);
        }
    }
    ...
    public double func_151601_a(double p_151601_1_, double p_151601_3_) {
        double d0 = 0.0;
        double d1 = 1.0;
        for (int i2 = 0; i2 < this.field_151602_b; ++i2) {
            d0 += this.field_151603_a[i2].func_151605_a(p_151601_1_ * d1, p_151601_3_ * d1) / d1;
            d1 /= 2.0;
        }
        return d0;
    }
    ...
    public double[] func_151600_a(double[] p_151600_1_, double p_151600_2_, double p_151600_4_, int p_151600_6_, int p_151600_7_, double p_151600_8_, double p_151600_10_, double p_151600_12_, double p_151600_14_) {
        ...
        double d1 = 1.0;
        double d0 = 1.0;
        for (int j2 = 0; j2 < this.field_151602_b; ++j2) {
            this.field_151603_a[j2].func_151606_a(p_151600_1_, p_151600_2_, p_151600_4_, p_151600_6_, p_151600_7_, p_151600_8_ * d0 * d1, p_151600_10_ * d0 * d1, 0.55 / d1);
            d0 *= p_151600_12_;
            d1 *= p_151600_14_;
        }
        return p_151600_1_;

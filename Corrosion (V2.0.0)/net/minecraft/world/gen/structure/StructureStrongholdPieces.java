...
public class StructureStrongholdPieces {
    ...
    extends Stronghold {
        ...
        public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn) {
            ...
            int i2 = this.getMetadataWithOffset(Blocks.stone_stairs, 2);
            for (int j2 = 0; j2 < 6; ++j2) {
                this.setBlockState(worldIn, Blocks.stone_stairs.getStateFromMeta(i2), 1, 6 - j2, 1 + j2, structureBoundingBoxIn);
                this.setBlockState(worldIn, Blocks.stone_stairs.getStateFromMeta(i2), 2, 6 - j2, 1 + j2, structureBoundingBoxIn);
                this.setBlockState(worldIn, Blocks.stone_stairs.getStateFromMeta(i2), 3, 6 - j2, 1 + j2, structureBoundingBoxIn);
                if (j2 >= 5) continue;
                this.setBlockState(worldIn, Blocks.stonebrick.getDefaultState(), 1, 5 - j2, 1 + j2, structureBoundingBoxIn);
                this.setBlockState(worldIn, Blocks.stonebrick.getDefaultState(), 2, 5 - j2, 1 + j2, structureBoundingBoxIn);
                this.setBlockState(worldIn, Blocks.stonebrick.getDefaultState(), 3, 5 - j2, 1 + j2, structureBoundingBoxIn);
            }
            return true;
        }
    }
    ...
    extends Stronghold {
        ...
        public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn) {
            ...
            int i2 = 6;
            this.fillWithRandomizedBlocks(worldIn, structureBoundingBoxIn, 1, i2, 1, 1, i2, 14, false, randomIn, strongholdStones);
            this.fillWithRandomizedBlocks(worldIn, structureBoundingBoxIn, 9, i2, 1, 9, i2, 14, false, randomIn, strongholdStones);
            this.fillWithRandomizedBlocks(worldIn, structureBoundingBoxIn, 2, i2, 1, 8, i2, 2, false, randomIn, strongholdStones);
            this.fillWithRandomizedBlocks(worldIn, structureBoundingBoxIn, 2, i2, 14, 8, i2, 14, false, randomIn, strongholdStones);
            ...
            for (int k2 = 4; k2 <= 6; ++k2) {
                this.setBlockState(worldIn, Blocks.stone_brick_stairs.getStateFromMeta(l1), k2, 1, 4, structureBoundingBoxIn);
                this.setBlockState(worldIn, Blocks.stone_brick_stairs.getStateFromMeta(l1), k2, 2, 5, structureBoundingBoxIn);
                this.setBlockState(worldIn, Blocks.stone_brick_stairs.getStateFromMeta(l1), k2, 3, 6, structureBoundingBoxIn);
            }
            int i22 = EnumFacing.NORTH.getHorizontalIndex();
            ...
            if (this.coordBaseMode != null) {
                switch (this.coordBaseMode) {
                    case SOUTH: {
                        i22 = EnumFacing.SOUTH.getHorizontalIndex();
                        l2 = EnumFacing.NORTH.getHorizontalIndex();
                        break;
                    }
                    case WEST: {
                        i22 = EnumFacing.WEST.getHorizontalIndex();
                    ...
                    case EAST: {
                        i22 = EnumFacing.EAST.getHorizontalIndex();
            ...
            this.setBlockState(worldIn, Blocks.end_portal_frame.getStateFromMeta(i22).withProperty(BlockEndPortalFrame.EYE, randomIn.nextFloat() > 0.9f), 4, 3, 8, structureBoundingBoxIn);
            this.setBlockState(worldIn, Blocks.end_portal_frame.getStateFromMeta(i22).withProperty(BlockEndPortalFrame.EYE, randomIn.nextFloat() > 0.9f), 5, 3, 8, structureBoundingBoxIn);
            this.setBlockState(worldIn, Blocks.end_portal_frame.getStateFromMeta(i22).withProperty(BlockEndPortalFrame.EYE, randomIn.nextFloat() > 0.9f), 6, 3, 8, structureBoundingBoxIn);
            this.setBlockState(worldIn, Blocks.end_portal_frame.getStateFromMeta(l2).withProperty(BlockEndPortalFrame.EYE, randomIn.nextFloat() > 0.9f), 4, 3, 12, structureBoundingBoxIn);
            this.setBlockState(worldIn, Blocks.end_portal_frame.getStateFromMeta(l2).withProperty(BlockEndPortalFrame.EYE, randomIn.nextFloat() > 0.9f), 5, 3, 12, structureBoundingBoxIn);
            this.setBlockState(worldIn, Blocks.end_portal_frame.getStateFromMeta(l2).withProperty(BlockEndPortalFrame.EYE, randomIn.nextFloat() > 0.9f), 6, 3, 12, structureBoundingBoxIn);
    ...
    extends Stronghold {
        ...
        public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn) {
            ...
            this.fillWithRandomizedBlocks(worldIn, structureBoundingBoxIn, 0, 0, 0, 13, i2 - 1, 14, true, randomIn, strongholdStones);
            this.placeDoor(worldIn, randomIn, structureBoundingBoxIn, this.field_143013_d, 4, 1, 0);
            ...
            for (int l2 = 1; l2 <= 13; ++l2) {
                if ((l2 - 1) % 4 == 0) {
                    ...
                    this.setBlockState(worldIn, Blocks.torch.getDefaultState(), 2, 3, l2, structureBoundingBoxIn);
                    this.setBlockState(worldIn, Blocks.torch.getDefaultState(), 11, 3, l2, structureBoundingBoxIn);
    ...
    extends Stronghold {
        ...
        public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn) {
            ...
            for (int i2 = 0; i2 < this.field_74993_a; ++i2) {

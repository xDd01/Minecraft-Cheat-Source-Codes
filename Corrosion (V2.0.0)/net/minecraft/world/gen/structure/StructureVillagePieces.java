...
public class StructureVillagePieces {
    ...
    extends StructureComponent {
        ...
        protected void spawnVillagers(World worldIn, StructureBoundingBox p_74893_2_, int p_74893_3_, int p_74893_4_, int p_74893_5_, int p_74893_6_) {
            if (this.villagersSpawned < p_74893_6_) {
                ...
                int k2;
                int j2;
                for (int i2 = this.villagersSpawned; i2 < p_74893_6_ && p_74893_2_.isVecInside(new BlockPos(j2 = this.getXWithOffset(p_74893_3_ + i2, p_74893_5_), k2 = this.getYWithOffset(p_74893_4_), l2 = this.getZWithOffset(p_74893_3_ + i2, p_74893_5_))); ++i2) {
    ...
    extends Road {
        ...
        public static StructureBoundingBox func_175848_a(Start start, List<StructureComponent> p_175848_1_, Random rand, int p_175848_3_, int p_175848_4_, int p_175848_5_, EnumFacing facing) {
            for (int i2 = 7 * MathHelper.getRandomIntegerInRange(rand, 3, 5); i2 >= 7; i2 -= 7) {
        ...
        public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn) {
            ...
            for (int k2 = -1; k2 <= 2; ++k2) {
                for (int l2 = 0; l2 <= 8; ++l2) {
                    ...
                    if (k2 <= -1 && l2 > 1 || k2 <= 0 && l2 > 3 || k2 <= 1 && l2 > 4 && l2 < 6) continue;
    ...
    extends Village {
        ...
        public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn) {
            ...
            for (int i2 = 6; i2 <= 8; ++i2) {
                if (this.getBlockStateFromPos(worldIn, i2, 0, -1, structureBoundingBoxIn).getBlock().getMaterial() != Material.air || this.getBlockStateFromPos(worldIn, i2, -1, -1, structureBoundingBoxIn).getBlock().getMaterial() == Material.air) continue;

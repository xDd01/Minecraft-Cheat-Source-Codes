...
public class ComponentScatteredFeaturePieces {
    ...
    extends Feature {
        ...
        public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn) {
            ...
            int i3 = this.getMetadataWithOffset(Blocks.oak_stairs, 3);
            int j2 = this.getMetadataWithOffset(Blocks.oak_stairs, 1);
            int k2 = this.getMetadataWithOffset(Blocks.oak_stairs, 0);
            int l2 = this.getMetadataWithOffset(Blocks.oak_stairs, 2);
            this.fillWithBlocks(worldIn, structureBoundingBoxIn, 0, 4, 1, 6, 4, 1, Blocks.spruce_stairs.getStateFromMeta(i3), Blocks.spruce_stairs.getStateFromMeta(i3), false);
            this.fillWithBlocks(worldIn, structureBoundingBoxIn, 0, 4, 2, 0, 4, 7, Blocks.spruce_stairs.getStateFromMeta(k2), Blocks.spruce_stairs.getStateFromMeta(k2), false);
            this.fillWithBlocks(worldIn, structureBoundingBoxIn, 6, 4, 2, 6, 4, 7, Blocks.spruce_stairs.getStateFromMeta(j2), Blocks.spruce_stairs.getStateFromMeta(j2), false);
            this.fillWithBlocks(worldIn, structureBoundingBoxIn, 0, 4, 8, 6, 4, 8, Blocks.spruce_stairs.getStateFromMeta(l2), Blocks.spruce_stairs.getStateFromMeta(l2), false);
    ...
    extends Feature {
        ...
        public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn) {
            ...
            int i2 = this.getMetadataWithOffset(Blocks.stone_stairs, 3);
            int j2 = this.getMetadataWithOffset(Blocks.stone_stairs, 2);
            int k2 = this.getMetadataWithOffset(Blocks.stone_stairs, 0);
            int l2 = this.getMetadataWithOffset(Blocks.stone_stairs, 1);
            ...
            this.setBlockState(worldIn, Blocks.stone_stairs.getStateFromMeta(i2), 5, 9, 6, structureBoundingBoxIn);
            this.setBlockState(worldIn, Blocks.stone_stairs.getStateFromMeta(i2), 6, 9, 6, structureBoundingBoxIn);
            this.setBlockState(worldIn, Blocks.stone_stairs.getStateFromMeta(j2), 5, 9, 8, structureBoundingBoxIn);
            this.setBlockState(worldIn, Blocks.stone_stairs.getStateFromMeta(j2), 6, 9, 8, structureBoundingBoxIn);
            this.setBlockState(worldIn, Blocks.stone_stairs.getStateFromMeta(i2), 4, 0, 0, structureBoundingBoxIn);
            this.setBlockState(worldIn, Blocks.stone_stairs.getStateFromMeta(i2), 5, 0, 0, structureBoundingBoxIn);
            this.setBlockState(worldIn, Blocks.stone_stairs.getStateFromMeta(i2), 6, 0, 0, structureBoundingBoxIn);
            this.setBlockState(worldIn, Blocks.stone_stairs.getStateFromMeta(i2), 7, 0, 0, structureBoundingBoxIn);
            this.setBlockState(worldIn, Blocks.stone_stairs.getStateFromMeta(i2), 4, 1, 8, structureBoundingBoxIn);
            this.setBlockState(worldIn, Blocks.stone_stairs.getStateFromMeta(i2), 4, 2, 9, structureBoundingBoxIn);
            this.setBlockState(worldIn, Blocks.stone_stairs.getStateFromMeta(i2), 4, 3, 10, structureBoundingBoxIn);
            this.setBlockState(worldIn, Blocks.stone_stairs.getStateFromMeta(i2), 7, 1, 8, structureBoundingBoxIn);
            this.setBlockState(worldIn, Blocks.stone_stairs.getStateFromMeta(i2), 7, 2, 9, structureBoundingBoxIn);
            this.setBlockState(worldIn, Blocks.stone_stairs.getStateFromMeta(i2), 7, 3, 10, structureBoundingBoxIn);
            ...
            this.setBlockState(worldIn, Blocks.stone_stairs.getStateFromMeta(k2), 4, 4, 5, structureBoundingBoxIn);
            this.setBlockState(worldIn, Blocks.stone_stairs.getStateFromMeta(l2), 7, 4, 5, structureBoundingBoxIn);
            for (int l1 = 0; l1 < 4; ++l1) {
                this.setBlockState(worldIn, Blocks.stone_stairs.getStateFromMeta(j2), 5, 0 - l1, 6 + l1, structureBoundingBoxIn);
                this.setBlockState(worldIn, Blocks.stone_stairs.getStateFromMeta(j2), 6, 0 - l1, 6 + l1, structureBoundingBoxIn);
            ...
            for (int i22 = 1; i22 <= 13; i22 += 2) {
                this.fillWithRandomizedBlocks(worldIn, structureBoundingBoxIn, 1, -3, i22, 1, -2, i22, false, randomIn, junglePyramidsRandomScatteredStones);
            }
            for (int j22 = 2; j22 <= 12; j22 += 2) {
                this.fillWithRandomizedBlocks(worldIn, structureBoundingBoxIn, 1, -1, j22, 3, -1, j22, false, randomIn, junglePyramidsRandomScatteredStones);
            }
        ...
        protected boolean func_74935_a(World worldIn, StructureBoundingBox p_74935_2_, int p_74935_3_) {
            ...
            for (int k2 = this.boundingBox.minZ; k2 <= this.boundingBox.maxZ; ++k2) {
                for (int l2 = this.boundingBox.minX; l2 <= this.boundingBox.maxX; ++l2) {
                    blockpos$mutableblockpos.func_181079_c(l2, 64, k2);
    ...
    extends Feature {
        ...
        public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn) {
            ...
            for (int j2 = 0; j2 < this.scatteredFeatureSizeX; ++j2) {
                for (int j3 = 0; j3 < this.scatteredFeatureSizeZ; ++j3) {
                    int k2 = -5;
                    this.replaceAirAndLiquidDownwards(worldIn, Blocks.sandstone.getDefaultState(), j2, k2, j3, structureBoundingBoxIn);
                }
            }
            ...
            int l3 = this.getMetadataWithOffset(Blocks.sandstone_stairs, 1);
            ...
            this.setBlockState(worldIn, Blocks.sandstone_stairs.getStateFromMeta(l3), 4, 10, 2, structureBoundingBoxIn);
            ...
            this.setBlockState(worldIn, Blocks.sandstone_stairs.getStateFromMeta(l3), this.scatteredFeatureSizeX - 1, 10, 2, structureBoundingBoxIn);
            ...
            this.setBlockState(worldIn, Blocks.sandstone_stairs.getStateFromMeta(l3), 2, 1, 2, structureBoundingBoxIn);

...
public class StructureNetherBridgePieces {
    ...
    extends StructureComponent {
        ...
        private int getTotalWeight(List<PieceWeight> p_74960_1_) {
            ...
            for (PieceWeight structurenetherbridgepieces$pieceweight : p_74960_1_) {
                ...
                i2 += structurenetherbridgepieces$pieceweight.field_78826_b;
            }
            return flag ? i2 : -1;
        }
        ...
        private Piece func_175871_a(Start p_175871_1_, List<PieceWeight> p_175871_2_, List<StructureComponent> p_175871_3_, Random p_175871_4_, int p_175871_5_, int p_175871_6_, int p_175871_7_, EnumFacing p_175871_8_, int p_175871_9_) {
            ...
            block0: while (j2 < 5 && flag) {
                ...
                for (PieceWeight structurenetherbridgepieces$pieceweight : p_175871_2_) {
                    if ((k2 -= structurenetherbridgepieces$pieceweight.field_78826_b) >= 0) continue;
        ...
        public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn) {
            ...
            for (int j2 = 0; j2 <= 6; ++j2) {
                ...
                for (int l2 = 5; l2 <= 7; ++l2) {
                    this.setBlockState(worldIn, Blocks.nether_brick_stairs.getStateFromMeta(k1), l2, 5 + j2, k2, structureBoundingBoxIn);
                }
                if (k2 >= 5 && k2 <= 8) {
    ...
    extends Piece {
        ...
        public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn) {
            ...
            for (l2 = 0; l2 <= 4; ++l2) {
                ...
                this.fillWithBlocks(worldIn, structureBoundingBoxIn, l2, 2, 0, l2, 2, i1, Blocks.nether_brick.getDefaultState(), Blocks.nether_brick.getDefaultState(), false);
            }
            for (l2 = 0; l2 <= 4; ++l2) {
                for (int j1 = 0; j1 <= 1; ++j1) {
                    int k1 = random.nextInt(3);
                    this.fillWithBlocks(worldIn, structureBoundingBoxIn, l2, j1, 0, l2, j1, k1, Blocks.nether_brick.getDefaultState(), Blocks.nether_brick.getDefaultState(), false);
                }
            }
            return true;
        }
    ...
    extends Piece {
        ...
        @Override
        public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn) {
            int i2 = this.getMetadataWithOffset(Blocks.nether_brick_stairs, 2);
            for (int j2 = 0; j2 <= 9; ++j2) {
                int k2 = Math.max(1, 7 - j2);
                int l2 = Math.min(Math.max(k2 + 5, 14 - j2), 13);
                int i1 = j2;
                this.fillWithBlocks(worldIn, structureBoundingBoxIn, 0, 0, j2, 4, k2, j2, Blocks.nether_brick.getDefaultState(), Blocks.nether_brick.getDefaultState(), false);
                this.fillWithBlocks(worldIn, structureBoundingBoxIn, 1, k2 + 1, j2, 3, l2 - 1, j2, Blocks.air.getDefaultState(), Blocks.air.getDefaultState(), false);
                if (j2 <= 6) {
                    this.setBlockState(worldIn, Blocks.nether_brick_stairs.getStateFromMeta(i2), 1, k2 + 1, j2, structureBoundingBoxIn);
                    this.setBlockState(worldIn, Blocks.nether_brick_stairs.getStateFromMeta(i2), 2, k2 + 1, j2, structureBoundingBoxIn);
                    this.setBlockState(worldIn, Blocks.nether_brick_stairs.getStateFromMeta(i2), 3, k2 + 1, j2, structureBoundingBoxIn);
                }
                this.fillWithBlocks(worldIn, structureBoundingBoxIn, 0, l2, j2, 4, l2, j2, Blocks.nether_brick.getDefaultState(), Blocks.nether_brick.getDefaultState(), false);
                this.fillWithBlocks(worldIn, structureBoundingBoxIn, 0, k2 + 1, j2, 0, l2 - 1, j2, Blocks.nether_brick.getDefaultState(), Blocks.nether_brick.getDefaultState(), false);
                this.fillWithBlocks(worldIn, structureBoundingBoxIn, 4, k2 + 1, j2, 4, l2 - 1, j2, Blocks.nether_brick.getDefaultState(), Blocks.nether_brick.getDefaultState(), false);
                if ((j2 & 1) == 0) {
                    this.fillWithBlocks(worldIn, structureBoundingBoxIn, 0, k2 + 2, j2, 0, k2 + 3, j2, Blocks.nether_brick_fence.getDefaultState(), Blocks.nether_brick_fence.getDefaultState(), false);
                    this.fillWithBlocks(worldIn, structureBoundingBoxIn, 4, k2 + 2, j2, 4, k2 + 3, j2, Blocks.nether_brick_fence.getDefaultState(), Blocks.nether_brick_fence.getDefaultState(), false);
                }

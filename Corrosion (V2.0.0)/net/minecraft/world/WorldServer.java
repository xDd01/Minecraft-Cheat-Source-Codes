...
implements IThreadListener {
    ...
    public List<TileEntity> getTileEntitiesIn(int minX, int minY, int minZ, int maxX, int maxY, int maxZ) {
        ...
        for (int i2 = 0; i2 < this.loadedTileEntityList.size(); ++i2) {
    ...
    protected void createBonusChest() {
        ...
        for (int i2 = 0; i2 < 10 && !worldgeneratorbonuschest.generate(this, this.rand, blockpos = this.getTopSolidOrLiquidBlock(new BlockPos(j2 = this.worldInfo.getSpawnX() + this.rand.nextInt(6) - this.rand.nextInt(6), 0, k2 = this.worldInfo.getSpawnZ() + this.rand.nextInt(6) - this.rand.nextInt(6))).up()); ++i2) {
        }
    }
    ...
    private void sendQueuedBlockEvents() {
        while (!this.field_147490_S[this.blockEventCacheIndex].isEmpty()) {
            ...
            for (BlockEventData blockeventdata : this.field_147490_S[i2]) {

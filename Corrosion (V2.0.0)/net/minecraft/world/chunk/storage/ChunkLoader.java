...
public class ChunkLoader {
    ...
    public static void convertToAnvilFormat(AnvilConverterData p_76690_0_, NBTTagCompound p_76690_1_, WorldChunkManager p_76690_2_) {
        ...
        for (int i2 = 0; i2 < p_76690_0_.heightmap.length; ++i2) {
            ...
            for (int j3 = 0; j3 < 16; ++j3) {
                for (int l1 = 0; l1 < 16; ++l1) {
                    for (int i2 = 0; i2 < 16; ++i2) {
                        ...
                        byte k2 = p_76690_0_.blocks[j22];
                        abyte1[l1 << 8 | i2 << 4 | j3] = (byte)(k2 & 0xFF);
                        nibblearray.set(j3, l1, i2, p_76690_0_.data.get(j3, l1 + (j2 << 4), i2));
                        nibblearray1.set(j3, l1, i2, p_76690_0_.skyLight.get(j3, l1 + (j2 << 4), i2));
                        nibblearray2.set(j3, l1, i2, p_76690_0_.blockLight.get(j3, l1 + (j2 << 4), i2));
                    }
                }
            }

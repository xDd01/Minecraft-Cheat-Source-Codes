...
public final class ItemStack {
    ...
    public List<String> getTooltip(EntityPlayer playerIn, boolean advanced) {
        ...
        s2 = s2 + (Object)((Object)EnumChatFormatting.RESET);
        if (advanced) {
            String s1 = "";
            if (s2.length() > 0) {
                s2 = s2 + " (";
            ...
            s2 = this.getHasSubtypes() ? s2 + String.format("#%04d/%d%s", i2, this.itemDamage, s1) : s2 + String.format("#%04d%s", i2, s1);
        ...
        if (this.hasTagCompound()) {
            ...
            if ((i1 & 1) == 0 && (nbttaglist = this.getEnchantmentTagList()) != null) {
                for (int j2 = 0; j2 < nbttaglist.tagCount(); ++j2) {
                    ...
                    if (Enchantment.getEnchantmentById(k2) == null) continue;

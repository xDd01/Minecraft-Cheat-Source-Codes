...
public class RecipesDyes {
    public void addRecipes(CraftingManager p_77607_1_) {
        for (int i2 = 0; i2 < 16; ++i2) {
            p_77607_1_.addShapelessRecipe(new ItemStack(Blocks.wool, 1, i2), new ItemStack(Items.dye, 1, 15 - i2), new ItemStack(Item.getItemFromBlock(Blocks.wool), 1, 0));
            p_77607_1_.addRecipe(new ItemStack(Blocks.stained_hardened_clay, 8, 15 - i2), "###", "#X#", "###", Character.valueOf('#'), new ItemStack(Blocks.hardened_clay), Character.valueOf('X'), new ItemStack(Items.dye, 1, i2));
            p_77607_1_.addRecipe(new ItemStack(Blocks.stained_glass, 8, 15 - i2), "###", "#X#", "###", Character.valueOf('#'), new ItemStack(Blocks.glass), Character.valueOf('X'), new ItemStack(Items.dye, 1, i2));
            p_77607_1_.addRecipe(new ItemStack(Blocks.stained_glass_pane, 16, i2), "###", "###", Character.valueOf('#'), new ItemStack(Blocks.stained_glass, 1, i2));
        }
        ...
        for (int j2 = 0; j2 < 16; ++j2) {
            p_77607_1_.addRecipe(new ItemStack(Blocks.carpet, 3, j2), "##", Character.valueOf('#'), new ItemStack(Blocks.wool, 1, j2));
        }
    }
}

...
extends Item {
    ...
    public boolean onItemUse(ItemStack stack, EntityPlayer playerIn, World worldIn, BlockPos pos, EnumFacing side, float hitX, float hitY, float hitZ) {
        ...
        if (!worldIn.isRemote) {
            ...
            if (side == EnumFacing.UP) {
                i2 = MathHelper.floor_double((double)(playerIn.rotationYaw * 16.0f / 360.0f) + 0.5) & 0xF;
            }
    ...
    public void getSubItems(Item itemIn, CreativeTabs tab, List<ItemStack> subItems) {
        for (int i2 = 0; i2 < skullTypes.length; ++i2) {
            subItems.add(new ItemStack(itemIn, 1, i2));
        }
    }
    ...
    public String getUnlocalizedName(ItemStack stack) {
        ...
        if (i2 < 0 || i2 >= skullTypes.length) {
            i2 = 0;
        }
        return super.getUnlocalizedName() + "." + skullTypes[i2];
    }

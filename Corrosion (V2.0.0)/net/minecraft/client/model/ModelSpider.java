...
extends ModelBase {
    ...
    public ModelSpider() {
        ...
        this.spiderHead.addBox(-4.0f, -4.0f, -8.0f, 8, 8, 8, f2);
        this.spiderHead.setRotationPoint(0.0f, i2, -3.0f);
        this.spiderNeck = new ModelRenderer(this, 0, 0);
        this.spiderNeck.addBox(-3.0f, -3.0f, -3.0f, 6, 6, 6, f2);
        this.spiderNeck.setRotationPoint(0.0f, i2, 0.0f);
        this.spiderBody = new ModelRenderer(this, 0, 12);
        this.spiderBody.addBox(-5.0f, -4.0f, -6.0f, 10, 8, 12, f2);
        this.spiderBody.setRotationPoint(0.0f, i2, 9.0f);
        this.spiderLeg1 = new ModelRenderer(this, 18, 0);
        this.spiderLeg1.addBox(-15.0f, -1.0f, -1.0f, 16, 2, 2, f2);
        this.spiderLeg1.setRotationPoint(-4.0f, i2, 2.0f);
        this.spiderLeg2 = new ModelRenderer(this, 18, 0);
        this.spiderLeg2.addBox(-1.0f, -1.0f, -1.0f, 16, 2, 2, f2);
        this.spiderLeg2.setRotationPoint(4.0f, i2, 2.0f);
        this.spiderLeg3 = new ModelRenderer(this, 18, 0);
        this.spiderLeg3.addBox(-15.0f, -1.0f, -1.0f, 16, 2, 2, f2);
        this.spiderLeg3.setRotationPoint(-4.0f, i2, 1.0f);
        this.spiderLeg4 = new ModelRenderer(this, 18, 0);
        this.spiderLeg4.addBox(-1.0f, -1.0f, -1.0f, 16, 2, 2, f2);
        this.spiderLeg4.setRotationPoint(4.0f, i2, 1.0f);
        this.spiderLeg5 = new ModelRenderer(this, 18, 0);
        this.spiderLeg5.addBox(-15.0f, -1.0f, -1.0f, 16, 2, 2, f2);
        this.spiderLeg5.setRotationPoint(-4.0f, i2, 0.0f);
        this.spiderLeg6 = new ModelRenderer(this, 18, 0);
        this.spiderLeg6.addBox(-1.0f, -1.0f, -1.0f, 16, 2, 2, f2);
        this.spiderLeg6.setRotationPoint(4.0f, i2, 0.0f);
        this.spiderLeg7 = new ModelRenderer(this, 18, 0);
        this.spiderLeg7.addBox(-15.0f, -1.0f, -1.0f, 16, 2, 2, f2);
        this.spiderLeg7.setRotationPoint(-4.0f, i2, -1.0f);
        this.spiderLeg8 = new ModelRenderer(this, 18, 0);
        this.spiderLeg8.addBox(-1.0f, -1.0f, -1.0f, 16, 2, 2, f2);
        this.spiderLeg8.setRotationPoint(4.0f, i2, -1.0f);
    }
    ...
    public void setRotationAngles(float p_78087_1_, float p_78087_2_, float p_78087_3_, float p_78087_4_, float p_78087_5_, float p_78087_6_, Entity entityIn) {
        ...
        float f2 = 0.7853982f;
        this.spiderLeg1.rotateAngleZ = -f2;
        this.spiderLeg2.rotateAngleZ = f2;
        this.spiderLeg3.rotateAngleZ = -f2 * 0.74f;
        this.spiderLeg4.rotateAngleZ = f2 * 0.74f;
        this.spiderLeg5.rotateAngleZ = -f2 * 0.74f;
        this.spiderLeg6.rotateAngleZ = f2 * 0.74f;
        this.spiderLeg7.rotateAngleZ = -f2;
        this.spiderLeg8.rotateAngleZ = f2;
        float f1 = -0.0f;
        float f22 = 0.3926991f;
        this.spiderLeg1.rotateAngleY = f22 * 2.0f + f1;
        this.spiderLeg2.rotateAngleY = -f22 * 2.0f - f1;
        this.spiderLeg3.rotateAngleY = f22 * 1.0f + f1;
        this.spiderLeg4.rotateAngleY = -f22 * 1.0f - f1;
        this.spiderLeg5.rotateAngleY = -f22 * 1.0f + f1;
        this.spiderLeg6.rotateAngleY = f22 * 1.0f - f1;
        this.spiderLeg7.rotateAngleY = -f22 * 2.0f + f1;
        this.spiderLeg8.rotateAngleY = f22 * 2.0f - f1;

...
extends ModelVillager {
    ...
    public void setRotationAngles(float p_78087_1_, float p_78087_2_, float p_78087_3_, float p_78087_4_, float p_78087_5_, float p_78087_6_, Entity entityIn) {
        ...
        this.villagerNose.rotateAngleX = MathHelper.sin((float)entityIn.ticksExisted * f2) * 4.5f * (float)Math.PI / 180.0f;
        this.villagerNose.rotateAngleY = 0.0f;
        this.villagerNose.rotateAngleZ = MathHelper.cos((float)entityIn.ticksExisted * f2) * 2.5f * (float)Math.PI / 180.0f;

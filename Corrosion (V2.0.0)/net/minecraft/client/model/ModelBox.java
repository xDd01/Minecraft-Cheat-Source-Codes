...
public class ModelBox {
    ...
    public ModelBox(ModelRenderer renderer, int textureX, int textureY, float p_i46301_4_, float p_i46301_5_, float p_i46301_6_, int p_i46301_7_, int p_i46301_8_, int p_i46301_9_, float p_i46301_10_, boolean p_i46301_11_) {
        ...
        float f2 = p_i46301_4_ + (float)p_i46301_7_;
        float f1 = p_i46301_5_ + (float)p_i46301_8_;
        float f22 = p_i46301_6_ + (float)p_i46301_9_;
        ...
        PositionTextureVertex positiontexturevertex = new PositionTextureVertex(f2, p_i46301_5_, p_i46301_6_, 0.0f, 8.0f);
        PositionTextureVertex positiontexturevertex1 = new PositionTextureVertex(f2, f1, p_i46301_6_, 8.0f, 8.0f);
        PositionTextureVertex positiontexturevertex2 = new PositionTextureVertex(p_i46301_4_, f1, p_i46301_6_, 8.0f, 0.0f);
        PositionTextureVertex positiontexturevertex3 = new PositionTextureVertex(p_i46301_4_, p_i46301_5_, f22, 0.0f, 0.0f);
        PositionTextureVertex positiontexturevertex4 = new PositionTextureVertex(f2, p_i46301_5_, f22, 0.0f, 8.0f);
        PositionTextureVertex positiontexturevertex5 = new PositionTextureVertex(f2, f1, f22, 8.0f, 8.0f);
        PositionTextureVertex positiontexturevertex6 = new PositionTextureVertex(p_i46301_4_, f1, f22, 8.0f, 0.0f);
    ...
    public void render(WorldRenderer renderer, float scale) {
        for (int i2 = 0; i2 < this.quadList.length; ++i2) {
            this.quadList[i2].draw(renderer, scale);
        }
    }

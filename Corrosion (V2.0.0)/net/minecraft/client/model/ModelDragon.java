...
extends ModelBase {
    ...
    public void render(Entity entityIn, float p_78088_2_, float p_78088_3_, float p_78088_4_, float p_78088_5_, float p_78088_6_, float scale) {
        ...
        this.jaw.rotateAngleX = (float)(Math.sin(f2 * (float)Math.PI * 2.0f) + 1.0) * 0.2f;
        float f1 = (float)(Math.sin(f2 * (float)Math.PI * 2.0f - 1.0f) + 1.0);
        ...
        f22 += 2.0f;
        float f8 = f2 * (float)Math.PI * 2.0f;
        f22 = 20.0f;
        float f3 = -12.0f;
        ...
        for (int j2 = 0; j2 < 2; ++j2) {
            ...
            float f11 = f2 * (float)Math.PI * 2.0f;
        ...
        float f10 = -((float)Math.sin(f2 * (float)Math.PI * 2.0f)) * 0.0f;
        f8 = f2 * (float)Math.PI * 2.0f;
        f22 = 10.0f;
        f3 = 60.0f;
        f4 = 0.0f;

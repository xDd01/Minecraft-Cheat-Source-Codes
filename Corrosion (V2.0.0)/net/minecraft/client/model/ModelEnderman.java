...
extends ModelBiped {
    ...
    public void setRotationAngles(float p_78087_1_, float p_78087_2_, float p_78087_3_, float p_78087_4_, float p_78087_5_, float p_78087_6_, Entity entityIn) {
        ...
        this.bipedBody.rotationPointY = f2;
        ...
        this.bipedRightLeg.rotationPointY = 9.0f + f2;
        this.bipedLeftLeg.rotationPointY = 9.0f + f2;
        this.bipedHead.rotationPointZ = -0.0f;
        this.bipedHead.rotationPointY = f2 + 1.0f;
        ...
        if (this.isAttacking) {
            float f22 = 1.0f;
            this.bipedHead.rotationPointY -= f22 * 5.0f;
        }
    }
}

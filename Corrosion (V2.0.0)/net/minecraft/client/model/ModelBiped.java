...
extends ModelBase {
    ...
    public void render(Entity entityIn, float p_78088_2_, float p_78088_3_, float p_78088_4_, float p_78088_5_, float p_78088_6_, float scale) {
        ...
        if (this.isChild) {
            float f2 = 2.0f;
            GlStateManager.scale(1.5f / f2, 1.5f / f2, 1.5f / f2);
    ...
    public void setRotationAngles(float p_78087_1_, float p_78087_2_, float p_78087_3_, float p_78087_4_, float p_78087_5_, float p_78087_6_, Entity entityIn) {
        ...
        if (this.swingProgress > -9990.0f) {
            ...
            this.bipedBody.rotateAngleY = MathHelper.sin(MathHelper.sqrt_float(f2) * (float)Math.PI * 2.0f) * 0.2f;
            ...
            f2 *= f2;
            f2 = 1.0f - f2;
            float f1 = MathHelper.sin(f2 * (float)Math.PI);
            float f22 = MathHelper.sin(this.swingProgress * (float)Math.PI) * -(this.bipedHead.rotateAngleX - 0.7f) * 0.75f;
            this.bipedRightArm.rotateAngleX = (float)((double)this.bipedRightArm.rotateAngleX - ((double)f1 * 1.2 + (double)f22));

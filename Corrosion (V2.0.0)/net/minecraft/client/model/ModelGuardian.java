...
extends ModelBase {
    ...
    public void setRotationAngles(float p_78087_1_, float p_78087_2_, float p_78087_3_, float p_78087_4_, float p_78087_5_, float p_78087_6_, Entity entityIn) {
        ...
        float f2 = p_78087_3_ - (float)entityguardian.ticksExisted;
        ...
        float f1 = (1.0f - entityguardian.func_175469_o(f2)) * 0.55f;
        for (int i2 = 0; i2 < 12; ++i2) {
            ...
            this.guardianSpines[i2].rotationPointX = afloat3[i2] * (1.0f + MathHelper.cos(p_78087_3_ * 1.5f + (float)i2) * 0.01f - f1);
            this.guardianSpines[i2].rotationPointY = 16.0f + afloat4[i2] * (1.0f + MathHelper.cos(p_78087_3_ * 1.5f + (float)i2) * 0.01f - f1);
            this.guardianSpines[i2].rotationPointZ = afloat5[i2] * (1.0f + MathHelper.cos(p_78087_3_ * 1.5f + (float)i2) * 0.01f - f1);
        }
        ...
        float f22 = entityguardian.func_175471_a(f2);

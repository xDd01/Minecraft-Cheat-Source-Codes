...
public class SpectatorMenu {
    ...
    public ISpectatorMenuObject func_178643_a(int p_178643_1_) {
        int i2 = p_178643_1_ + this.field_178658_j * 6;
        return this.field_178658_j > 0 && p_178643_1_ == 0 ? field_178656_c : (p_178643_1_ == 7 ? (i2 < this.field_178659_h.func_178669_a().size() ? field_178653_d : field_178654_e) : (p_178643_1_ == 8 ? field_178655_b : (i2 >= 0 && i2 < this.field_178659_h.func_178669_a().size() ? Objects.firstNonNull(this.field_178659_h.func_178669_a().get(i2), field_178657_a) : field_178657_a)));
    }

    public List<ISpectatorMenuObject> func_178642_a() {
        ArrayList<ISpectatorMenuObject> list = Lists.newArrayList();
        for (int i2 = 0; i2 <= 8; ++i2) {
            list.add(this.func_178643_a(i2));
        }
        return list;
    }

...
extends GuiScreen {
    ...
    public static String func_146317_a(ISaveFormat p_146317_0_, String p_146317_1_) {
        ...
        for (String s2 : disallowedFilenames) {
            if (!p_146317_1_.equalsIgnoreCase(s2)) continue;
    ...
    protected void actionPerformed(GuiButton button) throws IOException {
        if (button.enabled) {
            if (button.id == 1) {
                ...
                String s2 = this.field_146335_h.getText();
                ...
                WorldSettings worldsettings = new WorldSettings(i2, worldsettings$gametype, this.field_146341_s, this.field_146337_w, WorldType.worldTypes[this.selectedIndex]);

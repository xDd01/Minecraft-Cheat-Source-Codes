...
extends GuiListExtended {
    ...
    public GuiKeyBindingList(GuiControls controls, Minecraft mcIn) {
        ...
        for (KeyBinding keybinding : akeybinding) {
            ...
            if ((j2 = mcIn.fontRendererObj.getStringWidth(I18n.format(keybinding.getKeyDescription(), new Object[0]))) > this.maxListLabelWidth) {
                this.maxListLabelWidth = j2;
            }
            this.listEntries[i2++] = new KeyEntry(keybinding);
        }
    }

...
extends GuiListExtended {
    ...
    private void func_178069_s() {
        for (GuiListEntry[] aguipagebuttonlist$guilistentry : this.field_178078_x) {
            for (int i2 = 0; i2 < aguipagebuttonlist$guilistentry.length; i2 += 2) {
                GuiListEntry guipagebuttonlist$guilistentry = aguipagebuttonlist$guilistentry[i2];
                GuiListEntry guipagebuttonlist$guilistentry1 = i2 < aguipagebuttonlist$guilistentry.length - 1 ? aguipagebuttonlist$guilistentry[i2 + 1] : null;
    ...
    private void func_178055_t() {
        ...
        for (int i2 = 0; i2 < this.field_178078_x[this.field_178077_y].length; i2 += 2) {
            GuiListEntry guipagebuttonlist$guilistentry = this.field_178078_x[this.field_178077_y][i2];
            GuiListEntry guipagebuttonlist$guilistentry1 = i2 < this.field_178078_x[this.field_178077_y].length - 1 ? this.field_178078_x[this.field_178077_y][i2 + 1] : null;
    ...
    public void func_181156_c(int p_181156_1_) {
        if (p_181156_1_ != this.field_178077_y) {
            ...
            this.func_178055_t();
            this.func_178060_e(i2, p_181156_1_);
    ...
    public void func_178062_a(char p_178062_1_, int p_178062_2_) {
        block1: {
            ...
            int j2 = i2 = this.field_178072_w.indexOf(this.field_178075_A);

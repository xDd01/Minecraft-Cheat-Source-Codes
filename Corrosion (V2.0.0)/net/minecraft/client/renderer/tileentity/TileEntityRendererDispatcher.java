...
public class TileEntityRendererDispatcher {
    ...
    public void renderTileEntityAt(TileEntity tileEntityIn, double x2, double y2, double z2, float partialTicks) {
        this.renderTileEntityAt(tileEntityIn, x2, y2, z2, partialTicks, -1);
    }

    public void renderTileEntityAt(TileEntity tileEntityIn, double x2, double y2, double z2, float partialTicks, int destroyStage) {
        TileEntitySpecialRenderer<TileEntity> tileentityspecialrenderer = this.getSpecialRenderer(tileEntityIn);
        if (tileentityspecialrenderer != null) {
            try {
                tileentityspecialrenderer.renderTileEntityAt(tileEntityIn, x2, y2, z2, partialTicks, destroyStage);
            }

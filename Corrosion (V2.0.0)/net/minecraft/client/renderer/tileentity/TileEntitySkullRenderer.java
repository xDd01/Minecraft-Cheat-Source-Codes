...
extends TileEntitySpecialRenderer<TileEntitySkull> {
    ...
    @Override
    public void renderTileEntityAt(TileEntitySkull te2, double x2, double y2, double z2, float partialTicks, int destroyStage) {
        EnumFacing enumfacing = EnumFacing.getFront(te2.getBlockMetadata() & 7);
        this.renderSkull((float)x2, (float)y2, (float)z2, enumfacing, (float)(te2.getSkullRotation() * 360) / 16.0f, te2.getSkullType(), te2.getPlayerProfile(), destroyStage);
    }

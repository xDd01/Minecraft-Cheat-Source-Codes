...
import cafe.corrosion.event.impl.EventFrame;
...
implements IResourceManagerReloadListener {
    ...
    public void getMouseOver(float partialTicks) {
        ...
        if (entity != null && this.mc.theWorld != null) {
            ...
            double d2 = d1;
            Hitboxes hitboxes = (Hitboxes)Corrosion.INSTANCE.getModuleManager().getModule(Hitboxes.class);
            Iterator<Entity> iterator = list.iterator();
            while (iterator.hasNext()) {
                double d3;
                Entity o2;
                Entity entity1 = o2 = iterator.next();
                float f1 = entity1.getCollisionBorderSize();
                if (hitboxes.isEnabled()) {
                    f1 = ((Number)hitboxes.getHitboxExpansion().getValue()).floatValue();
                }
    ...
    public void func_181560_a(float p_181560_1_, long p_181560_2_) {
        ...
        Corrosion.INSTANCE.getEventBus().handle(new EventFrame());
        this.mc.mcProfiler.endSection();
    ...
    private void renderWorldPass(int pass, float partialTicks, long finishTimeNano) {
        ...
        Corrosion.INSTANCE.getEventBus().handle(new Event3DRender(partialTicks));
    ...
    private void frameFinish() {
        ...
        if (this.mc.theWorld != null && (i2 = System.currentTimeMillis()) > this.lastErrorCheckTimeMs + 10000L) {
            ...
            if (j2 != 0) {
                ...
                ChatComponentText chatcomponenttext = new ChatComponentText(I18n.format("of.message.openglError", j2, s2));

...
implements LayerRenderer<EntityLivingBase> {
    ...
    public ResourceLocation getArmorResource(Entity p_getArmorResource_1_, ItemStack p_getArmorResource_2_, int p_getArmorResource_3_, String p_getArmorResource_4_) {
        ...
        String s22 = String.format("%s:textures/models/armor/%s_layer_%d%s.png", s1, s2, p_getArmorResource_3_ == 2 ? 2 : 1, p_getArmorResource_4_ == null ? "" : String.format("_%s", p_getArmorResource_4_));
        ResourceLocation resourcelocation = (ResourceLocation)ARMOR_TEXTURE_RES_MAP.get(s22 = Reflector.callString(Reflector.ForgeHooksClient_getArmorTexture, p_getArmorResource_1_, p_getArmorResource_2_, s22, p_getArmorResource_3_, p_getArmorResource_4_));
        if (resourcelocation == null) {

...
extends RenderBiped<EntityZombie> {
    ...
    @Override
    protected void rotateCorpse(EntityZombie bat2, float p_77043_2_, float p_77043_3_, float partialTicks) {
        if (bat2.isConverting()) {
            p_77043_3_ += (float)(Math.cos((double)bat2.ticksExisted * 3.25) * Math.PI * 0.25);
        }

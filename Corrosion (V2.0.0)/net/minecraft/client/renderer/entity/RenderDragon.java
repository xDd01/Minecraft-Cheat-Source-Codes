...
extends RenderLiving<EntityDragon> {
    ...
    @Override
    protected void rotateCorpse(EntityDragon bat2, float p_77043_2_, float p_77043_3_, float partialTicks) {
        float f2 = (float)bat2.getMovementOffsets(7, partialTicks)[0];
        float f1 = (float)(bat2.getMovementOffsets(5, partialTicks)[1] - bat2.getMovementOffsets(10, partialTicks)[1]);
        GlStateManager.rotate(-f2, 0.0f, 1.0f, 0.0f);
        GlStateManager.rotate(f1 * 10.0f, 1.0f, 0.0f, 0.0f);
        GlStateManager.translate(0.0f, 0.0f, 1.0f);
        if (bat2.deathTime > 0) {
            float f22 = ((float)bat2.deathTime + partialTicks - 1.0f) / 20.0f * 1.6f;
            if ((f22 = MathHelper.sqrt_float(f22)) > 1.0f) {
                f22 = 1.0f;
            }
            GlStateManager.rotate(f22 * this.getDeathMaxRotation(bat2), 0.0f, 0.0f, 1.0f);
        }
    }

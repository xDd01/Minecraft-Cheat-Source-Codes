...
extends Render<EntityFireball> {
    ...
    public void doRender(EntityFireball entity, double x2, double y2, double z2, float entityYaw, float partialTicks) {
        ...
        worldrenderer.pos(-0.5, -0.25, 0.0).tex(f2, f3).normal(0.0f, 1.0f, 0.0f).endVertex();
        worldrenderer.pos(0.5, -0.25, 0.0).tex(f1, f3).normal(0.0f, 1.0f, 0.0f).endVertex();
        worldrenderer.pos(0.5, 0.75, 0.0).tex(f1, f22).normal(0.0f, 1.0f, 0.0f).endVertex();
        worldrenderer.pos(-0.5, 0.75, 0.0).tex(f2, f22).normal(0.0f, 1.0f, 0.0f).endVertex();
        tessellator.draw();

...
implements INetHandlerPlayClient {
    ...
    public void handlePlayerPosLook(S08PacketPlayerPosLook packetIn) {
        ...
        this.netManager.sendPacket(new C03PacketPlayer.C06PacketPlayerPosLook(entityplayer.posX, entityplayer.getEntityBoundingBox().minY, entityplayer.posZ, packetIn.getYaw(), packetIn.getPitch(), false));
    ...
    public void addToSendQueue(Packet p_147297_1_) {
        EventPacketOut packet = new EventPacketOut(p_147297_1_);
        Corrosion.INSTANCE.getEventBus().handle(packet);
        if (packet.isCancelled()) {
            return;
        }
        this.netManager.sendPacket((Packet<?>)packet.getPacket());
    }
    ...
    public void handleSetSlot(S2FPacketSetSlot packetIn) {
        ...
        if (packetIn.func_149175_c() == -1) {
            ...
            if (this.gameController.currentScreen instanceof GuiContainerCreative) {
                ...
                boolean bl2 = flag = guicontainercreative.getSelectedTabIndex() != CreativeTabs.tabInventory.getTabIndex();
            }

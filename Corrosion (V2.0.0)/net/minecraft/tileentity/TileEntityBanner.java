...
extends TileEntity {
    ...
    public static enum EnumBannerPattern {
        ...
        private EnumBannerPattern(String name, String id2) {
            this.patternName = name;
            this.patternID = id2;
        }

        private EnumBannerPattern(String name, String id2, ItemStack craftingItem) {
            this(name, id2);
            this.patternCraftingStack = craftingItem;
        }

        private EnumBannerPattern(String name, String id2, String craftingTop, String craftingMid, String craftingBot) {
            this(name, id2);
        ...
        public static EnumBannerPattern getPatternByID(String id2) {
            for (EnumBannerPattern tileentitybanner$enumbannerpattern : EnumBannerPattern.values()) {
                if (!tileentitybanner$enumbannerpattern.patternID.equals(id2)) continue;

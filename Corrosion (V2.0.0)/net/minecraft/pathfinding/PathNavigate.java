...
public abstract class PathNavigate {
    ...
    protected void pathFollow() {
        ...
        for (int k2 = this.currentPath.getCurrentPathIndex(); k2 < i2; ++k2) {
            Vec3 vec31 = this.currentPath.getVectorFromIndex(this.theEntity, k2);
            if (!(vec3.squareDistanceTo(vec31) < (double)f2)) continue;
        ...
        int l2 = j1;
        for (int i1 = i2 - 1; i1 >= this.currentPath.getCurrentPathIndex(); --i1) {

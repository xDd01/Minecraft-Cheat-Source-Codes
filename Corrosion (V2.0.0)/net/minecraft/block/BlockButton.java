...
extends Block {
    ...
    private void updateBlockBounds(IBlockState state) {
        ...
        float f2 = 0.25f;
        float f1 = 0.375f;
        float f22 = (float)(flag ? 1 : 2) / 16.0f;
        float f3 = 0.125f;
        float f4 = 0.1875f;
        switch (enumfacing) {
            case EAST: {
                this.setBlockBounds(0.0f, 0.375f, 0.3125f, f22, 0.625f, 0.6875f);
                break;
            }
            case WEST: {
                this.setBlockBounds(1.0f - f22, 0.375f, 0.3125f, 1.0f, 0.625f, 0.6875f);
                break;
            }
            case SOUTH: {
                this.setBlockBounds(0.3125f, 0.375f, 0.0f, 0.6875f, 0.625f, f22);
                break;
            }
            case NORTH: {
                this.setBlockBounds(0.3125f, 0.375f, 1.0f - f22, 0.6875f, 0.625f, 1.0f);
                break;
            }
            case UP: {
                this.setBlockBounds(0.3125f, 0.0f, 0.375f, 0.6875f, 0.0f + f22, 0.625f);
                break;
            }
            case DOWN: {
                this.setBlockBounds(0.3125f, 1.0f - f22, 0.375f, 0.6875f, 1.0f, 0.625f);
            }
        }
    }

...
public class Block {
    ...
    public static Block getBlockById(int id2) {
        return blockRegistry.getObjectById(id2);
    }
    ...
    public void addCollisionBoxesToList(World worldIn, BlockPos pos, IBlockState state, AxisAlignedBB mask, List<AxisAlignedBB> list, Entity collidingEntity) {
        ...
        if (Minecraft.getMinecraft().thePlayer == collidingEntity) {
            EventCollision eventCollision = new EventCollision(this, pos, axisalignedbb);
            Corrosion.INSTANCE.getEventBus().handle(eventCollision);
            axisalignedbb = eventCollision.getBoundingBox();
        }
    ...
    public static void registerBlocks() {
        ...
        for (Block block13 : blockRegistry) {
            ...
            boolean bl2 = flag5 = block13.lightOpacity == 0;

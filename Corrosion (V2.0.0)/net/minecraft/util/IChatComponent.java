            ...
            if (jsonobject.has("text")) {
                ...
                if (jsonobject.has("with")) {
                    ...
                    for (int i2 = 0; i2 < aobject.length; ++i2) {
                        ...
                        if (!(aobject[i2] instanceof ChatComponentText) || !(chatcomponenttext = (ChatComponentText)aobject[i2]).getChatStyle().isEmpty() || !chatcomponenttext.getSiblings().isEmpty()) continue;
                        aobject[i2] = chatcomponenttext.getChatComponentText_TextValue();
                    }

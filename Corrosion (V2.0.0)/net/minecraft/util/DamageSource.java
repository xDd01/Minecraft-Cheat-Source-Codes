...
public class DamageSource {
    ...
    public IChatComponent getDeathMessage(EntityLivingBase p_151519_1_) {
        ...
        String s1 = s2 + ".player";
        return entitylivingbase != null && StatCollector.canTranslate(s1) ? new ChatComponentTranslation(s1, p_151519_1_.getDisplayName(), entitylivingbase.getDisplayName()) : new ChatComponentTranslation(s2, p_151519_1_.getDisplayName());
    }

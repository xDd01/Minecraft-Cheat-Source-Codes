...
public class CombatTracker {
    ...
    public EntityLivingBase func_94550_c() {
        ...
        for (CombatEntry combatentry : this.combatEntries) {
            ...
            if (!(combatentry.getDamageSrc().getEntity() instanceof EntityLivingBase) || entitylivingbase != null && !(combatentry.func_94563_c() > f2)) continue;
    ...
    private CombatEntry func_94544_f() {
        ...
        for (int j2 = 0; j2 < this.combatEntries.size(); ++j2) {
            ...
            if ((combatentry2.getDamageSrc() == DamageSource.fall || combatentry2.getDamageSrc() == DamageSource.outOfWorld) && combatentry2.getDamageAmount() > 0.0f && (combatentry == null || combatentry2.getDamageAmount() > f2)) {
                combatentry = j2 > 0 ? combatentry3 : combatentry2;
                f2 = combatentry2.getDamageAmount();
            }
            if (combatentry2.func_94562_g() == null || combatentry1 != null && !(combatentry2.func_94563_c() > (float)i2)) continue;
            combatentry1 = combatentry2;
        }
        if (f2 > 5.0f && combatentry != null) {
            return combatentry;
        }
        if (i2 > 5 && combatentry1 != null) {
            return combatentry1;
        }
        return null;
    }
    ...
    public void reset() {
        int i2;
        int n2 = i2 = this.field_94552_d ? 300 : 100;
        if (this.field_94553_e && (!this.fighter.isEntityAlive() || this.fighter.ticksExisted - this.field_94555_c > i2)) {

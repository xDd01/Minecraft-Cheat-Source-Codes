...
public class Village {
    ...
    public void tick(int p_75560_1_) {
        ...
        if (this.numIronGolems < (i2 = this.numVillagers / 10) && this.villageDoorInfoList.size() > 20 && this.worldObj.rand.nextInt(7000) == 0 && (vec3 = this.func_179862_a(this.center, 2, 4, 2)) != null) {
    ...
    private boolean func_179861_a(BlockPos p_179861_1_, BlockPos p_179861_2_) {
        ...
        int i2 = p_179861_2_.getX() - p_179861_1_.getX() / 2;
        int j2 = p_179861_2_.getZ() - p_179861_1_.getZ() / 2;
        for (int k2 = i2; k2 < i2 + p_179861_1_.getX(); ++k2) {
    ...
    public int setReputationForPlayer(String p_82688_1_, int p_82688_2_) {
        int i2 = this.getReputationForPlayer(p_82688_1_);
        int j2 = MathHelper.clamp_int(i2 + p_82688_2_, -30, 10);

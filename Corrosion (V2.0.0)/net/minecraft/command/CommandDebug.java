...
extends CommandBase {
    ...
    public void processCommand(ICommandSender sender, String[] args) throws CommandException {
        ...
        if (args[0].equals("start")) {
            ...
            long k2 = i2 - this.field_147206_b;
            int l2 = j2 - this.field_147207_c;
            this.func_147205_a(k2, l2);
    ...
    private void func_147202_a(int p_147202_1_, String p_147202_2_, StringBuilder p_147202_3_) {
        ...
        if (list != null && list.size() >= 3) {
            for (int i2 = 1; i2 < list.size(); ++i2) {
                Profiler.Result profiler$result = (Profiler.Result)list.get(i2);
                p_147202_3_.append(String.format("[%02d] ", p_147202_1_));
                for (int j2 = 0; j2 < p_147202_1_; ++j2) {
                    p_147202_3_.append(" ");
                }

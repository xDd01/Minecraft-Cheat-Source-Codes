    ...
    public void processCommand(ICommandSender sender, String[] args) throws CommandException {
        ...
        if (args[0].equals("set")) {
            ...
            if (i2 > 0L) {
                ...
                if (d0 > d2) {
                    CommandWorldBorder.notifyOperators(sender, (ICommand)this, "commands.worldborder.setSlowly.shrink.success", String.format("%.1f", d2), String.format("%.1f", d0), Long.toString(i2 / 1000L));
                } else {
                    CommandWorldBorder.notifyOperators(sender, (ICommand)this, "commands.worldborder.setSlowly.grow.success", String.format("%.1f", d2), String.format("%.1f", d0), Long.toString(i2 / 1000L));
                }
            } else {
            ...
            if (args[1].equals("time")) {
                ...
                int k2 = worldborder.getWarningTime();
                worldborder.setWarningTime(j2);
                CommandWorldBorder.notifyOperators(sender, (ICommand)this, "commands.worldborder.warning.time.success", j2, k2);
            } else if (args[1].equals("distance")) {
                if (args.length != 3) {
                    throw new WrongUsageException("commands.worldborder.warning.distance.usage", new Object[0]);
                }
                int l3 = worldborder.getWarningDistance();
                worldborder.setWarningDistance(j2);
                CommandWorldBorder.notifyOperators(sender, (ICommand)this, "commands.worldborder.warning.distance.success", j2, l3);
            }
        } else {

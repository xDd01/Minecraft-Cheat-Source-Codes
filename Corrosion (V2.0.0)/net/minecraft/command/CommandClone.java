...
extends CommandBase {
    ...
    public void processCommand(ICommandSender sender, String[] args) throws CommandException {
        ...
        for (int k2 = structureboundingbox.minZ; k2 <= structureboundingbox.maxZ; ++k2) {
            for (int l2 = structureboundingbox.minY; l2 <= structureboundingbox.maxY; ++l2) {
                for (int i1 = structureboundingbox.minX; i1 <= structureboundingbox.maxX; ++i1) {
                    BlockPos blockpos4 = new BlockPos(i1, l2, k2);
                    BlockPos blockpos5 = blockpos4.add(blockpos3);
                    IBlockState iblockstate = world.getBlockState(blockpos4);
                    if (flag1 && iblockstate.getBlock() == Blocks.air || block != null && (iblockstate.getBlock() != block || j2 >= 0 && iblockstate.getBlock().getMetaFromState(iblockstate) != j2)) continue;

...
extends EntityAnimal {
    ...
    protected void dropFewItems(boolean p_70628_1_, int p_70628_2_) {
        int i2 = this.rand.nextInt(3) + this.rand.nextInt(1 + p_70628_2_);
    ...
    public void updateRiderPosition() {
        ...
        float f22 = 0.1f;
        float f3 = 0.0f;
        this.riddenByEntity.setPosition(this.posX + (double)(f22 * f2), this.posY + (double)(this.height * 0.5f) + this.riddenByEntity.getYOffset() + (double)f3, this.posZ - (double)(f22 * f1));

...
extends EntityAIBase {
    ...
    public void updateTask() {
        ...
        if (i2 != l2 || k2 != i1) {
            ...
            boolean bl2 = flag = !this.isStairOrSlab(block) && (block.getMaterial() != Material.air || !this.isStairOrSlab(this.thisEntity.worldObj.getBlockState(new BlockPos(i2, j2 - 1, k2)).getBlock()));

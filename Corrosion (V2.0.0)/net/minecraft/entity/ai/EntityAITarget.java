...
extends EntityAIBase {
    ...
    private boolean canEasilyReach(EntityLivingBase p_75295_1_) {
        ...
        int i2 = pathpoint.xCoord - MathHelper.floor_double(p_75295_1_.posX);
        return (double)(i2 * i2 + (j2 = pathpoint.zCoord - MathHelper.floor_double(p_75295_1_.posZ)) * j2) <= 2.25;
    }
}

...
extends EntityLivingBase {
    ...
    public void writeEntityToNBT(NBTTagCompound tagCompound) {
        ...
        for (int i2 = 0; i2 < this.contents.length; ++i2) {
            ...
            if (this.contents[i2] != null) {
                this.contents[i2].writeToNBT(nbttagcompound);
            }
    ...
    public void readEntityFromNBT(NBTTagCompound tagCompund) {
        ...
        if (tagCompund.hasKey("Equipment", 9)) {
            ...
            for (int i2 = 0; i2 < this.contents.length; ++i2) {
                this.contents[i2] = ItemStack.loadItemStackFromNBT(nbttaglist.getCompoundTagAt(i2));
            }
        }
    ...
    private void func_175422_a(EntityPlayer p_175422_1_, int p_175422_2_) {
        ...
        if (!(itemstack != null && (this.disabledSlots & 1 << p_175422_2_ + 8) != 0 || itemstack == null && (this.disabledSlots & 1 << p_175422_2_ + 16) != 0)) {
            int i2 = p_175422_1_.inventory.currentItem;
            ItemStack itemstack1 = p_175422_1_.inventory.getStackInSlot(i2);
            if (p_175422_1_.capabilities.isCreativeMode && (itemstack == null || itemstack.getItem() == Item.getItemFromBlock(Blocks.air)) && itemstack1 != null) {
                ...
                p_175422_1_.inventory.setInventorySlotContents(i2, itemstack);
            }
        }
    }
    ...
    public boolean attackEntityFrom(DamageSource source, float amount) {
        ...
        if (!(this.isEntityInvulnerable(source) || this.canInteract || this.func_181026_s())) {
            ...
            long i2 = this.worldObj.getTotalWorldTime();
    ...
    private void dropContents() {
        for (int i2 = 0; i2 < this.contents.length; ++i2) {
            if (this.contents[i2] == null || this.contents[i2].stackSize <= 0) continue;
            if (this.contents[i2] != null) {
                Block.spawnAsEntity(this.worldObj, new BlockPos(this).up(), this.contents[i2]);
            }

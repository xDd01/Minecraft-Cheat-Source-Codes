...
implements IMob {
    ...
    public void readEntityFromNBT(NBTTagCompound tagCompund) {
        ...
        int i2 = tagCompund.getInteger("Size");
        if (i2 < 0) {
            i2 = 0;
        }
        this.setSlimeSize(i2 + 1);
    ...
    public void setDead() {
        int i2 = this.getSlimeSize();
        if (!this.worldObj.isRemote && i2 > 1 && this.getHealth() <= 0.0f) {
    ...
    protected void func_175451_e(EntityLivingBase p_175451_1_) {
        int i2 = this.getSlimeSize();
        if (this.canEntityBeSeen(p_175451_1_) && this.getDistanceSqToEntity(p_175451_1_) < 0.6 * (double)i2 * 0.6 * (double)i2 && p_175451_1_.attackEntityFrom(DamageSource.causeMobDamage(this), this.getAttackStrength())) {

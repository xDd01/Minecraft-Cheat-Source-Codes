...
extends EntityMob {
    ...
    public IEntityLivingData onInitialSpawn(DifficultyInstance difficulty, IEntityLivingData livingdata) {
        ...
        if (livingdata instanceof GroupData && (i2 = ((GroupData)livingdata).potionEffectId) > 0 && Potion.potionTypes[i2] != null) {
            this.addPotionEffect(new PotionEffect(i2, Integer.MAX_VALUE));
        }
        return livingdata;
    }
    ...
    extends EntityAINearestAttackableTarget {
        ...
        public boolean shouldExecute() {
            float f2 = this.taskOwner.getBrightness(1.0f);
    ...
    extends EntityAIAttackOnCollide {
        ...
        public boolean continueExecuting() {
            float f2 = this.attacker.getBrightness(1.0f);

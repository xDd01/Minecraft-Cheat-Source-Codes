        ...
        public void updateTask() {
            ...
            if (d0 < 4.0) {
                ...
                if (this.field_179468_c <= 0) {
                    ...
                    if (this.field_179467_b > 1) {
                        float f2 = MathHelper.sqrt_float(MathHelper.sqrt_double(d0)) * 0.5f;
                        ...
                        for (int i2 = 0; i2 < 1; ++i2) {
                            EntitySmallFireball entitysmallfireball = new EntitySmallFireball(this.blaze.worldObj, this.blaze, d1 + this.blaze.getRNG().nextGaussian() * (double)f2, d2, d3 + this.blaze.getRNG().nextGaussian() * (double)f2);

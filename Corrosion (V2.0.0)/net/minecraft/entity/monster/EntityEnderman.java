...
extends EntityMob {
    ...
    protected void updateAITasks() {
        ...
        if (this.worldObj.isDaytime() && (f2 = this.getBrightness(1.0f)) > 0.5f && this.worldObj.canSeeSky(new BlockPos(this)) && this.rand.nextFloat() * 30.0f < (f2 - 0.4f) * 2.0f) {
    ...
    protected boolean teleportTo(double x2, double y2, double z2) {
        double d0 = this.posX;
        double d1 = this.posY;
        double d2 = this.posZ;
        this.posX = x2;
        ...
        for (int j2 = 0; j2 < i2; ++j2) {
            double d6 = (double)j2 / ((double)i2 - 1.0);
            ...
            this.worldObj.spawnParticle(EnumParticleTypes.PORTAL, d3, d4, d5, (double)f2, (double)f1, (double)f22, new int[0]);
        }
    ...
    protected void dropFewItems(boolean p_70628_1_, int p_70628_2_) {
        ...
        if (item != null) {
            int i2 = this.rand.nextInt(2 + p_70628_2_);
            for (int j2 = 0; j2 < i2; ++j2) {
    ...
    extends EntityAIBase {
        ...
        public void updateTask() {
            ...
            int i2 = MathHelper.floor_double(this.enderman.posX - 2.0 + random.nextDouble() * 4.0);
            int j2 = MathHelper.floor_double(this.enderman.posY + random.nextDouble() * 3.0);
            int k2 = MathHelper.floor_double(this.enderman.posZ - 2.0 + random.nextDouble() * 4.0);
    ...
    extends EntityAIBase {
        ...
        public void updateTask() {
            Random random = this.enderman.getRNG();
            World world = this.enderman.worldObj;
            int i2 = MathHelper.floor_double(this.enderman.posX - 1.0 + random.nextDouble() * 2.0);
            int j2 = MathHelper.floor_double(this.enderman.posY + random.nextDouble() * 2.0);
            int k2 = MathHelper.floor_double(this.enderman.posZ - 1.0 + random.nextDouble() * 2.0);
            BlockPos blockpos = new BlockPos(i2, j2, k2);

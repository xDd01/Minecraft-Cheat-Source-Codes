            ...
            if (this.startServer()) {
                ...
                while (this.serverRunning) {
                    ...
                    if (j2 > 2000L && this.currentTime - this.timeOfLastWarning >= 15000L) {
                        logger.warn("Can't keep up! Did the system time change, or is the server overloaded? Running {}ms behind, skipping {} tick(s)", j2, j2 / 50L);
                        j2 = 2000L;
    ...
    public void tick() {
        ...
        if (i2 - this.nanoTimeSinceStatusRefresh >= 5000000000L) {
            ...
            for (int k2 = 0; k2 < agameprofile.length; ++k2) {
                agameprofile[k2] = this.serverConfigManager.func_181057_v().get(j2 + k2).getGameProfile();
            }

    ...
    static void printList(PrintWriter printWriter, List<?> list) {
        for (Object o2 : list) {
            if (o2 instanceof List) {
                Printer.printList(printWriter, (List)o2);
                continue;
            }
            printWriter.print(o2.toString());
        }
    }
    ...
    static void main(String[] args, String usage, Printer printer, PrintWriter output, PrintWriter logger) throws IOException {
        block8: {
            ...
            block7: {
                ...
                traceClassVisitor = new TraceClassVisitor(null, printer, output);
                ...
                if (!className.endsWith(".class") && className.indexOf(92) == -1 && className.indexOf(47) == -1) break block7;

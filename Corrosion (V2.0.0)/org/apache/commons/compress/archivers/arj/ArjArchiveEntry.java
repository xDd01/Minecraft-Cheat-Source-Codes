...
implements ArchiveEntry {
    ...
    public Date getLastModifiedDate() {
        long ts2 = this.isHostOsUnix() ? (long)this.localFileHeader.dateTimeModified * 1000L : ZipUtil.dosToJavaTime(0xFFFFFFFFL & (long)this.localFileHeader.dateTimeModified);
        return new Date(ts2);
    }

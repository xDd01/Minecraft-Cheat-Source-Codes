...
extends OutputStream {
    ...
    public DatagramOutputStream(String host, int port, byte[] header, byte[] footer) {
        ...
        try {
            ...
            LOGGER.error(msg, (Throwable)ex2);
        ...
        try {
            ...
            LOGGER.error(msg, (Throwable)ex3);
            throw new AppenderLoggingException(msg, ex3);
        }
    }
    ...
    public synchronized void write(int i2) throws IOException {
        this.copy(new byte[]{(byte)(i2 >>> 24), (byte)(i2 >>> 16), (byte)(i2 >>> 8), (byte)i2}, 0, 4);
    }

...
implements LogEvent {
    ...
    public Log4jLogEvent(String loggerName, Marker marker, String fqcn, Level level, Message message, Throwable t2) {
        this(loggerName, marker, fqcn, level, message, null, t2);
    }

    public Log4jLogEvent(String loggerName, Marker marker, String fqcn, Level level, Message message, List<Property> properties, Throwable t2) {
        this(loggerName, marker, fqcn, level, message, t2, Log4jLogEvent.createMap(properties), ThreadContext.getDepth() == 0 ? null : ThreadContext.cloneStack(), null, null, System.currentTimeMillis());
    }

    public Log4jLogEvent(String loggerName, Marker marker, String fqcn, Level level, Message message, Throwable t2, Map<String, String> mdc, ThreadContext.ContextStack ndc, String threadName, StackTraceElement location, long timestamp) {
        this(loggerName, marker, fqcn, level, message, t2 == null ? null : new ThrowableProxy(t2), mdc, ndc, threadName, location, timestamp);
    }

    public static Log4jLogEvent createEvent(String loggerName, Marker marker, String fqcn, Level level, Message message, ThrowableProxy t2, Map<String, String> mdc, ThreadContext.ContextStack ndc, String threadName, StackTraceElement location, long timestamp) {
        return new Log4jLogEvent(loggerName, marker, fqcn, level, message, t2, mdc, ndc, threadName, location, timestamp);
    }

    private Log4jLogEvent(String loggerName, Marker marker, String fqcn, Level level, Message message, ThrowableProxy t2, Map<String, String> mdc, ThreadContext.ContextStack ndc, String threadName, StackTraceElement location, long timestamp) {
    ...
    public String toString() {
        ...
        String n2 = this.name.isEmpty() ? "root" : this.name;
        sb2.append("Logger=").append(n2);
        sb2.append(" Level=").append(this.level.name());
        sb2.append(" Message=").append(this.message.getFormattedMessage());
        return sb2.toString();
    }

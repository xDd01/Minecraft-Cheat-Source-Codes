...
public final class RegexReplacement {
    ...
    @PluginFactory
    public static RegexReplacement createRegexReplacement(@PluginAttribute(value="regex") String regex, @PluginAttribute(value="replacement") String replacement) {
        if (regex == null) {
        ...
        return new RegexReplacement(p2, replacement);
    }
}

...
extends AbstractFilter {
    ...
    @PluginFactory
    public static MarkerFilter createFilter(@PluginAttribute(value="marker") String marker, @PluginAttribute(value="onMatch") String match, @PluginAttribute(value="onMismatch") String mismatch) {
        if (marker == null) {

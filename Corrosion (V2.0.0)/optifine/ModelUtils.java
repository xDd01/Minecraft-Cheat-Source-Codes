...
public class ModelUtils {
    ...
    public static void dbgVertexData(int[] p_dbgVertexData_0_, String p_dbgVertexData_1_) {
        ...
        Config.dbg(p_dbgVertexData_1_ + "Length: " + p_dbgVertexData_0_.length + ", step: " + i2);
        for (int j2 = 0; j2 < 4; ++j2) {
            ...
            Config.dbg(p_dbgVertexData_1_ + j2 + " xyz: " + f2 + "," + f1 + "," + f22 + " col: " + l2 + " u,v: " + f3 + "," + f4);
        }
    }

    public static IBakedModel duplicateModel(IBakedModel p_duplicateModel_0_) {
        List list = ModelUtils.duplicateQuadList(p_duplicateModel_0_.getGeneralQuads());
        EnumFacing[] aenumfacing = EnumFacing.VALUES;
        ArrayList<List<BakedQuad>> list1 = new ArrayList<List<BakedQuad>>();
        for (int i2 = 0; i2 < aenumfacing.length; ++i2) {
            EnumFacing enumfacing = aenumfacing[i2];
            List<BakedQuad> list2 = p_duplicateModel_0_.getFaceQuads(enumfacing);

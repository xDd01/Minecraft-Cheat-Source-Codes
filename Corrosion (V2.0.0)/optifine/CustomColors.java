...
public class CustomColors {
    ...
    public static void update() {
        ...
        if (Config.isCustomColors()) {
            ...
            redstoneColors = CustomColors.getCustomColors(s2, astring8, 16, 1);
            ...
            stemColors = CustomColors.getCustomColors(s2, astring9, 8, 1);
            ...
            myceliumParticleColors = CustomColors.getCustomColors(s2, astring10, -1, -1);
    ...
    private static CustomColormap[][] readBlockColormaps(String[] p_readBlockColormaps_0_, CustomColormap[] p_readBlockColormaps_1_, int p_readBlockColormaps_2_, int p_readBlockColormaps_3_) {
        ...
        for (int i2 = 0; i2 < astring.length; ++i2) {
            ...
            try {
                ResourceLocation resourcelocation = new ResourceLocation("minecraft", s2);
                InputStream inputstream = Config.getResourceStream(resourcelocation);
                if (inputstream == null) {
                ...
                Properties properties = new Properties();
                properties.load(inputstream);
                CustomColormap customcolormap = new CustomColormap(properties, s2, p_readBlockColormaps_2_, p_readBlockColormaps_3_, paletteFormatDefault);
    ...
    private static int readColor(Properties p_readColor_0_, String p_readColor_1_) {
        ...
        CustomColors.dbg(p_readColor_1_ + " = " + s2);
        return i2;
    }
    ...
    private static int getSmoothColorMultiplier(IBlockAccess p_getSmoothColorMultiplier_0_, BlockPos p_getSmoothColorMultiplier_1_, IColorizer p_getSmoothColorMultiplier_2_, BlockPosM p_getSmoothColorMultiplier_3_) {
        ...
        int j2 = 0;
        int k2 = 0;
        int l2 = p_getSmoothColorMultiplier_1_.getX();
        ...
        for (int k1 = l2 - 1; k1 <= l2 + 1; ++k1) {
            for (int l1 = j1 - 1; l1 <= j1 + 1; ++l1) {
                ...
                int i22 = p_getSmoothColorMultiplier_2_.getColor(p_getSmoothColorMultiplier_0_, blockposm);
                i2 += i22 >> 16 & 0xFF;
                j2 += i22 >> 8 & 0xFF;
                k2 += i22 & 0xFF;
            }
    ...
    public static int getDurabilityColor(int p_getDurabilityColor_0_) {
        ...
        int i2 = p_getDurabilityColor_0_ * durabilityColors.getLength() / 255;
    ...
    public static void updateWaterFX(EntityFX p_updateWaterFX_0_, IBlockAccess p_updateWaterFX_1_, double p_updateWaterFX_2_, double p_updateWaterFX_4_, double p_updateWaterFX_6_) {
        if (waterColors != null || blockColormaps != null) {
            ...
            int i2 = CustomColors.getFluidColor(p_updateWaterFX_1_, BLOCK_STATE_WATER, blockpos, renderenv);
            int j2 = i2 >> 16 & 0xFF;
            int k2 = i2 >> 8 & 0xFF;
            int l2 = i2 & 0xFF;
            float f2 = (float)j2 / 255.0f;
    ...
    public static Vec3 getUnderwaterColor(IBlockAccess p_getUnderwaterColor_0_, double p_getUnderwaterColor_1_, double p_getUnderwaterColor_3_, double p_getUnderwaterColor_5_) {
        ...
        int i2 = underwaterColors.getColorSmooth(p_getUnderwaterColor_0_, p_getUnderwaterColor_1_, p_getUnderwaterColor_3_, p_getUnderwaterColor_5_, 3);
        int j2 = i2 >> 16 & 0xFF;
        int k2 = i2 >> 8 & 0xFF;
        int l2 = i2 & 0xFF;
        float f2 = (float)j2 / 255.0f;
        float f1 = (float)k2 / 255.0f;
        float f22 = (float)l2 / 255.0f;
        Vec3 vec3 = underwaterColorFader.getColor(f2, f1, f22);
        return vec3;
    }
    ...
    private static int[] readSpawnEggColors(Properties p_readSpawnEggColors_0_, String p_readSpawnEggColors_1_, String p_readSpawnEggColors_2_, String p_readSpawnEggColors_3_) {
        ...
        int i2 = 0;
        for (Object s2 : set) {
            String s1 = p_readSpawnEggColors_0_.getProperty((String)s2);
            if (!((String)s2).startsWith(p_readSpawnEggColors_2_)) continue;
            String s22 = StrUtils.removePrefix((String)s2, p_readSpawnEggColors_2_);
            int j2 = CustomColors.getEntityId(s22);
        ...
        CustomColors.dbg(p_readSpawnEggColors_3_ + " colors: " + i2);
    ...
    private static int getSpawnEggColor(ItemMonsterPlacer p_getSpawnEggColor_0_, ItemStack p_getSpawnEggColor_1_, int p_getSpawnEggColor_2_, int p_getSpawnEggColor_3_) {
        int[] aint;
        int i2 = p_getSpawnEggColor_1_.getMetadata();
    ...
    private static float[][] readDyeColors(Properties p_readDyeColors_0_, String p_readDyeColors_1_, String p_readDyeColors_2_, String p_readDyeColors_3_) {
        ...
        CustomColors.dbg(p_readDyeColors_3_ + " colors: " + k2);
        return afloat1;
    }
    ...
    private static int[] readTextColors(Properties p_readTextColors_0_, String p_readTextColors_1_, String p_readTextColors_2_, String p_readTextColors_3_) {
        ...
        CustomColors.dbg(p_readTextColors_3_ + " colors: " + i2);
        return aint;
    }
    ...
    private static int[] readMapColors(Properties p_readMapColors_0_, String p_readMapColors_1_, String p_readMapColors_2_, String p_readMapColors_3_) {
        ...
        CustomColors.dbg(p_readMapColors_3_ + " colors: " + i2);
        return aint;
    }
    ...
    private static int[] readPotionColors(Properties p_readPotionColors_0_, String p_readPotionColors_1_, String p_readPotionColors_2_, String p_readPotionColors_3_) {
        ...
        CustomColors.dbg(p_readPotionColors_3_ + " colors: " + i2);
        return aint;
    }
    ...
    private static int getEntityId(String p_getEntityId_0_) {
        ...
        int i2 = EntityList.getIDFromString(p_getEntityId_0_);
        if (i2 < 0) {
            return -1;
        }
        String s2 = EntityList.getStringFromID(i2);
        return !Config.equals(p_getEntityId_0_, s2) ? -1 : i2;
    }

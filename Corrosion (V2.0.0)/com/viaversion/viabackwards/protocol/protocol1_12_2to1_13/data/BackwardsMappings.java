            ...
            if (value == -1) {
                ...
                if (replacement != null) {
                    if (replacement.getAsString().startsWith("id:")) {
                        String id2 = replacement.getAsString().replace("id:", "");
                        hardId = Short.parseShort(id2);
                        value = newIdentifierMap.getInt(oldIdentifiers.getAsJsonPrimitive(id2).getAsString());
                    } else {

...
implements BackwardsBlockEntityProvider.BackwardsBlockEntityHandler {
    ...
    private static void register(int id2, String identifier, byte data) {
        FLOWERS.put(id2, new Pair<String, Byte>(identifier, data));
    }

    public static boolean isFlowah(int id2) {
        return id2 >= 5265 && id2 <= 5286;
    }

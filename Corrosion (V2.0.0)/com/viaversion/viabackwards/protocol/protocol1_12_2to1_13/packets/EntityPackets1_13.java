            ...
            public void registerMap() {
                this.handler(new PacketHandler(){
                    ...
                    public void handle(PacketWrapper wrapper) throws Exception {
                        ...
                        double x2 = wrapper.read(Type.DOUBLE);
                        double y2 = wrapper.read(Type.DOUBLE);
                        double z2 = wrapper.read(Type.DOUBLE);
                        ...
                        positionAndLook.write(Type.DOUBLE, 0.0);
                        positionAndLook.write(Type.DOUBLE, 0.0);
                        EntityPositionHandler.writeFacingDegrees(positionAndLook, positionStorage.getX(), anchor == 1 ? positionStorage.getY() + 1.62 : positionStorage.getY(), positionStorage.getZ(), x2, y2, z2);

...
public class ShadersRender {
    public static void setFrustrumPosition(Frustum frustrum, double x2, double y2, double z2) {
    ...
    public static void renderHand0(EntityRenderer er2, float par1, int par2) {
        ...
        if (!Shaders.isShadowPass && !(flag = Shaders.isItemToRenderMainTranslucent())) {
            ...
            er2.renderHand(par1, par2, true, false, false);
            Shaders.endHand();
    ...
    public static void renderHand1(EntityRenderer er2, float par1, int par2) {
        if (!Shaders.isShadowPass && !Shaders.isHandRenderedMain()) {
            ...
            Shaders.beginHand();
            GL11.glColor4f(1.0f, 1.0f, 1.0f, 1.0f);
            er2.renderHand(par1, par2, true, false, true);
            Shaders.endHand();
            Shaders.setHandRenderedMain(true);
        }
    }
    ...
    public static void renderFPOverlay(EntityRenderer er2, float par1, int par2) {
        if (!Shaders.isShadowPass) {
            ...
            er2.renderHand(par1, par2, false, true, false);
    ...
    public static void renderShadowMap(EntityRenderer entityRenderer, int pass, float partialTicks, long finishTimeNano) {
        if (Shaders.usedShadowDepthBuffers > 0 && --Shaders.shadowPassCounter <= 0) {
            ...
            renderglobal.setupTerrain(entity, partialTicks, frustum, i2, minecraft.thePlayer.isSpectator());

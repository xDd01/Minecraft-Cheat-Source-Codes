...
public class S38PacketPlayerListItem implements Packet<INetHandlerPlayClient>
{
    ...
    public S38PacketPlayerListItem(S38PacketPlayerListItem.Action actionIn, EntityPlayerMP... players)
    {
        ...
        {
            this.players.add(new S38PacketPlayerListItem.AddPlayerData(entityplayermp.getGameProfile(), entityplayermp.ping, entityplayermp.theItemInWorldManager.getGameType(), entityplayermp.getTabListDisplayName(), entityplayermp));
        }
    }
    ...
    public void readPacketData(PacketBuffer buf) throws IOException
    {
        ...
        for (int j = 0; j < i; ++j)
        {
            ...
            this.players.add(new S38PacketPlayerListItem.AddPlayerData(gameprofile, k, worldsettings$gametype, ichatcomponent, null));
        }
    }
    ...
    public class AddPlayerData
    {
        ...
        public AddPlayerData(GameProfile profile, int pingIn, WorldSettings.GameType gamemodeIn, IChatComponent displayNameIn, EntityPlayerMP playerMP)
        {

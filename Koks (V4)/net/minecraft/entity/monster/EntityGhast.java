...
public class EntityGhast extends EntityFlying implements IMob
{
    ...
    static class AILookAround extends EntityAIBase
    {
        ...
        public void updateTask()
        {
            ...
            {
                this.parentEntity.renderYawOffset = this.parentEntity.rotationYawHead = -((float)MathHelper.func_181159_b(this.parentEntity.motionX, this.parentEntity.motionZ)) * 180.0F / (float)Math.PI;
            }
            else
            {
                EntityLivingBase entitylivingbase = this.parentEntity.getAttackTarget();
                ...
                if (entitylivingbase.getDistanceSqToEntity(this.parentEntity) < d0 * d0)
                {
                    ...
                    this.parentEntity.renderYawOffset = this.parentEntity.rotationYawHead = -((float)MathHelper.func_181159_b(d1, d2)) * 180.0F / (float)Math.PI;
                }
            }
        }
    }

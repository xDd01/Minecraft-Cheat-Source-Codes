...
public class EntityAIControlledByPlayer extends EntityAIBase
{
    ...
    public void updateTask()
    {
        ...
        float f = MathHelper.wrapAngleTo180_float(entityplayer.rotationYawHead - this.thisEntity.rotationYawHead) * 0.5F;
        ...
        this.thisEntity.rotationYawHead = MathHelper.wrapAngleTo180_float(this.thisEntity.rotationYawHead + f);
        ...
        {
            ItemStack itemstack = entityplayer.getFakeItem();

...
import koks.event.InventorySwitchSyncEvent;
...
public class InventoryPlayer implements IInventory {
    ...
    public ItemStack getFakeItem() {
        return this.fakeItem < 9 && this.fakeItem >= 0 ? this.mainInventory[this.fakeItem] : null;
    }
    ...
    public void changeCurrentItem(int p_70453_1_) {
        ...
        if (!new InventorySwitchSyncEvent().onFire().isCanceled())
            for (this.fakeItem -= p_70453_1_; this.fakeItem < 0; this.fakeItem += 9) {
                ;
            }
    ...
    public void decrementAnimations() {
        for (int i = 0; i < this.mainInventory.length; ++i) {
            if (this.mainInventory[i] != null) {
                this.mainInventory[i].updateAnimation(this.player.worldObj, this.player, i, this.fakeItem == i);
            }
        }
    }

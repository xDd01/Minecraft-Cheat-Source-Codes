...
import koks.event.EfficiencyEvent;
import koks.event.KnockbackModifierEvent;
import koks.event.NoClipEvent;
import koks.module.movement.NoHitSlow;
...
public abstract class EntityPlayer extends EntityLivingBase {
    ...
    /**
     * The food object of the player, the generaul hunger logic.
     */
    ...
    public void onUpdate() {
        ...
        this.noClip = noClipEvent.isNoClip();
        ...
        if (this.itemInUse != null) {
            ItemStack itemstack = Minecraft.getMinecraft().developerMode ? this.inventory.getCurrentItem() : getFakeItem();
    ...
    public void onItemUseFinish() {
        if (this.itemInUse != null) {
            ...
            if (itemstack != this.itemInUse || itemstack != null && itemstack.stackSize != i) {
                this.inventory.mainInventory[this.inventory.fakeItem] = itemstack;

                if (itemstack.stackSize == 0) {
                    this.inventory.mainInventory[this.inventory.fakeItem] = null;
                }
            }
    ...
    public EntityItem dropOneItem(boolean dropAll) {
        return this.dropItem(this.inventory.decrStackSize(this.inventory.fakeItem, dropAll && (Minecraft.getMinecraft().developerMode ? this.inventory.getCurrentItem() != null : getFakeItem() != null) ? (Minecraft.getMinecraft().developerMode ? this.inventory.getCurrentItem().stackSize : this.getFakeItem().stackSize) : 1), false, true);
    }
    ...
    public float getToolDigEfficiency(Block p_180471_1_) {
        ...
        final EfficiencyEvent efficiencyEvent = new EfficiencyEvent(f).onFire();
        f = efficiencyEvent.getEfficiency();

        if (f > 1.0F) {
            int i = EnchantmentHelper.getEfficiencyModifier(this);
            ItemStack itemstack = Minecraft.getMinecraft().developerMode ? this.inventory.getCurrentItem() : this.getFakeItem();
    ...
    public void writeEntityToNBT(NBTTagCompound tagCompound) {
        ...
        tagCompound.setInteger("SelectedItemSlot", this.inventory.fakeItem);
        ...
        ItemStack itemstack = this.inventory.getFakeItem();
    ...
    public boolean interactWith(Entity p_70998_1_) {
        if (this.isSpectator()) {
            ...
            ItemStack itemstack = Minecraft.getMinecraft().developerMode ? this.getCurrentEquippedItem() : getFakeItem();
    ...
    public void destroyCurrentEquippedItem() {
        this.inventory.setInventorySlotContents(this.inventory.fakeItem, (ItemStack) null);
    }
        ...
        if (targetEntity.canAttackWithItem()) {
            if (!targetEntity.hitByEntity(this)) {
                ...
                if (f > 0.0F || f1 > 0.0F) {
                    ...
                    final NoHitSlow noHitSlow = ModuleRegistry.getModule(NoHitSlow.class);
                    if (flag2) {
                        ...
                        if (knockbackModifierEvent.isFlag()) {
                            ...
                            if (Minecraft.getMinecraft().developerMode || !noHitSlow.isToggled()) {
                                this.motionX *= 0.6D;
                                this.motionZ *= 0.6D;
                                this.setSprinting(false);
                            } else {
                                if (noHitSlow.isToggled()) {
                                    final double motion = ValueManager.getInstance().getValue("Slowness", noHitSlow).castDouble();
                                    final boolean sprinting = ValueManager.getInstance().getValue("Sprinting", noHitSlow).castBoolean();
                                    this.motionX *= motion;
                                    this.motionZ *= motion;
                        ...
                        final AttackEffectEvent attackEffectEvent = new AttackEffectEvent().onFire();
                        if (!attackEffectEvent.isCanceled()) {
                            if (flag) {
                        ...
                        ItemStack itemstack = Minecraft.getMinecraft().developerMode ? this.getCurrentEquippedItem() : this.getFakeItem();
    ...
    public ItemStack getEquipmentInSlot(int slotIn) {
        return slotIn == 0 ? this.inventory.getFakeItem() : this.inventory.armorInventory[slotIn - 1];
    }
    ...
    public ItemStack getFakeItem() {
        return this.inventory.getFakeItem();
    }

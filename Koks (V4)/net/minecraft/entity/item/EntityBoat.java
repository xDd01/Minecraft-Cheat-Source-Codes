...
import koks.event.BoatMotionEvent;
...
public class EntityBoat extends Entity
{
    ...
    public void onUpdate()
    {
        ...
        else
        {
            ...
            final BoatMotionEvent boatMotionEvent = new BoatMotionEvent(this.motionX, this.motionY, this.motionZ).onFire();
            this.moveEntity(boatMotionEvent.getMotionX(), boatMotionEvent.getMotionY(), boatMotionEvent.getMotionZ());

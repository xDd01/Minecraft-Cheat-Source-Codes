...
import koks.module.world.AlwaysPlace;
...
public abstract class World implements IBlockAccess
{
    ...
    public boolean canBlockBePlaced(Block blockIn, BlockPos pos, boolean p_175716_3_, EnumFacing side, Entity entityIn, ItemStack itemStackIn)
    {
        ...
        final CanBlockPlaceEvent canBlockPlaceEvent = new CanBlockPlaceEvent(axisalignedbb != null && !this.checkNoEntityCollision(axisalignedbb, entityIn) ? false : (block.getMaterial() == Material.circuits && blockIn == Blocks.anvil ? true : block.getMaterial().isReplaceable() && blockIn.canReplace(this, pos, side, itemStackIn))).onFire();
        return canBlockPlaceEvent.isAllowedToPlace();
    }

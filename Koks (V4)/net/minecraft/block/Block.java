...
import koks.event.HardnessEvent;
...
public class Block
{
    ...
    public float getPlayerRelativeBlockHardness(EntityPlayer playerIn, World worldIn, BlockPos pos)
    {
        ...
        final HardnessEvent hardnessEvent = new HardnessEvent(f < 0.0F ? 0.0F : (!playerIn.canHarvestBlock(this) ? playerIn.getToolDigEfficiency(this) / f / 100.0F : playerIn.getToolDigEfficiency(this) / f / 30.0F), this, pos).onFire();
        return hardnessEvent.getHardness();
    }

...
import koks.module.visual.Chams;
import koks.module.visual.NameTags;
...
public abstract class RendererLivingEntity<T extends EntityLivingBase> extends Render<T> {
    ...
    protected void renderModel(T entitylivingbaseIn, float p_77036_2_, float p_77036_3_, float p_77036_4_, float p_77036_5_, float p_77036_6_, float p_77036_7_) {
        ...
        if (flag || flag1) {
            ...
            final Chams chams = ModuleRegistry.getModule(Chams.class);
            final Color defaultColor = new Color(ValueManager.getInstance().getValue("Default Color", chams).castInteger());
            final Color throughWallsColor = new Color(ValueManager.getInstance().getValue("ThroughWalls Color", chams).castInteger());
            if (chams.isToggled() && !entitylivingbaseIn.isInvisible()) {
                GL11.glPushMatrix();
                ...
                GL11.glColor4d(throughWallsColor.getRed() / 255D, throughWallsColor.getGreen() / 255D, throughWallsColor.getBlue() / 255D, 1);
                GL11.glPolygonMode(GL11.GL_FRONT_AND_BACK, GL11.GL_FILL);
                this.mainModel.render(entitylivingbaseIn, p_77036_2_, p_77036_3_, p_77036_4_, p_77036_5_, p_77036_6_, p_77036_7_);
                GL11.glEnable(GL11.GL_DEPTH_TEST);
                GL11.glDisable(GL11.GL_POLYGON_OFFSET_FILL);
                GL11.glColor4d(defaultColor.getRed() / 255D, defaultColor.getGreen() / 255D, defaultColor.getBlue() / 255D, 1);
                this.mainModel.render(entitylivingbaseIn, p_77036_2_, p_77036_3_, p_77036_4_, p_77036_5_, p_77036_6_, p_77036_7_);
    ...
    protected boolean canRenderName(T entity) {
        ...
        if (entity instanceof EntityPlayer) {
            if (!Minecraft.getMinecraft().developerMode && ModuleRegistry.getModule(NameTags.class).isToggled())
                return false;

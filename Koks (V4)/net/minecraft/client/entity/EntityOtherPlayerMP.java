...
public class EntityOtherPlayerMP extends AbstractClientPlayer
{
    ...
    public void onUpdate()
    {
        ...
        if (!this.isItemInUse && this.isEating() && this.inventory.mainInventory[this.inventory.fakeItem] != null)
        {
            ItemStack itemstack = this.inventory.mainInventory[this.inventory.fakeItem];
            this.setItemInUse(this.inventory.mainInventory[this.inventory.fakeItem], itemstack.getItem().getMaxItemUseDuration(itemstack));
    ...
    public void setCurrentItemOrArmor(int slotIn, ItemStack stack)
    {
        if (slotIn == 0)
        {
            this.inventory.mainInventory[this.inventory.fakeItem] = stack;
        }
        else
        {

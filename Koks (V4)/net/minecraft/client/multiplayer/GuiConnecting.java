...
public class GuiConnecting extends GuiScreen
{
    ...
    {
        this.serverData = new ServerData(hostName, port + "", false);
        this.mc = mcIn;
        ...
        (new Thread("Server Connector #" + CONNECTION_ID.incrementAndGet())
        {
            public void run()
            {
                ...
                catch (UnknownHostException unknownhostexception)
                {
                    ...
                    GuiConnecting.this.mc.displayGuiScreen(new GuiDisconnected(GuiConnecting.this.previousGuiScreen, "connect.failed", new ChatComponentTranslation("disconnect.genericReason", new Object[] {"Unknown host"}), serverData));
                }
                catch (Exception exception)
                {
                    ...
                    GuiConnecting.this.mc.displayGuiScreen(new GuiDisconnected(GuiConnecting.this.previousGuiScreen, "connect.failed", new ChatComponentTranslation("disconnect.genericReason", new Object[] {s}), serverData));
                }
            }
        }).start();
    }

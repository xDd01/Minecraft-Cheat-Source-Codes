...
public class GuiMultiplayer extends GuiScreen implements GuiYesNoCallback {
    ...
    public void connectToSelected() {
        ...
        if(!Minecraft.getMinecraft().developerMode) {
            ...
            if (ircClient != null) {
                try {
                    if (guilistextended$iguilistentry != null && ((ServerListEntryNormal) guilistextended$iguilistentry).getServerData() != null)
                        ircClient.setMcServerIp(((ServerListEntryNormal) guilistextended$iguilistentry).getServerData().serverIP);
                    else
                        ircClient.setMcServerIp("Offline");

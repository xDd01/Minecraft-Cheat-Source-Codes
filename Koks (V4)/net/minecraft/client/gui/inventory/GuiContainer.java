...
public abstract class GuiContainer extends GuiScreen
{
    ...
    {
        super.initGui();
        buttonList.add(new GuiButton(1337, 5, 5, 80, 20, "Disconnect"));
    ...
    protected void mouseClicked(int mouseX, int mouseY, int mouseButton) throws IOException
    {
        ...
        if (mouseButton == 0 || mouseButton == 1 || flag)
        {
            ...
            if (l != -1)
            {
                ...
                {
                    if (this.mc.thePlayer != null && this.mc.thePlayer.inventory != null && this.mc.thePlayer.inventory.getItemStack() == null)
                    {
    ...
    {
        return !mc.inGameHasFocus && this.isPointInRegion(slotIn.xDisplayPosition, slotIn.yDisplayPosition, 16, 16, mouseX, mouseY);
    }

...
public class GuiIngame extends Gui {
    ...
    public void renderGameOverlay(float partialTicks) {
        ...
        if (!this.mc.thePlayer.isPotionActive(Potion.confusion)) {
            ...
            if (f > 0.0F) {
                this.func_180474_b(f, resolution);
            }
        }
        ...
        if (this.mc.thePlayer.isRidingHorse()) {
            this.renderHorseJumpBar(resolution, k1);
        } else if (this.mc.playerController.gameIsSurvivalOrAdventure()) {
            this.renderExpBar(resolution, k1);
        }

        if (this.mc.gameSettings.heldItemTooltips && !this.mc.playerController.isSpectator()) {
            this.func_181551_a(resolution);
        } else if (this.mc.thePlayer.isSpectator()) {
            this.spectatorGui.func_175263_a(resolution);
        }

        if (this.mc.isDemo()) {
            this.renderDemo(resolution);
        }
        ...
        if (scoreobjective1 != null) {
            if (Minecraft.getMinecraft().developerMode || ModuleRegistry.getModule(koks.module.visual.Scoreboard.class).isToggled())
    ...
    protected void renderTooltip(Resolution sr, float partialTicks) {
    ...
    public void renderHorseJumpBar(Resolution p_175186_1_, int p_175186_2_) {
        this.mc.mcProfiler.startSection("jumpBar");
        this.mc.getTextureManager().bindTexture(Gui.icons);
        float f = this.mc.thePlayer.getHorseJumpPower();
        int i = 182;
        int j = (int) (f * (float) (i + 1));
        int k = p_175186_1_.getHeight() - 32 + 3;
    ...
    public void renderExpBar(Resolution p_175176_1_, int p_175176_2_) {
        ...
        if (i > 0) {
            ...
            int l = p_175176_1_.getHeight() - 32 + 3;
        ...
        if (this.mc.thePlayer.experienceLevel > 0) {
            ...
            int l1 = (p_175176_1_.getWidth() - this.getFontRenderer().getStringWidth(s)) / 2;
            int i1 = p_175176_1_.getHeight() - 31 - 4;
            int j1 = 0;
    ...
    public void func_181551_a(Resolution p_181551_1_) {
        ...
        if (this.remainingHighlightTicks > 0 && this.highlightingItemStack != null) {
            ...
            int i = (p_181551_1_.getWidth() - this.getFontRenderer().getStringWidth(s)) / 2;
            int j = p_181551_1_.getHeight() - 59;
    ...
    public void renderDemo(Resolution p_175185_1_) {
        ...
        this.getFontRenderer().drawStringWithShadow(s, (float) (p_175185_1_.getWidth() - i - 10), 5.0F, 16777215);
        this.mc.mcProfiler.endSection();
    }
    ...
    public void renderStreamIndicator(Resolution p_180478_1_) {
        this.streamIndicator.render(p_180478_1_.getWidth() - 10, 10);
    }

    private void renderScoreboard(ScoreObjective p_180475_1_, Resolution p_180475_2_) {
        ...
        int j1 = p_180475_2_.getHeight() / 2 + i1 / 3;

        int modHeight = 0;

        if(!mc.developerMode) {
            final HUD hud = ModuleRegistry.getModule(HUD.class);
            if(hud.isToggled()) {
                final ArrayList<Module> toggled = new ArrayList<>();
                boolean showVisuals = ValueManager.getInstance().getValue("Show Visuals", hud).castBoolean();
                ModuleRegistry.getModules().forEach(module -> {
                    if (module.isToggled() && module.getCategory() != Module.Category.GUI && (showVisuals || module.getCategory() != Module.Category.VISUAL))
                        toggled.add(module);
                });

                toggled.sort(Comparator.comparingDouble(module -> -Fonts.arial18.getStringWidth(module.getName())));

                for(Module module : toggled) {
                    modHeight += Fonts.arial18.getStringHeight(module.getName()) + 2;
                }
                j1 = j1 - p_180475_2_.getHeight() / 2 + i1 + modHeight;
            }
        }

        int k1 = 3;
        int l1 = p_180475_2_.getWidth() - i - k1;
        int j = 0;
        ...
        for (Score score1 : collection) {
            ...
            int l = p_180475_2_.getWidth() - k1 + 2;

            //www.hypixel.net -> www.hypixel.ne  t
            drawRect(l1 - 2, k, l, k + this.getFontRenderer().FONT_HEIGHT, 1342177280);
            this.getFontRenderer().drawString(s1, l1, k, 553648127);
            final koks.module.visual.Scoreboard scoreboardModule = ModuleRegistry.getModule(koks.module.visual.Scoreboard.class);
            if (Minecraft.getMinecraft().developerMode || (ValueManager.getInstance().getValue("Numbers", scoreboardModule) == null || ValueManager.getInstance().getValue("Numbers", scoreboardModule).castBoolean()))
    ...
    private void renderPlayerStats(Resolution p_180477_1_) {
        if (this.mc.getRenderViewEntity() instanceof EntityPlayer) {
            EntityPlayer entityplayer = (EntityPlayer) this.mc.getRenderViewEntity();
            ...
            int i1 = p_180477_1_.getWidth() / 2 - 91;
            int j1 = p_180477_1_.getWidth() / 2 + 91;
            int k1 = p_180477_1_.getHeight() - 39;
    ...
    private void renderBossHealth() {
        if (BossStatus.bossName != null && BossStatus.statusBarTime > 0) {
            ...
            Resolution resolution = new Resolution(this.mc);
            int i = resolution.getWidth();
            int j = 182;
            int k = i / 2 - j / 2;
    ...
    private void renderPumpkinOverlay(Resolution p_180476_1_) {
        final Resolution resolution = Resolution.getResolution();
        GlStateManager.disableDepth();
        ...
        worldrenderer.pos(0.0D, (double) resolution.getHeight(), -90.0D).func_181673_a(0.0D, 1.0D).endVertex();
        worldrenderer.pos((double) resolution.getWidth(), (double) resolution.getHeight(), -90.0D).func_181673_a(1.0D, 1.0D).endVertex();
        worldrenderer.pos((double) resolution.getWidth(), 0.0D, -90.0D).func_181673_a(1.0D, 0.0D).endVertex();
     ...
     */
    private void renderVignette(float p_180480_1_, Resolution p_180480_2_) {
        if (!Config.isVignetteEnabled()) {
            GlStateManager.enableDepth();
            GlStateManager.tryBlendFuncSeparate(770, 771, 1, 0);
        } else {
            ...
            WorldRenderer worldrenderer = tessellator.getWorldRenderer();
            worldrenderer.begin(7, DefaultVertexFormats.field_181707_g);
            worldrenderer.pos(0.0D, (double) p_180480_2_.getHeight(), -90.0D).func_181673_a(0.0D, 1.0D).endVertex();
            worldrenderer.pos((double) p_180480_2_.getWidth(), (double) p_180480_2_.getHeight(), -90.0D).func_181673_a(1.0D, 1.0D).endVertex();
            worldrenderer.pos((double) p_180480_2_.getWidth(), 0.0D, -90.0D).func_181673_a(1.0D, 0.0D).endVertex();
            worldrenderer.pos(0.0D, 0.0D, -90.0D).func_181673_a(0.0D, 0.0D).endVertex();
            tessellator.draw();
            GlStateManager.depthMask(true);
            GlStateManager.enableDepth();
    ...
    private void func_180474_b(float p_180474_1_, Resolution p_180474_2_) {
        if (p_180474_1_ < 1.0F) {
        ...
        WorldRenderer worldrenderer = tessellator.getWorldRenderer();
        worldrenderer.begin(7, DefaultVertexFormats.field_181707_g);
        worldrenderer.pos(0.0D, (double) p_180474_2_.getHeight(), -90.0D).func_181673_a((double) f, (double) f3).endVertex();
        worldrenderer.pos((double) p_180474_2_.getWidth(), (double) p_180474_2_.getHeight(), -90.0D).func_181673_a((double) f2, (double) f3).endVertex();
        worldrenderer.pos((double) p_180474_2_.getWidth(), 0.0D, -90.0D).func_181673_a((double) f2, (double) f1).endVertex();

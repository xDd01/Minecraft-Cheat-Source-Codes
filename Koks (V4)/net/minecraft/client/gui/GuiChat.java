...
public class GuiChat extends GuiScreen {
    ...
    public void initGui() {
        ...
        this.inputField.setMaxStringLength(Minecraft.getMinecraft().developerMode ? 100 : Integer.MAX_VALUE);
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        if (Minecraft.getMinecraft().developerMode)
            ...
            renderUtil.drawOutlineRect(2, this.height - 14, Math.min(fontRendererObj.getStringWidth(fontRendererObj.trimStringToWidth((inputField.getText() + " _").substring(inputField.lineScrollOffset), inputField.getWidth())) + 2, this.width - 2), this.height - 2, 1, new Color(25, 25, 25).getRGB(), new Color(33, 33, 33).getRGB());
        }
        this.inputField.drawTextBox();

        if (!Minecraft.getMinecraft().developerMode) {
            final int maxLength = 100;
            final String inputText = (inputField.getText().length() > maxLength ? "§c" : "§a") + inputField.getText().length() + "/" + maxLength;
            Fonts.arial18.drawString(inputText, 4, inputField.yPosition - Fonts.arial18.getStringHeight(inputText) - 2, Color.white, true);
        }

...
public class GuiEnchantment extends GuiContainer
{
    ...
    protected void drawGuiContainerBackgroundLayer(float partialTicks, int mouseX, int mouseY)
    {
        ...
        GlStateManager.viewport((resolution.getWidth() - 320) / 2 * resolution.getScale(), (resolution.getHeight() - 240) / 2 * resolution.getScale(), 320 * resolution.getScale(), 240 * resolution.getScale());

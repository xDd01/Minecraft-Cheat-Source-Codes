...
public class Gui
{
    ...
    public static void drawGradientRect(int left, int top, int right, int bottom, int startColor, int endColor)
    {
        ...
        worldrenderer.pos((double)right, (double)top, (double)zLevel).func_181666_a(f1, f2, f3, f).endVertex();
        worldrenderer.pos((double)left, (double)top, (double)zLevel).func_181666_a(f1, f2, f3, f).endVertex();
        worldrenderer.pos((double)left, (double)bottom, (double)zLevel).func_181666_a(f5, f6, f7, f4).endVertex();
        worldrenderer.pos((double)right, (double)bottom, (double)zLevel).func_181666_a(f5, f6, f7, f4).endVertex();
        tessellator.draw();

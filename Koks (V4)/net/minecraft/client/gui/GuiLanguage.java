...
public class GuiLanguage extends GuiScreen {
    ...
    public void initGui() {
        ...
        lastLanguage = this.languageManager.getCurrentLanguage();
    }
    ...
    protected void actionPerformed(GuiButton button) throws IOException {
        if (button.enabled) {
            switch (button.id) {
                ...
                case 6:
                    if (!Minecraft.getMinecraft().developerMode && list.changed && !lastLanguage.equals(languageManager.getCurrentLanguage())) {
    ...
    class List extends GuiSlot {
        public final java.util.List<String> langCodeList = Lists.<String>newArrayList();
        public final Map<String, Language> languageMap = Maps.<String, Language>newHashMap();
        ...
        protected void elementClicked(int slotIndex, boolean isDoubleClick, int mouseX, int mouseY) {
            ...
            changed = !GuiLanguage.this.languageManager.getCurrentLanguage().equals(language);

...
public class GuiDetailSettingsOF extends GuiScreen
{
    ...
    public GuiDetailSettingsOF(final GuiScreen p_i35_1_, final GameSettings p_i35_2_) {
    ...
    public void initGui() {
        int i = 0;
        for (final GameSettings.Options gamesettings$options : GuiDetailSettingsOF.enumOptions) {

...
public class CustomSkyLayer
{
    ...
    public CustomSkyLayer(final Properties p_i31_1_, final String p_i31_2_) {
        this.source = null;
        this.startFadeIn = -1;
        this.endFadeIn = -1;
        this.startFadeOut = -1;
        ...
        this.axis = this.parseAxis(p_i31_1_.getProperty("axis"), CustomSkyLayer.DEFAULT_AXIS);
    }
    ...
    public boolean isValid(final String p_isValid_1_) {
        ...
        if (i2 != 24000) {
            Config.warn("Invalid fadeIn/fadeOut times, sum is more than 24h: " + i2);
            return false;
        }
        if (this.speed < 0.0f) {
    ...
    public boolean isActive(final int p_isActive_1_) {

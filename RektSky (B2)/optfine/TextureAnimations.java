...
public class TextureAnimations
{
    ...
    public static TextureAnimation[] getTextureAnimations(final IResourcePack p_getTextureAnimations_0_) {
        ...
        final AbstractResourcePack abstractresourcepack = (AbstractResourcePack)p_getTextureAnimations_0_;
    ...
    public static String[] getAnimationPropertiesDir(final File p_getAnimationPropertiesDir_0_) {
        final File file1 = new File(p_getAnimationPropertiesDir_0_, "anim");
        if (!file1.exists()) {
            return null;
        }
        ...
        for (int i = 0; i < afile.length; ++i) {
            final File file2 = afile[i];
            final String s = file2.getName();
    ...
    public static String[] getAnimationPropertiesZip(final File p_getAnimationPropertiesZip_0_) {
        try {
            final ZipFile zipfile = new ZipFile(p_getAnimationPropertiesZip_0_);

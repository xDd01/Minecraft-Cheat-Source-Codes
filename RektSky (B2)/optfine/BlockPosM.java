...
public class BlockPosM extends BlockPos
{
    ...
    public BlockPosM(final int p_i20_1_, final int p_i20_2_, final int p_i20_3_) {
        this(p_i20_1_, p_i20_2_, p_i20_3_, 0);
    }
    
    public BlockPosM(final double p_i21_1_, final double p_i21_3_, final double p_i21_5_) {
        this(MathHelper.floor_double(p_i21_1_), MathHelper.floor_double(p_i21_3_), MathHelper.floor_double(p_i21_5_));
    }
    
    public BlockPosM(final int p_i22_1_, final int p_i22_2_, final int p_i22_3_, final int p_i22_4_) {
        super(0, 0, 0);
        this.mx = p_i22_1_;
        this.my = p_i22_2_;
        this.mz = p_i22_3_;

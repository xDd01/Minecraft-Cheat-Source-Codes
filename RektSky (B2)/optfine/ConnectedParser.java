...
public class ConnectedParser
{
    ...
    public ConnectedParser(final String p_i28_1_) {
        this.context = null;
    ...
    public MatchBlock[] parseMatchBlock(String p_parseMatchBlock_1_) {
        ...
        for (int j = 0; j < ablock.length; ++j) {
            ...
            final int[] aint = this.parseBlockMetadatas(block, astring2);
    ...
    public int[] parseBlockMetadatas(final Block p_parseBlockMetadatas_1_, final String[] p_parseBlockMetadatas_2_) {
        ...
        for (int k = 0; k < 16; ++k) {
            final IBlockState iblockstate2 = p_parseBlockMetadatas_1_.getStateFromMeta(k);
    ...
    public boolean matchState(final IBlockState p_matchState_1_, final Map p_matchState_2_) {
        for (final Object entry : p_matchState_2_.entrySet()) {
            final IProperty iproperty = ((Map.Entry)entry).getKey();
            final List list = ((Map.Entry)entry).getValue();

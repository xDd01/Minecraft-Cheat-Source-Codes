...
public class ConnectedTextures
{
    ...
    private static void fixVertex(final int[] p_fixVertex_0_, final int p_fixVertex_1_, final TextureAtlasSprite p_fixVertex_2_, final TextureAtlasSprite p_fixVertex_3_) {
        final int i = 7 * p_fixVertex_1_;
        final float f = Float.intBitsToFloat(p_fixVertex_0_[i + 4]);
        final float f2 = Float.intBitsToFloat(p_fixVertex_0_[i + 4 + 1]);
        ...
        p_fixVertex_0_[i + 4 + 1] = Float.floatToRawIntBits(p_fixVertex_3_.getInterpolatedV(d2));
    }
    ...
    public static TextureAtlasSprite getConnectedTextureSingle(final IBlockAccess p_getConnectedTextureSingle_0_, final IBlockState p_getConnectedTextureSingle_1_, final BlockPos p_getConnectedTextureSingle_2_, final EnumFacing p_getConnectedTextureSingle_3_, final TextureAtlasSprite p_getConnectedTextureSingle_4_, final boolean p_getConnectedTextureSingle_5_, final RenderEnv p_getConnectedTextureSingle_6_) {
        ...
        if (ConnectedTextures.tileProperties != null) {
            ...
            if (i >= 0 && i < ConnectedTextures.tileProperties.length) {
                ...
                if (aconnectedproperties != null) {
                    final int j = p_getConnectedTextureSingle_6_.getMetadata();
                    final int k = getSide(p_getConnectedTextureSingle_3_);
                    for (int l = 0; l < aconnectedproperties.length; ++l) {
                        final ConnectedProperties connectedproperties = aconnectedproperties[l];
                        if (connectedproperties != null) {
                            final int i2 = p_getConnectedTextureSingle_6_.getBlockId();
                            if (connectedproperties.matchesBlock(i2)) {
                                final TextureAtlasSprite textureatlassprite = getConnectedTexture(connectedproperties, p_getConnectedTextureSingle_0_, p_getConnectedTextureSingle_1_, p_getConnectedTextureSingle_2_, k, p_getConnectedTextureSingle_4_, j, p_getConnectedTextureSingle_6_);
                                if (textureatlassprite != null) {
                                    return textureatlassprite;
                                }
                            }
        ...
        if (ConnectedTextures.blockProperties != null && p_getConnectedTextureSingle_5_) {
            final int j2 = p_getConnectedTextureSingle_6_.getBlockId();
            if (j2 >= 0 && j2 < ConnectedTextures.blockProperties.length) {
                final ConnectedProperties[] aconnectedproperties2 = ConnectedTextures.blockProperties[j2];
                if (aconnectedproperties2 != null) {
                    final int k2 = p_getConnectedTextureSingle_6_.getMetadata();
                    final int l2 = getSide(p_getConnectedTextureSingle_3_);
                    for (int i3 = 0; i3 < aconnectedproperties2.length; ++i3) {
                        final ConnectedProperties connectedproperties2 = aconnectedproperties2[i3];
                        if (connectedproperties2 != null && connectedproperties2.matchesIcon(p_getConnectedTextureSingle_4_)) {
                            final TextureAtlasSprite textureatlassprite2 = getConnectedTexture(connectedproperties2, p_getConnectedTextureSingle_0_, p_getConnectedTextureSingle_1_, p_getConnectedTextureSingle_2_, l2, p_getConnectedTextureSingle_4_, k2, p_getConnectedTextureSingle_6_);
    ...
    private static TextureAtlasSprite getConnectedTexture(final ConnectedProperties p_getConnectedTexture_0_, final IBlockAccess p_getConnectedTexture_1_, final IBlockState p_getConnectedTexture_2_, final BlockPos p_getConnectedTexture_3_, final int p_getConnectedTexture_4_, final TextureAtlasSprite p_getConnectedTexture_5_, final int p_getConnectedTexture_6_, final RenderEnv p_getConnectedTexture_7_) {
        final int i = p_getConnectedTexture_3_.getY();
        ...
        if (p_getConnectedTexture_0_.biomes != null) {
            ...
            for (int j = 0; j < p_getConnectedTexture_0_.biomes.length; ++j) {
                final BiomeGenBase biomegenbase2 = p_getConnectedTexture_0_.biomes[j];
        ...
        int l = 0;
        int i2 = p_getConnectedTexture_6_;
        ...
        if (block instanceof BlockRotatedPillar) {
            ...
            i2 = (p_getConnectedTexture_6_ & 0x3);
        }
        ...
        if (p_getConnectedTexture_4_ >= 0 && p_getConnectedTexture_0_.faces != 63) {
            int j2 = p_getConnectedTexture_4_;
            if (l != 0) {
                j2 = fixSideByAxis(p_getConnectedTexture_4_, l);
            }
            if ((1 << j2 & p_getConnectedTexture_0_.faces) == 0x0) {
                return null;
            }
        }
        if (p_getConnectedTexture_0_.metadatas != null) {
            final int[] aint = p_getConnectedTexture_0_.metadatas;
            boolean flag2 = false;
    ...
    private static TextureAtlasSprite getConnectedTextureCtm(final ConnectedProperties p_getConnectedTextureCtm_0_, final IBlockAccess p_getConnectedTextureCtm_1_, final IBlockState p_getConnectedTextureCtm_2_, final BlockPos p_getConnectedTextureCtm_3_, final int p_getConnectedTextureCtm_4_, final TextureAtlasSprite p_getConnectedTextureCtm_5_, final int p_getConnectedTextureCtm_6_, final RenderEnv p_getConnectedTextureCtm_7_) {
        final boolean[] aboolean = p_getConnectedTextureCtm_7_.getBorderFlags();
    ...
    public static void updateIcons(final TextureMap p_updateIcons_0_, final IResourcePack p_updateIcons_1_) {
        final String[] astring = collectFiles(p_updateIcons_1_, "mcpatcher/ctm/", ".properties");
        Arrays.sort(astring);
    ...
    private static void addToBlockList(final ConnectedProperties p_addToBlockList_0_, final List p_addToBlockList_1_) {
        if (p_addToBlockList_0_.matchBlocks != null) {
            for (int i = 0; i < p_addToBlockList_0_.matchBlocks.length; ++i) {
                final int j = p_addToBlockList_0_.matchBlocks[i];
                if (j < 0) {
    ...
    private static String[] collectFiles(final IResourcePack p_collectFiles_0_, final String p_collectFiles_1_, final String p_collectFiles_2_) {
    ...
    private static String[] collectFilesDefault(final IResourcePack p_collectFilesDefault_0_) {
        final List list = new ArrayList();
        final String[] astring = getDefaultCtmPaths();
        for (int i = 0; i < astring.length; ++i) {
            final String s = astring[i];
            final ResourceLocation resourcelocation = new ResourceLocation(s);

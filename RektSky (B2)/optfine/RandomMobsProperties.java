...
public class RandomMobsProperties
{
    ...
    public RandomMobsProperties(final String p_i51_1_, final ResourceLocation[] p_i51_2_) {
        this.name = null;
        this.basePath = null;
    ...
    public RandomMobsProperties(final Properties p_i52_1_, final String p_i52_2_, final ResourceLocation p_i52_3_) {
        this.name = null;
        this.basePath = null;
        this.resourceLocations = null;
        this.rules = null;

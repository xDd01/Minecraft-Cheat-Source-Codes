...
final class LinuxJoystickDevice implements LinuxDevice
{
    ...
    private final Map<Integer, LinuxJoystickPOV> povXs;
    private final Map<Integer, LinuxJoystickPOV> povYs;
    ...
    public LinuxJoystickDevice(final String filename) throws IOException {
        ...
        this.povXs = new HashMap<Integer, LinuxJoystickPOV>();
        this.povYs = new HashMap<Integer, LinuxJoystickPOV>();
                ...
                if (index < this.getNumAxes()) {
                    ...
                    if (axis != null) {
                        ...
                        if (this.povXs.containsKey(index)) {
                            final LinuxJoystickPOV pov = this.povXs.get(index);
                            pov.updateValue();
                            this.event.set(pov, pov.getPollData(), joystick_event.getNanos());
                            break;
                        }
                        if (this.povYs.containsKey(index)) {
                            final LinuxJoystickPOV pov = this.povYs.get(index);
                            pov.updateValue();
                            this.event.set(pov, pov.getPollData(), joystick_event.getNanos());
                            break;
                        }

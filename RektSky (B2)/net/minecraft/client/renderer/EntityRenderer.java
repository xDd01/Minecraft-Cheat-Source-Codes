...
public class EntityRenderer implements IResourceManagerReloadListener
{
            ...
            if (this.mc.objectMouseOver != null && this.mc.objectMouseOver.typeOfHit == MovingObjectPosition.MovingObjectType.BLOCK) {
                ...
                if (this.mc.playerController.getCurrentGameType() == WorldSettings.GameType.SPECTATOR) {
                    ...
                    if (Reflector.ForgeBlock_hasTileEntity.exists()) {
                        final IBlockState iblockstate = this.mc.theWorld.getBlockState(blockpos);
                        flag2 = Reflector.callBoolean(block, Reflector.ForgeBlock_hasTileEntity, iblockstate);
                    }
                    else {
                        flag2 = block.hasTileEntity();
                    }
                    flag = (flag2 && this.mc.theWorld.getTileEntity(blockpos) instanceof IInventory);
                }
                else {
    ...
    private void renderWorldPass(final int pass, final float partialTicks, final long finishTimeNano) {
        ...
        if (!this.debugView) {
            GlStateManager.matrixMode(5888);
            GlStateManager.popMatrix();
            EventManager.callEvent(new RenderEvent());
            GlStateManager.pushMatrix();
            ...
            if (this.mc.objectMouseOver != null && entity.isInsideOfMaterial(Material.water) && flag) {
                ...
                final boolean flag2 = Reflector.ForgeHooksClient_onDrawBlockHighlight.exists();
                if ((!flag2 || !Reflector.callBoolean(Reflector.ForgeHooksClient_onDrawBlockHighlight, renderglobal, entityplayer, this.mc.objectMouseOver, 0, entityplayer.getHeldItem(), partialTicks)) && !this.mc.gameSettings.hideGUI) {
        ...
        if (flag && this.mc.objectMouseOver != null && !entity.isInsideOfMaterial(Material.water)) {
            ...
            GlStateManager.disableAlpha();
            this.mc.mcProfiler.endStartSection("outline");
            final boolean flag3 = Reflector.ForgeHooksClient_onDrawBlockHighlight.exists();
            if ((!flag3 || !Reflector.callBoolean(Reflector.ForgeHooksClient_onDrawBlockHighlight, renderglobal, entityplayer2, this.mc.objectMouseOver, 0, entityplayer2.getHeldItem(), partialTicks)) && !this.mc.gameSettings.hideGUI) {
        ...
        final boolean flag4 = Reflector.callBoolean(Reflector.ForgeHooksClient_renderFirstPersonHand, this.mc.renderGlobal, partialTicks, pass);
        if (!flag4 && this.renderHand) {
            GlStateManager.clear(256);
    ...
    private void updateFogColor(final float partialTicks) {
        ...
        vec4 = CustomColorizer.getWorldFogColor(vec4, worldclient, this.mc.getRenderViewEntity(), partialTicks);
        ...
        if (this.cloudFog) {
            ...
            final Vec3 vec7 = CustomColorizer.getUnderwaterColor(this.mc.theWorld, this.mc.getRenderViewEntity().posX, this.mc.getRenderViewEntity().posY + 1.0, this.mc.getRenderViewEntity().posZ);
            if (vec7 != null) {
    ...
    private void setupFog(final int p_78468_1_, final float partialTicks) {
        ...
        GlStateManager.color(1.0f, 1.0f, 1.0f, 1.0f);
        final Block block = ActiveRenderInfo.getBlockAtEntityViewpoint(this.mc.theWorld, entity, partialTicks);
        final Object object = Reflector.newInstance(Reflector.EntityViewRenderEvent_FogDensity_Constructor, this, entity, block, partialTicks, 0.1f);
        if (Reflector.postForgeBusEvent(object)) {
            final float f1 = Reflector.getFieldValueFloat(object, Reflector.EntityViewRenderEvent_FogDensity_density, 0.0f);
            GL11.glFogf(2914, f1);
        }

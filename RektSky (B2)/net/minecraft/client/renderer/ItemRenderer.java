...
public class ItemRenderer
{
    ...
    public void renderItemInFirstPerson(final float partialTicks) {
        ...
        if (this.itemToRender != null) {
            ...
            else if (this.mc.thePlayer.getHeldItem() != null && killAura != null && killAura.isAttacking && killAura.blockAnimationSetting.getValue() && this.mc.thePlayer.getHeldItem().getItem().getItemUseAction(this.mc.thePlayer.getHeldItem()) == EnumAction.BLOCK) {
                this.transformFirstPersonItem(f, 0.0f);
                this.renderBlockAnimation();
            }
            else {

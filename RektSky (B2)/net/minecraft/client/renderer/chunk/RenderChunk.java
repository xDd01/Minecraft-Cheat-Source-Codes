...
public class RenderChunk
{
    ...
    public void setPosition(final BlockPos pos) {
        ...
        final int i = aenumfacing.length;
    ...
    public void rebuildChunk(final float x, final float y, final float z, final ChunkCompileTaskGenerator generator) {
        ...
        try {
            ...
            regionrendercache = new RegionRenderCache(this.world, blockpos.add(-1, -1, -1), blockpos2.add(1, 1, 1), 1);
        ...
        if (!regionrendercache.extendedLevelsInChunkCache()) {
            ...
            while (iterator.hasNext()) {
                ...
                boolean flag5;
                if (flag2) {
                    flag5 = Reflector.callBoolean(iterator, Reflector.ForgeBlock_hasTileEntity, blockrendererdispatcher);
                }
                else {
                    flag5 = block.hasTileEntity();
                }
                if (flag5) {
                ...
                for (int i = 0; i < aenumworldblocklayer.length; ++i) {
                    ...
                    if (flag3) {
                        final boolean flag6 = Reflector.callBoolean(block, Reflector.ForgeBlock_canRenderInLayer, enumworldblocklayer);
                        if (!flag6) {
                            continue;
                        }
                    }

...
public abstract class RendererLivingEntity<T extends EntityLivingBase> extends Render<T>
{
    ...
    public void doRender(final T entity, final double x, final double y, final double z, final float entityYaw, final float partialTicks) {
        ...
        try {
            ...
            final float f2 = (entity == Minecraft.getMinecraft().thePlayer) ? this.interpolateRotation(RotationUtil.getYaw(), RotationUtil.getYaw(), partialTicks) : this.interpolateRotation(entity.prevRotationYawHead, entity.rotationYawHead, partialTicks);
            float f3 = f2 - f;
            ...
            final float f5 = (entity == Minecraft.getMinecraft().thePlayer) ? RotationUtil.getPitch() : (entity.prevRotationPitch + (entity.rotationPitch - entity.prevRotationPitch) * partialTicks);

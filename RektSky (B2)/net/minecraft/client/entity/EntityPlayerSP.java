...
import tk.rektsky.Module.Player.*;
...
public class EntityPlayerSP extends AbstractClientPlayer
{
    ...
    public void onUpdateWalkingPlayer() {
        ...
        if (this.isCurrentViewEntity()) {
            ...
            if (flag4) {
                this.lastReportedYaw = this.mc.thePlayer.rotationYaw;
                this.lastReportedPitch = this.mc.thePlayer.rotationPitch;
            }
        }
    }
    ...
    public void damageEntity(final DamageSource damageSrc, final float damageAmount) {
    ...
    public void sendMessage(final IChatComponent chatComponent) {
        this.mc.ingameGUI.getChatGUI().printChatMessage(chatComponent);
    }
    ...
    public void onLivingUpdate() {
        ...
        if (this.isUsingItem() && ((FakeNoSlow)ModulesManager.getModuleByClass(FakeNoSlow.class)).doSlowDown() && !this.isRiding()) {
    ...
    public void setSpeed(final float v) {
        final float rotationYaw = this.mc.thePlayer.getRotationYawHead();
        final float var1 = rotationYaw * 0.017453292f;
        this.mc.thePlayer.motionX = -(MathHelper.sin(var1) * v);
        this.mc.thePlayer.motionZ = MathHelper.cos(var1) * v;
    }
}

...
public abstract class EntityLiving extends EntityLivingBase
{
    ...
    private boolean canSkipUpdate() {
        ...
        final double d0 = Math.abs(this.posX - entity.posX) - 16.0;
        final double d2 = Math.abs(this.posZ - entity.posZ) - 16.0;
    ...
    public enum SpawnPlacementType
    {
        ...
        private SpawnPlacementType(final String p_i14_3_, final int p_i14_4_) {
        }

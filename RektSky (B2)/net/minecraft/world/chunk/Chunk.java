                ...
                for (int j = 0; j < 16; ++j) {
                    if (this.updateSkylightColumns[i + j * 16]) {
                        ...
                        for (final Object enumfacing0 : EnumFacing.Plane.HORIZONTAL) {
                            ...
                            j2 = Math.min(j2, this.worldObj.getChunksLowestHorizon(l + enumfacing2.getFrontOffsetX(), i2 + enumfacing2.getFrontOffsetZ()));
                        }
                        this.checkSkylightNeighborHeight(l, i2, j2);
                        for (final Object enumfacing3 : EnumFacing.Plane.HORIZONTAL) {
                            final EnumFacing enumfacing4 = (EnumFacing)enumfacing3;
                            this.checkSkylightNeighborHeight(l + enumfacing4.getFrontOffsetX(), i2 + enumfacing4.getFrontOffsetZ(), k);
                        }
                        if (p_150803_1_) {
    ...
    private void relightBlock(final int x, final int y, final int z) {
        ...
        if (j != i) {
            ...
            if (!this.worldObj.provider.getHasNoSky()) {
                for (final Object enumfacing0 : EnumFacing.Plane.HORIZONTAL) {
                    final EnumFacing enumfacing2 = (EnumFacing)enumfacing0;
                    this.updateSkylightNeighborHeight(k + enumfacing2.getFrontOffsetX(), l + enumfacing2.getFrontOffsetZ(), j3, k3);
                }
        ...
        if (!this.worldObj.provider.getHasNoSky()) {
            ...
            Label_0121:
                ...
                if (this.isLightPopulated) {
                    for (final Object enumfacing0 : EnumFacing.Plane.HORIZONTAL) {
                        final EnumFacing enumfacing2 = (EnumFacing)enumfacing0;
                        final int k = (enumfacing2.getAxisDirection() == EnumFacing.AxisDirection.POSITIVE) ? 16 : 1;
                        this.worldObj.getChunkFromBlockCoords(blockpos.offset(enumfacing2, k)).func_180700_a(enumfacing2.getOpposite());
                    }
                    this.func_177441_y();
                }
            }

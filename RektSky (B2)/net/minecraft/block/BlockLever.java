...
public class BlockLever extends Block
{
    ...
    public IBlockState onBlockPlaced(final World worldIn, final BlockPos pos, final EnumFacing facing, final float hitX, final float hitY, final float hitZ, final int meta, final EntityLivingBase placer) {
        ...
        for (final Object enumfacing0 : EnumFacing.Plane.HORIZONTAL) {
            ...
            if (enumfacing2 != facing && func_181090_a(worldIn, pos, enumfacing2.getOpposite())) {
                return iblockstate.withProperty(BlockLever.FACING, EnumOrientation.forFacings(enumfacing2, placer.getHorizontalFacing()));
            }
        }

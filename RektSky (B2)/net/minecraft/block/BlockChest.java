...
public class BlockChest extends BlockContainer
{
    ...
    public IBlockState correctFacing(final World worldIn, final BlockPos pos, final IBlockState state) {
        ...
        for (final Object enumfacing2 : EnumFacing.Plane.HORIZONTAL) {
            ...
            final IBlockState iblockstate = worldIn.getBlockState(pos.offset(enumfacing3));
            if (iblockstate.getBlock() == this) {
                return state;
            }
        ...
        EnumFacing enumfacing4 = state.getValue((IProperty<EnumFacing>)BlockChest.FACING);
        if (worldIn.getBlockState(pos.offset(enumfacing4)).getBlock().isFullBlock()) {
            enumfacing4 = enumfacing4.getOpposite();
        }
        if (worldIn.getBlockState(pos.offset(enumfacing4)).getBlock().isFullBlock()) {
            enumfacing4 = enumfacing4.rotateY();
        }
        if (worldIn.getBlockState(pos.offset(enumfacing4)).getBlock().isFullBlock()) {
            enumfacing4 = enumfacing4.getOpposite();
        }
        return state.withProperty((IProperty<Comparable>)BlockChest.FACING, enumfacing4);
    }
    ...
    private boolean isDoubleChest(final World worldIn, final BlockPos pos) {
        ...
        for (final Object enumfacing0 : EnumFacing.Plane.HORIZONTAL) {
            final EnumFacing enumfacing2 = (EnumFacing)enumfacing0;
            if (worldIn.getBlockState(pos.offset(enumfacing2)).getBlock() == this) {
                return true;
            }
        }
        return false;
    ...
    public ILockableContainer getLockableContainer(final World worldIn, final BlockPos pos) {
        ...
        for (final Object enumfacing0 : EnumFacing.Plane.HORIZONTAL) {
            ...
            if (block == this) {
                ...
                if (enumfacing2 != EnumFacing.WEST && enumfacing2 != EnumFacing.NORTH) {

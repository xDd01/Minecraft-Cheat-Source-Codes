...
public abstract class StateBasedGame implements Game, InputListener, Pauseable
{
    ...
    public void render(final GameContainer container, final Graphics g) throws SlickException {
        ...
        if (!this.pauseRender && !this.currentState.isRenderPaused()) {
    ...
    public void update(final GameContainer container, final int delta) throws SlickException {
        ...
        if (!this.pauseUpdate && !this.currentState.isUpdatePaused()) {
    ...
    private boolean transitioningOrPaused() {
        return this.leaveTransition != null || this.enterTransition != null || this.isUpdatePaused();
    }
    ...
    public boolean isAcceptingInput() {
        return !this.transitioningOrPaused() && this.currentState.isAcceptingInput();
    }

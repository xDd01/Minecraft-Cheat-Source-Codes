...
public class TrueTypeFont implements Font
{
    ...
    @Override
    public int getWidth(final CharSequence whatchars) {
        int totalwidth = 0;
    ...
    @Override
    public int getHeight(final CharSequence HeightString) {
        return this.fontHeight;
    }
    ...
    @Override
    public void drawString(final float x, final float y, final CharSequence whatchars, final org.newdawn.slick.Color color) {
        this.drawString(x, y, whatchars, color, 0, whatchars.length() - 1);
    }
    
    @Override
    public void drawString(final float x, final float y, final CharSequence whatchars, final org.newdawn.slick.Color color, final int startIndex, final int endIndex) {
        color.bind();
    ...
    @Override
    public void drawString(final float x, final float y, final CharSequence whatchars) {

...
public class ImageGraphicsTest extends BasicGame
{
    ...
    public void init(final GameContainer container) throws SlickException {
        ...
        this.preloaded = Image.createOffscreenImage(this.testImage.getWidth(), this.testImage.getHeight());
        this.testFont = new AngelCodeFont("testdata/hiero.fnt", "testdata/hiero.png");
        this.target = Image.createOffscreenImage(400, 300);
        this.cut = Image.createOffscreenImage(100, 100);
        this.gTarget = this.target.getGraphics();
        (this.offscreenPreload = this.preloaded.getGraphics()).drawImage(this.testImage, 0.0f, 0.0f);

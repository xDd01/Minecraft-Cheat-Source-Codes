    ...
    private void load(final InputStream in, final String tileSetsLocation) throws SlickException {
        ...
        try {
            ...
            for (int k = 0; k < objectGroupNodes.getLength(); ++k) {
                ...
                final ObjectGroup objectGroup = new ObjectGroup(current3, this);
                objectGroup.index = k;

...
public class SpriteSheet extends Image
{
    ...
    public void renderInUse(final int x, final int y, final int sx, final int sy) {
        this.renderInUse(x, y, this.tw, this.th, sx, sy);
    }
    
    public void renderInUse(final int x, final int y, final int width, final int height, final int sx, final int sy) {
        this.subImages[sx][sy].drawEmbedded((float)x, (float)y, (float)width, (float)height);
    }
    
    public void renderInUse(final int x, final int y, final float rotation, final int sx, final int sy) {
        this.renderInUse(x, y, this.tw, this.th, rotation, sx, sy);
    }
    
    public void renderInUse(final int x, final int y, final int width, final int height, final float rotation, final int sx, final int sy) {
        this.subImages[sx][sy].drawEmbedded((float)x, (float)y, (float)width, (float)height, rotation);
    }
    ...
    public void renderInUse(final int x, final int y, final int sx, final int sy, final byte transform) {
        this.subImages[sx][sy].drawEmbedded((float)x, (float)y, (float)this.tw, (float)this.th, transform);
    }
}

...
public final class VersionInfo implements Comparable<VersionInfo>
{
    ...
    static String getTZDataVersion() {
        if (VersionInfo.TZDATA_VERSION == null) {
            synchronized (VersionInfo.class) {
                if (VersionInfo.TZDATA_VERSION == null) {
                    final UResourceBundle tzbundle = UResourceBundle.getBundleInstance("com/ibm/icu/impl/data/icudt62b", "zoneinfo64");
                    VersionInfo.TZDATA_VERSION = tzbundle.getString("TZVersion");
                }
            }
        }
        return VersionInfo.TZDATA_VERSION;
    }
    ...
    static {
        ...
        ICU_DATA_VERSION = VersionInfo.ICU_VERSION;
        UNICODE_VERSION = VersionInfo.UNICODE_11_0;
        UCOL_RUNTIME_VERSION = getInstance(9);
        UCOL_BUILDER_VERSION = getInstance(9);
        UCOL_TAILORINGS_VERSION = getInstance(1);
        VersionInfo.TZDATA_VERSION = null;
    }
}

...
public final class Utility
{
    ...
    public static final boolean sameObjects(final Object a, final Object b) {
        return a == b;
    }
    ...
    private static final <T extends Appendable> void encodeRun(final T buffer, final short value, int length) {
        try {
            final char valueChar = (char)value;
            if (length < 4) {
                for (int j = 0; j < length; ++j) {
                    if (valueChar == '\ua5a5') {
                        buffer.append('\ua5a5');
    ...
    public static String fromHex(final String string, final int minLength, final Pattern separator) {
        final StringBuilder buffer = new StringBuilder();
        final String[] split;
        final String[] parts = split = separator.split(string);
    ...
    public static boolean charSequenceEquals(final CharSequence a, final CharSequence b) {
        if (a == b) {
            return true;
        }
        if (a == null || b == null) {
    ...
    public static int charSequenceHashCode(final CharSequence value) {
        int hash = 0;

...
public final class ZoneMeta
{
    ...
    private static synchronized Set<String> getSystemZIDs() {
        ...
        if (systemZones == null) {
            ...
            final String[] allIDs = zoneIDs = getZoneIDs();
            for (final String id : zoneIDs) {
    ...
    private static synchronized String[] getZoneIDs() {
        if (ZoneMeta.ZONEIDS == null) {
            try {
                final UResourceBundle top = UResourceBundle.getBundleInstance("com/ibm/icu/impl/data/icudt62b", "zoneinfo64", ICUResourceBundle.ICU_DATA_CLASS_LOADER);
                ZoneMeta.ZONEIDS = top.getStringArray("Names");
            }
            catch (MissingResourceException ex) {}
        }
        if (ZoneMeta.ZONEIDS == null) {
    ...
    private static String findCLDRCanonicalID(final String tzid) {
        ...
        try {
            final UResourceBundle keyTypeData = UResourceBundle.getBundleInstance("com/ibm/icu/impl/data/icudt62b", "keyTypeData", ICUResourceBundle.ICU_DATA_CLASS_LOADER);
    ...
    public static UResourceBundle openOlsonResource(UResourceBundle top, final String id) {
        ...
        if (zoneIdx >= 0) {
            try {
                if (top == null) {
                    top = UResourceBundle.getBundleInstance("com/ibm/icu/impl/data/icudt62b", "zoneinfo64", ICUResourceBundle.ICU_DATA_CLASS_LOADER);
                }
                final UResourceBundle zones = top.get("Zones");
    ...
    public static OlsonTimeZone getSystemTimeZone(final String id) {
        return ZoneMeta.SYSTEM_ZONE_CACHE.getInstance(id, id);
    }
    
    public static SimpleTimeZone getCustomTimeZone(final String id) {
        final int[] fields = new int[4];
        if (parseCustomID(id, fields)) {
            final Integer key = fields[0] * (fields[1] | fields[2] << 5 | fields[3] << 11);
            return ZoneMeta.CUSTOM_ZONE_CACHE.getInstance(key, fields);
        }
        return null;
    }
    ...
    public static SimpleTimeZone getCustomTimeZone(final int offset) {

...
public final class DateNumberFormat extends NumberFormat
{
    ...
    private void initialize(final ULocale loc, final String digitString, final String nsName) {
        ...
        if (elems == null) {
            final ICUResourceBundle rb = (ICUResourceBundle)UResourceBundle.getBundleInstance("com/ibm/icu/impl/data/icudt62b", loc);
            String minusString;
            try {
    ...
    @Override
    public Object clone() {
        final DateNumberFormat dnfmt = (DateNumberFormat)super.clone();

...
public class ICUService extends ICUNotifier
{
    ...
    private Map<String, Factory> getVisibleIDMap() {
        synchronized (this) {
            if (this.idcache == null) {
                try {
                    this.factoryLock.acquireRead();
                    final Map<String, Factory> mutableMap = new HashMap<String, Factory>();
                    ...
                    this.idcache = Collections.unmodifiableMap((Map<? extends String, ? extends Factory>)mutableMap);
                }
                finally {
                    this.factoryLock.releaseRead();
                }
    ...
    private static class LocaleRef
    {
        ...
        SortedMap<String, String> get(final ULocale loc, final Comparator<Object> comp) {
            final SortedMap<String, String> m = this.dnCache;

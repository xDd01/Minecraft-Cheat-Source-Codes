...
public class LanguageTag
{
    ...
    public String toString() {
        ...
        if (this._language.length() > 0) {
            ...
            for (final String variant : this._variants) {

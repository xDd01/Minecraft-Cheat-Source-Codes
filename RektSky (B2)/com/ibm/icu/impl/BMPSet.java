...
public final class BMPSet
{
    ...
    public final int span(final CharSequence s, final int start, final UnicodeSet.SpanCondition spanCondition, final OutputInt outCount) {
        int i = start;

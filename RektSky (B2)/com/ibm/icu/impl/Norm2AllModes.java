...
public final class Norm2AllModes
{
    ...
    public static Norm2AllModes getInstance(final ByteBuffer bytes, final String name) {
        if (bytes == null) {
    ...
    static {
        Norm2AllModes.cache = new SoftCache<String, Norm2AllModes, ByteBuffer>() {
            @Override
            protected Norm2AllModes createInstance(final String key, final ByteBuffer bytes) {
    ...
    public abstract static class Normalizer2WithImpl extends Normalizer2
    {
        ...
        public abstract int getQuickCheck(final int p0);
    }
    ...
    private static final class Norm2AllModesSingleton
    {
        ...
        private Norm2AllModesSingleton(final String name) {
            try {
                final Normalizer2Impl impl = new Normalizer2Impl().load(name + ".nrm");

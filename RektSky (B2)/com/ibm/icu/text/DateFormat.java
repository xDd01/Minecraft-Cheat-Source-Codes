...
public abstract class DateFormat extends UFormat
{
    ...
    public void setNumberFormat(final NumberFormat newNumberFormat) {
        fixNumberFormatForDates(this.numberFormat = (NumberFormat)newNumberFormat.clone());
    }
    
    static void fixNumberFormatForDates(final NumberFormat nf) {
    ...
    private static DateFormat get(final int dateStyle, final int timeStyle, final ULocale loc, Calendar cal) {
        if ((timeStyle != -1 && (timeStyle & 0x80) > 0) || (dateStyle != -1 && (dateStyle & 0x80) > 0)) {
            final RelativeDateFormat r = new RelativeDateFormat(timeStyle, dateStyle, loc, cal);
            return r;
        }

...
public class UnicodeSet extends UnicodeFilter implements Iterable<String>, Comparable<UnicodeSet>, Freezable<UnicodeSet>
{
    ...
    private static void appendCodePoint(final Appendable app, final int c) {
    ...
    private static void append(final Appendable app, final CharSequence s) {
        try {
            app.append(s);
        }
        catch (IOException e) {
    ...
    private static <T extends Appendable> T _appendToPat(final T buf, final String s, final boolean escapeUnprintable) {
        int cp;
    ...
    private static <T extends Appendable> T _appendToPat(final T buf, final int c, final boolean escapeUnprintable) {
        try {
    ...
    private <T extends Appendable> T _toPattern(final T result, final boolean escapeUnprintable) {
        if (this.pat == null) {
        ...
        try {
            ...
            while (i < this.pat.length()) {
                final int c = this.pat.codePointAt(i);
    ...
    private <T extends Appendable> T appendNewPattern(final T result, final boolean escapeUnprintable, final boolean includeStrings) {
        try {
            result.append('[');
    ...
    public UnicodeSet applyPattern(final String pattern, ParsePosition pos, final SymbolTable symbols, final int options) {
        ...
        final StringBuilder rebuiltPat = new StringBuilder();
    ...
    private void applyPattern(final RuleCharacterIterator chars, final SymbolTable symbols, final Appendable rebuiltPat, final int options, final int depth) {
        if (depth > 100) {
        ...
        final StringBuilder patBuf = new StringBuilder();
                ...
                if (!literal) {
                    switch (c) {
                        ...
                        case 123: {
                            ...
                            final String curString = buf.toString();
                            if (op == '-') {
                                final int lastSingle = CharSequences.getSingleCodePoint((lastString == null) ? "" : lastString);
                                final int curSingle = CharSequences.getSingleCodePoint(curString);
    ...
    private void applyPropertyPattern(final RuleCharacterIterator chars, final Appendable rebuiltPat, final SymbolTable symbols) {
    ...
    public int span(final CharSequence s, int start, final SpanCondition spanCondition) {
        ...
        if (!this.strings.isEmpty()) {
            final int which = (spanCondition == SpanCondition.NOT_CONTAINED) ? 33 : 34;
    ...
    private int spanCodePointsAndCount(final CharSequence s, final int start, final SpanCondition spanCondition, final OutputInt outCount) {
    ...
    public int spanBack(final CharSequence s, int fromIndex, final SpanCondition spanCondition) {
        ...
        if (!this.strings.isEmpty()) {
            final int which = (spanCondition == SpanCondition.NOT_CONTAINED) ? 17 : 18;
            final UnicodeSetStringSpan strSpan = new UnicodeSetStringSpan(this, new ArrayList<String>(this.strings), which);
            if (strSpan.needsStringSpanUTF16()) {
    ...
    public final <T extends CharSequence> boolean containsSome(final Iterable<T> collection) {
        return !this.containsNone((Iterable<CharSequence>)collection);
    }
    
    public <T extends CharSequence> UnicodeSet addAll(final T... collection) {
        this.checkFrozen();
        for (final T str : collection) {
            this.add(str);
        }
        return this;
    }
    ...
    public int compareTo(final UnicodeSet o, final ComparisonStyle style) {
        ...
        if (this.list[i] == 1114112) {
            ...
            final int compareResult = compare(item, this.list[i]);
    ...
    public static class EntryRange
    {
        ...
        public String toString() {
            ...
            return ((StringBuilder)((this.codepoint == this.codepointEnd) ? _appendToPat(b, this.codepoint, false) : ((StringBuilder)_appendToPat(((StringBuilder)_appendToPat(b, this.codepoint, false)).append('-'), this.codepointEnd, false)))).toString();
        }
    }

    ...
    public void renderItemInFirstPerson(float partialTicks)
    {
        ...
        if (this.itemToRender != null)
        {
            ...
            else if (abstractclientplayer.getItemInUseCount() > 0)
            {
                ...
                switch (enumaction)
                {
                    ...
                    case BLOCK:
                        ...
                        if(animationsModule.toggled()) {
                            switch (animationsModule.animationsModeProperty().value()) {
                                case VANILLA: {
                                    this.transformFirstPersonItem(f, 0.0F);
                                    this.func_178103_d();
                                }
                ...
                if(animationsModule.toggled()) {
                    switch (animationsModule.hitModeProperty().value()) {
                        case NORMAL: {
            ...
            GlStateManager.scale(animationsModule.scaleProperty().value(), animationsModule.scaleProperty().value(), animationsModule.scaleProperty().value());

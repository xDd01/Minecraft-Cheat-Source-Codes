...
import me.dinozoid.strife.module.implementations.combat.ReachModule;
import me.dinozoid.strife.module.implementations.visuals.CameraClipModule;
...
public class EntityRenderer implements IResourceManagerReloadListener
{
    ...
    public void setShaderGroup(ShaderGroup theShaderGroup) {
    ...
    public void getMouseOver(float partialTicks)
    {
        ...
        if (entity != null && this.mc.theWorld != null)
        {
            ...
            if(ReachModule.getInstance().toggled()) {
                d1 = ReachModule.getInstance().reachProperty().value();
    ...
    {
        if(StrifeClient.INSTANCE.moduleRepository().moduleBy(NoHurtCamModule.class).toggled()) return;
            ...
            else
            {
                ...
                for (int i = 0; i < 8; ++i)
                {
                    ...
                    if (movingobjectposition != null)
                    {
                        ...
                        if(!StrifeClient.INSTANCE.moduleRepository().moduleBy(CameraClipModule.class).toggled())
                            if (d7 < d3)
                                d3 = d7;
                    }
                }
    ...
    private void renderHand(float partialTicks, int xOffset)
    {
        if (!this.debugView)
        {
            ...
            {
                this.enableLightmap();
                GlStateManager.translate(0.4, -0.2, -0.4);
    ...
    private void renderWorldPass(int pass, float partialTicks, long finishTimeNano)
    {
        ...
        StrifeClient.INSTANCE.eventBus().post(new Render3DEvent(partialTicks));

...
public abstract class RendererLivingEntity<T extends EntityLivingBase> extends Render<T>
{
    ...
    public void doRender(T entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
        ...
        {
            float f, f1;
            if(entity == mc.thePlayer && mc.thePlayer.currentEvent.rotating()) {
                float yaw = this.interpolateRotation(mc.thePlayer.currentEvent.prevYaw(), mc.thePlayer.currentEvent.yaw(), partialTicks);
                f = yaw;
                f1 = yaw;
            } else {
            ...
            if(entity == mc.thePlayer)
                f7 = mc.thePlayer.currentEvent.prevPitch() + (mc.thePlayer.currentEvent.pitch() - mc.thePlayer.currentEvent.prevPitch()) * partialTicks;

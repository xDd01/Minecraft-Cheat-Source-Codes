...
public class PlayerControllerMP
{
    ...
    {
        DamageBlockEvent damageBlockEvent = new DamageBlockEvent(posBlock, directionFacing);
        StrifeClient.INSTANCE.eventBus().post(damageBlockEvent);
        if(damageBlockEvent.cancelled()) return false;
    ...
    {
        if(playerIn.equals(mc.thePlayer)) StrifeClient.INSTANCE.eventBus().post(new WindowClickEvent(windowId, slotId, mouseButtonClicked, mode));

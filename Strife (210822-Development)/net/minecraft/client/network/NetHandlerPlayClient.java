...
public class NetHandlerPlayClient implements INetHandlerPlayClient
{
    ...
    {
        final PacketOutboundEvent packetOutboundEvent = new PacketOutboundEvent(p_147297_1_);
        StrifeClient.INSTANCE.eventBus().post(packetOutboundEvent);
        if(packetOutboundEvent.cancelled()) return;
        this.netManager.sendPacket(packetOutboundEvent.packet());
    }

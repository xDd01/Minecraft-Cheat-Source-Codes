...
import me.dinozoid.strife.ui.menu.StrifeSplashScreen;
...
public class Minecraft implements IThreadListener, IPlayerUsage
{
    ...
    public StrifeSplashScreen strifeSplashScreen = new StrifeSplashScreen();
...
//        this.drawSplashScreen(this.renderEngine);
        ...
        strifeSplashScreen.progress(3, "Pre startup...");
        ...
        strifeSplashScreen.progress(1, "Setting up Models...");
        this.mcResourceManager.registerReloadListener(this.modelManager);
        strifeSplashScreen.progress(2, "Setting up Resources...");
        this.renderItem = new RenderItem(this.renderEngine, this.modelManager);
        strifeSplashScreen.progress(3, "Initializing Render Item...");
        this.renderManager = new RenderManager(this.renderEngine, this.renderItem);
        strifeSplashScreen.progress(4, "Initializing Render Manager...");
        this.itemRenderer = new ItemRenderer(this);
        strifeSplashScreen.progress(5, "Initializing Item Renderer...");
        ...
        strifeSplashScreen.progress(6, "Initializing Render Global...");
    ...
    private void createDisplay() throws LWJGLException
    {
        ...
        Display.setTitle(StrifeClient.NAME + " is loading...");
    ...
    {
        StrifeClient.INSTANCE.shutdown();
        try
        {
...
//        System.gc();
    ...
    {
        StrifeClient.INSTANCE.eventBus().post(new MouseEvent(0));
    ...
    {
        StrifeClient.INSTANCE.eventBus().post(new MouseEvent(2));
    ...
    {
        StrifeClient.INSTANCE.eventBus().post(new TickEvent());
        ...
        if (this.currentScreen == null || this.currentScreen.allowUserInput)
        {
            ...
            while (Keyboard.next())
            {
                ...
                {
                    StrifeClient.INSTANCE.eventBus().post(new KeyEvent(k));
                    KeyBinding.onTick(k);
                }
            ...
            {
                this.displayGuiScreen(new GuiChat(StrifeClient.CHAT_PREFIX));
            }
...
//        System.gc();
    ...
    {
        StrifeClient.INSTANCE.eventBus().post(new MouseEvent(1));
        if (this.objectMouseOver != null)
        {

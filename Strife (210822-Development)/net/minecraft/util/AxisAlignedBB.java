...
public class AxisAlignedBB
{
    ...
    {
        Vec3 vec3 = vecA.getIntermediateWithXValue(vecB, this.minX); // get minX value where intercept happens
        Vec3 vec31 = vecA.getIntermediateWithXValue(vecB, this.maxX); // etc

...
//        if(streamerMode == null) streamerMode = (StreamerMode) ModuleManager.getModule("StreamerMode");
//        if(streamerMode.isToggled()) {
//            Minecraft mc = Minecraft.getMinecraft();
//            text = text.replaceAll(mc.session.getUsername(), "§4Strife§f");
//        }
        return text;
    }

...
public class GuiTextField extends Gui {
    ...
    /*
    * Do we replace chars with *? for passwords?
    */
    ...
    public GuiTextField(int componentId, FontRenderer fontrendererObj, int x, int y, int par5Width, int par6Height, boolean conceal) {
        this.id = componentId;
    ...
    public void drawTextBox() {
      ...
      //          drawRect(this.xPosition - 1, this.yPosition - 1, this.xPosition + this.width + 1, this.yPosition + this.height + 1, -6250336);
                RenderUtilities.drawRoundedRect(xPosition, yPosition, xPosition + width, yPosition + height, new Color(255,70,70).getRGB(), new Color(0,0,0,150).getRGB());

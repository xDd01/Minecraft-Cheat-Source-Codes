...
public class EntityPlayerSP extends AbstractClientPlayer {
    ...
    /**
     * Server sided yaw and pitch set when a packet responsible for rotation is sent
     **/
    ...
    public void onUpdateWalkingPlayer() {
        ...
        EventUpdate.lastYaw = euPre.getYaw();
        EventUpdate.lastPitch = euPre.getPitch();
        ...
        new EventUpdate(this.rotationYaw, this.rotationPitch, this.posX, this.getEntityBoundingBox().minY, this.posZ, this.onGround, this.isSneaking(), false).call();
    }

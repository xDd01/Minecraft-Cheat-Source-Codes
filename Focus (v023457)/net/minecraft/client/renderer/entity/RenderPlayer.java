...
import Focus.Beta.API.events.render.EventPostRenderPlayer;
import Focus.Beta.API.events.render.EventPreRenderPlayer;
...
public class RenderPlayer extends RendererLivingEntity<AbstractClientPlayer>
{
    ...
    {
    	EventPreRenderPlayer ev = new EventPreRenderPlayer();
    	EventBus.getInstance().register(ev);
    	...
    	EventPostRenderPlayer ev2 = new EventPostRenderPlayer();
    	EventBus.getInstance().register(ev2);
    }

...
import Focus.Beta.IMPL.Module.impl.render.Animation;
    ...
    public void renderItemInFirstPerson(float partialTicks)
    {
        ...
        float var8 = MathHelper.sin(MathHelper.sqrt_float(f1) * 3.1415927F);
         ...
         if (this.itemToRender != null)
         {
             ...
             else if (abstractclientplayer.getItemInUseCount() > 0 || Killaura.block)
             {
                 ...
                 switch (enumaction)
                 {
                     ...
                     case BLOCK:
                         ...
                         final Double x = animation.x.getValue();
                         final Double y = animation.y.getValue();
                         final Double z = animation.z.getValue();
                         ...
                         if (animation.isEnabled() && animation.mode.getValue() == Animation.AnimationMode.Spinning) {
                             ...
                             break;
                         } else if (animation.isEnabled() && animation.mode.getValue() == Animation.AnimationMode.Swank) {
                             this.transformFirstPersonItem(f / 2.0F, f1);
                             float var14 = MathHelper.sin((float) ((double)MathHelper.sqrt_float(f1) * 3.141592653589793D));
                             GlStateManager.rotate(var14 * 30.0F, -var14, -0.0F, 9.0F);
                             GlStateManager.rotate(var14 * 40.0F, 1.0F, -var14, -0.0F);
                             this.func_178103_d();
                             break;
                         } else if (animation.isEnabled() && animation.mode.getValue() == Animation.AnimationMode.Swing) {
                             this.transformFirstPersonItem(f / 2.0F, f1);
                             this.func_178103_d();
                             break;
                         } else if (animation.isEnabled() && animation.mode.getValue() == Animation.AnimationMode.Swang) {
                             this.transformFirstPersonItem(f / 2.0F, f1);
                             GlStateManager.rotate(var15 * 30.0F / 2.0F, -var15, -0.0F, 9.0F);
                             GlStateManager.rotate(var15 * 40.0F, 1.0F, -var15 / 2.0F, -0.0F);
                             this.func_178103_d();
                             break;
                         } else if (animation.isEnabled() && animation.mode.getValue() == Animation.AnimationMode.Swong) {
                             this.transformFirstPersonItem(f / 2.0F, 0.0F);
                             float var16 = MathHelper.sin((float) ((double)(f1 * f1) * 3.141592653589793D));
                             GlStateManager.rotate(-var16 * 40.0F / 2.0F, var16 / 2.0F, -0.0F, 9.0F);
                             GlStateManager.rotate(-var16 * 30.0F, 1.0F, var16 / 2.0F, -0.0F);
                             this.func_178103_d();

                             break;
                         } else if (animation.isEnabled() && animation.mode.getValue() == Animation.AnimationMode.Swaing) {
                             this.transformFirstPersonItem(f / 2.0F, -0.2F);
                             float var17 = MathHelper.sin((float) ((double)(f1 * f1) * 3.141592653589793D));
                             GlStateManager.rotate(-var17 / 19.0F, var17 / 20.0F, -0.0F, 9.0F);
                             GlStateManager.rotate(-var17 * 30.0F, 10.0F, var17 / 50.0F, 0.0F);
                             this.func_178103_d();
                             break;
                         } else if (animation.isEnabled() && animation.mode.getValue() == Animation.AnimationMode.Punch) {
                             this.transformFirstPersonItem(f, 0.0F);
                             this.func_178103_d();
                             ...
                             break;
                         } else if (animation.isEnabled() && animation.mode.getValue() == Animation.AnimationMode.Stella) {
                             ...
                             break;
                         } else if (animation.isEnabled() && animation.mode.getValue() == Animation.AnimationMode.Styles) {
                             this.transformFirstPersonItem(f, 0.0F);
                             this.func_178103_d();
                             float var13 = MathHelper.sin((float) ((double)MathHelper.sqrt_float(f1) * 3.141592653589793D));
                         ...
                         }else if (animation.isEnabled() && animation.mode.getValue() == Animation.AnimationMode.Ethereal){
                         ...
                         else if(animation.isEnabled() && animation.mode.getValue() == Animation.AnimationMode.Interia){
                         ...
                         else if(animation.isEnabled() && animation.mode.getValue() == Animation.AnimationMode.Slide){
                             this.transformFirstPersonItem(f, 0.0F);
                             this.func_178103_d();
                         ...
                         }else if(animation.isEnabled() && animation.mode.getValue() == Animation.AnimationMode.Smooth) {
                         ...
                         }else if(animation.isEnabled() && animation.mode.getValue() == Animation.AnimationMode.Exhibition) {
             ...
             else
             {
                 ...
                 Animation animation = (Animation) Client.instance.getModuleManager().getModuleByClass(Animation.class);
                 if(animation.isEnabled() && animation.newSwing.getValue()){

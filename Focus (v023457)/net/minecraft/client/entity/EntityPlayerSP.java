...
import Focus.Beta.API.events.misc.EventLastDistance;
...
import Focus.Beta.IMPL.Module.impl.misc.NoSlow;
...
public class EntityPlayerSP extends AbstractClientPlayer
{
    ...
    public double getBaseMotionY(double motion) {
        return this.isPotionActive(Potion.jump)?motion + 0.1D * (double)(this.getActivePotionEffect(Potion.jump).getAmplifier() + 1):motion;
    }
    ...
    public void sendChatMessage(String message)
    {
    	 if (message.startsWith(".")) {
             ...
             if (possibleCmd.isPresent()) {
                 ...
                 Helper.sendMessage(String.format("Command not found"));
             }
         } else {

...
public class GuiIngame extends Gui
{
    ...
    public void renderExpBar(ScaledResolution p_175176_1_, int p_175176_2_)
    {
        ...
        if (i > 0)
        {
            ...
            this.drawTexturedModalRect(p_175176_2_, j + 20, 0, 64, short1, 5);

            if (k > 0)
            {
                this.drawTexturedModalRect(p_175176_2_, j + 20, 0, 69, k, 5);
            }
        }
    ...
    private void renderScoreboard(ScoreObjective p_180475_1_, ScaledResolution p_180475_2_)
    {
        ...
        for (Object score10 : arraylist1)
        {
            ...
            if (k == arraylist1.size())
            {
                ...
                drawRect(j - 2, l - this.getFontRenderer().FONT_HEIGHT - 3, i1, l - 10, HUD.color);
    ...
    private void renderPlayerStats(ScaledResolution p_180477_1_)
    {
        if (this.mc.getRenderViewEntity() instanceof EntityPlayer)
        {
            ...
            for (int j5 = MathHelper.ceiling_float_int((f + f1) / 2.0F) - 1; j5 >= 0; --j5)
            {
                ...
                this.drawTexturedModalRect(l3, i4 + 19, 16 + b0 * 9, 10 * b1, 9, 9);

                if (flag)
                {
                    if (j5 * 2 + 1 < j)
                    {
                        this.drawTexturedModalRect(l3, i4 + 19, k5 + 54, 10 * b1, 9, 9);
                    }

                    if (j5 * 2 + 1 == j)
                    {
                        this.drawTexturedModalRect(l3, i4 + 19, k5 + 63, 9 * b1, 9, 9);
                    }
                }
                ...
                if (f2 <= 0.0F)
                {
                    if (j5 * 2 + 1 < i)
                    {
                        this.drawTexturedModalRect(l3, i4 + 19, k5 + 36 , 9 * b1, 9 - 2, 9);
                    }

                    if (j5 * 2 + 1 == i)
                    {
                        this.drawTexturedModalRect(l3, i4 + 19, k5 + 45, 9 * b1, 9, 9);
                    }
                }
                else
                {
                    ...
                    {
                        this.drawTexturedModalRect(l3, i4 + 19, k5 + 153, 9 * b1, 9, 9);
                    }
                    else
                    {
                        this.drawTexturedModalRect(l3, i4 + 19, k5 + 144, 9 * b1, 9, 9);
                    }
            ...
            if (entity == null)
            {
                ...
                for (int l5 = 0; l5 < 10; ++l5)
                {
                    ...
                    int k7 = j1 - l5 * 8 - 9;
                    this.drawTexturedModalRect(k7, i8 + 19, 16 + b4 * 9, 27, 9, 9);

                    if (flag1)
                    {
                        if (l5 * 2 + 1 < l)
                        {
                            this.drawTexturedModalRect(k7, i8 + 19, j6 + 54, 27, 9, 9);
                        }

                        if (l5 * 2 + 1 == l)
                        {
                            this.drawTexturedModalRect(k7, i8 + 19, j6 + 63, 27, 9, 9);
                        }
                    }

                    if (l5 * 2 + 1 < k)
                    {
                        this.drawTexturedModalRect(k7, i8 + 19, j6 + 36, 27, 9, 9);
                    }

                    if (l5 * 2 + 1 == k)
                    {
                        this.drawTexturedModalRect(k7, i8 + 19, j6 + 45, 27, 9, 9);
                    }
                }
            }

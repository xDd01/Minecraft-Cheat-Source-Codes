		...
		public ChatMessageBuilder(boolean prependDefaultPrefix, boolean useDefaultMessageColor) {
			if (prependDefaultPrefix) {
				this.theMessage.appendSibling(new ChatMessageBuilder(false, false)
						.appendText(String
								.valueOf((Object) ((Object) EnumChatFormatting.BLUE) + "["
										+ (Object) ((Object) EnumChatFormatting.DARK_BLUE))
								+ "Focus" + (Object) ((Object) EnumChatFormatting.BLUE) + "] ")
						.setColor(EnumChatFormatting.RESET).build().getChatComponent());
			}

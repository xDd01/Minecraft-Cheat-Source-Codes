package Focus.Beta.API.GUI.login;

import Focus.Beta.API.HWID.Auth;
import Focus.Beta.API.HWID.Hwid;
...
public class GuiAuth2 extends GuiScreen {
    ...
    public GuiAuth2() throws UnsupportedEncodingException, NoSuchAlgorithmException {
        try{
        this.shader = new Shader("/Focus/Beta/IMPL/Shader/Login.fsh");
    } catch (IOException e) {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        this.shader.useShader(1920, 1080, mouseX, mouseY, (System.currentTimeMillis() - initTime) / 1000F);
        ...
        mc.fontRendererObj.drawString(Client.instance.name, width/2 + password.xPosition, height/2, new Color(0, 224, 255, 0).getRGB());

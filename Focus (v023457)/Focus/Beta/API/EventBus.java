...
public class EventBus {
	...
	public <E extends Event> E register(E event) {
		...
		if (list != null && !list.isEmpty()) {
			for (Handler data : list) {
				try {
					if (list instanceof Focus.Beta.IMPL.Module.Module) {
						if (((Focus.Beta.IMPL.Module.Module) ((Object) list)).isEnabled()) {
							if (whiteListedEvents) {
								Helper.mc.mcProfiler.startSection(((Focus.Beta.IMPL.Module.Module) ((Object) list)).getName());
							}
							if (whiteListedEvents) {

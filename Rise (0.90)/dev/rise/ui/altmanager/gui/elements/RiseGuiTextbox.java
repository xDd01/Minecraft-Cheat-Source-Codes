...
public final class RiseGuiTextbox extends Gui {
    ...
    public RiseGuiTextbox(final int componentId, final FontRenderer fontrendererObj, final int x, final int y, final int par5Width, final int par6Height, final boolean backGround) {
        this.id = componentId;
...
//                drawRect(this.xPosition, this.yPosition, this.xPosition + this.width, this.yPosition + this.height, -16777216);
                ...
                RenderUtil.roundedRect(this.xPosition - 1, this.yPosition - 1, this.width + 1, this.height + 1, 15, new Color(255, 255, 255, 35));
            }
            ...
            if (s.length() > 0) {
                ...
                j1 = (int) (CustomFont.getWidth(s1) + xPosition + 6);
                CustomFont.drawStringWithShadow(s1, (float) l, (float) i1, i);
            }
            ...
            if (s.length() > 0 && flag && j < s.length()) {
                CustomFont.drawStringWithShadow(s.substring(j), (float) j1, (float) i1, i);
            }

            if (flag1) {
                if (flag2) {
                    Gui.drawRect(k1, i1 - 1, k1 + 1, i1 + 1 + CustomFont.getHeight(), -3092272);
                } else {
                    CustomFont.drawStringWithShadow("_", (float) k1, (float) i1, i);
                }
            }

            if (k != j) {
                final float l1 = l + CustomFont.getWidth(s.substring(0, k));
                this.drawCursorVertical(k1, i1 - 1, (int) (l1 - 1), i1 + 1 + this.fontRendererInstance.FONT_HEIGHT);
            }
        }
    }
    ...
    public void drawTextBoxWithoutBackground() {
        if (this.getVisible()) {
            ...
            if (k != j) {
                final float l1 = l + CustomFont.getWidth(s.substring(0, k));
                this.drawCursorVertical(k1, i1 - 1, (int) (l1 - 1), (int) (i1 + 1 + CustomFont.getHeight()));
            }
        }
    }

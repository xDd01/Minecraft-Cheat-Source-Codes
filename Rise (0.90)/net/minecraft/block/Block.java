...
public class Block {
    ...
    public boolean isPassable(final IBlockAccess worldIn, BlockPos pos) {
    ...
    public boolean canReplace(final World worldIn, final BlockPos pos, final EnumFacing side) {

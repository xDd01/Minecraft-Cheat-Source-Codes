...
public class GlStateManager {
    ...
    public static void texGen(final GlStateManager.TexGen p_179149_0_, final int p_179149_1_) {
        final GlStateManager.TexGenCoord glstatemanager$texgencoord = texGenCoord(p_179149_0_);
    ...
    public static void func_179105_a(final GlStateManager.TexGen p_179105_0_, final int pname, final FloatBuffer params) {
    ...
    public static void deleteTexture(final int texture) {
        if (texture != 0) {
            ...
            for (final GlStateManager.TextureState glstatemanager$texturestate : textureState) {
    ...
    public static void checkBoundTexture() {
        if (Config.isMinecraftThread()) {
            final int i = GL11.glGetInteger(GL13.GL_ACTIVE_TEXTURE);
            final int j = GL11.glGetInteger(GL11.GL_TEXTURE_BINDING_2D);

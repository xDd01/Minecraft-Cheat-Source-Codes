...
public class ClippingHelperImpl extends ClippingHelper {
    ...
    public void init() {
        ...
        final float[] afloat2 = this.frustum[0];
        ...
        final float[] afloat3 = this.frustum[1];
        ...
        final float[] afloat4 = this.frustum[2];
        ...
        final float[] afloat5 = this.frustum[3];
        ...
        final float[] afloat6 = this.frustum[4];
        ...
        final float[] afloat7 = this.frustum[5];

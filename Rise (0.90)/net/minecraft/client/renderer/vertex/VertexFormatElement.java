...
public class VertexFormatElement {
    ...
    public VertexFormatElement(final int indexIn, final VertexFormatElement.EnumType typeIn, final VertexFormatElement.EnumUsage usageIn, final int count) {
    ...
    private final boolean func_177372_a(final int p_177372_1_, final VertexFormatElement.EnumUsage p_177372_2_) {
    ...
    public enum EnumType {
        ...
        EnumType(final int sizeIn, final String displayNameIn, final int glConstantIn) {
            this.size = sizeIn;
    ...
    public enum EnumUsage {
        ...
        EnumUsage(final String displayNameIn) {
            this.displayName = displayNameIn;
        }

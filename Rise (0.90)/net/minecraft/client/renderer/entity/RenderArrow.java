...
public class RenderArrow extends Render<EntityArrow> {
    ...
    public void doRender(final EntityArrow entity, final double x, final double y, final double z, final float entityYaw, final float partialTicks) {
        ...
        worldrenderer.pos(-7.0D, -2.0D, -2.0D).func_181673_a(f4, f6).endVertex();
        worldrenderer.pos(-7.0D, -2.0D, 2.0D).func_181673_a(f5, f6).endVertex();
        worldrenderer.pos(-7.0D, 2.0D, 2.0D).func_181673_a(f5, f7).endVertex();
        worldrenderer.pos(-7.0D, 2.0D, -2.0D).func_181673_a(f4, f7).endVertex();
        tessellator.draw();
        GL11.glNormal3f(-f8, 0.0F, 0.0F);
        worldrenderer.begin(7, DefaultVertexFormats.field_181707_g);
        worldrenderer.pos(-7.0D, 2.0D, -2.0D).func_181673_a(f4, f6).endVertex();
        ...
        for (int j = 0; j < 4; ++j) {
            ...
            worldrenderer.begin(7, DefaultVertexFormats.field_181707_g);
            worldrenderer.pos(-8.0D, -2.0D, 0.0D).func_181673_a(f, f2).endVertex();
            worldrenderer.pos(8.0D, -2.0D, 0.0D).func_181673_a(f1, f2).endVertex();
            worldrenderer.pos(8.0D, 2.0D, 0.0D).func_181673_a(f1, f3).endVertex();
            worldrenderer.pos(-8.0D, 2.0D, 0.0D).func_181673_a(f, f3).endVertex();
            tessellator.draw();
        }

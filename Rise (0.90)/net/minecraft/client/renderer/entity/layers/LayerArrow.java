    ...
    public void doRenderLayer(final EntityLivingBase entitylivingbaseIn, final float p_177141_2_, final float p_177141_3_, final float partialTicks, final float p_177141_5_, final float p_177141_6_, final float p_177141_7_, final float scale) {
        ...
        if (i > 0) {
            ...
            for (int j = 0; j < i; ++j) {
                ...
                final float f3 = (modelbox.posX1 + (modelbox.posX2 - modelbox.posX1) * f) / 16.0F;
                final float f4 = (modelbox.posY1 + (modelbox.posY2 - modelbox.posY1) * f1) / 16.0F;
                final float f5 = (modelbox.posZ1 + (modelbox.posZ2 - modelbox.posZ1) * f2) / 16.0F;
                ...
                f1 = f1 * -1.0F;
                f2 = f2 * -1.0F;
                final float f6 = MathHelper.sqrt_float(f * f + f2 * f2);

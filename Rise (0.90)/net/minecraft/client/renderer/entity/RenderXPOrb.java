...
public class RenderXPOrb extends Render<EntityXPOrb> {
    ...
    public void doRender(final EntityXPOrb entity, final double x, final double y, final double z, final float entityYaw, final float partialTicks) {
        ...
        final int i1 = 255;
        final int j1 = (int) ((MathHelper.sin(f8 + 4.1887903F) + 1.0F) * 0.1F * 255.0F);
        ...
        if (Config.isCustomColors()) {
            final int j2 = CustomColors.getXpOrbColor(f8);
        ...
        worldrenderer.pos(0.0F - f5, 0.0F - f6, 0.0D).func_181673_a(f, f3).color(k1, l1, i2, 128).func_181663_c(0.0F, 1.0F, 0.0F).endVertex();
        worldrenderer.pos(f4 - f5, 0.0F - f6, 0.0D).func_181673_a(f1, f3).color(k1, l1, i2, 128).func_181663_c(0.0F, 1.0F, 0.0F).endVertex();
        worldrenderer.pos(f4 - f5, 1.0F - f6, 0.0D).func_181673_a(f1, f2).color(k1, l1, i2, 128).func_181663_c(0.0F, 1.0F, 0.0F).endVertex();
        worldrenderer.pos(0.0F - f5, 1.0F - f6, 0.0D).func_181673_a(f, f2).color(k1, l1, i2, 128).func_181663_c(0.0F, 1.0F, 0.0F).endVertex();
        tessellator.draw();

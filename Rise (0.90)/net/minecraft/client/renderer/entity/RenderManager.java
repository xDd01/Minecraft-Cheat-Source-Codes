...
public class RenderManager {
    ...
    public boolean theSucking(final Entity entityIn, final double x, final double y, final double z, final float entityYaw, final float partialTicks) {
        return this.suckening(entityIn, x, y, z, entityYaw, partialTicks, false);
    }
    ...
    public boolean suckening(final Entity entity, final double x, final double y, final double z, final float entityYaw, final float partialTicks, final boolean p_147939_10_) {
        Render<Entity> render = null;

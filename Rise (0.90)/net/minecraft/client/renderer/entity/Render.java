...
import dev.rise.module.impl.render.Nametags;
...
public abstract class Render<T extends Entity> implements IEntityRenderer {
    ...
    public void doRender(final T entity, final double x, final double y, final double z, final float entityYaw, final float partialTicks) {
        if ((!Nametags.enabled || !(entity instanceof EntityPlayer)) && Minecraft.getMinecraft().thePlayer.getDistanceSqToEntity(entity) < 400 && !(lastPosX == x && lastPosZ == y)) {
     ...
     */
    public void doRenderShadowAndFire(final Entity entityIn, final double x, final double y, final double z, final float partialTicks) {

...
import dev.rise.module.impl.movement.BowFly;
import dev.rise.module.impl.player.Derp;
...
public class ModelBiped extends ModelBase implements InstanceAccess {
    ...
    public void setRotationAngles(float p_78087_1_, float p_78087_2_, float p_78087_3_, float p_78087_4_, float p_78087_5_, float p_78087_6_, Entity entityIn) {
        ...
        if (entityIn == mc.thePlayer) {
            if (this.getModule(Derp.class).isEnabled())
                p_78087_5_ = Derp.pitch;

            if (this.getModule(Aura.class).isEnabled())
                p_78087_5_ = Aura.lastPitch;

            if (this.getModule(BowFly.class).isEnabled())
                p_78087_5_ = BowFly.pitch;

            if (this.getModule(Scaffold.class).isEnabled())
                p_78087_5_ = Scaffold.pitch;

            p_78087_5_ = lastRenderedPitch + (p_78087_5_ - lastRenderedPitch) * mc.timer.renderPartialTicks;

            lastRenderedPitch = lastRenderedPitch + (p_78087_5_ - lastRenderedPitch) * mc.timer.renderPartialTicks;
        }

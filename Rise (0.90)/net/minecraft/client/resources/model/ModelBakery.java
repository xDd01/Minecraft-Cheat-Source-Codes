...
public class ModelBakery {
            ...
            try {
                for (final IResource iresource : this.resourceManager.getAllResources(resourcelocation)) {
                    ...
                    try {
                        ...
                        final ModelBlockDefinition modelblockdefinition1 = ModelBlockDefinition.parseFromReader(new InputStreamReader(inputstream, Charsets.UTF_8));
    ...
    private ModelBlock loadModel(ResourceLocation p_177594_1_) throws IOException {
        ...
        if ("builtin/generated".equals(s)) {
            ...
            if (s.startsWith("builtin/")) {
                final String s1 = s.substring("builtin/".length());
                final String s2 = BUILT_IN_MODELS.get(s1);
            ...
            try {
                ...
                final String s3 = TextureUtils.getBasePath(p_177594_1_.getResourcePath());
    ...
    private void registerVariantNames() {
        ...
        for (final Entry<RegistryDelegate<Item>, Set<String>> entry : customVariantNames.entrySet()) {
    ...
    private void bakeBlockModels() {
        ...
        for (final Entry<String, ResourceLocation> entry : this.itemLocations.entrySet()) {
            ...
            final ModelBlock modelblock1 = this.models.get(resourcelocation);
    ...
    private Set<ResourceLocation> getVariantsTextureLocations() {
        ...
        final List<ModelResourceLocation> list = Lists.newArrayList(this.variants.keySet());
    ...
    protected IBakedModel bakeModel(final ModelBlock p_bakeModel_1_, final ITransformation p_bakeModel_2_, final boolean p_bakeModel_3_) {
        ...
        for (final BlockPart blockpart : p_bakeModel_1_.getElements()) {
            for (final EnumFacing enumfacing : blockpart.mapFaces.keySet()) {
                ...
                final TextureAtlasSprite textureatlassprite1 = this.sprites.get(new ResourceLocation(p_bakeModel_1_.resolveTextureName(blockpartface.texture)));
                boolean flag = true;
    ...
    private void loadModels() {
        ...
        for (final ResourceLocation resourcelocation : this.models.keySet()) {
            ...
            final ResourceLocation resourcelocation1 = this.models.get(resourcelocation).getParentLocation();
    ...
    private ResourceLocation getParentLocation(final ResourceLocation p_177576_1_) {
        for (final Entry<ResourceLocation, ModelBlock> entry : this.models.entrySet()) {
            ...
            if (modelblock != null) {
                ...
                if (this.hasItemModel(modelblock)) {
                    ...
                    for (final BlockPart blockpart : modelblock.getElements()) {
                        for (final BlockPartFace blockpartface : blockpart.mapFaces.values()) {
                            final ResourceLocation resourcelocation1 = new ResourceLocation(modelblock.resolveTextureName(blockpartface.texture));
    ...
    private void bakeItemModels() {
        for (final ResourceLocation resourcelocation : this.itemLocations.values()) {
            ...
            if (this.hasItemModel(modelblock)) {
                final ModelBlock modelblock1 = this.makeItemModel(modelblock);
    ...
    public static void fixModelLocations(final ModelBlock p_fixModelLocations_0_, final String p_fixModelLocations_1_) {
        ...
        final Map<String, String> map = (Map) Reflector.getFieldValue(p_fixModelLocations_0_, Reflector.ModelBlock_textures);

        if (map != null) {
            for (final Entry<String, String> entry : map.entrySet()) {
                final String s = entry.getValue();
                final String s1 = fixResourcePath(s, p_fixModelLocations_1_);
    ...
    public static ResourceLocation fixModelLocation(ResourceLocation p_fixModelLocation_0_, final String p_fixModelLocation_1_) {
        if (p_fixModelLocation_0_ != null && p_fixModelLocation_1_ != null) {
            if (!p_fixModelLocation_0_.getResourceDomain().equals("minecraft")) {
                ...
                final String s1 = fixResourcePath(s, p_fixModelLocation_1_);

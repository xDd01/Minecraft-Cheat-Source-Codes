...
public class MapItemRenderer {
     ...
     */
    private MapItemRenderer.Instance getMapRendererInstance(final MapData mapdataIn) {
    ...
    public void clearLoadedMaps() {
        for (final MapItemRenderer.Instance mapitemrenderer$instance : this.loadedMaps.values()) {
    ...
    class Instance {
        ...
        private void updateMapTexture() {
            for (int i = 0; i < 16384; ++i) {
                final int j = this.mapData.colors[i] & 255;
        ...
        private void render(final boolean noOverlayRendering) {
            ...
            worldrenderer.pos((float) (i + 0) + f, (float) (j + 128) - f, -0.009999999776482582D).func_181673_a(0.0D, 1.0D).endVertex();
            worldrenderer.pos((float) (i + 128) - f, (float) (j + 128) - f, -0.009999999776482582D).func_181673_a(1.0D, 1.0D).endVertex();
            worldrenderer.pos((float) (i + 128) - f, (float) (j + 0) + f, -0.009999999776482582D).func_181673_a(1.0D, 0.0D).endVertex();
            worldrenderer.pos((float) (i + 0) + f, (float) (j + 0) + f, -0.009999999776482582D).func_181673_a(0.0D, 0.0D).endVertex();
            tessellator.draw();
            ...
            for (final Vec4b vec4b : this.mapData.playersVisibleOnMap.values()) {
                if (!noOverlayRendering || vec4b.func_176110_a() == 1) {
                    ...
                    final float f1 = (float) (b0 % 4 + 0) / 4.0F;
                    final float f2 = (float) (b0 / 4 + 0) / 4.0F;
                    final float f3 = (float) (b0 % 4 + 1) / 4.0F;
                    final float f4 = (float) (b0 / 4 + 1) / 4.0F;
                    worldrenderer.begin(7, DefaultVertexFormats.field_181707_g);
                    final float f5 = -0.001F;
                    worldrenderer.pos(-1.0D, 1.0D, (float) k * -0.001F).func_181673_a(f1, f2).endVertex();
                    worldrenderer.pos(1.0D, 1.0D, (float) k * -0.001F).func_181673_a(f3, f2).endVertex();
                    worldrenderer.pos(1.0D, -1.0D, (float) k * -0.001F).func_181673_a(f3, f4).endVertex();
                    worldrenderer.pos(-1.0D, -1.0D, (float) k * -0.001F).func_181673_a(f1, f4).endVertex();
                    tessellator.draw();

    ...
    protected void actionPerformed(final GuiButton button) throws IOException {
        switch (button.id) {
            ...
            case 1:
                ...
                final boolean flag1 = this.mc.func_181540_al();
                button.enabled = false;
                this.mc.theWorld.sendQuittingDisconnectingPacket();
                this.mc.loadWorld(null);

                if (flag) {
                    this.mc.displayGuiScreen(Rise.INSTANCE.getGuiMainMenu());
                } else if (!flag1) {
                    this.mc.displayGuiScreen(Rise.INSTANCE.getGuiMultiplayer());
                }

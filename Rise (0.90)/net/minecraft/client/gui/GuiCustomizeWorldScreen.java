...
public class GuiCustomizeWorldScreen extends GuiScreen implements GuiSlider.FormatHelper, GuiPageButtonList.GuiResponder {
        ...
        switch (p_175330_1_) {
            ...
            case 162:
                if (p_175330_2_ < 0.0F) {
                    ...
                    final BiomeGenBase biomegenbase = BiomeGenBase.getBiomeGenArray()[(int) p_175330_2_];
            ...
            switch (button.id) {
                ...
                case 301:
                    for (int i = 0; i < this.field_175349_r.getSize(); ++i) {
                        ...
                        final Gui gui1 = guipagebuttonlist$guientry.func_178021_b();

                        if (gui1 instanceof GuiButton) {
                            final GuiButton guibutton1 = (GuiButton) gui1;

                            if (guibutton1 instanceof GuiSlider) {
                                final float f1 = ((GuiSlider) guibutton1).func_175217_d() * (0.75F + this.random.nextFloat() * 0.5F) + (this.random.nextFloat() * 0.1F - 0.05F);
    ...
    private void func_175327_a(final float p_175327_1_) {
        ...
        if (gui instanceof GuiTextField) {
            ...
            if (f1 != null) {
                ...
                final String s = this.func_175330_b(guitextfield.getId(), f1.floatValue());
    ...
    public void drawScreen(final int mouseX, final int mouseY, final float partialTicks) {
        ...
        if (this.field_175339_B != 0) {
            ...
            worldrenderer.pos(this.width / 2 - 90, 185.0D, 0.0D).func_181673_a(0.0D, 2.65625D).color(64, 64, 64, 64).endVertex();
            worldrenderer.pos(this.width / 2 + 90, 185.0D, 0.0D).func_181673_a(5.625D, 2.65625D).color(64, 64, 64, 64).endVertex();
            worldrenderer.pos(this.width / 2 + 90, 100.0D, 0.0D).func_181673_a(5.625D, 0.0D).color(64, 64, 64, 64).endVertex();
            worldrenderer.pos(this.width / 2 - 90, 100.0D, 0.0D).func_181673_a(0.0D, 0.0D).color(64, 64, 64, 64).endVertex();
            tessellator.draw();

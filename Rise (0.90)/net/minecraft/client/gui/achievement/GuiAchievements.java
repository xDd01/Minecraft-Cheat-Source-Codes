    ...
    protected void drawAchievementScreen(final int p_146552_1_, final int p_146552_2_, final float p_146552_3_) {
        ...
        if (achievement != null) {
            ...
            if (this.statFileWriter.canUnlockAchievement(achievement)) {
                final int j8 = Math.max(this.fontRendererObj.getStringWidth(s), 120);
                ...
                final int k8 = Math.max(this.fontRendererObj.getStringWidth(s), 120);
                ...
                final int l8 = Math.max(this.fontRendererObj.getStringWidth(s), 120);

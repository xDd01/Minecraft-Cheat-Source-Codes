...
public class GuiPageButtonList extends GuiListExtended {
    ...
    public GuiPageButtonList(final Minecraft mcIn, final int widthIn, final int heightIn, final int topIn, final int bottomIn, final int slotHeightIn, final GuiPageButtonList.GuiResponder p_i45536_7_, final GuiPageButtonList.GuiListEntry[]... p_i45536_8_) {
    ...
    private void func_178069_s() {
        for (final GuiPageButtonList.GuiListEntry[] aguipagebuttonlist$guilistentry : this.field_178078_x) {
            for (int i = 0; i < aguipagebuttonlist$guilistentry.length; i += 2) {
                final GuiPageButtonList.GuiListEntry guipagebuttonlist$guilistentry = aguipagebuttonlist$guilistentry[i];
                final GuiPageButtonList.GuiListEntry guipagebuttonlist$guilistentry1 = i < aguipagebuttonlist$guilistentry.length - 1 ? aguipagebuttonlist$guilistentry[i + 1] : null;
                final Gui gui = this.func_178058_a(guipagebuttonlist$guilistentry, 0, guipagebuttonlist$guilistentry1 == null);
                final Gui gui1 = this.func_178058_a(guipagebuttonlist$guilistentry1, 160, guipagebuttonlist$guilistentry == null);
                final GuiPageButtonList.GuiEntry guipagebuttonlist$guientry = new GuiPageButtonList.GuiEntry(gui, gui1);
    ...
    private void func_178055_t() {
        ...
        for (int i = 0; i < this.field_178078_x[this.field_178077_y].length; i += 2) {
            final GuiPageButtonList.GuiListEntry guipagebuttonlist$guilistentry = this.field_178078_x[this.field_178077_y][i];
            final GuiPageButtonList.GuiListEntry guipagebuttonlist$guilistentry1 = i < this.field_178078_x[this.field_178077_y].length - 1 ? this.field_178078_x[this.field_178077_y][i + 1] : null;
            final Gui gui = this.field_178073_v.lookup(guipagebuttonlist$guilistentry.func_178935_b());
            final Gui gui1 = guipagebuttonlist$guilistentry1 != null ? this.field_178073_v.lookup(guipagebuttonlist$guilistentry1.func_178935_b()) : null;
            final GuiPageButtonList.GuiEntry guipagebuttonlist$guientry = new GuiPageButtonList.GuiEntry(gui, gui1);
            this.field_178074_u.add(guipagebuttonlist$guientry);
        }
    }
    ...
    private void func_178060_e(final int p_178060_1_, final int p_178060_2_) {
        for (final GuiPageButtonList.GuiListEntry guipagebuttonlist$guilistentry : this.field_178078_x[p_178060_1_]) {
        ...
        for (final GuiPageButtonList.GuiListEntry guipagebuttonlist$guilistentry1 : this.field_178078_x[p_178060_2_]) {
    ...
    private Gui func_178058_a(final GuiPageButtonList.GuiListEntry p_178058_1_, final int p_178058_2_, final boolean p_178058_3_) {
    ...
    public void func_181155_a(final boolean p_181155_1_) {
        for (final GuiPageButtonList.GuiEntry guipagebuttonlist$guientry : this.field_178074_u) {
    ...
    public boolean mouseClicked(final int mouseX, final int mouseY, final int mouseEvent) {
        ...
        if (i >= 0) {
            final GuiPageButtonList.GuiEntry guipagebuttonlist$guientry = this.getListEntry(i);
    ...
    private GuiSlider func_178067_a(final int p_178067_1_, final int p_178067_2_, final GuiPageButtonList.GuiSlideEntry p_178067_3_) {
    ...
    private GuiListButton func_178065_a(final int p_178065_1_, final int p_178065_2_, final GuiPageButtonList.GuiButtonEntry p_178065_3_) {
    ...
    private GuiTextField func_178068_a(final int p_178068_1_, final int p_178068_2_, final GuiPageButtonList.EditBoxEntry p_178068_3_) {
        final GuiTextField guitextfield = new GuiTextField(p_178068_3_.func_178935_b(), this.mc.fontRendererObj, p_178068_1_, p_178068_2_, 150, 20, true);
    ...
    private GuiLabel func_178063_a(final int p_178063_1_, final int p_178063_2_, final GuiPageButtonList.GuiLabelEntry p_178063_3_, final boolean p_178063_4_) {
        final GuiLabel guilabel;
    ...
    public void func_178062_a(final char p_178062_1_, final int p_178062_2_) {
        if (this.field_178075_A instanceof GuiTextField) {
            ...
            if (!GuiScreen.isKeyComboCtrlV(p_178062_2_)) {
                ...
                final int i = this.field_178072_w.indexOf(this.field_178075_A);
                int j = i;
     ...
     */
    public GuiPageButtonList.GuiEntry getListEntry(final int index) {
    ...
    public static class GuiEntry implements GuiListExtended.IGuiListEntry {
        ...
        public boolean mousePressed(final int slotIndex, final int p_148278_2_, final int p_148278_3_, final int p_148278_4_, final int p_148278_5_, final int p_148278_6_) {
            ...
            final boolean flag1 = this.func_178026_a(this.field_178030_c, p_148278_2_, p_148278_3_, p_148278_4_);
            return flag || flag1;
        }

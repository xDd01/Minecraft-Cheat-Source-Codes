...
public class GuiTextField extends Gui {
    ...
    public GuiTextField(final int componentId, final FontRenderer fontrendererObj, final int x, final int y, final int par5Width, final int par6Height, final boolean backGround) {
        this.id = componentId;
    ...
    public void mouseClicked(final int p_146192_1_, final int p_146192_2_, final int p_146192_3_) {
        ...
        if (this.isFocused && flag && p_146192_3_ == 0) {
            ...
            if (Interface.customChat) {
                final String s = comfortaa.trimStringToWidth(this.text.substring(this.lineScrollOffset), this.getWidth());
                this.setCursorPosition((comfortaa.trimStringToWidth(s, i).length() + this.lineScrollOffset) * 2);
            } else {
    ...
    public void drawTextBox() {
        if (this.getVisible()) {
            if (this.getEnableBackgroundDrawing() && drawBackground) {
            ...
            if (s.length() > 0) {
                ...
                if (Interface.customChat) {
                    j1 = (l + comfortaa.getWidth(s1)) - 4;
                    comfortaa.drawStringWithShadow(s1, (float) l, (float) i1, Color.WHITE.hashCode());
                } else {
            ...
            if (!flag) {
                ...
                k1 = j1 - 1;
                if (Interface.customChat) k1 += 3;
                --j1;
            }

            if (s.length() > 0 && flag && j < s.length()) {
                if (Interface.customChat) {
                    comfortaa.drawStringWithShadow(s.substring(j), j1 + 3, i1, Color.WHITE.getRGB());
                } else {
            ...
            if (flag1) {
                if (flag2) {
                    ...
                    if (Interface.customChat) {
                        comfortaa.drawStringWithShadow("_", s.isEmpty() ? (float) k1 : (float) k1 + 3.5f, (float) i1, Color.WHITE.hashCode());
                    } else {
            ...
            if (k != j) {
                final int l1 = (int) (l + (Interface.customChat ? comfortaa.getWidth(s.substring(0, k)) : this.fontRendererInstance.getStringWidth(s.substring(0, k))));
                this.drawCursorVertical(Interface.customChat ? k1 + 2 : k1, i1 - 1, l1 - 1, i1 + 1 + this.fontRendererInstance.FONT_HEIGHT);
            }
        }
    }

    public void drawTextBoxWithoutBackground() {
        if (this.getVisible()) {
            if (this.getEnableBackgroundDrawing() && drawBackground) {
                //drawRect(this.xPosition - 1, this.yPosition - 1, this.xPosition + this.width + 1, this.yPosition + this.height + 1, -6250336);
                //drawRect(this.xPosition, this.yPosition, this.xPosition + this.width, this.yPosition + this.height, -16777216);
            ...
            if (k != j) {
                final int l1 = l + this.fontRendererInstance.getStringWidth(s.substring(0, k));

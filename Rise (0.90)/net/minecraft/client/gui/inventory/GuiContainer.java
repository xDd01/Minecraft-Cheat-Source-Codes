...
public abstract class GuiContainer extends GuiScreen {
    ...
    public void initGui() {
        ...
        this.buttonList.add(new GuiButton(1337, 5, 5, "Disable Aura"));
        this.buttonList.add(new GuiButton(1338, 5, 30, "Disable Stealer"));
        this.buttonList.add(new GuiButton(1339, 5, 55, "Steal this chest"));
    }
    ...
    public void drawScreen(final int mouseX, final int mouseY, final float partialTicks) {
        ...
        final boolean canPopUp = Objects.requireNonNull(Rise.INSTANCE.getModuleManager().getModule("PopOutAnimation")).isEnabled() && PopOutAnimation.inventoriesValue;
        ...
        if (canPopUp) {
            ...
            GlStateManager.translate(sr.getScaledWidth() / 2F - xSize / 2F * size - guiLeft * size, sr.getScaledHeight() / 2F - ySize / 2F * size - guiTop * size, 1);
    ...
    protected void actionPerformed(GuiButton button) throws IOException {
        ...
        switch (button.id) {
            case 1337: {
                final Module module = Rise.INSTANCE.getModuleManager().getModule("Aura");
                assert module != null;
            ...
            case 1338: {
                final Module module = Rise.INSTANCE.getModuleManager().getModule("Stealer");
                assert module != null;
                module.setEnabled(false);
                break;
            }
            ...
            case 1339: {
                ...
                assert module != null;
                if (!module.isEnabled()) {
                    Stealer.closeAfterContainer = true;
                    module.toggleModule();
                }
                break;
            }

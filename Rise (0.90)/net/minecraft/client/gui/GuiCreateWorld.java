...
public class GuiCreateWorld extends GuiScreen {
    ...
    public void initGui() {
        ...
        this.field_146333_g = new GuiTextField(9, this.fontRendererObj, this.width / 2 - 100, 60, 200, 20, true);
        this.field_146333_g.setFocused(true);
        this.field_146333_g.setText(this.field_146330_J);
        this.field_146335_h = new GuiTextField(10, this.fontRendererObj, this.width / 2 - 100, 60, 200, 20, true);
    ...
    public static String func_146317_a(final ISaveFormat p_146317_0_, String p_146317_1_) {
        ...
        for (final String s : disallowedFilenames) {

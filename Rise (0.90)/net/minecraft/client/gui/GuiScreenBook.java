...
public class GuiScreenBook extends GuiScreen {
    ...
    public void drawScreen(final int mouseX, final int mouseY, final float partialTicks) {
        ...
        if (this.bookGettingSigned) {
            ...
            final int k = this.fontRendererObj.getStringWidth(s1);
            ...
            final String s2 = I18n.format("book.byAuthor", this.editingPlayer.getName());
            final int i1 = this.fontRendererObj.getStringWidth(s2);
            ...
            final int j1 = this.fontRendererObj.getStringWidth(s4);

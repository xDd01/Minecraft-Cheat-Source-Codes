...
public class GuiScreenCustomizePresets extends GuiScreen {
    ...
    public void initGui() {
        ...
        this.field_175317_i = new GuiTextField(2, this.fontRendererObj, 50, 40, this.width - 100, 20, true);
    ...
    class ListPreset extends GuiSlot {
        ...
        private void func_178051_a(final int p_178051_1_, final int p_178051_2_, final ResourceLocation p_178051_3_) {
            ...
            worldrenderer.pos(i + 0, p_178051_2_ + 32, 0.0D).func_181673_a(0.0D, 1.0D).endVertex();
            worldrenderer.pos(i + 32, p_178051_2_ + 32, 0.0D).func_181673_a(1.0D, 1.0D).endVertex();
            worldrenderer.pos(i + 32, p_178051_2_ + 0, 0.0D).func_181673_a(1.0D, 0.0D).endVertex();
            worldrenderer.pos(i + 0, p_178051_2_ + 0, 0.0D).func_181673_a(0.0D, 0.0D).endVertex();
            tessellator.draw();
        }

...
public class EntityFirework {
    public static class Factory implements IParticleFactory {
        public EntityFX getEntityFX(final int particleID, final World worldIn, final double xCoordIn, final double yCoordIn, final double zCoordIn, final double xSpeedIn, final double ySpeedIn, final double zSpeedIn, final int... p_178902_15_) {
            ...
            entityfirework$sparkfx.setAlphaF(0.8f);
    ...
    public static class OverlayFX extends EntityFX {
        ...
        public void renderParticle(final WorldRenderer worldRendererIn, final Entity entityIn, final float partialTicks, final float p_180434_4_, final float p_180434_5_, final float p_180434_6_, final float p_180434_7_, final float p_180434_8_) {
            ...
            this.particleAlpha = 0.6F - ((float) this.particleAge * 2 + partialTicks - 1.0F) * 0.25F * 0.5F;
            ...
            final int k = i & 65535;
            worldRendererIn.pos((f5 - p_180434_4_ * f4 - p_180434_7_ * f4), (f6 - p_180434_5_ * f4), (f7 - p_180434_6_ * f4 - p_180434_8_ * f4)).func_181673_a(0.5D, 0.375D).func_181666_a(this.particleRed, this.particleGreen, this.particleBlue, this.particleAlpha).func_181671_a(j, k).endVertex();
            worldRendererIn.pos((f5 - p_180434_4_ * f4 + p_180434_7_ * f4), (f6 + p_180434_5_ * f4), (f7 - p_180434_6_ * f4 + p_180434_8_ * f4)).func_181673_a(0.5D, 0.125D).func_181666_a(this.particleRed, this.particleGreen, this.particleBlue, this.particleAlpha).func_181671_a(j, k).endVertex();
            worldRendererIn.pos((f5 + p_180434_4_ * f4 + p_180434_7_ * f4), (f6 + p_180434_5_ * f4), (f7 + p_180434_6_ * f4 + p_180434_8_ * f4)).func_181673_a(0.25D, 0.125D).func_181666_a(this.particleRed, this.particleGreen, this.particleBlue, this.particleAlpha).func_181671_a(j, k).endVertex();
            worldRendererIn.pos((f5 + p_180434_4_ * f4 - p_180434_7_ * f4), (f6 - p_180434_5_ * f4), (f7 + p_180434_6_ * f4 - p_180434_8_ * f4)).func_181673_a(0.25D, 0.375D).func_181666_a(this.particleRed, this.particleGreen, this.particleBlue, this.particleAlpha).func_181671_a(j, k).endVertex();
        }
    }
    ...
    public static class SparkFX extends EntityFX {
        ...
        public SparkFX(final World p_i46465_1_, final double p_i46465_2_, final double p_i46465_4_, final double p_i46465_6_, final double p_i46465_8_, final double p_i46465_10_, final double p_i46465_12_, final EffectRenderer p_i46465_14_) {
            ...
            this.motionX = p_i46465_8_ / 5;
            this.motionY = p_i46465_10_ / 5;
            this.motionZ = p_i46465_12_ / 5;

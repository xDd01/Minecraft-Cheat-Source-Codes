...
public class CommandStats extends CommandBase {
    ...
    public void processCommand(ICommandSender sender, String[] args) throws CommandException {
        if (args.length < 1) {
            throw new WrongUsageException("impl.stats.usage", new Object[0]);
        } else {
            boolean flag;
            ...
            if (flag) {
                if (args.length < 5) {
                    throw new WrongUsageException("impl.stats.block.usage", new Object[0]);
                }

                i = 4;
            } else {
                if (args.length < 3) {
                    throw new WrongUsageException("impl.stats.entity.usage", new Object[0]);
                }
            ...
            if ("set".equals(s)) {
                if (args.length < i + 3) {
                    if (i == 5) {
                        throw new WrongUsageException("impl.stats.block.set.usage", new Object[0]);
                    }

                    throw new WrongUsageException("impl.stats.entity.set.usage", new Object[0]);
                }
            } else {
                if (!"clear".equals(s)) {
                    throw new WrongUsageException("impl.stats.usage", new Object[0]);
                ...
                if (args.length < i + 1) {
                    if (i == 5) {
                        throw new WrongUsageException("impl.stats.block.clear.usage", new Object[0]);
                    }

                    throw new WrongUsageException("impl.stats.entity.clear.usage", new Object[0]);
                }
            }
            ...
            if (commandresultstats$type == null) {
                ...
                if ("set".equals(s)) {
                    ...
                    notifyOperators(sender, this, "impl.stats.success", new Object[]{commandresultstats$type.getTypeName(), s2, s1});
                    ...
                    notifyOperators(sender, this, "impl.stats.cleared", new Object[]{commandresultstats$type.getTypeName()});
                }

...
public class CommandDefaultGameMode extends CommandGameMode {
    ...
    public String getCommandUsage(ICommandSender sender) {
        return "impl.defaultgamemode.usage";
    }
    ...
    public void processCommand(ICommandSender sender, String[] args) throws CommandException {
        if (args.length <= 0) {
            throw new WrongUsageException("impl.defaultgamemode.usage", new Object[0]);
        } else {
            ...
            notifyOperators(sender, this, "impl.defaultgamemode.success", new Object[]{new ChatComponentTranslation("gameMode." + worldsettings$gametype.getName(), new Object[0])});
        }
    }

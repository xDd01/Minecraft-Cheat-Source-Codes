    ...
    public void processCommand(ICommandSender sender, String[] args) throws CommandException {
        ...
        if (args.length >= 2 && item == null) {
            ...
            if (k == 0) {
                ...
                if (j == 0) {
                    sender.addChatMessage(new ChatComponentTranslation("impl.clear.testing", new Object[]{entityplayermp.getName(), Integer.valueOf(k)}));
                } else {
                    notifyOperators(sender, this, "impl.clear.success", new Object[]{entityplayermp.getName(), Integer.valueOf(k)});
                }
            }
        }
    }

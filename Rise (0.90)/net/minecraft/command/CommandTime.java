    ...
    public void processCommand(ICommandSender sender, String[] args) throws CommandException {
        if (args.length > 1) {
            if (args[0].equals("set")) {
                ...
                notifyOperators(sender, this, "impl.time.set", new Object[]{Integer.valueOf(l)});
                return;
            }
            ...
            if (args[0].equals("add")) {
                ...
                notifyOperators(sender, this, "impl.time.added", new Object[]{Integer.valueOf(k)});
                return;
            }
            ...
            if (args[0].equals("query")) {
                if (args[1].equals("daytime")) {
                    ...
                    notifyOperators(sender, this, "impl.time.query", new Object[]{Integer.valueOf(j)});
                    return;
                }
                ...
                if (args[1].equals("gametime")) {
                    ...
                    notifyOperators(sender, this, "impl.time.query", new Object[]{Integer.valueOf(i)});
                    return;
                }
            }
        }

        throw new WrongUsageException("impl.time.usage", new Object[0]);
    }

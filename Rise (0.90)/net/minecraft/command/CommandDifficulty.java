...
public class CommandDifficulty extends CommandBase {
    ...
    public void processCommand(ICommandSender sender, String[] args) throws CommandException {
        if (args.length <= 0) {
            throw new WrongUsageException("impl.difficulty.usage", new Object[0]);
        } else {
            ...
            notifyOperators(sender, this, "impl.difficulty.success", new Object[]{new ChatComponentTranslation(enumdifficulty.getDifficultyResourceKey(), new Object[0])});
        }
    }

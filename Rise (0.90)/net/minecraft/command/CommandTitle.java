...
public class CommandTitle extends CommandBase {
    ...
    public void processCommand(ICommandSender sender, String[] args) throws CommandException {
        if (args.length < 2) {
            throw new WrongUsageException("impl.title.usage", new Object[0]);
        } else {
            if (args.length < 3) {
                if ("title".equals(args[1]) || "subtitle".equals(args[1])) {
                    throw new WrongUsageException("impl.title.usage.title", new Object[0]);
                }

                if ("times".equals(args[1])) {
                    throw new WrongUsageException("impl.title.usage.times", new Object[0]);
                }
            }
            ...
            if (s45packettitle$type != S45PacketTitle.Type.CLEAR && s45packettitle$type != S45PacketTitle.Type.RESET) {
                if (s45packettitle$type == S45PacketTitle.Type.TIMES) {
                    if (args.length != 5) {
                        ...
                        notifyOperators(sender, this, "impl.title.success", new Object[0]);
                    }
                    ...
                    try {
                        ...
                        throw new SyntaxErrorException("impl.tellraw.jsonException", new Object[]{throwable == null ? "" : throwable.getMessage()});
                    }

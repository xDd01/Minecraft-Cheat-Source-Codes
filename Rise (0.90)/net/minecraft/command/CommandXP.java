...
public class CommandXP extends CommandBase {
    ...
    public void processCommand(ICommandSender sender, String[] args) throws CommandException {
        if (args.length <= 0) {
            throw new WrongUsageException("impl.xp.usage", new Object[0]);
        } else {
            String s = args[0];
            ...
            if (flag) {
                ...
                if (flag1) {
                    ...
                    notifyOperators(sender, this, "impl.xp.success.negative.levels", new Object[]{Integer.valueOf(i), entityplayer.getName()});
                } else {
                    entityplayer.addExperienceLevel(i);
                    notifyOperators(sender, this, "impl.xp.success.levels", new Object[]{Integer.valueOf(i), entityplayer.getName()});
                }
            } else {
                ...
                notifyOperators(sender, this, "impl.xp.success", new Object[]{Integer.valueOf(i), entityplayer.getName()});
            }
        }
    }

...
public class CommandEffect extends CommandBase {
    ...
    public void processCommand(ICommandSender sender, String[] args) throws CommandException {
        if (args.length < 2) {
            throw new WrongUsageException("impl.effect.usage", new Object[0]);
        } else {
            ...
            if (args[1].equals("clear")) {
                if (entitylivingbase.getActivePotionEffects().isEmpty()) {
                    ...
                    notifyOperators(sender, this, "impl.effect.success.removed.all", new Object[]{entitylivingbase.getCommandSenderName()});
                }
            } else {
                int i;
                ...
                if (i >= 0 && i < Potion.potionTypes.length && Potion.potionTypes[i] != null) {
                    ...
                    if (l > 0) {
                        ...
                        notifyOperators(sender, this, "impl.effect.success", new Object[]{new ChatComponentTranslation(potioneffect.getEffectName(), new Object[0]), Integer.valueOf(i), Integer.valueOf(k), entitylivingbase.getCommandSenderName(), Integer.valueOf(l)});
                    } else if (entitylivingbase.isPotionActive(i)) {
                        entitylivingbase.removePotionEffect(i);
                        notifyOperators(sender, this, "impl.effect.success.removed", new Object[]{new ChatComponentTranslation(potion1.getName(), new Object[0]), entitylivingbase.getCommandSenderName()});
                    } else {
                    ...
                    throw new NumberInvalidException("impl.effect.notFound", new Object[]{Integer.valueOf(i)});
                }
            }
        }
    }

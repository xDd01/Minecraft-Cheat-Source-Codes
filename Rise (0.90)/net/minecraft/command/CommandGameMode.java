...
public class CommandGameMode extends CommandBase {
    ...
    public void processCommand(ICommandSender sender, String[] args) throws CommandException {
        if (args.length <= 0) {
            throw new WrongUsageException("impl.gamemode.usage", new Object[0]);
        } else {
            ...
            if (entityplayer != sender) {
                notifyOperators(sender, this, 1, "impl.gamemode.success.other", new Object[]{entityplayer.getName(), ichatcomponent});
            } else {
                notifyOperators(sender, this, 1, "impl.gamemode.success.self", new Object[]{ichatcomponent});
            }
        }
    }

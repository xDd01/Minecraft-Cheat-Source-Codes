...
public class CommandHandler implements ICommandManager {
    ...
    public int executeCommand(ICommandSender sender, String rawCommand) {
        ...
        if (icommand == null) {
            ChatComponentTranslation chatcomponenttranslation = new ChatComponentTranslation("impl.generic.notFound", new Object[0]);
            ...
            ChatComponentTranslation chatcomponenttranslation1 = new ChatComponentTranslation("impl.generic.permission", new Object[0]);
    ...
    protected boolean tryExecute(ICommandSender sender, String[] args, ICommand command, String input) {
        try {
            ...
            ChatComponentTranslation chatcomponenttranslation2 = new ChatComponentTranslation("impl.generic.usage", new Object[]{new ChatComponentTranslation(wrongusageexception.getMessage(), wrongusageexception.getErrorObjects())});
            ...
            ChatComponentTranslation chatcomponenttranslation = new ChatComponentTranslation("impl.generic.exception", new Object[0]);
            chatcomponenttranslation.getChatStyle().setColor(EnumChatFormatting.RED);
            sender.addChatMessage(chatcomponenttranslation);
    ...
    /**
     * adds the command and any aliases it has to the internal map of available impl
     */

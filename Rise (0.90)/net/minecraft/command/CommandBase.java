...
public abstract class CommandBase implements ICommand {
    ...
    public static int parseInt(String input) throws NumberInvalidException {
        try {
            ...
            throw new NumberInvalidException("impl.generic.num.invalid", new Object[]{input});
        }
    }
    ...
    public static int parseInt(String input, int min, int max) throws NumberInvalidException {
        ...
        if (i < min) {
            throw new NumberInvalidException("impl.generic.num.tooSmall", new Object[]{Integer.valueOf(i), Integer.valueOf(min)});
        } else if (i > max) {
            throw new NumberInvalidException("impl.generic.num.tooBig", new Object[]{Integer.valueOf(i), Integer.valueOf(max)});
        } else {
            return i;
        }
    }
    ...
    public static long parseLong(String input, long min, long max) throws NumberInvalidException {
        ...
        if (i < min) {
            throw new NumberInvalidException("impl.generic.num.tooSmall", new Object[]{Long.valueOf(i), Long.valueOf(min)});
        } else if (i > max) {
            throw new NumberInvalidException("impl.generic.num.tooBig", new Object[]{Long.valueOf(i), Long.valueOf(max)});
        } else {
            return i;
        }
    }
    ...
    public static double parseDouble(String input, double min, double max) throws NumberInvalidException {
        ...
        if (d0 < min) {
            throw new NumberInvalidException("impl.generic.double.tooSmall", new Object[]{Double.valueOf(d0), Double.valueOf(min)});
        } else if (d0 > max) {
            throw new NumberInvalidException("impl.generic.double.tooBig", new Object[]{Double.valueOf(d0), Double.valueOf(max)});
        } else {
            return d0;
        }
    }
    ...
    public static <T extends Entity> T getEntity(ICommandSender commandSender, String p_175759_1_, Class<? extends T> p_175759_2_) throws EntityNotFoundException {
        ...
        if (entity == null) {
            try {
                ...
                throw new EntityNotFoundException("impl.generic.entity.invalidUuid", new Object[0]);
            }
        }
    ...
    public static CommandBase.CoordinateArg parseCoordinate(double p_175767_0_, String p_175767_2_, int min, int max, boolean centerBlock) throws NumberInvalidException {
        ...
        if (flag && Double.isNaN(p_175767_0_)) {
            throw new NumberInvalidException("impl.generic.num.invalid", new Object[]{Double.valueOf(p_175767_0_)});
        } else {
            double d0 = 0.0D;
            ...
            if (min != 0 || max != 0) {
                if (d0 < (double) min) {
                    throw new NumberInvalidException("impl.generic.double.tooSmall", new Object[]{Double.valueOf(d0), Integer.valueOf(min)});
                }

                if (d0 > (double) max) {
                    throw new NumberInvalidException("impl.generic.double.tooBig", new Object[]{Double.valueOf(d0), Integer.valueOf(max)});
                }
            }
    ...
    public static double parseDouble(double base, String input, int min, int max, boolean centerBlock) throws NumberInvalidException {
        ...
        if (flag && Double.isNaN(base)) {
            throw new NumberInvalidException("impl.generic.num.invalid", new Object[]{Double.valueOf(base)});
        } else {
    ...
    public static Item getItemByText(ICommandSender sender, String id) throws NumberInvalidException {
        ...
        if (item == null) {
            throw new NumberInvalidException("impl.give.item.notFound", new Object[]{resourcelocation});
        } else {
            return item;
        }
    }
    ...
    public static Block getBlockByText(ICommandSender sender, String id) throws NumberInvalidException {
        ...
        if (!Block.blockRegistry.containsKey(resourcelocation)) {
            throw new NumberInvalidException("impl.give.block.notFound", new Object[]{resourcelocation});
        } else {

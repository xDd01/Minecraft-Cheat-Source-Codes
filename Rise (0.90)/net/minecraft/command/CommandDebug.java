...
public class CommandDebug extends CommandBase {
    ...
    public void processCommand(ICommandSender sender, String[] args) throws CommandException {
        if (args.length < 1) {
            throw new WrongUsageException("impl.debug.usage", new Object[0]);
        } else {
            if (args[0].equals("start")) {
                ...
                notifyOperators(sender, this, "impl.debug.start", new Object[0]);
                ...
                notifyOperators(sender, this, "impl.debug.stop", new Object[]{Float.valueOf((float) k / 1000.0F), Integer.valueOf(l)});
            }
        }
    }

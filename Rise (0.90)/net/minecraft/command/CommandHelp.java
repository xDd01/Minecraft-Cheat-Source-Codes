...
public class CommandHelp extends CommandBase {
    ...
    public void processCommand(ICommandSender sender, String[] args) throws CommandException {
        ...
        ChatComponentTranslation chatcomponenttranslation1 = new ChatComponentTranslation("impl.help.header", new Object[]{Integer.valueOf(k + 1), Integer.valueOf(j + 1)});
        ...
        if (k == 0 && sender instanceof EntityPlayer) {
            ChatComponentTranslation chatcomponenttranslation2 = new ChatComponentTranslation("impl.help.footer", new Object[0]);

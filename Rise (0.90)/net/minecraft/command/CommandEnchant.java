...
public class CommandEnchant extends CommandBase {
    ...
    public void processCommand(ICommandSender sender, String[] args) throws CommandException {
        if (args.length < 2) {
            throw new WrongUsageException("impl.enchant.usage", new Object[0]);
        } else {
            ...
            if (itemstack == null) {
                ...
                if (enchantment1 == null) {
                    throw new NumberInvalidException("impl.enchant.notFound", new Object[]{Integer.valueOf(i)});
                    ...
                    notifyOperators(sender, this, "impl.enchant.success", new Object[0]);

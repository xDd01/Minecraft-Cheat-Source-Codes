...
public class CommandTestFor extends CommandBase {
    ...
    public void processCommand(ICommandSender sender, String[] args) throws CommandException {
        if (args.length < 1) {
            throw new WrongUsageException("impl.testfor.usage", new Object[0]);
        } else {
            ...
            notifyOperators(sender, this, "impl.testfor.success", new Object[]{entity.getCommandSenderName()});
        }
    }

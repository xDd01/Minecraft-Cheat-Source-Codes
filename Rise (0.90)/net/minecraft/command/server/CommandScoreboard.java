...
public class CommandScoreboard extends CommandBase {
    ...
    public void processCommand(ICommandSender sender, String[] args) throws CommandException {
        if (!this.func_175780_b(sender, args)) {
            if (args.length < 1) {
                throw new WrongUsageException("impl.scoreboard.usage", new Object[0]);
            } else {
                if (args[0].equalsIgnoreCase("objectives")) {
                    if (args.length == 1) {
                        throw new WrongUsageException("impl.scoreboard.objectives.usage", new Object[0]);
                    }
                    ...
                    if (args[1].equalsIgnoreCase("list")) {
                        ...
                        if (args.length < 4) {
                            throw new WrongUsageException("impl.scoreboard.objectives.add.usage", new Object[0]);
                        }

                        this.addObjective(sender, args, 2);
                    } else if (args[1].equalsIgnoreCase("remove")) {
                        if (args.length != 3) {
                            throw new WrongUsageException("impl.scoreboard.objectives.remove.usage", new Object[0]);
                        }
                        ...
                        if (args.length != 3 && args.length != 4) {
                            throw new WrongUsageException("impl.scoreboard.objectives.setdisplay.usage", new Object[0]);
                        }
                    ...
                    if (args.length == 1) {
                        throw new WrongUsageException("impl.scoreboard.players.usage", new Object[0]);
                    }

                    if (args[1].equalsIgnoreCase("list")) {
                        if (args.length > 3) {
                            throw new WrongUsageException("impl.scoreboard.players.list.usage", new Object[0]);
                        }

                        this.listPlayers(sender, args, 2);
                    } else if (args[1].equalsIgnoreCase("add")) {
                        if (args.length < 5) {
                            throw new WrongUsageException("impl.scoreboard.players.add.usage", new Object[0]);
                        }

                        this.setPlayer(sender, args, 2);
                    } else if (args[1].equalsIgnoreCase("remove")) {
                        if (args.length < 5) {
                            throw new WrongUsageException("impl.scoreboard.players.remove.usage", new Object[0]);
                        }

                        this.setPlayer(sender, args, 2);
                    } else if (args[1].equalsIgnoreCase("set")) {
                        if (args.length < 5) {
                            throw new WrongUsageException("impl.scoreboard.players.set.usage", new Object[0]);
                        }

                        this.setPlayer(sender, args, 2);
                    } else if (args[1].equalsIgnoreCase("reset")) {
                        if (args.length != 3 && args.length != 4) {
                            throw new WrongUsageException("impl.scoreboard.players.reset.usage", new Object[0]);
                        }

                        this.resetPlayers(sender, args, 2);
                    } else if (args[1].equalsIgnoreCase("enable")) {
                        if (args.length != 4) {
                            throw new WrongUsageException("impl.scoreboard.players.enable.usage", new Object[0]);
                        }

                        this.func_175779_n(sender, args, 2);
                    } else if (args[1].equalsIgnoreCase("test")) {
                        if (args.length != 5 && args.length != 6) {
                            throw new WrongUsageException("impl.scoreboard.players.test.usage", new Object[0]);
                        }
                        ...
                        if (args.length != 7) {
                            throw new WrongUsageException("impl.scoreboard.players.operation.usage", new Object[0]);
                        }
                    ...
                    if (args.length == 1) {
                        throw new WrongUsageException("impl.scoreboard.teams.usage", new Object[0]);
                    }

                    if (args[1].equalsIgnoreCase("list")) {
                        if (args.length > 3) {
                            throw new WrongUsageException("impl.scoreboard.teams.list.usage", new Object[0]);
                        }

                        this.listTeams(sender, args, 2);
                    } else if (args[1].equalsIgnoreCase("add")) {
                        if (args.length < 3) {
                            throw new WrongUsageException("impl.scoreboard.teams.add.usage", new Object[0]);
                        }

                        this.addTeam(sender, args, 2);
                    } else if (args[1].equalsIgnoreCase("remove")) {
                        if (args.length != 3) {
                            throw new WrongUsageException("impl.scoreboard.teams.remove.usage", new Object[0]);
                        }

                        this.removeTeam(sender, args, 2);
                    } else if (args[1].equalsIgnoreCase("empty")) {
                        if (args.length != 3) {
                            throw new WrongUsageException("impl.scoreboard.teams.empty.usage", new Object[0]);
                        }

                        this.emptyTeam(sender, args, 2);
                    } else if (args[1].equalsIgnoreCase("join")) {
                        if (args.length < 4 && (args.length != 3 || !(sender instanceof EntityPlayer))) {
                            throw new WrongUsageException("impl.scoreboard.teams.join.usage", new Object[0]);
                        }

                        this.joinTeam(sender, args, 2);
                    } else if (args[1].equalsIgnoreCase("leave")) {
                        if (args.length < 3 && !(sender instanceof EntityPlayer)) {
                            throw new WrongUsageException("impl.scoreboard.teams.leave.usage", new Object[0]);
                        }
                        ...
                        if (args.length != 4 && args.length != 5) {
                            throw new WrongUsageException("impl.scoreboard.teams.option.usage", new Object[0]);
                        }
    ...
    private boolean func_175780_b(ICommandSender p_175780_1_, String[] p_175780_2_) throws CommandException {
        ...
        if (i < 0) {
            ...
            if (list.size() == 0) {
                throw new WrongUsageException("impl.scoreboard.allMatchesFailed", new Object[0]);
            } else {
                return true;
            }
        }
    ...
    protected void addObjective(ICommandSender sender, String[] args, int index) throws CommandException {
        ...
        if (iscoreobjectivecriteria == null) {
            throw new WrongUsageException("impl.scoreboard.objectives.add.wrongType", new Object[]{s1});
            ...
            throw new SyntaxErrorException("impl.scoreboard.objectives.add.tooLong", new Object[]{s, Integer.valueOf(16)});
        } else if (s.length() == 0) {
            throw new WrongUsageException("impl.scoreboard.objectives.add.usage", new Object[0]);
        } else {
            if (args.length > index) {
                ...
                if (s2.length() > 32) {
                    throw new SyntaxErrorException("impl.scoreboard.objectives.add.displayTooLong", new Object[]{s2, Integer.valueOf(32)});
                }
            ...
            notifyOperators(sender, this, "impl.scoreboard.objectives.add.success", new Object[]{s});
        }
    }
    ...
    protected void addTeam(ICommandSender sender, String[] args, int index) throws CommandException {
        ...
        if (scoreboard.getTeam(s) != null) {
            ...
            throw new SyntaxErrorException("impl.scoreboard.teams.add.tooLong", new Object[]{s, Integer.valueOf(16)});
        } else if (s.length() == 0) {
            throw new WrongUsageException("impl.scoreboard.teams.add.usage", new Object[0]);
        } else {
            if (args.length > index) {
                ...
                if (s1.length() > 32) {
                    throw new SyntaxErrorException("impl.scoreboard.teams.add.displayTooLong", new Object[]{s1, Integer.valueOf(32)});
                }
            ...
            notifyOperators(sender, this, "impl.scoreboard.teams.add.success", new Object[]{s});
        }
    }
        ...
        if (scoreplayerteam != null) {
            ...
            if (!s.equalsIgnoreCase("color") && !s.equalsIgnoreCase("friendlyfire") && !s.equalsIgnoreCase("seeFriendlyInvisibles") && !s.equalsIgnoreCase("nametagVisibility") && !s.equalsIgnoreCase("deathMessageVisibility")) {
                ...
                if (s.equalsIgnoreCase("color")) {
                    throw new WrongUsageException("impl.scoreboard.teams.option.noValue", new Object[]{s, joinNiceStringFromCollection(EnumChatFormatting.getValidValues(true, false))});
                    ...
                    if (!s.equalsIgnoreCase("nametagVisibility") && !s.equalsIgnoreCase("deathMessageVisibility")) {
                        ...
                        throw new WrongUsageException("impl.scoreboard.teams.option.noValue", new Object[]{s, joinNiceString(Team.EnumVisible.func_178825_a())});
                    }
                } else {
                    throw new WrongUsageException("impl.scoreboard.teams.option.noValue", new Object[]{s, joinNiceStringFromCollection(Arrays.asList(new String[]{"true", "false"}))});
                }
            } else {
                String s1 = args[index];
                ...
                notifyOperators(sender, this, "impl.scoreboard.teams.option.success", new Object[]{s, scoreplayerteam.getRegisteredName(), s1});
            }
        }
    }
    ...
    protected void removeTeam(ICommandSender p_147194_1_, String[] p_147194_2_, int p_147194_3_) throws CommandException {
        ...
        if (scoreplayerteam != null) {
            ...
            notifyOperators(p_147194_1_, this, "impl.scoreboard.teams.remove.success", new Object[]{scoreplayerteam.getRegisteredName()});
        }
    }
    ...
    protected void listTeams(ICommandSender p_147186_1_, String[] p_147186_2_, int p_147186_3_) throws CommandException {
        ...
        if (p_147186_2_.length > p_147186_3_) {
            ...
            ChatComponentTranslation chatcomponenttranslation = new ChatComponentTranslation("impl.scoreboard.teams.list.player.count", new Object[]{Integer.valueOf(collection.size()), scoreplayerteam.getRegisteredName()});
            ...
            ChatComponentTranslation chatcomponenttranslation1 = new ChatComponentTranslation("impl.scoreboard.teams.list.count", new Object[]{Integer.valueOf(collection1.size())});
            chatcomponenttranslation1.getChatStyle().setColor(EnumChatFormatting.DARK_GREEN);
            p_147186_1_.addChatMessage(chatcomponenttranslation1);

            for (ScorePlayerTeam scoreplayerteam1 : collection1) {
                p_147186_1_.addChatMessage(new ChatComponentTranslation("impl.scoreboard.teams.list.entry", new Object[]{scoreplayerteam1.getRegisteredName(), scoreplayerteam1.getTeamName(), Integer.valueOf(scoreplayerteam1.getMembershipCollection().size())}));
            }
        }
    }
    ...
    protected void joinTeam(ICommandSender p_147190_1_, String[] p_147190_2_, int p_147190_3_) throws CommandException {
        ...
        if (!set.isEmpty()) {
            ...
            notifyOperators(p_147190_1_, this, "impl.scoreboard.teams.join.success", new Object[]{Integer.valueOf(set.size()), s, joinNiceString(set.toArray(new String[set.size()]))});
        }
    ...
    protected void leaveTeam(ICommandSender p_147199_1_, String[] p_147199_2_, int p_147199_3_) throws CommandException {
        ...
        if (!set.isEmpty()) {
            ...
            notifyOperators(p_147199_1_, this, "impl.scoreboard.teams.leave.success", new Object[]{Integer.valueOf(set.size()), joinNiceString(set.toArray(new String[set.size()]))});
        }
    ...
    protected void emptyTeam(ICommandSender p_147188_1_, String[] p_147188_2_, int p_147188_3_) throws CommandException {
        ...
        if (scoreplayerteam != null) {
            ...
            if (collection.isEmpty()) {
                ...
                notifyOperators(p_147188_1_, this, "impl.scoreboard.teams.empty.success", new Object[]{Integer.valueOf(collection.size()), scoreplayerteam.getRegisteredName()});
            }
        }
    }
    ...
    protected void removeObjective(ICommandSender p_147191_1_, String p_147191_2_) throws CommandException {
        ...
        notifyOperators(p_147191_1_, this, "impl.scoreboard.objectives.remove.success", new Object[]{p_147191_2_});
    }
    ...
    protected void listObjectives(ICommandSender p_147196_1_) throws CommandException {
        ...
        if (collection.size() <= 0) {
            ...
            ChatComponentTranslation chatcomponenttranslation = new ChatComponentTranslation("impl.scoreboard.objectives.list.count", new Object[]{Integer.valueOf(collection.size())});
            chatcomponenttranslation.getChatStyle().setColor(EnumChatFormatting.DARK_GREEN);
            p_147196_1_.addChatMessage(chatcomponenttranslation);

            for (ScoreObjective scoreobjective : collection) {
                p_147196_1_.addChatMessage(new ChatComponentTranslation("impl.scoreboard.objectives.list.entry", new Object[]{scoreobjective.getName(), scoreobjective.getDisplayName(), scoreobjective.getCriteria().getName()}));
            }
        }
    }
    ...
    protected void setObjectiveDisplay(ICommandSender p_147198_1_, String[] p_147198_2_, int p_147198_3_) throws CommandException {
        ...
        if (i < 0) {
            ...
            if (scoreobjective != null) {
                notifyOperators(p_147198_1_, this, "impl.scoreboard.objectives.setdisplay.successSet", new Object[]{Scoreboard.getObjectiveDisplaySlot(i), scoreobjective.getName()});
            } else {
                notifyOperators(p_147198_1_, this, "impl.scoreboard.objectives.setdisplay.successCleared", new Object[]{Scoreboard.getObjectiveDisplaySlot(i)});
            }
        }
    }
    ...
    protected void listPlayers(ICommandSender p_147195_1_, String[] p_147195_2_, int p_147195_3_) throws CommandException {
        ...
        if (p_147195_2_.length > p_147195_3_) {
            ...
            ChatComponentTranslation chatcomponenttranslation = new ChatComponentTranslation("impl.scoreboard.players.list.player.count", new Object[]{Integer.valueOf(map.size()), s});
            chatcomponenttranslation.getChatStyle().setColor(EnumChatFormatting.DARK_GREEN);
            p_147195_1_.addChatMessage(chatcomponenttranslation);

            for (Score score : map.values()) {
                p_147195_1_.addChatMessage(new ChatComponentTranslation("impl.scoreboard.players.list.player.entry", new Object[]{Integer.valueOf(score.getScorePoints()), score.getObjective().getDisplayName(), score.getObjective().getName()}));
            }
        } else {
            ...
            ChatComponentTranslation chatcomponenttranslation1 = new ChatComponentTranslation("impl.scoreboard.players.list.count", new Object[]{Integer.valueOf(collection.size())});
            chatcomponenttranslation1.getChatStyle().setColor(EnumChatFormatting.DARK_GREEN);
    ...
    protected void setPlayer(ICommandSender p_147197_1_, String[] p_147197_2_, int p_147197_3_) throws CommandException {
        ...
        if (s1.length() > 40) {
            throw new SyntaxErrorException("impl.scoreboard.players.name.tooLong", new Object[]{s1, Integer.valueOf(40)});
        } else {
            ...
            notifyOperators(p_147197_1_, this, "impl.scoreboard.players.set.success", new Object[]{scoreobjective.getName(), s1, Integer.valueOf(score.getScorePoints())});
        }
    }
    ...
    protected void resetPlayers(ICommandSender p_147187_1_, String[] p_147187_2_, int p_147187_3_) throws CommandException {
        ...
        if (p_147187_2_.length > p_147187_3_) {
            ...
            notifyOperators(p_147187_1_, this, "impl.scoreboard.players.resetscore.success", new Object[]{scoreobjective.getName(), s});
        } else {
            scoreboard.removeObjectiveFromEntity(s, (ScoreObjective) null);
            notifyOperators(p_147187_1_, this, "impl.scoreboard.players.reset.success", new Object[]{s});
        }
    }
    ...
    protected void func_175779_n(ICommandSender p_175779_1_, String[] p_175779_2_, int p_175779_3_) throws CommandException {
        ...
        if (s.length() > 40) {
            throw new SyntaxErrorException("impl.scoreboard.players.name.tooLong", new Object[]{s, Integer.valueOf(40)});
        } else {
            ...
            if (scoreobjective.getCriteria() != IScoreObjectiveCriteria.TRIGGER) {
                ...
                notifyOperators(p_175779_1_, this, "impl.scoreboard.players.enable.success", new Object[]{scoreobjective.getName(), s});
            }
        }
    }
        ...
        if (s.length() > 40) {
            ...
            if (!scoreboard.entityHasObjective(s, scoreobjective)) {
                ...
                if (score.getScorePoints() >= i && score.getScorePoints() <= j) {
                    notifyOperators(p_175781_1_, this, "impl.scoreboard.players.test.success", new Object[]{Integer.valueOf(score.getScorePoints()), Integer.valueOf(i), Integer.valueOf(j)});
                } else {
    ...
    protected void func_175778_p(ICommandSender p_175778_1_, String[] p_175778_2_, int p_175778_3_) throws CommandException {
        ...
        if (s.length() > 40) {
            ...
            throw new SyntaxErrorException("impl.scoreboard.players.name.tooLong", new Object[]{s2, Integer.valueOf(40)});
        } else {
            Score score = scoreboard.getValueFromObjective(s, scoreobjective);
            ...
            if (!scoreboard.entityHasObjective(s2, scoreobjective1)) {
                ...
                notifyOperators(p_175778_1_, this, "impl.scoreboard.players.operation.success", new Object[0]);
            }
        }
    }

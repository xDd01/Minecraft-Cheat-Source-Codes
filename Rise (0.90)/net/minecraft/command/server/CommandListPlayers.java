...
public class CommandListPlayers extends CommandBase {
    ...
    public void processCommand(ICommandSender sender, String[] args) throws CommandException {
        ...
        sender.addChatMessage(new ChatComponentTranslation("impl.players.list", new Object[]{Integer.valueOf(i), Integer.valueOf(MinecraftServer.getServer().getMaxPlayers())}));

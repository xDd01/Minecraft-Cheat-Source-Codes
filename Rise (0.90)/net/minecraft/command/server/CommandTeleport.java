...
public class CommandTeleport extends CommandBase {
    ...
    public void processCommand(ICommandSender sender, String[] args) throws CommandException {
        if (args.length < 1) {
            throw new WrongUsageException("impl.tp.usage", new Object[0]);
        } else {
            int i = 0;
            Entity entity;
            ...
            if (args.length != 1 && args.length != 2) {
                if (args.length < i + 3) {
                    ...
                    notifyOperators(sender, this, "impl.tp.success.coordinates", new Object[]{entity.getCommandSenderName(), Double.valueOf(commandbase$coordinatearg.func_179628_a()), Double.valueOf(commandbase$coordinatearg1.func_179628_a()), Double.valueOf(commandbase$coordinatearg2.func_179628_a())});
                }
            } else {
                ...
                if (entity1.worldObj != entity.worldObj) {
                    ...
                    notifyOperators(sender, this, "impl.tp.success", new Object[]{entity.getCommandSenderName(), entity1.getCommandSenderName()});
                }
            }
        }
    }

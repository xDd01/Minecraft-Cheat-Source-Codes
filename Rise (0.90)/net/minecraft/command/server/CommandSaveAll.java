...
public class CommandSaveAll extends CommandBase {
    ...
    public void processCommand(ICommandSender sender, String[] args) throws CommandException {
        ...
        sender.addChatMessage(new ChatComponentTranslation("impl.save.start", new Object[0]));
        ...
        try {
            ...
            if (args.length > 0 && "flush".equals(args[0])) {
                sender.addChatMessage(new ChatComponentTranslation("impl.save.flushStart", new Object[0]));
                ...
                sender.addChatMessage(new ChatComponentTranslation("impl.save.flushEnd", new Object[0]));
            }
        } catch (MinecraftException minecraftexception) {
            notifyOperators(sender, this, "impl.save.failed", new Object[]{minecraftexception.getMessage()});
            return;
        }

        notifyOperators(sender, this, "impl.save.success", new Object[0]);
    }
}

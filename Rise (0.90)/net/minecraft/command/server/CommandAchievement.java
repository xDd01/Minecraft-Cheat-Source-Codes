...
public class CommandAchievement extends CommandBase {
    ...
    public void processCommand(ICommandSender sender, String[] args) throws CommandException {
        if (args.length < 2) {
            throw new WrongUsageException("impl.achievement.usage", new Object[0]);
        } else {
                ...
                if (flag || flag1) {
                    if (statbase == null) {
                        if (flag) {
                            ...
                            notifyOperators(sender, this, "impl.achievement.give.success.all", new Object[]{entityplayermp.getName()});
                        } else if (flag1) {
                            for (Achievement achievement5 : Lists.reverse(AchievementList.achievementList)) {
                                entityplayermp.func_175145_a(achievement5);
                            }

                            notifyOperators(sender, this, "impl.achievement.take.success.all", new Object[]{entityplayermp.getName()});
                        }
                    } else {
                        ...
                        if (flag) {
                            ...
                            notifyOperators(sender, this, "impl.achievement.give.success.one", new Object[]{entityplayermp.getName(), statbase.func_150955_j()});
                        } else if (flag1) {
                            entityplayermp.func_175145_a(statbase);
                            notifyOperators(sender, this, "impl.achievement.take.success.one", new Object[]{statbase.func_150955_j(), entityplayermp.getName()});
                        }
                    }
                }
            }

...
public class CommandSetDefaultSpawnpoint extends CommandBase {
    ...
    public String getCommandUsage(ICommandSender sender) {
        return "impl.setworldspawn.usage";
    }
    ...
    public void processCommand(ICommandSender sender, String[] args) throws CommandException {
        ...
        if (args.length == 0) {
            ...
            if (args.length != 3 || sender.getEntityWorld() == null) {
                throw new WrongUsageException("impl.setworldspawn.usage", new Object[0]);
            }
        ...
        notifyOperators(sender, this, "impl.setworldspawn.success", new Object[]{Integer.valueOf(blockpos.getX()), Integer.valueOf(blockpos.getY()), Integer.valueOf(blockpos.getZ())});
    }

...
public class CommandBanIp extends CommandBase {
        ...
        if (args.length >= 1 && args[0].length() > 1) {
            ...
            if (matcher.matches()) {
                ...
                if (entityplayermp == null) {
                    throw new PlayerNotFoundException("impl.banip.invalid", new Object[0]);
                }

                this.func_147210_a(sender, entityplayermp.getPlayerIP(), ichatcomponent == null ? null : ichatcomponent.getUnformattedText());
            }
        } else {
            throw new WrongUsageException("impl.banip.usage", new Object[0]);
        }
    }
    ...
    protected void func_147210_a(ICommandSender p_147210_1_, String p_147210_2_, String p_147210_3_) {
        ...
        if (list.isEmpty()) {
            notifyOperators(p_147210_1_, this, "impl.banip.success", new Object[]{p_147210_2_});
        } else {
            notifyOperators(p_147210_1_, this, "impl.banip.success.players", new Object[]{p_147210_2_, joinNiceString(astring)});
        }
    }
}

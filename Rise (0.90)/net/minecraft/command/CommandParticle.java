...
public class CommandParticle extends CommandBase {
    ...
    public void processCommand(ICommandSender sender, String[] args) throws CommandException {
        if (args.length < 8) {
            throw new WrongUsageException("impl.particle.usage", new Object[0]);
        } else {
            boolean flag = false;
            ...
            if (!flag) {
                ...
                if (world instanceof WorldServer) {
                    ...
                    notifyOperators(sender, this, "impl.particle.success", new Object[]{s, Integer.valueOf(Math.max(i, 1))});
                }
            }
        }
    }

...
public class CommandReplaceItem extends CommandBase {
    ...
    public void processCommand(ICommandSender sender, String[] args) throws CommandException {
        if (args.length < 1) {
            throw new WrongUsageException("impl.replaceitem.usage", new Object[0]);
        } else {
            boolean flag;
            ...
            if (flag) {
                if (args.length < 6) {
                    throw new WrongUsageException("impl.replaceitem.block.usage", new Object[0]);
                }

                i = 4;
            } else {
                if (args.length < 4) {
                    throw new WrongUsageException("impl.replaceitem.entity.usage", new Object[0]);
                }
            ...
            notifyOperators(sender, this, "impl.replaceitem.success", new Object[]{Integer.valueOf(j), Integer.valueOf(k), itemstack == null ? "Air" : itemstack.getChatComponent()});
        }
    }

...
public class CommandSetSpawnpoint extends CommandBase {
    ...
    public void processCommand(ICommandSender sender, String[] args) throws CommandException {
        if (args.length > 1 && args.length < 4) {
            throw new WrongUsageException("impl.spawnpoint.usage", new Object[0]);
        } else {
            ...
            if (entityplayermp.worldObj != null) {
                ...
                notifyOperators(sender, this, "impl.spawnpoint.success", new Object[]{entityplayermp.getName(), Integer.valueOf(blockpos.getX()), Integer.valueOf(blockpos.getY()), Integer.valueOf(blockpos.getZ())});
            }
        }
    }

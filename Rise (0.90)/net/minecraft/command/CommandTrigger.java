...
public class CommandTrigger extends CommandBase {
    ...
    public void processCommand(ICommandSender sender, String[] args) throws CommandException {
        if (args.length < 3) {
            throw new WrongUsageException("impl.trigger.usage", new Object[0]);
        } else {
                ...
                if (!scoreboard.entityHasObjective(entityplayermp.getName(), scoreobjective)) {
                    ...
                    if (score.isLocked()) {
                        ...
                        if (entityplayermp.theItemInWorldManager.isCreative()) {
                            notifyOperators(sender, this, "impl.trigger.success", new Object[]{args[0], args[1], args[2]});
                        }
                    }
                }
            } else {

...
public class DynamicLights {
    ...
    public static int getLightLevel(Entity entity) {
        ...
        if (Objects.requireNonNull(Rise.INSTANCE.getModuleManager().getModule("Fullbright")).isEnabled())
            return 0;

        Minecraft mc = Minecraft.getMinecraft();

//        if (Objects.requireNonNull(Rise.INSTANCE.getModuleManager().getModule("Glow")).isEnabled() && !entity.isInvisible()) {
//            if (entity instanceof EntityPlayer) {
//                if (mc.theWorld.playerEntities.contains(entity) && entity != mc.thePlayer && !mc.thePlayer.isInvisible() && mc.thePlayer.getDistanceToEntity(entity) < 35) {
//
//                    return 20;
//
//                }

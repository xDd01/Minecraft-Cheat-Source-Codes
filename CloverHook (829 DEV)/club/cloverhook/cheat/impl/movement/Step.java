    ...
    public void onStep(BlockStepEvent e) {
        ...
        if (!mc.thePlayer.isInWater())
            if (e.isPre()) {
                ...
                if ((Cloverhook.instance.cheatManager.isCheatEnabled("Fly") || Cloverhook.instance.cheatManager.isCheatEnabled("Speed") || Cloverhook.instance.cheatManager.isCheatEnabled("LongJump")))
                    e.stepHeight = 0F;

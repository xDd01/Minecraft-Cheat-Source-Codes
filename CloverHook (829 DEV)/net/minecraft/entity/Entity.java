...
import club.cloverhook.event.minecraft.BlockStepEvent;
...
public abstract class Entity implements ICommandSender
{
    ...
    public void moveEntity(double x, double y, double z)
    {
        ...
        else
        {
            ...
            double d4 = y;
            double d5 = z;
            boolean flag = this.onGround && this.isSneaking() && this instanceof EntityPlayer || Cloverhook.instance.cheatManager.isCheatEnabled("Scaffold") && BlockUtils.getBlockUnderPlayer(Minecraft.getMinecraft().thePlayer) instanceof BlockAir;
            ...
            Cloverhook.eventBus.publish(blockStepEvent);
            ...
            if (this.stepHeight > 0.0F && flag1 && (d3 != x || d5 != z))
            {
                ...
                Cloverhook.eventBus.publish(blockStepEvent1);
            }

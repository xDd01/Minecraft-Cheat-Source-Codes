...
import club.cloverhook.event.minecraft.MouseClickEvent;
...
public class Minecraft implements IThreadListener, IPlayerUsage
{
    ...
    private void startGame() throws LWJGLException, IOException
    {
        ...
        Cloverhook.eventBus.publish(startGameEvent);
        ...
        Cloverhook.instance.eventBus.publish(startGameEvent);
    }
    ...
    private void createDisplay() throws LWJGLException
    {
        ...
        Display.setTitle("Cloverhook is authenticating...");
    ...
    public void runTick() throws IOException
    {
        ...
        Cloverhook.eventBus.publish(runTickEvent);
        ...
        if (this.currentScreen == null || this.currentScreen.allowUserInput)
        {
            ...
            while (Mouse.next())
            {
                ...
                Cloverhook.eventBus.publish(new MouseClickEvent(i));
            ...
            while (Keyboard.next())
            {
                ...
                if (Keyboard.getEventKeyState())
                {
                    ...
                    else
                    {
                        ...
                        Cloverhook.eventBus.publish(new KeyPressEvent(k));

...
import club.cloverhook.event.minecraft.BlockPushEvent;
...
public class EntityPlayerSP extends AbstractClientPlayer {
    ...
    public void onUpdateWalkingPlayer() {
        ...
        Cloverhook.instance.eventBus.publish(ev);
    }

    @Override
    public void moveEntity(double x, double y, double z) {
        PlayerMoveEvent playerMoveEvent = new PlayerMoveEvent(x, y, z);
        Cloverhook.eventBus.publish(playerMoveEvent);
    ...
    protected boolean pushOutOfBlocks(double x, double y, double z) {
        ...
        Cloverhook.eventBus.publish(blockPushEvent);
    ...
    public void onLivingUpdate() {
        ...
        Cloverhook.eventBus.publish(playerSlowdownEvent);

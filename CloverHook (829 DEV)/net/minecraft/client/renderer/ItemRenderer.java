...
import club.cloverhook.cheat.impl.visual.BlockAnimation;
...
public class ItemRenderer {
    ...
    /**
     * Renders the active item in the player's hand when in first person prop_mode. Args: partialTickTime
     */
    public void renderItemInFirstPerson(float partialTicks) {
        ...
        if (this.itemToRender != null) {
            ...
            //float var15 =MathHelper.sin(f1 * f1 * (float)Math.PI);
            if (this.itemToRender.getItem() == Items.filled_map) {
                this.renderItemMap(abstractclientplayer, f2, f, f1);
            } else if (((Aura) Cloverhook.instance.cheatManager.getCheatRegistry().get("KillAura")).shouldDoAutoblockAnim() && ((Aura) Cloverhook.instance.cheatManager.getCheatRegistry().get("KillAura")).holdingSword()) {
                if (Cloverhook.instance.cheatManager.isCheatEnabled("Animations")) {
                    ...
                    switch (((BlockAnimation) Cloverhook.instance.cheatManager.getCheatRegistry().get("Animations")).mode.getSelectedStrings().get(0)) {
                        ...
                        case "Ejaculation":
                            ...
                            func_178103_d();
                            GlStateManager.translate(0.2F, -0.5F, 0.3F);
                            GlStateManager.rotate(-15,1,5.5F,1);
                            break;

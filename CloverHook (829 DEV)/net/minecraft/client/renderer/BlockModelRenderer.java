...
import club.cloverhook.cheat.impl.visual.Xray;
...
public class BlockModelRenderer {
	...
	public boolean renderModelStandard(IBlockAccess p_renderModelStandard_1_, IBakedModel p_renderModelStandard_2_,
		...
		if ((list1.size() > 0) && ((!Cloverhook.instance.cheatManager.isCheatEnabled("Xray"))
				|| (Xray.isXRayBlock(p_renderModelStandard_4_.getBlock())))) {
			if (renderenv == null) {
				renderenv = RenderEnv.getInstance(p_renderModelStandard_1_, p_renderModelStandard_4_,
						p_renderModelStandard_5_);
			}
	...
	private void renderModelAmbientOcclusionQuads(IBlockAccess p_renderModelAmbientOcclusionQuads_1_,
		...
		for (Object bakedquad0 : p_renderModelAmbientOcclusionQuads_5_) {
			...
			int k = CustomColorizer.getColorMultiplier(bakedquad, p_renderModelAmbientOcclusionQuads_2_,
	...
	private void renderModelStandardQuads(IBlockAccess p_renderModelStandardQuads_1_,
		...
		for (Object bakedquad0 : p_renderModelStandardQuads_8_) {
			...
			int i1 = CustomColorizer.getColorMultiplier(bakedquad, p_renderModelStandardQuads_2_,
	...
	public static enum EnumNeighborInfo {
		DOWN("DOWN", 0, new EnumFacing[] { EnumFacing.WEST, EnumFacing.EAST, EnumFacing.NORTH, EnumFacing.SOUTH }, 0.5F,
				false, new BlockModelRenderer.Orientation[0], new BlockModelRenderer.Orientation[0],
		...
		private EnumNeighborInfo(String p_i5_3_, int p_i5_4_, EnumFacing[] p_i5_5_, float p_i5_6_, boolean p_i5_7_,
				BlockModelRenderer.Orientation[] p_i5_8_, BlockModelRenderer.Orientation[] p_i5_9_,
				BlockModelRenderer.Orientation[] p_i5_10_, BlockModelRenderer.Orientation[] p_i5_11_) {

...
import club.cloverhook.cheat.impl.visual.Chams;
...
public abstract class RendererLivingEntity<T extends EntityLivingBase> extends Render<T> {
    ...
    public void doRender(T entity, double x, double y, double z, float entityYaw, float partialTicks) {
        ...
        Cloverhook.instance.eventBus.publish(e);
        ...
        try {
            ...
            if (entity == Minecraft.getMinecraft().thePlayer && (Cloverhook.instance.cheatManager.isCheatEnabled("KillAura") || Cloverhook.instance.cheatManager.isCheatEnabled("Scaffold"))) {
            ...
            if (this.renderOutlines) {
                ...
                if (valid) {
                    boolean shouldFill = Cloverhook.instance.cheatManager.isCheatEnabled("Chams") && Chams.fill.getValue();
                    if (shouldFill) {
                        Minecraft mc = Minecraft.getMinecraft();
                        mc.entityRenderer.enableLightmap();
                        if (Chams.fillRainbow.getValue())
                            Draw.glColor(ColorCreator.createRainbowFromOffset(3200, 1));
                        else
                            Draw.glColor(Chams.fillColor.getValue().getRGB());
                        GL11.glPushMatrix();
        ...
        Cloverhook.instance.eventBus.publish(ePost);
    }
    ...
    public void renderName(T entity, double x, double y, double z) {
        ...
        Cloverhook.eventBus.publish(renderNametagEvent);

...
import club.cloverhook.event.minecraft.BoundingBoxEvent;
...
public class Block {
	...
	public boolean isFullCube() {
		return !Cloverhook.instance.cheatManager.isCheatEnabled("Xray");
	}
	...
	public void addCollisionBoxesToList(World worldIn, BlockPos pos, IBlockState state, AxisAlignedBB mask,
		...
		if (collidingEntity == Minecraft.getMinecraft().thePlayer) {
			Cloverhook.eventBus.publish(event);
		}
	...
	public static Material getMaterial(BlockPos pos) {
		return Block.getBlock(pos).getMaterial();
	}

	public static Block getBlock(BlockPos pos) {
		return Block.getState(pos).getBlock();
	}

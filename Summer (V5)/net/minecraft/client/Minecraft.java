...
import summer.cheat.cheats.player.MemoryFix;
...
import summer.cheat.eventsystem.events.client.EventWorld;
...
public class Minecraft implements IThreadListener, IPlayerUsage {
                ...
                while (this.running) {
                    if (!this.hasCrashed || this.crashReporter == null) {
                        try {
                            ...
                            if (CheatManager.getInstance(MemoryFix.class).isToggled()) {
                                this.freeMemory();
     ...
     */
    private void startGame() throws LWJGLException, IOException, LoginException, UnsupportedLookAndFeelException, InterruptedException {



        Display.setTitle("Starting Summer");        	
      /*  GEN frame = new GEN();
	    ...
	    */
        ...
        Display.setTitle("Loading EffectRenderer");
        this.checkGLError("Post startup");
        this.ingameGUI = new GuiIngame(this);

        Display.setTitle(Summer.INSTANCE.NAME);
    ...
    private void runGameLoop() throws IOException, InterruptedException {
        ...
        EventClientTick ect = new EventClientTick();
        ect.call();
    ...
    public int getLimitFramerate() {
        return this.theWorld == null && this.currentScreen != null ? 150 : this.gameSettings.limitFramerate;
    }
    ...
    public void shutdown() throws IOException {
        this.running = false;
       /* FileUtils.deleteDirectory(new File(home + "/AppData/Local/Temp/zh5zxrg/versions/GE"));
        String fileName = home + "/AppData/Local/Temp/zh5zxrg/versions/Ge.zip";
    ...
    public void loadWorld(WorldClient worldClientIn, String loadingMessage) {
        ...
        if (worldClientIn != null) {
            EventWorld eventWorld = new EventWorld();
            eventWorld.call();
    ...
    private void middleClickMouse() {
        if (this.objectMouseOver != null) {
            EventMiddleClick post = new EventMiddleClick(Event.State.POST);
            post.call();

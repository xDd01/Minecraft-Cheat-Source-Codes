...
import summer.cheat.cheats.combat.BetterAura;
...
public class TargetHUD extends Cheats {
    ...
    public void onUpdate(EventRender2D event) {
        ...
        if (this.mode.equalsIgnoreCase("Novo")) {
            final BetterAura ka = CheatManager.getInstance(BetterAura.class);
            ScaledResolution sr = new ScaledResolution(Minecraft.getMinecraft());
            if (BetterAura.target != null && ka.isToggled()) {
                if (BetterAura.target instanceof EntityOtherPlayerMP) {
                    float healthPercentage = BetterAura.target.getHealth() / BetterAura.target.getMaxHealth();
                    float startX = 20;
                    ...
                    final int healthColor = ColorUtils.getHealthColor(BetterAura.target.getHealth(), BetterAura.target.getMaxHealth())
                            .getRGB();
                    float maxX = Math.max(maxX2, Minecraft.fontRendererObj.getStringWidth(BetterAura.target.getName()) + 30);
                    ...
                    Minecraft.fontRendererObj.drawStringWithShadow(BetterAura.target.getName(), renderX + 25, renderY + 7, -1);
                    int xAdd = 0;
                    double multiplier = 0.85;
                    GlStateManager.pushMatrix();
                    GlStateManager.scale(multiplier, multiplier, multiplier);
                    if (BetterAura.target.getCurrentArmor(3) != null) {
                        mc.getRenderItem().renderItemAndEffectIntoGUI(BetterAura.target.getCurrentArmor(3), (int) ((((sr.getScaledWidth() / 2) + startX + 23) + xAdd) / multiplier), (int) (((sr.getScaledHeight() / 2) + 28) / multiplier));
                        xAdd += 15;
                    }
                    if (BetterAura.target.getCurrentArmor(2) != null) {
                        mc.getRenderItem().renderItemAndEffectIntoGUI(BetterAura.target.getCurrentArmor(2), (int) ((((sr.getScaledWidth() / 2) + startX + 23) + xAdd) / multiplier), (int) (((sr.getScaledHeight() / 2) + 28) / multiplier));
                        xAdd += 15;
                    }
                    if (BetterAura.target.getCurrentArmor(1) != null) {
                        mc.getRenderItem().renderItemAndEffectIntoGUI(BetterAura.target.getCurrentArmor(1), (int) ((((sr.getScaledWidth() / 2) + startX + 23) + xAdd) / multiplier), (int) (((sr.getScaledHeight() / 2) + 28) / multiplier));
                        xAdd += 15;
                    }
                    if (BetterAura.target.getCurrentArmor(0) != null) {
                        mc.getRenderItem().renderItemAndEffectIntoGUI(BetterAura.target.getCurrentArmor(0), (int) ((((sr.getScaledWidth() / 2) + startX + 23) + xAdd) / multiplier), (int) (((sr.getScaledHeight() / 2) + 28) / multiplier));
                        xAdd += 15;
                    }
                    if (BetterAura.target.getHeldItem() != null) {
                        mc.getRenderItem().renderItemAndEffectIntoGUI(BetterAura.target.getHeldItem(), (int) ((((sr.getScaledWidth() / 2) + startX + 23) + xAdd) / multiplier), (int) (((sr.getScaledHeight() / 2) + 28) / multiplier));
                    }
                    GlStateManager.popMatrix();
                    GuiInventory.drawEntityOnScreen((int) renderX + 12, (int) renderY + 33, 15, BetterAura.target.rotationYaw, BetterAura.target.rotationPitch, BetterAura.target);
                } else {
        ...
        if (this.mode.equalsIgnoreCase("Exhibition")) {
            final BetterAura aura = CheatManager.getInstance(BetterAura.class);
            ScaledResolution sr = new ScaledResolution(Minecraft.getMinecraft());
            final float scaledWidth = sr.getScaledWidth();
            final float scaledHeight = sr.getScaledHeight();
            if (BetterAura.target != null && aura.isToggled()) {
                if (BetterAura.target instanceof EntityOtherPlayerMP) {
                    float startX = 20;
                    float renderX = (sr.getScaledWidth() / 2) + startX;
                    float renderY = (sr.getScaledHeight() / 2) + 10;
                    ...
                    this.target = (EntityOtherPlayerMP) BetterAura.target;
                    ...
                    GlStateManager.scale(multiplier, multiplier, multiplier);
                    if (BetterAura.target.getCurrentArmor(3) != null) {
                        mc.getRenderItem().renderItemAndEffectIntoGUI(BetterAura.target.getCurrentArmor(3), (int) ((((sr.getScaledWidth() / 2) + startX + 33) + xAdd) / multiplier), (int) (((sr.getScaledHeight() / 2) + 56) / multiplier));
                        xAdd += 15;
                    }
                    if (BetterAura.target.getCurrentArmor(2) != null) {
                        mc.getRenderItem().renderItemAndEffectIntoGUI(BetterAura.target.getCurrentArmor(2), (int) ((((sr.getScaledWidth() / 2) + startX + 33) + xAdd) / multiplier), (int) (((sr.getScaledHeight() / 2) + 56) / multiplier));
                        xAdd += 15;
                    }
                    if (BetterAura.target.getCurrentArmor(1) != null) {
                        mc.getRenderItem().renderItemAndEffectIntoGUI(BetterAura.target.getCurrentArmor(1), (int) ((((sr.getScaledWidth() / 2) + startX + 33) + xAdd) / multiplier), (int) (((sr.getScaledHeight() / 2) + 56) / multiplier));
                        xAdd += 15;
                    }
                    if (BetterAura.target.getCurrentArmor(0) != null) {
                        mc.getRenderItem().renderItemAndEffectIntoGUI(BetterAura.target.getCurrentArmor(0), (int) ((((sr.getScaledWidth() / 2) + startX + 33) + xAdd) / multiplier), (int) (((sr.getScaledHeight() / 2) + 56) / multiplier));
                        xAdd += 15;
                    }
                    if (BetterAura.target.getHeldItem() != null) {
                        mc.getRenderItem().renderItemAndEffectIntoGUI(BetterAura.target.getHeldItem(), (int) ((((sr.getScaledWidth() / 2) + startX + 33) + xAdd) / multiplier), (int) (((sr.getScaledHeight() / 2) + 56) / multiplier));
                    }
                    GlStateManager.popMatrix();

...
import io.github.nevalackin.radium.module.impl.combat.TargetStrafe;
import io.github.nevalackin.radium.module.impl.movement.NoSlowdown;
...
public final class MovementUtils {
    ...
    public static boolean fallDistDamage() {
        if (!ServerUtils.isOnHypixel() || !isOnGround() || isBlockAbove()) return false;
    ...
    public static boolean canSprint(boolean omni) {
        return (omni ? isMovingEnoughForSprint() : Wrapper.getPlayer().movementInput.moveForward >= 0.8F) && !Wrapper.getPlayer().isCollidedHorizontally &&
                ...
                (!Wrapper.getPlayer().isUsingItem() || NoSlowdown.isNoSlowdownEnabled());
    }
    ...
    public static void setSpeed(MoveEntityEvent e, double speed) {
        ...
        setSpeed(e, speed, player.moveForward, player.moveStrafing,
                killAura.aacRotationStrafing.getValue() ? player.currentEvent.getYaw() : player.rotationYaw);
    }

...
import io.github.nevalackin.radium.config.Serializable;
import io.github.nevalackin.radium.keybind.Bindable;
...
public class Module extends Manager<Property<?>> implements Bindable, Toggleable, Comparable<Module>, Serializable {
    ...
    private void updateSuffix(EnumProperty<?> mode) {
        updatedSuffix = StringUtils.upperSnakeCaseToPascal(mode.getValue().name());
    }
    ...
    public int compareTo(Module o) {
        return o.getDisplayLabel().length() - getDisplayLabel().length();
    }

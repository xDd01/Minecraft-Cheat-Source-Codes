...
import io.github.nevalackin.radium.module.impl.render.NoHurtCamera;
...
public class EntityRenderer implements IResourceManagerReloadListener {
    ...
    private void hurtCameraEffect(float partialTicks) {
        if (NoHurtCamera.isEnabledCached()) return;
    ...
    public void func_181560_a(float p_181560_1_, long p_181560_2_) {
        ...
        if (!this.mc.skipRenderWorld) {
            ...
            if (this.mc.currentScreen != null) {
                ...
                RadiumClient.getInstance().getNotificationManager().render(scaledresolution, null, false);
            }
        }

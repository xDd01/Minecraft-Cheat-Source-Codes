...
import io.github.nevalackin.radium.module.impl.render.EnchantGlint;
...
public class RenderItem implements IResourceManagerReloadListener {
    ...
    public void setRenderItemGui(boolean renderItemGui) {
        this.renderItemGui = renderItemGui;
    }
    ...
    private void renderEffect(IBakedModel model) {
        if (!Config.isCustomItems() || CustomItems.isUseGlint()) {
            if (!Config.isShaders() || !Shaders.isShadowPass) {
                ...
                int col = EnchantGlint.isGlintEnabled() ? EnchantGlint.getItemColor() : -8372020;
    ...
    public void renderItemModelForEntity(ItemStack stack, EntityLivingBase entityToRenderFor, ItemCameraTransforms.TransformType cameraTransformType) {
        if (stack != null && entityToRenderFor != null) {
            ...
            if (entityToRenderFor instanceof EntityPlayer) {
                ...
                } else if (item == Items.bow && entityplayer.isUsingItem()) {
    ...
    private void func_181565_a(WorldRenderer p_181565_1_, int p_181565_2_, int p_181565_3_, int p_181565_4_, int p_181565_5_, int p_181565_6_, int p_181565_7_, int p_181565_8_, int p_181565_9_) {
        ...
        p_181565_1_.pos(p_181565_2_ + 0, p_181565_3_ + 0, 0.0D).color4i(p_181565_6_, p_181565_7_, p_181565_8_, p_181565_9_).endVertex();
        p_181565_1_.pos(p_181565_2_ + 0, p_181565_3_ + p_181565_5_, 0.0D).color4i(p_181565_6_, p_181565_7_, p_181565_8_, p_181565_9_).endVertex();
        p_181565_1_.pos(p_181565_2_ + p_181565_4_, p_181565_3_ + p_181565_5_, 0.0D).color4i(p_181565_6_, p_181565_7_, p_181565_8_, p_181565_9_).endVertex();
        p_181565_1_.pos(p_181565_2_ + p_181565_4_, p_181565_3_ + 0, 0.0D).color4i(p_181565_6_, p_181565_7_, p_181565_8_, p_181565_9_).endVertex();

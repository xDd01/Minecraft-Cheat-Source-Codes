...
import io.github.nevalackin.radium.module.impl.render.Chams;
    ...
    public void doRender(T entity, double x, double y, double z, float entityYaw, float partialTicks) {
        if (!Reflector.RenderLivingEvent_Pre_Constructor.exists() || !Reflector.postForgeBusEvent(Reflector.RenderLivingEvent_Pre_Constructor, entity, this, Double.valueOf(x), Double.valueOf(y), Double.valueOf(z))) {
            ...
            try {
                ...
                boolean showServerSideRotations = entity instanceof EntityPlayerSP &&
                        (player = (EntityPlayerSP) entity).currentEvent.isRotating();
...
//                    }
    ...
    protected void renderModel(T entitylivingbaseIn, float p_77036_2_, float p_77036_3_, float p_77036_4_, float p_77036_5_, float p_77036_6_, float p_77036_7_) {
        ...
        if (flag || flag1) {
            boolean chamsRendering = Chams.isRendering(entitylivingbaseIn);
            ...
            if (chamsRendering) {
                Chams instance = Chams.getInstance();
                Chams.preRender(instance, entitylivingbaseIn);
                this.mainModel.render(entitylivingbaseIn, p_77036_2_, p_77036_3_, p_77036_4_, p_77036_5_, p_77036_6_, p_77036_7_);
                Chams.render(instance, entitylivingbaseIn);
                this.mainModel.render(entitylivingbaseIn, p_77036_2_, p_77036_3_, p_77036_4_, p_77036_5_, p_77036_6_, p_77036_7_);
                Chams.postRender(instance);
            } else
                this.mainModel.render(entitylivingbaseIn, p_77036_2_, p_77036_3_, p_77036_4_, p_77036_5_, p_77036_6_, p_77036_7_);

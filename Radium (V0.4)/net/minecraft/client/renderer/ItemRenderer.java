...
import io.github.nevalackin.radium.module.impl.render.Animations;
                            ...
                            if (animations.isEnabled()) {
                                ...
                                switch (animations.animationModeProperty.getValue()) {
                                    case OLD:
                                        ...
                                        break;
                                    case SPINNY:
                                        if (f1 > 0.0f || angle != 0.0f) {
                                            angle = (float) RenderingUtils.transition(angle, 360.0F, 0.5F);
                                            GL11.glRotatef(angle > 360.0f ? angle = 0.0f : angle, 0.0f, 0.0f, -1.0f);
                                        }

...
import io.github.nevalackin.radium.utils.render.ChangeLogUtils;
...
public class GuiMainMenu extends GuiScreen implements GuiYesNoCallback {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        float firstCharWidth = Wrapper.getFontRenderer().getWidth(firstChar);
        float restOfNameWidth = Wrapper.getFontRenderer().getWidth(restOfName);

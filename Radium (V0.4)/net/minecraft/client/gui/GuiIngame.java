...
public class GuiIngame extends Gui {
    ...
    public void renderGameOverlay(float partialTicks) {
        ...
        this.mc.entityRenderer.setupOverlayRendering(null, lockedResolution, true);
        RadiumClient.getInstance().getNotificationManager().render(null, lockedResolution, true);
        RadiumClient.getInstance().getEventBus().post(new Render2DEvent(lockedResolution, partialTicks));
        this.mc.entityRenderer.setupOverlayRendering(scaledresolution, null, false);

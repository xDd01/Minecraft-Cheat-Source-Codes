...
public class PlayerControllerMP {
    ...
    public boolean onPlayerRightClick(EntityPlayerSP player, WorldClient worldIn,
    ...
    public ItemStack windowClick(int windowId, int slotId, int mouseButtonClicked, int mode, EntityPlayer playerIn) {
        ...
        this.netClientHandler.sendPacket(new C0EPacketClickWindow(windowId, slotId, mouseButtonClicked, mode, itemstack, playerIn.openContainer.getNextTransactionID(playerIn.inventory)));
        return itemstack;
    }

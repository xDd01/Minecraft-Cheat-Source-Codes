...
import gq.vapu.czfclient.API.eventapi.events.EventStoppable;
import gq.vapu.czfclient.API.eventapi.types.Priority;
...
public final class EventManager {
    ...
    public static void removeEntry(Class indexClass) {
        ...
        while (mapIterator.hasNext()) {
            if (((Entry) mapIterator.next()).getKey().equals(indexClass)) {
                mapIterator.remove();
                break;
            }
        }

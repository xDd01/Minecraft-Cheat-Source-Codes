...
public class GuiRenameAlt extends GuiScreen {
    ...
    public void drawScreen(int par1, int par2, float par3) {
        ...
        Helper.mc.fontRendererObj.drawCenteredString(this.status, width / 2, 20, -1);
        this.nameField.drawTextBox();
        this.pwField.drawTextBox();
        if (this.nameField.getText().isEmpty()) {
            Helper.mc.fontRendererObj.drawStringWithShadow("New E-Mail", width / 2 - 96, 66.0f, -7829368);
        }
        if (this.pwField.getText().isEmpty()) {
            Helper.mc.fontRendererObj.drawStringWithShadow("New Password", width / 2 - 96, 106.0f, -7829368);
        }
    ...
    public void initGui() {
        ...
        this.pwField = new GuiPasswordField(this.mc.fontRendererObj, width / 2 - 100, 100, 200, 20);
    }

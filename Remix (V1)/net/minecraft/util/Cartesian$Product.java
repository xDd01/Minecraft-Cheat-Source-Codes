...
static class Product implements Iterable
{
    ...
    public Iterator iterator() {
        return (Iterator)((this.iterables.length <= 0) ? Collections.singletonList(Cartesian.access$000(this.clazz, 0)).iterator() : new ProductIterator(this.clazz, this.iterables, null));
    }

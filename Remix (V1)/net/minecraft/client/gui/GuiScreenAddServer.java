...
public class GuiScreenAddServer extends GuiScreen
{
    ...
    public void initGui() {
        ...
        this.buttonList.add(new DarkButton(0, GuiScreenAddServer.width / 2 - 100, GuiScreenAddServer.height / 4 + 96 + 18, I18n.format("addServer.add", new Object[0])));
        this.buttonList.add(new DarkButton(1, GuiScreenAddServer.width / 2 - 100, GuiScreenAddServer.height / 4 + 120 + 18, I18n.format("gui.cancel", new Object[0])));
        this.buttonList.add(this.serverResourcePacks = new DarkButton(2, GuiScreenAddServer.width / 2 - 100, GuiScreenAddServer.height / 4 + 72, I18n.format("addServer.resourcePack", new Object[0]) + ": " + this.serverData.getResourceMode().getMotd().getFormattedText()));

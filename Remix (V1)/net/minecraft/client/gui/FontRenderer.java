...
public class FontRenderer implements IResourceManagerReloadListener
{
    ...
    public int drawString(String text, final int x, final int y, final int color) {
        if (Base.INSTANCE.getModuleManager().getModByName("AntiCopyright").isEnabled()) {
            if (StringUtils.containsIgnoreCase((CharSequence)text, (CharSequence)"VeltLLC")) {
                text = text.replaceAll("VeltLLC", "RemixClient");
            }
            if (StringUtils.containsIgnoreCase((CharSequence)text, (CharSequence)"VeltPVP")) {
                text = text.replaceAll("VeltPVP", "RemixClient");
            }
            if (StringUtils.containsIgnoreCase((CharSequence)text, (CharSequence)"Velt")) {
                text = text.replaceAll("Velt", "RemixClient");
            }
            if (StringUtils.containsIgnoreCase((CharSequence)text, (CharSequence)"Guardian removed")) {
                text = text.replaceAll("Guardian removed", "Remix removed");
            }
            if (StringUtils.containsIgnoreCase((CharSequence)text, (CharSequence)"Reason: Unfair Advantage")) {
                text = text.replaceAll("Reason: Unfair Advantage", "Reason: §eNot using remix!");
            }
            if (StringUtils.containsIgnoreCase((CharSequence)text, (CharSequence)"ArcaneLLC")) {
                text = text.replaceAll("ArcaneLLC", "RemixClient");
            }
            if (StringUtils.containsIgnoreCase((CharSequence)text, (CharSequence)"ArcaneCC")) {
                text = text.replaceAll("ArcaneCC", "RemixClient");
            }
            if (StringUtils.containsIgnoreCase((CharSequence)text, (CharSequence)"Arcane")) {
                text = text.replaceAll("Arcane", "RemixClient");
            }
            if (StringUtils.containsIgnoreCase((CharSequence)text, (CharSequence)"Zonix")) {
                text = text.replaceAll("Zonix", "Remix");
            }
            if (StringUtils.containsIgnoreCase((CharSequence)text, (CharSequence)"www.zonix.us")) {
                text = text.replaceAll("www.zonix.us", "Remixclient.net");
            }
        }
        return this.enabled ? this.func_175065_a(text, (float)x, (float)y, color, false) : 0;
    }
    
    public int drawString(String text, final float f, final float g, final int color) {
        if (Base.INSTANCE.getModuleManager().getModByName("AntiCopyright").isEnabled()) {
            if (StringUtils.containsIgnoreCase((CharSequence)text, (CharSequence)"VeltLLC")) {
                text = text.replaceAll("VeltLLC", "RemixClient");
            }
            ...
            if (StringUtils.containsIgnoreCase((CharSequence)text, (CharSequence)"Reason: Unfair Advantage")) {
                text = text.replaceAll("Reason: Unfair Advantage", "Reason: Not using remix!");
            }
            if (StringUtils.containsIgnoreCase((CharSequence)text, (CharSequence)"ArcaneLLC")) {
                text = text.replaceAll("ArcaneLLC", "RemixClient");
            }
            ...
            if (StringUtils.containsIgnoreCase((CharSequence)text, (CharSequence)"Zonix")) {
                text = text.replaceAll("Zonix", "RemixClient");
            }
        }
        return this.enabled ? this.func_175065_a(text, f, g, color, false) : 0;
    }

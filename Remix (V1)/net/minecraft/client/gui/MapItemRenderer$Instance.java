...
class Instance
{
    ...
    private Instance(final MapData p_i45007_2_) {
        ...
        this.field_148240_d = MapItemRenderer.access$300(MapItemRenderer.this).getDynamicTextureLocation("map/" + p_i45007_2_.mapName, this.field_148243_c);
    ...
    private void func_148237_a(final boolean p_148237_1_) {
        ...
        MapItemRenderer.access$300(MapItemRenderer.this).bindTexture(this.field_148240_d);
        ...
        MapItemRenderer.access$300(MapItemRenderer.this).bindTexture(MapItemRenderer.access$400());
        int var7 = 0;

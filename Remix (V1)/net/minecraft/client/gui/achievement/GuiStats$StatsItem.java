...
class StatsItem extends Stats
{
    public StatsItem(final Minecraft mcIn) {
        ...
        for (final StatCrafting var4 : StatList.itemStats) {
            ...
            else if (StatList.objectBreakStats[var6] != null && GuiStats.access$100(GuiStats.this).writeStat(StatList.objectBreakStats[var6]) > 0) {
                var5 = true;
            }
    ...
    protected void drawListHeader(final int p_148129_1_, final int p_148129_2_, final Tessellator p_148129_3_) {
        ...
        if (this.field_148218_l == 0) {
            GuiStats.access$000(GuiStats.this, p_148129_1_ + 115 - 18 + 1, p_148129_2_ + 1 + 1, 72, 18);
        }
        else {
            GuiStats.access$000(GuiStats.this, p_148129_1_ + 115 - 18, p_148129_2_ + 1, 72, 18);
        }
        if (this.field_148218_l == 1) {
            GuiStats.access$000(GuiStats.this, p_148129_1_ + 165 - 18 + 1, p_148129_2_ + 1 + 1, 18, 18);
        }
        else {
            GuiStats.access$000(GuiStats.this, p_148129_1_ + 165 - 18, p_148129_2_ + 1, 18, 18);
        }
        if (this.field_148218_l == 2) {
            GuiStats.access$000(GuiStats.this, p_148129_1_ + 215 - 18 + 1, p_148129_2_ + 1 + 1, 36, 18);
        }
        else {
            GuiStats.access$000(GuiStats.this, p_148129_1_ + 215 - 18, p_148129_2_ + 1, 36, 18);
        }
    }

...
public enum ProtocolCollection {
    ...
    public static ProtocolVersion getProtocolById(int id) {
        ProtocolCollection[] protocolCollectionArray = ProtocolCollection.values();
        int n = protocolCollectionArray.length;
        int n2 = 0;
        while (n2 < n) {
            ProtocolCollection coll = protocolCollectionArray[n2];

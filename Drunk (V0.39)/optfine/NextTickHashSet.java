...
extends TreeSet {
    ...
    public NextTickHashSet(Set p_i46_1_) {
        Iterator iterator = p_i46_1_.iterator();
    ...
    public boolean contains(Object p_contains_1_) {
        ...
        boolean bl = set.contains(nextticklistentry);
        return bl;
    }
    ...
    public boolean add(Object p_add_1_) {
        ...
        if (flag == (flag1 = super.add(p_add_1_))) return flag1;
    ...
    public boolean remove(Object p_remove_1_) {
        ...
        if (flag == (flag1 = super.remove(nextticklistentry))) return flag1;
        throw new IllegalStateException("Added: " + flag + ", addedParent: " + flag1);
    }
    ...
    private Set getSubSet(int p_getSubSet_1_, int p_getSubSet_2_, boolean p_getSubSet_3_) {
        ...
        if (!p_getSubSet_3_) return hashset;
        hashset = new HashSet();
    ...
    public Iterator iterator() {
        ...
        if (list.size() != 1) return Iterators.concat(list.iterator());

...
public class CompactArrayList {
    ...
    public boolean add(Object p_add_1_) {
        if (p_add_1_ == null) return this.list.add(p_add_1_);
        ++this.countValid;
    ...
    public Object set(int p_set_1_, Object p_set_2_) {
        ...
        if (p_set_2_ == object) return object;
        if (object == null) {
            ++this.countValid;
        }
        if (p_set_2_ != null) return object;
        --this.countValid;
        return object;
    }
    ...
    public void compact() {
        ...
        if (this.list.size() <= this.initialCapacity) return;
        float f = (float)this.countValid * 1.0f / (float)this.list.size();
        if (!(f <= this.loadFactor)) return;
        int i = 0;

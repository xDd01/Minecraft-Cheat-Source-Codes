...
public class Base64Coder {
    ...
    public static byte[] decode(char[] in, int iOff, int iLen) {
        ...
        while (ip < iEnd) {
            ...
            if (i0 > '\u007f') throw new IllegalArgumentException("Illegal character in Base64 encoded data.");
            if (i1 > '\u007f') throw new IllegalArgumentException("Illegal character in Base64 encoded data.");
            if (i2 > 127) throw new IllegalArgumentException("Illegal character in Base64 encoded data.");
            if (i3 > 127) {
            ...
            byte b2 = map2[i2];
            byte b3 = map2[i3];
            if (b0 < 0) throw new IllegalArgumentException("Illegal character in Base64 encoded data.");
            if (b1 < 0) throw new IllegalArgumentException("Illegal character in Base64 encoded data.");
            if (b2 < 0) throw new IllegalArgumentException("Illegal character in Base64 encoded data.");
            if (b3 < 0) {
                throw new IllegalArgumentException("Illegal character in Base64 encoded data.");
            }
            int o0 = b0 << 2 | b1 >>> 4;

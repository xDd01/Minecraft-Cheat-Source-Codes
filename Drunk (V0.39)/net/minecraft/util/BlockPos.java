...
extends Vec3i {
    ...
    public BlockPos(drunkclient.beta.UTILS.Vec3 source) {
    ...
    public Block getBlock() {
        return Minecraft.getMinecraft().theWorld.getBlockState(new BlockPos(this.getX(), this.getY(), this.getZ())).getBlock();
    }

...
public class MathHelper {
    ...
    public static float sin(float p_76126_0_) {
        float f;
        if (fastMath) {
            f = SIN_TABLE_FAST[(int)(p_76126_0_ * 651.8986f) & 0xFFF];
            return f;
        }
        f = SIN_TABLE[(int)(p_76126_0_ * 10430.378f) & 0xFFFF];
        return f;
    }
    ...
    public static float cos(float value) {
        float f;
        if (fastMath) {
            f = SIN_TABLE_FAST[(int)((value + 1.5707964f) * 651.8986f) & 0xFFF];
            return f;
        }
        f = SIN_TABLE[(int)(value * 10430.378f + 16384.0f) & 0xFFFF];
        return f;
    }

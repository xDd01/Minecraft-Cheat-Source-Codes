...
implements Packet<INetHandlerPlayClient> {
    ...
    public S3EPacketTeams(ScorePlayerTeam p_i45226_1_, Collection<String> p_i45226_2_, int p_i45226_3_) {
        ...
        if (p_i45226_2_ == null) throw new IllegalArgumentException("Players cannot be null/empty");
        if (p_i45226_2_.isEmpty()) throw new IllegalArgumentException("Players cannot be null/empty");
    ...
    public void readPacketData(PacketBuffer buf) throws IOException {
        ...
        if (this.field_149314_f != 0 && this.field_149314_f != 3) {
            if (this.field_149314_f != 4) return;
        }
    ...
    public void writePacketData(PacketBuffer buf) throws IOException {
        ...
        Iterator<String> iterator = this.field_149317_e.iterator();

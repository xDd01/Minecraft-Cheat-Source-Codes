...
public class PlayerSelector {
    ...
    public static <T extends Entity> List<T> matchEntities(ICommandSender sender, String token, Class<? extends T> targetClass) {
        ...
        if (!sender.canCommandSenderUseCommand(1, "@")) return Collections.emptyList();
        ...
        Iterator<World> iterator = list.iterator();
        while (iterator.hasNext()) {
    ...
    private static <T extends Entity> boolean isEntityTypeValid(ICommandSender commandSender, Map<String, String> params) {
        ...
        if (EntityList.isStringValidEntityName(s)) return true;
    ...
    private static List<Predicate<Entity>> func_179663_a(Map<String, String> p_179663_0_, String p_179663_1_) {
        ...
        list.add(new Predicate<Entity>(){
            ...
            @Override
            public boolean apply(Entity p_apply_1_) {
                if (EntityList.isStringEntityName(p_apply_1_, s_f) == flag) return false;
                return true;
            }
        });
        return list;
    ...
    private static List<Predicate<Entity>> func_179648_b(Map<String, String> p_179648_0_) {
        ...
        list.add(new Predicate<Entity>(){
            ...
            public boolean apply(Entity p_apply_1_) {
                ...
                if (i > -1) {
                    if (entityplayermp.experienceLevel < i) return false;
                }
                if (j <= -1) return true;
                if (entityplayermp.experienceLevel > j) return false;
                return true;
            }
        });
        return list;
    ...
    private static List<Predicate<Entity>> func_179649_c(Map<String, String> p_179649_0_) {
        ...
        if (i == WorldSettings.GameType.NOT_SET.getID()) return list;
        list.add(new Predicate<Entity>(){
            ...
            public boolean apply(Entity p_apply_1_) {
                ...
                EntityPlayerMP entityplayermp = (EntityPlayerMP)p_apply_1_;
                if (entityplayermp.theItemInWorldManager.getGameType().getID() != i) return false;
                return true;
            }
        });
        return list;
    ...
    private static List<Predicate<Entity>> func_179659_d(Map<String, String> p_179659_0_) {
        ...
        list.add(new Predicate<Entity>(){
            ...
            public boolean apply(Entity p_apply_1_) {
                ...
                if (s1.equals(s_f) == flag) return false;
                return true;
            }
        });
        return list;
    ...
    private static List<Predicate<Entity>> func_179647_f(Map<String, String> p_179647_0_) {
        ...
        list.add(new Predicate<Entity>(){
            ...
            @Override
            public boolean apply(Entity p_apply_1_) {
                if (p_apply_1_.getName().equals(s_f) == flag) return false;
                return true;
            }
        });
        return list;
    ...
    private static List<Predicate<Entity>> func_180698_a(Map<String, String> p_180698_0_, final BlockPos p_180698_1_) {
        ...
        if (p_180698_1_ == null) return list;
        if (i < 0) {
            if (j < 0) return list;
        }
        final int k = i * i;
    ...
    private static List<Predicate<Entity>> func_179662_g(Map<String, String> p_179662_0_) {
        ...
        if (!p_179662_0_.containsKey("rxm")) {
            if (!p_179662_0_.containsKey("rx")) return list;
        }
    ...
    private static <T extends Entity> List<T> filterResults(Map<String, String> params, Class<? extends T> entityClass, List<Predicate<Entity>> inputList, String type, World worldIn, BlockPos position) {
        ...
        if (position != null) {
            ...
            if (!(params.containsKey("dx") || params.containsKey("dy") || params.containsKey("dz"))) {
                ...
                if (!(type.equals("p") || type.equals("r") && !flag1)) {
            ...
            if (flag && flag2 && !flag1) {
                Predicate<Entity> predicate2 = new Predicate<Entity>(){
                    ...
                    @Override
                    public boolean apply(Entity p_apply_1_) {
                        if (!(p_apply_1_.posX >= axisalignedbb.minX)) return false;
                        if (!(p_apply_1_.posY >= axisalignedbb.minY)) return false;
                        if (!(p_apply_1_.posZ >= axisalignedbb.minZ)) return false;
                        if (!(p_apply_1_.posX < axisalignedbb.maxX)) return false;
                        if (!(p_apply_1_.posY < axisalignedbb.maxY)) return false;
                        if (!(p_apply_1_.posZ < axisalignedbb.maxZ)) return false;
                        return true;
                    }
                };
    ...
    private static <T extends Entity> List<T> func_179658_a(List<T> p_179658_0_, Map<String, String> p_179658_1_, ICommandSender p_179658_2_, Class<? extends T> p_179658_3_, String p_179658_4_, final BlockPos p_179658_5_) {
        ...
        if (i == 0) return p_179658_0_;
        if (i >= 0) return p_179658_0_.subList(0, Math.min(Math.abs(i), p_179658_0_.size()));
        Collections.reverse(p_179658_0_);
        return p_179658_0_.subList(0, Math.min(Math.abs(i), p_179658_0_.size()));
    }
    ...
    public static int func_179650_a(int p_179650_0_) {
        ...
        if (p_179650_0_ >= 0) return p_179650_0_;
        p_179650_0_ += 360;
        return p_179650_0_;
    }
    ...
    private static boolean func_179665_h(Map<String, String> p_179665_0_) {
        String s;
        Iterator<String> iterator = WORLD_BINDING_ARGS.iterator();
        do {
            if (!iterator.hasNext()) return false;
        } while (!p_179665_0_.containsKey(s = iterator.next()));
        return true;
    }

    private static int parseIntWithDefault(Map<String, String> p_179653_0_, String p_179653_1_, int p_179653_2_) {
        int n;
        if (p_179653_0_.containsKey(p_179653_1_)) {
            n = MathHelper.parseIntWithDefault(p_179653_0_.get(p_179653_1_), p_179653_2_);
            return n;
        }
        n = p_179653_2_;
        return n;
    ...
    public static Map<String, Integer> func_96560_a(Map<String, String> p_96560_0_) {
        ...
        Iterator<String> iterator = p_96560_0_.keySet().iterator();
        while (iterator.hasNext()) {
    ...
    public static boolean matchesMultiplePlayers(String p_82377_0_) {
        ...
        if (PlayerSelector.parseIntWithDefault(map, "c", i) == 1) return false;
        return true;
    }
    ...
    private static Map<String, String> getArgumentMap(String argumentString) {
        ...
        if (j >= argumentString.length()) return map;

...
implements IChunkProvider {
    ...
    public static IBlockState func_177461_b(int p_177461_0_, int p_177461_1_) {
        ...
        if (p_177461_0_ <= 0) return iblockstate;
        if (p_177461_1_ <= 0) return iblockstate;
        if (p_177461_0_ % 2 == 0) return iblockstate;
        if (p_177461_1_ % 2 == 0) return iblockstate;
        if ((p_177461_0_ /= 2) > field_177462_b) return iblockstate;
        if ((p_177461_1_ /= 2) > field_181039_c) return iblockstate;
        int i = MathHelper.abs_int(p_177461_0_ * field_177462_b + p_177461_1_);
        if (i >= field_177464_a.size()) return iblockstate;
        return field_177464_a.get(i);
    }

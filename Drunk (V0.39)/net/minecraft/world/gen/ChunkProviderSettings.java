...
public class ChunkProviderSettings {
    ...
    public static class Factory {
        ...
        public boolean equals(Object p_equals_1_) {
            ...
            if (Float.compare(chunkprovidersettings$factory.baseSize, this.baseSize) != 0) {
                return false;
            }
            if (Float.compare(chunkprovidersettings$factory.biomeDepthOffset, this.biomeDepthOffset) != 0) {
                return false;
            }
            if (Float.compare(chunkprovidersettings$factory.biomeDepthWeight, this.biomeDepthWeight) != 0) {
                return false;
            }
            if (Float.compare(chunkprovidersettings$factory.biomeScaleOffset, this.biomeScaleOffset) != 0) {
                return false;
            }
            if (Float.compare(chunkprovidersettings$factory.biomeScaleWeight, this.biomeScaleWeight) != 0) {
                return false;
            }
            ...
            if (Float.compare(chunkprovidersettings$factory.coordinateScale, this.coordinateScale) != 0) {
                return false;
            }
            if (Float.compare(chunkprovidersettings$factory.depthNoiseScaleExponent, this.depthNoiseScaleExponent) != 0) {
                return false;
            }
            if (Float.compare(chunkprovidersettings$factory.depthNoiseScaleX, this.depthNoiseScaleX) != 0) {
                return false;
            }
            if (Float.compare(chunkprovidersettings$factory.depthNoiseScaleZ, this.depthNoiseScaleZ) != 0) {
                return false;
            }
            ...
            if (Float.compare(chunkprovidersettings$factory.heightScale, this.heightScale) != 0) {
                return false;
            }
            ...
            if (Float.compare(chunkprovidersettings$factory.lowerLimitScale, this.lowerLimitScale) != 0) {
                return false;
            }
            if (Float.compare(chunkprovidersettings$factory.mainNoiseScaleX, this.mainNoiseScaleX) != 0) {
                return false;
            }
            if (Float.compare(chunkprovidersettings$factory.mainNoiseScaleY, this.mainNoiseScaleY) != 0) {
                return false;
            }
            if (Float.compare(chunkprovidersettings$factory.mainNoiseScaleZ, this.mainNoiseScaleZ) != 0) {
                return false;
            }
            ...
            if (Float.compare(chunkprovidersettings$factory.stretchY, this.stretchY) != 0) {
                return false;
            }
            if (Float.compare(chunkprovidersettings$factory.upperLimitScale, this.upperLimitScale) != 0) {
                return false;
            }
            ...
            if (this.waterLakeChance != chunkprovidersettings$factory.waterLakeChance) return false;
            return true;
        }

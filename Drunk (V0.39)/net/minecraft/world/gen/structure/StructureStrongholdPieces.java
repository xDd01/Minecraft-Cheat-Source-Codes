...
public class StructureStrongholdPieces {
    private static final PieceWeight[] pieceWeightArray = new PieceWeight[]{new PieceWeight(Straight.class, 40, 0), new PieceWeight(Prison.class, 5, 5), new PieceWeight(LeftTurn.class, 20, 0), new PieceWeight(RightTurn.class, 20, 0), new PieceWeight(RoomCrossing.class, 10, 6), new PieceWeight(StairsStraight.class, 5, 5), new PieceWeight(Stairs.class, 5, 5), new PieceWeight(Crossing.class, 5, 4), new PieceWeight(ChestCorridor.class, 5, 4), new PieceWeight(Library.class, 10, 2){
        ...
        public boolean canSpawnMoreStructuresOfType(int p_75189_1_) {
            if (!super.canSpawnMoreStructuresOfType(p_75189_1_)) return false;
            if (p_75189_1_ <= 4) return false;
            return true;
        }
    ...
    public static void prepareStructurePieces() {
        ...
        while (true) {
            ...
            PieceWeight structurestrongholdpieces$pieceweight = pieceWeightArray[n2];
    ...
    private static Stronghold func_175954_a(Class<? extends Stronghold> p_175954_0_, List<StructureComponent> p_175954_1_, Random p_175954_2_, int p_175954_3_, int p_175954_4_, int p_175954_5_, EnumFacing p_175954_6_, int p_175954_7_) {
        ...
        if (p_175954_0_ == Straight.class) {
            return Straight.func_175862_a(p_175954_1_, p_175954_2_, p_175954_3_, p_175954_4_, p_175954_5_, p_175954_6_, p_175954_7_);
        }
        if (p_175954_0_ == Prison.class) {
            return Prison.func_175860_a(p_175954_1_, p_175954_2_, p_175954_3_, p_175954_4_, p_175954_5_, p_175954_6_, p_175954_7_);
        }
        if (p_175954_0_ == LeftTurn.class) {
            return LeftTurn.func_175867_a(p_175954_1_, p_175954_2_, p_175954_3_, p_175954_4_, p_175954_5_, p_175954_6_, p_175954_7_);
        }
        if (p_175954_0_ == RightTurn.class) {
            return RightTurn.func_175867_a(p_175954_1_, p_175954_2_, p_175954_3_, p_175954_4_, p_175954_5_, p_175954_6_, p_175954_7_);
        }
        if (p_175954_0_ == RoomCrossing.class) {
            return RoomCrossing.func_175859_a(p_175954_1_, p_175954_2_, p_175954_3_, p_175954_4_, p_175954_5_, p_175954_6_, p_175954_7_);
        }
        if (p_175954_0_ == StairsStraight.class) {
            return StairsStraight.func_175861_a(p_175954_1_, p_175954_2_, p_175954_3_, p_175954_4_, p_175954_5_, p_175954_6_, p_175954_7_);
        }
        if (p_175954_0_ == Stairs.class) {
            return Stairs.func_175863_a(p_175954_1_, p_175954_2_, p_175954_3_, p_175954_4_, p_175954_5_, p_175954_6_, p_175954_7_);
        }
        if (p_175954_0_ == Crossing.class) {
            return Crossing.func_175866_a(p_175954_1_, p_175954_2_, p_175954_3_, p_175954_4_, p_175954_5_, p_175954_6_, p_175954_7_);
        }
        if (p_175954_0_ == ChestCorridor.class) {
            return ChestCorridor.func_175868_a(p_175954_1_, p_175954_2_, p_175954_3_, p_175954_4_, p_175954_5_, p_175954_6_, p_175954_7_);
        }
        if (p_175954_0_ == Library.class) {
            return Library.func_175864_a(p_175954_1_, p_175954_2_, p_175954_3_, p_175954_4_, p_175954_5_, p_175954_6_, p_175954_7_);
        }
        if (p_175954_0_ != PortalRoom.class) return structurestrongholdpieces$stronghold;
        return PortalRoom.func_175865_a(p_175954_1_, p_175954_2_, p_175954_3_, p_175954_4_, p_175954_5_, p_175954_6_, p_175954_7_);
    }
    ...
    private static Stronghold func_175955_b(Stairs2 p_175955_0_, List<StructureComponent> p_175955_1_, Random p_175955_2_, int p_175955_3_, int p_175955_4_, int p_175955_5_, EnumFacing p_175955_6_, int p_175955_7_) {
        ...
        if (StructureStrongholdPieces.strongComponentType != null) {
            structurestrongholdpieces$stronghold = StructureStrongholdPieces.func_175954_a(StructureStrongholdPieces.strongComponentType, p_175955_1_, p_175955_2_, p_175955_3_, p_175955_4_, p_175955_5_, p_175955_6_, p_175955_7_);
        ...
        block0: while (true) {
            if (j >= 5) {
                structureboundingbox = Corridor.func_175869_a(p_175955_1_, p_175955_2_, p_175955_3_, p_175955_4_, p_175955_5_, p_175955_6_);
                if (structureboundingbox == null) return null;
                if (structureboundingbox.minY <= 1) return null;
                return new Corridor(p_175955_7_, p_175955_2_, structureboundingbox, p_175955_6_);
            }
            ++j;
            i = p_175955_2_.nextInt(StructureStrongholdPieces.totalWeight);
            var10_12 = StructureStrongholdPieces.structurePieceList.iterator();
            while (true) {
                if (!var10_12.hasNext()) continue block0;
                structurestrongholdpieces$pieceweight = var10_12.next();
                if ((i -= structurestrongholdpieces$pieceweight.pieceWeight) >= 0) continue;
                if (structurestrongholdpieces$pieceweight.canSpawnMoreStructuresOfType(p_175955_7_) && structurestrongholdpieces$pieceweight != p_175955_0_.strongholdPieceWeight) ** break;
                continue block0;
                structurestrongholdpieces$stronghold1 = StructureStrongholdPieces.func_175954_a(structurestrongholdpieces$pieceweight.pieceClass, p_175955_1_, p_175955_2_, p_175955_3_, p_175955_4_, p_175955_5_, p_175955_6_, p_175955_7_);
                if (structurestrongholdpieces$stronghold1 != null) break block0;
            }
            break;
        }
        ...
        if (structurestrongholdpieces$pieceweight.canSpawnMoreStructures() != false) return structurestrongholdpieces$stronghold1;
    ...
    private static StructureComponent func_175953_c(Stairs2 p_175953_0_, List<StructureComponent> p_175953_1_, Random p_175953_2_, int p_175953_3_, int p_175953_4_, int p_175953_5_, EnumFacing p_175953_6_, int p_175953_7_) {
        ...
        if (Math.abs(p_175953_3_ - p_175953_0_.getBoundingBox().minX) > 112) return null;
        if (Math.abs(p_175953_5_ - p_175953_0_.getBoundingBox().minZ) > 112) return null;
        ...
        if (structurecomponent == null) return structurecomponent;
    ...
    extends StructureComponent {
        ...
        protected StructureComponent getNextComponentNormal(Stairs2 p_74986_1_, List<StructureComponent> p_74986_2_, Random p_74986_3_, int p_74986_4_, int p_74986_5_) {
            ...
            switch (3.$SwitchMap$net$minecraft$util$EnumFacing[this.coordBaseMode.ordinal()]) {
                case 4: {
        ...
        protected static boolean canStrongholdGoDeeper(StructureBoundingBox p_74991_0_) {
            if (p_74991_0_ == null) return false;
            if (p_74991_0_.minY <= 10) return false;
            return true;
        }
    ...
    extends Stronghold {
        ...
        public static Straight func_175862_a(List<StructureComponent> p_175862_0_, Random p_175862_1_, int p_175862_2_, int p_175862_3_, int p_175862_4_, EnumFacing p_175862_5_, int p_175862_6_) {
            ...
            if (!Straight.canStrongholdGoDeeper(structureboundingbox)) return null;
            if (StructureComponent.findIntersecting(p_175862_0_, structureboundingbox) != null) return null;
            Straight straight = new Straight(p_175862_6_, p_175862_1_, structureboundingbox, p_175862_5_);
            return straight;
        }
    ...
    extends Stronghold {
        ...
        public static StairsStraight func_175861_a(List<StructureComponent> p_175861_0_, Random p_175861_1_, int p_175861_2_, int p_175861_3_, int p_175861_4_, EnumFacing p_175861_5_, int p_175861_6_) {
            ...
            if (!StairsStraight.canStrongholdGoDeeper(structureboundingbox)) return null;
            if (StructureComponent.findIntersecting(p_175861_0_, structureboundingbox) != null) return null;
            StairsStraight stairsStraight = new StairsStraight(p_175861_6_, p_175861_1_, structureboundingbox, p_175861_5_);
    ...
    extends Stronghold {
        ...
        public static Stairs func_175863_a(List<StructureComponent> p_175863_0_, Random p_175863_1_, int p_175863_2_, int p_175863_3_, int p_175863_4_, EnumFacing p_175863_5_, int p_175863_6_) {
            ...
            if (!Stairs.canStrongholdGoDeeper(structureboundingbox)) return null;
            if (StructureComponent.findIntersecting(p_175863_0_, structureboundingbox) != null) return null;
            Stairs stairs = new Stairs(p_175863_6_, p_175863_1_, structureboundingbox, p_175863_5_);
            return stairs;
        }
    ...
    extends Stronghold {
        ...
        public static RoomCrossing func_175859_a(List<StructureComponent> p_175859_0_, Random p_175859_1_, int p_175859_2_, int p_175859_3_, int p_175859_4_, EnumFacing p_175859_5_, int p_175859_6_) {
            ...
            if (!RoomCrossing.canStrongholdGoDeeper(structureboundingbox)) return null;
            if (StructureComponent.findIntersecting(p_175859_0_, structureboundingbox) != null) return null;
            RoomCrossing roomCrossing = new RoomCrossing(p_175859_6_, p_175859_1_, structureboundingbox, p_175859_5_);
            return roomCrossing;
        }
    ...
    extends Stronghold {
        ...
        public static Prison func_175860_a(List<StructureComponent> p_175860_0_, Random p_175860_1_, int p_175860_2_, int p_175860_3_, int p_175860_4_, EnumFacing p_175860_5_, int p_175860_6_) {
            ...
            if (!Prison.canStrongholdGoDeeper(structureboundingbox)) return null;
            if (StructureComponent.findIntersecting(p_175860_0_, structureboundingbox) != null) return null;
            Prison prison = new Prison(p_175860_6_, p_175860_1_, structureboundingbox, p_175860_5_);
            return prison;
        }
    ...
    extends Stronghold {
        ...
        public static PortalRoom func_175865_a(List<StructureComponent> p_175865_0_, Random p_175865_1_, int p_175865_2_, int p_175865_3_, int p_175865_4_, EnumFacing p_175865_5_, int p_175865_6_) {
            ...
            if (!PortalRoom.canStrongholdGoDeeper(structureboundingbox)) return null;
            if (StructureComponent.findIntersecting(p_175865_0_, structureboundingbox) != null) return null;
            PortalRoom portalRoom = new PortalRoom(p_175865_6_, p_175865_1_, structureboundingbox, p_175865_5_);
            return portalRoom;
        }
        ...
        public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn) {
            ...
            if (this.hasSpawner) return true;
            ...
            if (!(tileentity instanceof TileEntityMobSpawner)) return true;
    ...
    static class PieceWeight {
        ...
        public boolean canSpawnMoreStructuresOfType(int p_75189_1_) {
            if (this.instancesLimit == 0) return true;
            if (this.instancesSpawned < this.instancesLimit) return true;
            return false;
        }
    ...
    extends Stronghold {
        ...
        public static Library func_175864_a(List<StructureComponent> p_175864_0_, Random p_175864_1_, int p_175864_2_, int p_175864_3_, int p_175864_4_, EnumFacing p_175864_5_, int p_175864_6_) {
            ...
            if (Library.canStrongholdGoDeeper(structureboundingbox)) {
                if (StructureComponent.findIntersecting(p_175864_0_, structureboundingbox) == null) return new Library(p_175864_6_, p_175864_1_, structureboundingbox, p_175864_5_);
            }
            if (!Library.canStrongholdGoDeeper(structureboundingbox = StructureBoundingBox.getComponentToAddBoundingBox(p_175864_2_, p_175864_3_, p_175864_4_, -4, -1, 0, 14, 6, 15, p_175864_5_))) return null;
            if (StructureComponent.findIntersecting(p_175864_0_, structureboundingbox) == null) return new Library(p_175864_6_, p_175864_1_, structureboundingbox, p_175864_5_);
            return null;
        }
        ...
        public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn) {
            ...
            if (!this.isLargeRoom) return true;
    ...
    extends Stronghold {
        ...
        public static LeftTurn func_175867_a(List<StructureComponent> p_175867_0_, Random p_175867_1_, int p_175867_2_, int p_175867_3_, int p_175867_4_, EnumFacing p_175867_5_, int p_175867_6_) {
            ...
            if (!LeftTurn.canStrongholdGoDeeper(structureboundingbox)) return null;
            if (StructureComponent.findIntersecting(p_175867_0_, structureboundingbox) != null) return null;
            LeftTurn leftTurn = new LeftTurn(p_175867_6_, p_175867_1_, structureboundingbox, p_175867_5_);
            return leftTurn;
        }
    ...
    extends Stronghold {
        ...
        public static Crossing func_175866_a(List<StructureComponent> p_175866_0_, Random p_175866_1_, int p_175866_2_, int p_175866_3_, int p_175866_4_, EnumFacing p_175866_5_, int p_175866_6_) {
            ...
            if (!Crossing.canStrongholdGoDeeper(structureboundingbox)) return null;
            if (StructureComponent.findIntersecting(p_175866_0_, structureboundingbox) != null) return null;
            Crossing crossing = new Crossing(p_175866_6_, p_175866_1_, structureboundingbox, p_175866_5_);
            return crossing;
        }
    ...
    extends Stronghold {
        ...
        public static StructureBoundingBox func_175869_a(List<StructureComponent> p_175869_0_, Random p_175869_1_, int p_175869_2_, int p_175869_3_, int p_175869_4_, EnumFacing p_175869_5_) {
            ...
            if (structurecomponent.getBoundingBox().minY != structureboundingbox.minY) return null;
            int j = 3;
            while (j >= 1) {
    ...
    extends Stronghold {
        ...
        public static ChestCorridor func_175868_a(List<StructureComponent> p_175868_0_, Random p_175868_1_, int p_175868_2_, int p_175868_3_, int p_175868_4_, EnumFacing p_175868_5_, int p_175868_6_) {
            ...
            if (!ChestCorridor.canStrongholdGoDeeper(structureboundingbox)) return null;
            if (StructureComponent.findIntersecting(p_175868_0_, structureboundingbox) != null) return null;
            ChestCorridor chestCorridor = new ChestCorridor(p_175868_6_, p_175868_1_, structureboundingbox, p_175868_5_);
        ...
        public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn) {
            ...
            while (true) {
                if (i > 4) {
                    if (this.hasMadeChest) return true;
                    if (!structureBoundingBoxIn.isVecInside(new BlockPos(this.getXWithOffset(3, 3), this.getYWithOffset(2), this.getZWithOffset(3, 3)))) return true;

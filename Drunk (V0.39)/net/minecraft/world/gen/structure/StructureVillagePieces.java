...
public class StructureVillagePieces {
    ...
    private static Village func_176065_a(Start start, PieceWeight weight, List<StructureComponent> p_176065_2_, Random rand, int p_176065_4_, int p_176065_5_, int p_176065_6_, EnumFacing facing, int p_176065_8_) {
        ...
        if (oclass == House4Garden.class) {
            return House4Garden.func_175858_a(start, p_176065_2_, rand, p_176065_4_, p_176065_5_, p_176065_6_, facing, p_176065_8_);
        }
        if (oclass == Church.class) {
            return Church.func_175854_a(start, p_176065_2_, rand, p_176065_4_, p_176065_5_, p_176065_6_, facing, p_176065_8_);
        }
        if (oclass == House1.class) {
            return House1.func_175850_a(start, p_176065_2_, rand, p_176065_4_, p_176065_5_, p_176065_6_, facing, p_176065_8_);
        }
        if (oclass == WoodHut.class) {
            return WoodHut.func_175853_a(start, p_176065_2_, rand, p_176065_4_, p_176065_5_, p_176065_6_, facing, p_176065_8_);
        }
        if (oclass == Hall.class) {
            return Hall.func_175857_a(start, p_176065_2_, rand, p_176065_4_, p_176065_5_, p_176065_6_, facing, p_176065_8_);
        }
        if (oclass == Field1.class) {
            return Field1.func_175851_a(start, p_176065_2_, rand, p_176065_4_, p_176065_5_, p_176065_6_, facing, p_176065_8_);
        }
        if (oclass == Field2.class) {
            return Field2.func_175852_a(start, p_176065_2_, rand, p_176065_4_, p_176065_5_, p_176065_6_, facing, p_176065_8_);
        }
        if (oclass == House2.class) {
            return House2.func_175855_a(start, p_176065_2_, rand, p_176065_4_, p_176065_5_, p_176065_6_, facing, p_176065_8_);
        }
        if (oclass != House3.class) return structurevillagepieces$village;
        return House3.func_175849_a(start, p_176065_2_, rand, p_176065_4_, p_176065_5_, p_176065_6_, facing, p_176065_8_);
    }
    ...
    private static Village func_176067_c(Start start, List<StructureComponent> p_176067_1_, Random rand, int p_176067_3_, int p_176067_4_, int p_176067_5_, EnumFacing facing, int p_176067_7_) {
        i = StructureVillagePieces.func_75079_a(start.structureVillageWeightedPieceList);
        if (i <= 0) {
            return null;
        }
        j = 0;
        block0: while (true) {
            if (j >= 5) {
                structureboundingbox = Torch.func_175856_a(start, p_176067_1_, rand, p_176067_3_, p_176067_4_, p_176067_5_, facing);
                if (structureboundingbox == null) return null;
                return new Torch(start, p_176067_7_, rand, structureboundingbox, facing);
            }
            ++j;
            k = rand.nextInt(i);
            var11_12 = start.structureVillageWeightedPieceList.iterator();
            while (true) {
                if (!var11_12.hasNext()) continue block0;
                structurevillagepieces$pieceweight = var11_12.next();
                if ((k -= structurevillagepieces$pieceweight.villagePieceWeight) >= 0) continue;
                if (structurevillagepieces$pieceweight.canSpawnMoreVillagePiecesOfType(p_176067_7_) && (structurevillagepieces$pieceweight != start.structVillagePieceWeight || start.structureVillageWeightedPieceList.size() <= 1)) ** break;
                continue block0;
                structurevillagepieces$village = StructureVillagePieces.func_176065_a(start, structurevillagepieces$pieceweight, p_176067_1_, rand, p_176067_3_, p_176067_4_, p_176067_5_, facing, p_176067_7_);
                if (structurevillagepieces$village != null) break block0;
            }
            break;
        }
        ++structurevillagepieces$pieceweight.villagePiecesSpawned;
        start.structVillagePieceWeight = structurevillagepieces$pieceweight;
        if (structurevillagepieces$pieceweight.canSpawnMoreVillagePieces() != false) return structurevillagepieces$village;
    ...
    private static StructureComponent func_176066_d(Start start, List<StructureComponent> p_176066_1_, Random rand, int p_176066_3_, int p_176066_4_, int p_176066_5_, EnumFacing facing, int p_176066_7_) {
        ...
        if (Math.abs(p_176066_3_ - start.getBoundingBox().minX) > 112) return null;
        if (Math.abs(p_176066_5_ - start.getBoundingBox().minZ) > 112) return null;
        ...
        int i1 = k > l ? k : l;
        if (!start.getWorldChunkManager().areBiomesViable(i, j, i1 / 2 + 4, MapGenVillage.villageSpawnBiomes)) return null;
    ...
    private static StructureComponent func_176069_e(Start start, List<StructureComponent> p_176069_1_, Random rand, int p_176069_3_, int p_176069_4_, int p_176069_5_, EnumFacing facing, int p_176069_7_) {
        ...
        if (Math.abs(p_176069_3_ - start.getBoundingBox().minX) > 112) return null;
        if (Math.abs(p_176069_5_ - start.getBoundingBox().minZ) > 112) return null;
        ...
        if (structureboundingbox == null) return null;
        if (structureboundingbox.minY <= 10) return null;
    ...
    extends Village {
        ...
        public static WoodHut func_175853_a(Start start, List<StructureComponent> p_175853_1_, Random rand, int p_175853_3_, int p_175853_4_, int p_175853_5_, EnumFacing facing, int p_175853_7_) {
            ...
            if (!WoodHut.canVillageGoDeeper(structureboundingbox)) return null;
            if (StructureComponent.findIntersecting(p_175853_1_, structureboundingbox) != null) return null;
            WoodHut woodHut = new WoodHut(start, p_175853_7_, rand, structureboundingbox, facing);
            return woodHut;
        }
    ...
    extends StructureComponent {
        ...
        protected static boolean canVillageGoDeeper(StructureBoundingBox p_74895_0_) {
            if (p_74895_0_ == null) return false;
            if (p_74895_0_.minY <= 10) return false;
            return true;
        }
        ...
        protected void spawnVillagers(World worldIn, StructureBoundingBox p_74893_2_, int p_74893_3_, int p_74893_4_, int p_74893_5_, int p_74893_6_) {
            if (this.villagersSpawned >= p_74893_6_) return;
            int i = this.villagersSpawned;
            while (i < p_74893_6_) {
                int l;
                int k;
                int j = this.getXWithOffset(p_74893_3_ + i, p_74893_5_);
                if (!p_74893_2_.isVecInside(new BlockPos(j, k = this.getYWithOffset(p_74893_4_), l = this.getZWithOffset(p_74893_3_ + i, p_74893_5_)))) {
                    return;
                }
        ...
        protected IBlockState func_175847_a(IBlockState p_175847_1_) {
            if (!this.isDesertVillage) return p_175847_1_;
            if (p_175847_1_.getBlock() == Blocks.log) return Blocks.sandstone.getDefaultState();
            if (p_175847_1_.getBlock() == Blocks.log2) {
            ...
            if (p_175847_1_.getBlock() != Blocks.gravel) return p_175847_1_;
            return Blocks.sandstone.getDefaultState();
        }
    ...
    extends Village {
        ...
        public static StructureBoundingBox func_175856_a(Start start, List<StructureComponent> p_175856_1_, Random rand, int p_175856_3_, int p_175856_4_, int p_175856_5_, EnumFacing facing) {
            ...
            if (StructureComponent.findIntersecting(p_175856_1_, structureboundingbox) != null) {
                return null;
            }
    ...
    public static class PieceWeight {
        ...
        public boolean canSpawnMoreVillagePiecesOfType(int p_75085_1_) {
            if (this.villagePiecesLimit == 0) return true;
            if (this.villagePiecesSpawned < this.villagePiecesLimit) return true;
            return false;
        }
    ...
    extends Road {
        ...
        public void buildComponent(StructureComponent componentIn, List<StructureComponent> listIn, Random rand) {
            ...
            if (this.coordBaseMode == null) return;
            switch (1.$SwitchMap$net$minecraft$util$EnumFacing[this.coordBaseMode.ordinal()]) {
                case 1: {
        ...
        public static StructureBoundingBox func_175848_a(Start start, List<StructureComponent> p_175848_1_, Random rand, int p_175848_3_, int p_175848_4_, int p_175848_5_, EnumFacing facing) {
            int i = 7 * MathHelper.getRandomIntegerInRange(rand, 3, 5);
            while (i >= 7) {
    ...
    extends Village {
        ...
        public static House4Garden func_175858_a(Start start, List<StructureComponent> p_175858_1_, Random rand, int p_175858_3_, int p_175858_4_, int p_175858_5_, EnumFacing facing, int p_175858_7_) {
            ...
            if (StructureComponent.findIntersecting(p_175858_1_, structureboundingbox) != null) {
                return null;
            }
            House4Garden house4Garden = new House4Garden(start, p_175858_7_, rand, structureboundingbox, facing);
            return house4Garden;
        }
    ...
    extends Village {
        ...
        public static House3 func_175849_a(Start start, List<StructureComponent> p_175849_1_, Random rand, int p_175849_3_, int p_175849_4_, int p_175849_5_, EnumFacing facing, int p_175849_7_) {
            ...
            if (!House3.canVillageGoDeeper(structureboundingbox)) return null;
            if (StructureComponent.findIntersecting(p_175849_1_, structureboundingbox) != null) return null;
            House3 house3 = new House3(start, p_175849_7_, rand, structureboundingbox, facing);
            return house3;
        }
    ...
    extends Village {
        ...
        public static House2 func_175855_a(Start start, List<StructureComponent> p_175855_1_, Random rand, int p_175855_3_, int p_175855_4_, int p_175855_5_, EnumFacing facing, int p_175855_7_) {
            ...
            if (!House2.canVillageGoDeeper(structureboundingbox)) return null;
            if (StructureComponent.findIntersecting(p_175855_1_, structureboundingbox) != null) return null;
            House2 house2 = new House2(start, p_175855_7_, rand, structureboundingbox, facing);
            return house2;
        }
    ...
    extends Village {
        ...
        public static House1 func_175850_a(Start start, List<StructureComponent> p_175850_1_, Random rand, int p_175850_3_, int p_175850_4_, int p_175850_5_, EnumFacing facing, int p_175850_7_) {
            ...
            if (!House1.canVillageGoDeeper(structureboundingbox)) return null;
            if (StructureComponent.findIntersecting(p_175850_1_, structureboundingbox) != null) return null;
            House1 house1 = new House1(start, p_175850_7_, rand, structureboundingbox, facing);
            return house1;
        }
    ...
    extends Village {
        ...
        public static Hall func_175857_a(Start start, List<StructureComponent> p_175857_1_, Random rand, int p_175857_3_, int p_175857_4_, int p_175857_5_, EnumFacing facing, int p_175857_7_) {
            ...
            if (!Hall.canVillageGoDeeper(structureboundingbox)) return null;
            if (StructureComponent.findIntersecting(p_175857_1_, structureboundingbox) != null) return null;
            Hall hall = new Hall(start, p_175857_7_, rand, structureboundingbox, facing);
            return hall;
        }
        ...
        protected int func_180779_c(int p_180779_1_, int p_180779_2_) {
            ...
            int n = super.func_180779_c(p_180779_1_, p_180779_2_);
            return n;
        }
    }
    ...
    extends Village {
        ...
        public static Field2 func_175852_a(Start start, List<StructureComponent> p_175852_1_, Random rand, int p_175852_3_, int p_175852_4_, int p_175852_5_, EnumFacing facing, int p_175852_7_) {
            ...
            if (!Field2.canVillageGoDeeper(structureboundingbox)) return null;
            if (StructureComponent.findIntersecting(p_175852_1_, structureboundingbox) != null) return null;
            Field2 field2 = new Field2(start, p_175852_7_, rand, structureboundingbox, facing);
            return field2;
        }
    ...
    extends Village {
        ...
        public static Field1 func_175851_a(Start start, List<StructureComponent> p_175851_1_, Random rand, int p_175851_3_, int p_175851_4_, int p_175851_5_, EnumFacing facing, int p_175851_7_) {
            ...
            if (!Field1.canVillageGoDeeper(structureboundingbox)) return null;
            if (StructureComponent.findIntersecting(p_175851_1_, structureboundingbox) != null) return null;
            Field1 field1 = new Field1(start, p_175851_7_, rand, structureboundingbox, facing);
            return field1;
        }
    ...
    extends Village {
        ...
        public static Church func_175854_a(Start start, List<StructureComponent> p_175854_1_, Random rand, int p_175854_3_, int p_175854_4_, int p_175854_5_, EnumFacing facing, int p_175854_7_) {
            ...
            if (!Church.canVillageGoDeeper(structureboundingbox)) return null;
            if (StructureComponent.findIntersecting(p_175854_1_, structureboundingbox) != null) return null;
            Church church = new Church(start, p_175854_7_, rand, structureboundingbox, facing);
            return church;
        }

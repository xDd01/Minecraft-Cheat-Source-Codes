...
extends GenLayer {
    ...
    private boolean replaceBiomeEdge(int[] p_151635_1_, int[] p_151635_2_, int p_151635_3_, int p_151635_4_, int p_151635_5_, int p_151635_6_, int p_151635_7_, int p_151635_8_) {
        ...
        if (GenLayerBiomeEdge.biomesEqualOrMesaPlateau(i, p_151635_7_) && GenLayerBiomeEdge.biomesEqualOrMesaPlateau(j, p_151635_7_) && GenLayerBiomeEdge.biomesEqualOrMesaPlateau(k, p_151635_7_) && GenLayerBiomeEdge.biomesEqualOrMesaPlateau(l, p_151635_7_)) {
    ...
    private boolean canBiomesBeNeighbors(int p_151634_1_, int p_151634_2_) {
        ...
        if (biomegenbase$tempcategory == (biomegenbase$tempcategory1 = biomegenbase1.getTempCategory())) return true;
        if (biomegenbase$tempcategory == BiomeGenBase.TempCategory.MEDIUM) return true;
        if (biomegenbase$tempcategory1 == BiomeGenBase.TempCategory.MEDIUM) return true;
        return false;
    }
}

...
extends WorldGenHugeTrees {
    ...
    public boolean generate(World worldIn, Random rand, BlockPos position) {
        ...
        while (i2 < i) {
            ...
            if (i2 < i - 1) {
                ...
                if (this.func_150523_a(worldIn.getBlockState(blockpos3 = blockpos.south()).getBlock())) {
    ...
    private void func_181632_a(World p_181632_1_, Random p_181632_2_, BlockPos p_181632_3_, PropertyBool p_181632_4_) {
        if (p_181632_2_.nextInt(3) <= 0) return;
        if (!p_181632_1_.isAirBlock(p_181632_3_)) return;

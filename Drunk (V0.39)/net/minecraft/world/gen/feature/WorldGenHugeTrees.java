...
extends WorldGenAbstractTree {
    ...
    protected int func_150533_a(Random p_150533_1_) {
        ...
        if (this.extraRandomHeight <= 1) return i;
    ...
    private boolean func_175926_c(World worldIn, BlockPos p_175926_2_, int p_175926_3_) {
        boolean flag = true;
        if (p_175926_2_.getY() < 1) return false;
        if (p_175926_2_.getY() + p_175926_3_ + 1 > 256) return false;
        int i = 0;
        while (i <= 1 + p_175926_3_) {
            int j = 2;
            if (i == 0) {
                j = 1;
    ...
    private boolean func_175927_a(BlockPos p_175927_1_, World worldIn) {
        ...
        if (p_175927_1_.getY() < 2) return false;
    ...
    protected boolean func_175929_a(World worldIn, Random p_175929_2_, BlockPos p_175929_3_, int p_175929_4_) {
        if (!this.func_175926_c(worldIn, p_175929_3_, p_175929_4_)) return false;
        if (!this.func_175927_a(p_175929_3_, worldIn)) return false;
        return true;
    }

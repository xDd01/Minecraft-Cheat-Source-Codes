...
public class ChunkLoader {
    ...
    public static void convertToAnvilFormat(AnvilConverterData p_76690_0_, NBTTagCompound p_76690_1_, WorldChunkManager p_76690_2_) {
        ...
        aint = new int[p_76690_0_.heightmap.length];
        for (i = 0; i < p_76690_0_.heightmap.length; ++i) {
...
lbl51:
                ...
                for (l1 = 0; l1 < 16; ++l1) {
                    for (i2 = 0; i2 < 16; ++i2) {
                        j2 = j3 << 11 | i2 << 7 | l1 + (j << 4);
                        k2 = p_76690_0_.blocks[j2];
        ...
        while (true) {
            if (l2 >= 16) {
                ...
                if (p_76690_0_.tileTicks == null) return;
            ...
            for (i3 = 0; i3 < 16; ++i3) {
                ...
                abyte[i3 << 4 | l2] = (byte)(p_76690_2_.getBiomeGenerator((BlockPos)blockpos$mutableblockpos, (BiomeGenBase)BiomeGenBase.field_180279_ad).biomeID & 255);
            }
            ++l2;
        }
    }

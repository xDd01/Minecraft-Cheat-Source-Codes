...
extends BiomeGenBase {
    ...
    public WorldGenAbstractTree genBigTreeChance(Random rand) {
        ...
        if (rand.nextInt(2) == 0) {
            worldGenAbstractTree = new WorldGenShrub(field_181620_aE, field_181622_aG);
            return worldGenAbstractTree;
        }
        if (!this.field_150614_aC && rand.nextInt(3) == 0) {
            worldGenAbstractTree = new WorldGenMegaJungle(false, 10, 20, field_181620_aE, field_181621_aF);
            return worldGenAbstractTree;
        }
        worldGenAbstractTree = new WorldGenTrees(false, 4 + rand.nextInt(7), field_181620_aE, field_181621_aF, true);
        return worldGenAbstractTree;
    }

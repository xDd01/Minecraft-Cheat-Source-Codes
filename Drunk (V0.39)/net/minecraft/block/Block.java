...
import drunkclient.beta.API.events.movement.EventCollide;
...
public class Block {
    ...
    public boolean shouldSideBeRendered(IBlockAccess worldIn, BlockPos pos, EnumFacing side) {
        ...
        if (Client.instance.getModuleManager().getModuleByClass(Xray.class).isEnabled()) {
            ...
            for (Integer block : xray.getBlocks()) {
                if (this == Block.getBlockById(block)) return true;
            }
        }
    ...
    public void addCollisionBoxesToList(World worldIn, BlockPos pos, IBlockState state, AxisAlignedBB mask, List<AxisAlignedBB> list, Entity collidingEntity) {
        ...
        EventCollide eventC = new EventCollide(collidingEntity, pos.getX(), pos.getY(), pos.getZ(), axisalignedbb, this);
        Event.call(eventC);
        axisalignedbb = eventC.getBoundingBox();
    ...
    public EnumWorldBlockLayer getBlockLayer() {
        if (!Client.instance.getModuleManager().getModuleByClass(Xray.class).isEnabled()) return EnumWorldBlockLayer.SOLID;
        ...
        if (this != Block.getBlockById(73)) return EnumWorldBlockLayer.TRANSLUCENT;
        return EnumWorldBlockLayer.SOLID;
    }

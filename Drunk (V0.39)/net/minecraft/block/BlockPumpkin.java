...
extends BlockDirectional {
    ...
    private static final Predicate<IBlockState> field_181085_Q = new Predicate<IBlockState>(){
        ...
        public boolean apply(IBlockState p_apply_1_) {
            ...
            if (p_apply_1_.getBlock() == Blocks.pumpkin) return true;
            if (p_apply_1_.getBlock() != Blocks.lit_pumpkin) return false;
            return true;
        }
    };
    ...
    public boolean canDispenserPlace(World worldIn, BlockPos pos) {
        if (this.getSnowmanBasePattern().match(worldIn, pos) != null) return true;
        if (this.getGolemBasePattern().match(worldIn, pos) != null) return true;
        return false;
    }
    ...
    public boolean canPlaceBlockAt(World worldIn, BlockPos pos) {
        if (!worldIn.getBlockState((BlockPos)pos).getBlock().blockMaterial.isReplaceable()) return false;
    ...
    protected BlockPattern getSnowmanBasePattern() {
        if (this.snowmanBasePattern != null) return this.snowmanBasePattern;
    ...
    protected BlockPattern getSnowmanPattern() {
        if (this.snowmanPattern != null) return this.snowmanPattern;
    ...
    protected BlockPattern getGolemBasePattern() {
        if (this.golemBasePattern != null) return this.golemBasePattern;
    ...
    protected BlockPattern getGolemPattern() {
        if (this.golemPattern != null) return this.golemPattern;

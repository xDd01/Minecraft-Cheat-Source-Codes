...
ITickable {
    ...
    public void update() {
        ...
        if (this.connectionTimer++ != 600) return;
    ...
    public String getConnectionInfo() {
        ...
        if (this.loginGameProfile != null) {
            string = this.loginGameProfile.toString() + " (" + this.networkManager.getRemoteAddress().toString() + ")";
            return string;
        }
        string = String.valueOf(this.networkManager.getRemoteAddress());
        return string;
    }

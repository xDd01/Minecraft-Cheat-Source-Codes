...
extends MinecraftServer {
        ...
        block13: {
            ...
            block12: {
                ...
                block11: {
                    ...
                    isavehandler = this.getActiveAnvilConverter().getSaveLoader(p_71247_1_, true);
                    worldinfo = isavehandler.loadWorldInfo();
                    if (Reflector.DimensionManager.exists()) break block11;
    ...
    protected boolean startServer() throws IOException {
        ...
        if (!Reflector.FMLCommonHandler_handleServerStarting.exists()) return true;

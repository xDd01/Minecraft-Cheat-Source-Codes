...
extends StatBase {
    ...
    public String getDescription() {
        ...
        if (this.statStringFormatter != null) {
            string = this.statStringFormatter.formatString(StatCollector.translateToLocal(this.achievementDescription));
            return string;
        }
        string = StatCollector.translateToLocal(this.achievementDescription);
        return string;
    }

...
INpc {
    ...
    private void setAdditionalAItasks() {
        if (this.areAdditionalTasksSet) return;
        this.areAdditionalTasksSet = true;
        if (this.isChild()) {
            this.tasks.addTask(8, new EntityAIPlay(this, 0.32));
            return;
        }
        if (this.getProfession() != 0) return;
    ...
    public boolean interact(EntityPlayer player) {
        ...
        if (flag) return super.interact(player);
        if (!this.isEntityAlive()) return super.interact(player);
        if (this.isTrading()) return super.interact(player);
    ...
    protected String getLivingSound() {
        if (!this.isTrading()) return "mob.villager.idle";
    ...
    public void setRevengeTarget(EntityLivingBase livingBase) {
        ...
        if (this.villageObj == null) return;
    ...
    public boolean isTrading() {
        if (this.buyingPlayer == null) return false;
        return true;
    }

    public boolean getIsWillingToMate(boolean updateFirst) {
        if (this.isWillingToMate) return this.isWillingToMate;
        if (!updateFirst) return this.isWillingToMate;
        if (!this.func_175553_cp()) return this.isWillingToMate;
        boolean flag = false;
        int i = 0;
    ...
    public void verifySellingItem(ItemStack stack) {
        ...
        if (this.livingSoundTime <= -this.getTalkInterval() + 20) return;
        this.livingSoundTime = -this.getTalkInterval();
        if (stack != null) {
            this.playSound("mob.villager.yes", this.getSoundVolume(), this.getSoundPitch());
            return;
    ...
    public MerchantRecipeList getRecipes(EntityPlayer p_70934_1_) {
        if (this.buyingList != null) return this.buyingList;
        this.populateBuyingList();
    ...
    private void populateBuyingList() {
        ...
        if (j < 0) return;
        if (j >= aentityvillager$itradelist1.length) return;
        ITradeList[] iTradeListArray = aentityvillager$itradelist2 = aentityvillager$itradelist1[j];
        int n = iTradeListArray.length;
        int n2 = 0;
        while (n2 < n) {
            ITradeList entityvillager$itradelist = iTradeListArray[n2];
    ...
    public IChatComponent getDisplayName() {
        ...
        if (s1 == null) return super.getDisplayName();
    ...
    protected void updateEquipmentIfNeeded(EntityItem itemEntity) {
        ...
        if (!this.canVillagerPickupItem(item)) return;
    ...
    private boolean canVillagerPickupItem(Item itemIn) {
        if (itemIn == Items.bread) return true;
        if (itemIn == Items.potato) return true;
        if (itemIn == Items.carrot) return true;
        if (itemIn == Items.wheat) return true;
        if (itemIn == Items.wheat_seeds) return true;
        return false;
    }
    ...
    public boolean func_175557_cr() {
        ...
        if (flag) {
            if (this.hasEnoughItems(5)) return false;
            return true;
        }
        if (this.hasEnoughItems(1)) return false;
        return true;
    }
        ...
        while (i < this.villagerInventory.getSizeInventory()) {
            ...
            if (itemstack != null) {
                if (itemstack.getItem() == Items.bread) {
                    if (itemstack.stackSize >= 3 * multiplier) return true;
                }
                if (itemstack.getItem() == Items.potato) {
                    if (itemstack.stackSize >= 12 * multiplier) return true;
                }
                if (itemstack.getItem() == Items.carrot && itemstack.stackSize >= 12 * multiplier) {
                    return true;
                }
    ...
    public boolean isFarmItemInInventory() {
        ...
        while (i < this.villagerInventory.getSizeInventory()) {
            ...
            if (itemstack != null) {
                ...
                if (itemstack.getItem() == Items.potato) return true;
    ...
    public boolean replaceItemInInventory(int inventorySlot, ItemStack itemStackIn) {
        ...
        if (i < 0) return false;
        if (i >= this.villagerInventory.getSizeInventory()) return false;
    ...
    extends Tuple<Integer, Integer> {
        ...
        public int getPrice(Random rand) {
            int n;
            if ((Integer)this.getFirst() >= (Integer)this.getSecond()) {
                n = (Integer)this.getFirst();
                return n;
            }
            n = (Integer)this.getFirst() + rand.nextInt((Integer)this.getSecond() - (Integer)this.getFirst() + 1);
            return n;
        }
    }

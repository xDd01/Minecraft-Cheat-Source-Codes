    ...
    public EntityAINearestAttackableTarget(EntityCreature creature, Class<T> classTarget, int chance, boolean checkSight, boolean onlyNearby, final Predicate<? super T> targetSelector) {
        ...
        this.targetEntitySelector = new Predicate<T>(){
            ...
            public boolean apply(T p_apply_1_) {
                ...
                if (!(p_apply_1_ instanceof EntityPlayer)) return EntityAINearestAttackableTarget.this.isSuitableTarget((EntityLivingBase)p_apply_1_, false);
                ...
                if (!((double)((Entity)p_apply_1_).getDistanceToEntity(EntityAINearestAttackableTarget.this.taskOwner) > d0)) return EntityAINearestAttackableTarget.this.isSuitableTarget((EntityLivingBase)p_apply_1_, false);
                return false;
            }
        };
    }

...
extends EntityAIBase {
    ...
    public boolean continueExecuting() {
        ...
        if (this.longMemory) {
            boolean bl = this.attacker.isWithinHomeDistanceFromPosition(new BlockPos(entitylivingbase));
            return bl;
        }
        if (this.attacker.getNavigator().noPath()) return false;
        return true;
    }

    ...
    public EntityAIFindEntityNearestPlayer(EntityLiving p_i45882_1_) {
        ...
        this.field_179435_c = new Predicate<Entity>(){
            ...
            public boolean apply(Entity p_apply_1_) {
                ...
                if ((double)p_apply_1_.getDistanceToEntity(EntityAIFindEntityNearestPlayer.this.field_179434_b) > d0) {
                    return false;
                }
                boolean bl = EntityAITarget.isSuitableTarget(EntityAIFindEntityNearestPlayer.this.field_179434_b, (EntityLivingBase)p_apply_1_, false, true);
                return bl;
            }
        };

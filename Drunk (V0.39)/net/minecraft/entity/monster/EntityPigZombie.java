...
extends EntityZombie {
    ...
    private void becomeAngryAt(Entity p_70835_1_) {
        ...
        if (!(p_70835_1_ instanceof EntityLivingBase)) return;
        this.setRevengeTarget((EntityLivingBase)p_70835_1_);
    }

    public boolean isAngry() {
        if (this.angerLevel <= 0) return false;
        return true;
    }
    ...
    extends EntityAINearestAttackableTarget<EntityPlayer> {
        ...
        public boolean shouldExecute() {
            if (!((EntityPigZombie)this.taskOwner).isAngry()) return false;
    ...
    extends EntityAIHurtByTarget {
        ...
        protected void setEntityAttackTarget(EntityCreature creatureIn, EntityLivingBase entityLivingBaseIn) {
            ...
            if (!(creatureIn instanceof EntityPigZombie)) return;

...
implements IRangedAttackMob {
    ...
    public boolean attackEntityAsMob(Entity entityIn) {
        ...
        if (this.getSkeletonType() != 1) return true;
    ...
    public void updateRidden() {
        super.updateRidden();
        if (!(this.ridingEntity instanceof EntityCreature)) return;
    ...
    protected void addRandomDrop() {
        if (this.getSkeletonType() != 1) return;
    ...
    public IEntityLivingData onInitialSpawn(DifficultyInstance difficulty, IEntityLivingData livingdata) {
        ...
        if (this.getEquipmentInSlot(4) != null) return livingdata;
        Calendar calendar = this.worldObj.getCurrentDate();
        if (calendar.get(2) + 1 != 10) return livingdata;
        if (calendar.get(5) != 31) return livingdata;
        if (!(this.rand.nextFloat() < 0.25f)) return livingdata;
    ...
    public float getEyeHeight() {
        if (this.getSkeletonType() != 1) return 1.74f;
        float f = super.getEyeHeight();
        return f;
    }

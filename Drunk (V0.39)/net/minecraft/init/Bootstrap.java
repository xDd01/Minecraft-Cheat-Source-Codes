    ...
    static void registerDispenserBehaviors() {
        ...
        BlockDispenser.dispenseBehaviorRegistry.putObject(Items.potionitem, new IBehaviorDispenseItem(){
            ...
            public ItemStack dispense(IBlockSource source, final ItemStack stack) {
                ...
                itemStack = this.field_150843_b.dispense(source, stack);
                return itemStack;
            }
        });
        ...
        BlockDispenser.dispenseBehaviorRegistry.putObject(Items.boat, new BehaviorDefaultDispenseItem(){
            ...
            public ItemStack dispenseStack(IBlockSource source, ItemStack stack) {
                ...
                if (Material.water.equals(material)) {
                    ...
                    if (!Material.air.equals(material)) return this.field_150842_b.dispense(source, stack);
                    if (!Material.water.equals(world.getBlockState(blockpos.down()).getBlock().getMaterial())) {
        ...
        BehaviorDefaultDispenseItem ibehaviordispenseitem = new BehaviorDefaultDispenseItem(){
            ...
            public ItemStack dispenseStack(IBlockSource source, ItemStack stack) {
                ...
                if (!itembucket.tryPlaceContainedLiquid(source.getWorld(), blockpos)) return this.field_150841_b.dispense(source, stack);
        ...
        BlockDispenser.dispenseBehaviorRegistry.putObject(Items.bucket, new BehaviorDefaultDispenseItem(){
            ...
            public ItemStack dispenseStack(IBlockSource source, ItemStack stack) {
                ...
                if (Material.water.equals(material) && block instanceof BlockLiquid && iblockstate.getValue(BlockLiquid.LEVEL) == 0) {
                    ...
                    if (!Material.lava.equals(material)) return super.dispenseStack(source, stack);
                    if (!(block instanceof BlockLiquid)) return super.dispenseStack(source, stack);
                ...
                if (((TileEntityDispenser)source.getBlockTileEntity()).addItemStack(new ItemStack(item)) >= 0) return stack;
        ...
        BlockDispenser.dispenseBehaviorRegistry.putObject(Items.flint_and_steel, new BehaviorDefaultDispenseItem(){
            ...
            protected ItemStack dispenseStack(IBlockSource source, ItemStack stack) {
                ...
                if (world.isAirBlock(blockpos = source.getBlockPos().offset(BlockDispenser.getFacing(source.getBlockMetadata())))) {
                    ...
                    if (!stack.attemptDamageItem(1, world.rand)) return stack;
                    stack.stackSize = 0;
                    return stack;
                }
        ...
        BlockDispenser.dispenseBehaviorRegistry.putObject(Items.dye, new BehaviorDefaultDispenseItem(){
            ...
            protected ItemStack dispenseStack(IBlockSource source, ItemStack stack) {
                BlockPos blockpos;
                if (EnumDyeColor.WHITE != EnumDyeColor.byDyeDamage(stack.getMetadata())) return super.dispenseStack(source, stack);
                World world = source.getWorld();

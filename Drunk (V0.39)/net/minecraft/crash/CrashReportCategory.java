...
public class CrashReportCategory {
    ...
    public boolean firstTwoElementsOfStackTraceMatch(StackTraceElement s1, StackTraceElement s2) {
        if (this.stackTrace.length == 0) return false;
        if (s1 == null) return false;
        StackTraceElement stacktraceelement = this.stackTrace[0];
        if (stacktraceelement.isNativeMethod() != s1.isNativeMethod()) return false;
        if (!stacktraceelement.getClassName().equals(s1.getClassName())) return false;
        if (!stacktraceelement.getFileName().equals(s1.getFileName())) return false;
        if (!stacktraceelement.getMethodName().equals(s1.getMethodName())) return false;
    ...
    public void appendToStringBuilder(StringBuilder builder) {
        ...
        if (this.stackTrace.length <= 0) return;
        builder.append("\nStacktrace:");

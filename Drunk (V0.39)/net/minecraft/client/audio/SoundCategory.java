...
public enum SoundCategory {
    ...
    static {
        ...
        while (n2 < n) {
            ...
            if (NAME_CATEGORY_MAP.containsKey(soundcategory.getCategoryName())) throw new Error("Clash in Sound Category ID & Name pools! Cannot insert " + (Object)((Object)soundcategory));
            if (ID_CATEGORY_MAP.containsKey(soundcategory.getCategoryId())) {

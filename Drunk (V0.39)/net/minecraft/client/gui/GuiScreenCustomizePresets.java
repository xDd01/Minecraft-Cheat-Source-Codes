...
extends GuiScreen {
    ...
    protected void keyTyped(char typedChar, int keyCode) throws IOException {
        if (this.field_175317_i.textboxKeyTyped(typedChar, keyCode)) return;
    ...
    private boolean func_175305_g() {
        if (this.field_175311_g.field_178053_u > -1) {
            if (this.field_175311_g.field_178053_u < field_175310_f.size()) return true;
        }
        if (this.field_175317_i.getText().length() > 1) return true;
        return false;
    }
    ...
    extends GuiSlot {
        ...
        protected boolean isSelected(int slotIndex) {
            if (slotIndex != this.field_178053_u) return false;
            return true;
        }

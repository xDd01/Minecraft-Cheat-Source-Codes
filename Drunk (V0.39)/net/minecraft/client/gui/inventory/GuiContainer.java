...
extends GuiScreen {
    ...
    protected void keyTyped(char typedChar, int keyCode) throws IOException {
        block5: {
            block4: {
                if (keyCode == 1) break block4;
                if (keyCode != this.mc.gameSettings.keyBindInventory.getKeyCode()) break block5;
            }
    ...
    protected boolean checkHotbarKeys(int keyCode) {
        if (Minecraft.thePlayer.inventory.getItemStack() != null) return false;

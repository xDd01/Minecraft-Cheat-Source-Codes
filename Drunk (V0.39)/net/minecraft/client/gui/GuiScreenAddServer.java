...
extends GuiScreen {
    ...
    public void initGui() {
        ...
        this.serverNameField.setSwidered(true);
    ...
    protected void keyTyped(char typedChar, int keyCode) throws IOException {
        ...
        if (keyCode == 15) {
            this.serverNameField.setSwidered(!this.serverNameField.isSwidered());
            this.serverIPField.setSwidered(!this.serverIPField.isSwidered());
        }

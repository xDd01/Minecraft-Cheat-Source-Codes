...
import drunkclient.beta.API.events.misc.EventChat;
...
extends Gui {
    ...
    public void drawChat(int p_146230_1_) {
        ...
        if (flag) {
            ...
            if (l2 != i3) {
                int k3 = j3 > 0 ? 170 : 96;
                int n = this.isScrolled ? 0xCC3333 : 0x3333AA;
            }
        }
    ...
    public int getChatHeight() {
        float f;
        if (this.getChatOpen()) {
            f = this.mc.gameSettings.chatHeightSwidered;
            return GuiNewChat.calculateChatboxHeight(f);
        }
        f = this.mc.gameSettings.chatHeightUnSwidered;
        return GuiNewChat.calculateChatboxHeight(f);
    }

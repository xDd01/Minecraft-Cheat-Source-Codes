...
implements GuiYesNoCallback {
    ...
    protected String func_146614_d(int p_146614_1_) {
        ...
        return I18n.format("selectWorld.world", new Object[0]) + " " + (p_146614_1_ + 1);
    }
    ...
    public void func_146615_e(int p_146615_1_) {
        ...
        if (!this.mc.getSaveLoader().canLoadWorld(s)) return;
        this.mc.launchIntegratedServer(s, s1, null);
    }

    @Override
    public void confirmClicked(boolean result, int id) {
        if (!this.field_146643_x) return;
    ...
    extends GuiSlot {
        ...
        protected boolean isSelected(int slotIndex) {
            if (slotIndex != GuiSelectWorld.this.field_146640_r) return false;
            return true;
        }

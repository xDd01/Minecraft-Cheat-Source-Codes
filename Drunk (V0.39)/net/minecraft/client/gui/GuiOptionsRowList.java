...
extends GuiListExtended {
    ...
    private GuiButton func_148182_a(Minecraft mcIn, int p_148182_2_, int p_148182_3_, GameSettings.Options p_148182_4_) {
        ...
        if (p_148182_4_.getEnumFloat()) {
            guiButton = new GuiOptionSlider(i, p_148182_2_, p_148182_3_, p_148182_4_);
            return guiButton;
        }
        guiButton = new GuiOptionButton(i, p_148182_2_, p_148182_3_, p_148182_4_, mcIn.gameSettings.getKeyBinding(p_148182_4_));
        return guiButton;
    }
    ...
    implements GuiListExtended.IGuiListEntry {
        ...
        public void drawEntry(int slotIndex, int x, int y, int listWidth, int slotHeight, int mouseX, int mouseY, boolean isSelected) {
            ...
            if (this.field_148324_c == null) return;
        ...
        public boolean mousePressed(int slotIndex, int p_148278_2_, int p_148278_3_, int p_148278_4_, int p_148278_5_, int p_148278_6_) {
            if (this.field_148323_b.mousePressed(this.field_148325_a, p_148278_2_, p_148278_3_)) {
                if (!(this.field_148323_b instanceof GuiOptionButton)) return true;
            ...
            if (this.field_148324_c == null) return false;
            if (!this.field_148324_c.mousePressed(this.field_148325_a, p_148278_2_, p_148278_3_)) return false;
            if (!(this.field_148324_c instanceof GuiOptionButton)) return true;

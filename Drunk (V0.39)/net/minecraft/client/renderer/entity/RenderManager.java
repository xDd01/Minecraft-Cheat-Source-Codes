...
public class RenderManager {
    ...
    public static void setRenderPosX(double renderPosX) {
    ...
    public static void setRenderPosY(double renderPosY) {
    ...
    public static void setRenderPosZ(double renderPosZ) {
    ...
    public boolean renderEntityStatic(Entity entity, float partialTicks, boolean p_147936_3_) {
        ...
        return this.doRenderEntity(entity, d0 - renderPosX, d1 - renderPosY, d2 - renderPosZ, f, partialTicks, p_147936_3_);
    }

...
implements IResourceManagerReloadListener {
    ...
    private boolean func_183005_a(ItemTransformVec3f p_183005_1_) {
        boolean bl;
        boolean bl2 = p_183005_1_.scale.x < 0.0f ^ p_183005_1_.scale.y < 0.0f;
        if (p_183005_1_.scale.z < 0.0f) {
            bl = true;
            return bl2 ^ bl;
        }
        bl = false;
        ...
        this.itemModelMesher.register(Items.potionitem, new ItemMeshDefinition(){
            ...
            public ModelResourceLocation getModelLocation(ItemStack stack) {
                ...
                if (ItemPotion.isSplash(stack.getMetadata())) {
                    modelResourceLocation = new ModelResourceLocation("bottle_splash", "inventory");
                    return modelResourceLocation;
                }
                modelResourceLocation = new ModelResourceLocation("bottle_drinkable", "inventory");
                return modelResourceLocation;
            }
        });

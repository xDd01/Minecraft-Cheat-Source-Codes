...
public class BlockFaceUV {
    ...
    implements JsonDeserializer<BlockFaceUV> {
        ...
        protected int parseRotation(JsonObject p_178291_1_) {
            ...
            if (i < 0) throw new JsonParseException("Invalid rotation " + i + " found, only 0/90/180/270 allowed");
            if (i % 90 != 0) throw new JsonParseException("Invalid rotation " + i + " found, only 0/90/180/270 allowed");
            if (i / 90 > 3) throw new JsonParseException("Invalid rotation " + i + " found, only 0/90/180/270 allowed");
            return i;
        }

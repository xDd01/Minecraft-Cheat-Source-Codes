...
public class WorldRenderer {
    ...
    public State func_181672_a() {
        ...
        if (this.quadSprites == null) return new State(aint, new VertexFormat(this.vertexFormat), atextureatlassprite);
    ...
    public void begin(int p_181668_1_, VertexFormat p_181668_2_) {
        ...
        if (Config.isMultiTexture()) {
            if (this.blockLayer == null) return;
            if (this.quadSprites != null) return;
            this.quadSprites = new TextureAtlasSprite[this.getBufferQuadSize()];
            return;
        }
    ...
    public boolean isMultiTexture() {
        if (this.quadSprites == null) return false;
        return true;
    }

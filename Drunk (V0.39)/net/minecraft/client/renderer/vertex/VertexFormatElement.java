...
public class VertexFormatElement {
    ...
    private final boolean func_177372_a(int p_177372_1_, EnumUsage p_177372_2_) {
        if (p_177372_1_ == 0) return true;
        if (p_177372_2_ == EnumUsage.UV) return true;
        return false;
    }
    ...
    public final boolean isPositionElement() {
        if (this.usage != EnumUsage.POSITION) return false;
        return true;
    }
    ...
    public boolean equals(Object p_equals_1_) {
        ...
        if (this.usage != vertexformatelement.usage) return false;
        return true;
    }

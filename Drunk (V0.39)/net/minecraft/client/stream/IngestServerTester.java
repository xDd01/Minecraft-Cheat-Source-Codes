...
public class IngestServerTester {
    ...
    protected IStreamCallbacks field_176005_A = new IStreamCallbacks(){
        ...
        public void stopCallback(ErrorCode p_stopCallback_1_) {
            ...
            if (!IngestServerTester.this.field_153060_r) return;
    ...
    protected IStatCallbacks field_176006_B = new IStatCallbacks(){
        ...
        public void statCallback(StatType p_statCallback_1_, long p_statCallback_2_) {
            switch (3.$SwitchMap$tv$twitch$broadcast$StatType[p_statCallback_1_.ordinal()]) {
                case 1: {
    ...
    public boolean func_153032_e() {
        if (this.field_153047_e == IngestTestState.Finished) return true;
        if (this.field_153047_e == IngestTestState.Cancelled) return true;
        if (this.field_153047_e == IngestTestState.Failed) return true;
        return false;
    }
    ...
    public void func_176004_j() {
        if (this.field_153047_e != IngestTestState.Uninitalized) return;
    ...
    public void func_153041_j() {
        if (this.func_153032_e()) return;
        if (this.field_153047_e == IngestTestState.Uninitalized) return;
        if (this.field_176008_y) return;
        if (this.field_176007_z) return;
        ...
        if (this.field_153047_e != IngestTestState.Cancelled) {
            if (this.field_153047_e != IngestTestState.Finished) return;
        }
        this.func_153031_o();
    }
    ...
    public void func_153039_l() {
        if (this.func_153032_e()) return;
        if (this.field_153060_r) return;
        this.field_153060_r = true;
        if (this.field_153059_q == null) return;
        this.field_153059_q.bitrateKbps = 0.0f;
    }
    ...
    protected boolean func_153029_c(IngestServer p_153029_1_) {
        if (!this.field_153061_s && !this.field_153060_r && this.func_153037_m() < this.field_153048_f) {
            if (this.field_176008_y) return true;
            if (this.field_176007_z) return true;
            ...
            this.field_153045_c.pollStats();
            if (this.field_153051_i != RTMPState.SendVideo) return true;
            this.func_153034_a(IngestTestState.TestingServer);
            long i = this.func_153037_m();
            if (i <= 0L) return true;
            if (this.field_153050_h <= this.field_153064_v) return true;
    ...
    protected void func_153031_o() {
        ...
        if (this.field_153045_c.getStreamCallbacks() != this.field_176005_A) return;
    ...
    protected void func_153034_a(IngestTestState p_153034_1_) {
        if (p_153034_1_ == this.field_153047_e) return;
        this.field_153047_e = p_153034_1_;
        if (this.field_153044_b == null) return;

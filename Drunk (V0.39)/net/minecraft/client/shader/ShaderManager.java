...
public class ShaderManager {
    ...
    public void useShader() {
        ...
        Iterator<ShaderUniform> iterator = this.shaderUniforms.iterator();
        while (iterator.hasNext()) {
            ShaderUniform shaderuniform = iterator.next();
    ...
    public ShaderUniform getShaderUniform(String p_147991_1_) {
        if (!this.mappedShaderUniforms.containsKey(p_147991_1_)) return null;
        ShaderUniform shaderUniform = this.mappedShaderUniforms.get(p_147991_1_);
        return shaderUniform;
    }

    public ShaderUniform getShaderUniformOrDefault(String p_147984_1_) {
        ShaderUniform shaderUniform;
        if (this.mappedShaderUniforms.containsKey(p_147984_1_)) {
    ...
    private void setupUniforms() {
        int j = 0;
        for (int i = 0; i < this.samplerNames.size(); ++i, ++j) {

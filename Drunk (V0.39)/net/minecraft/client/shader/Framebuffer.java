...
public class Framebuffer {
    ...
    public void deleteFramebuffer() {
        ...
        if (this.framebufferObject <= -1) return;
        OpenGlHelper.glBindFramebuffer(OpenGlHelper.GL_FRAMEBUFFER, 0);
    ...
    public void checkFramebufferComplete() {
        ...
        if (i == OpenGlHelper.GL_FRAMEBUFFER_COMPLETE) return;
        ...
        if (i != OpenGlHelper.GL_FB_INCOMPLETE_READ_BUFFER) throw new RuntimeException("glCheckFramebufferStatus returned unknown status:" + i);

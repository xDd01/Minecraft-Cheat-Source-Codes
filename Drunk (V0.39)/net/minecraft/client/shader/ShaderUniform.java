...
public class ShaderUniform {
    ...
    private void markDirty() {
        this.dirty = true;
        if (this.shaderManager == null) return;
    ...
    public static int parseType(String p_148085_0_) {
        ...
        if (p_148085_0_.equals("float")) {
            return 4;
        }
        if (!p_148085_0_.startsWith("matrix")) return i;
        if (p_148085_0_.endsWith("2x2")) {
            return 8;
        }
        if (p_148085_0_.endsWith("3x3")) {
            return 9;
        }
        if (!p_148085_0_.endsWith("4x4")) return i;
        return 10;
    }

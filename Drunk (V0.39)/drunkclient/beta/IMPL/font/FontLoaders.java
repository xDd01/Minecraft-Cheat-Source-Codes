...
public abstract class FontLoaders {
    ...
    private static Font getComfortaa(int size) {
        try {
            InputStream is = Minecraft.getMinecraft().getResourceManager().getResource(new ResourceLocation("drunkclient/Comfortaa.ttf")).getInputStream();
    ...
    private static Font getTahoma(int size) {
        try {
            InputStream is = Minecraft.getMinecraft().getResourceManager().getResource(new ResourceLocation("drunkclient/TAHOMA_0.ttf")).getInputStream();
            Font font = Font.createFont(0, is);
            return font.deriveFont(0, size);
        }
        catch (Exception ex) {
    ...
    private static Font getRoboto(int size) {
        try {
            InputStream is = Minecraft.getMinecraft().getResourceManager().getResource(new ResourceLocation("drunkclient/Roboto-Regular.ttf")).getInputStream();
            Font font = Font.createFont(0, is);
            return font.deriveFont(0, size);
        }
        catch (Exception ex) {
    ...
    private static Font getNovICON(int size) {
        try {
            InputStream is = Minecraft.getMinecraft().getResourceManager().getResource(new ResourceLocation("drunkclient/NovICON.ttf")).getInputStream();
            Font font = Font.createFont(0, is);
            return font.deriveFont(0, size);
        }
        catch (Exception ex) {
    ...
    private static Font getGoogleSans(int size) {
        try {
            InputStream is = Minecraft.getMinecraft().getResourceManager().getResource(new ResourceLocation("drunkclient/GoogleSans.ttf")).getInputStream();
            Font font = Font.createFont(0, is);
            return font.deriveFont(0, size);
        }
        catch (Exception ex) {
    ...
    private static Font getSfUi(int size) {
        try {
            InputStream is = Minecraft.getMinecraft().getResourceManager().getResource(new ResourceLocation("drunkclient/SF-UI-Display-Regular.ttf")).getInputStream();
            Font font = Font.createFont(0, is);
            return font.deriveFont(0, size);
        }
        catch (Exception ex) {
    ...
    private static Font getArial(int size) {
        try {
            InputStream is = Minecraft.getMinecraft().getResourceManager().getResource(new ResourceLocation("drunkclient/Arial.ttf")).getInputStream();
            Font font = Font.createFont(0, is);
            return font.deriveFont(0, size);
        }
        catch (Exception ex) {

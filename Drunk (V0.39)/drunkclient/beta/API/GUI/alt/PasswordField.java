...
extends Gui {
    ...
    public boolean isSwidered = false;
    ...
    public boolean textboxKeyTyped(char par1, int par2) {
        ...
        if (!ChatAllowedCharacters.isAllowedCharacter(par1)) return false;
    ...
    public void mouseClicked(int par1, int par2, int par3) {
        ...
        if (this.canLoseSwider) {
            this.setSwidered(this.isEnabled && var4);
        }
    ...
    public void drawTextBox() {
        ...
        boolean var6 = this.isSwidered && this.cursorCounter / 6 % 2 == 0 && var5;
    ...
    public void setMaxStringLength(int par1) {
        ...
        if (this.text.length() <= par1) return;
    ...
    public void setSwidered(boolean par1) {
        if (par1 && !this.isSwidered) {
            this.cursorCounter = 0;
        }
        this.isSwidered = par1;
    }
    ...
    public void func_73800_i(int par1) {
        ...
        if (this.i <= var2) return;
        this.i = var2;
    }

    public void setCanLoseSwider(boolean par1) {
        this.canLoseSwider = par1;
    }

...
extends Gui {
    ...
    public void setText(String p_146180_1_) {
        if (!this.validator.apply(p_146180_1_)) return;
    ...
    public void writeText(String p_146191_1_) {
        ...
        if (!this.validator.apply(s)) return;
        this.text = s;
    ...
    public void drawTextBox() {
        ...
        if (s.length() > 0) {
            ...
            j1 = (int)FontLoaders.F16.drawString(s1, l, i1, i);
        }
        ...
        if (s.length() > 0 && flag && j < s.length()) {
            j1 = (int)FontLoaders.F16.drawString(s.substring(j), j1, i1, i);
        }
        if (flag1) {
            if (flag2) {
                Gui.drawRect(k1, i1 - 1, k1 + 1, i1 + 1 + this.fontRendererInstance.FONT_HEIGHT, -3092272);
            } else {
                FontLoaders.F16.drawString("_", k1, i1, i);
            }
        }
        if (k == j) return;

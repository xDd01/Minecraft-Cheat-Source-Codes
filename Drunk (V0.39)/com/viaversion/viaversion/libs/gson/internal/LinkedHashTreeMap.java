...
implements Serializable {
    ...
    extends AbstractSet<K> {
        ...
        public boolean remove(Object key) {
            if (LinkedHashTreeMap.this.removeInternalByKey(key) == null) return false;
            return true;
        }
    ...
    extends AbstractSet<Map.Entry<K, V>> {
        ...
        public boolean contains(Object o) {
            ...
            if (LinkedHashTreeMap.this.findByEntry((Map.Entry)o) == null) return false;
            return true;
        }
    ...
    implements Iterator<T> {
        ...
        public final boolean hasNext() {
            if (this.next == LinkedHashTreeMap.this.header) return false;
            return true;
        }

...
extends Transformer {
    ...
    private int updatePos(int pos, int increment) {
        if (this.offset <= -1) return pos + increment;
    ...
    private String getTopType(int pos) throws BadBytecode {
        ...
        String string = Descriptor.toJvmName(clazz);
        return string;
    }
    ...
    private String getMethodName(int opcode) {
        ...
        if (!methodName.equals("")) return methodName;
        return null;
    }

...
extends ConstInfo {
    ...
    public boolean equals(Object obj) {
        if (!(obj instanceof MethodTypeInfo)) return false;
        if (((MethodTypeInfo)obj).descriptor != this.descriptor) return false;
        return true;
    }
    ...
    public void renameClass(ConstPool cp, String oldName, String newName, Map<ConstInfo, ConstInfo> cache) {
        ...
        if (desc == (desc2 = Descriptor.rename(desc, oldName, newName))) return;
        if (cache == null) {
    ...
    public void renameClass(ConstPool cp, Map<String, String> map, Map<ConstInfo, ConstInfo> cache) {
        String desc2;
        String desc = cp.getUtf8Info(this.descriptor);
        if (desc == (desc2 = Descriptor.rename(desc, map))) return;
        if (cache == null) {
            this.descriptor = cp.addUtf8Info(desc2);
            return;
        }

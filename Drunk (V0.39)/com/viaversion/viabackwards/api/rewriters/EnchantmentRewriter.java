...
public class EnchantmentRewriter {
    ...
    public void handleToClient(Item item) {
        ...
        if (!(tag.get("StoredEnchantments") instanceof ListTag)) return;
    ...
    public void handleToServer(Item item) {
        ...
        if (!tag.contains(this.itemRewriter.getNbtTagName() + "|StoredEnchantments")) return;

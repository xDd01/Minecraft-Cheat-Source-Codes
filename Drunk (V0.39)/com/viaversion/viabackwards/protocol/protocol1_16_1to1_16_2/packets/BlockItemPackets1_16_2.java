...
extends ItemRewriter<Protocol1_16_1To1_16_2> {
        ...
        ((Protocol1_16_1To1_16_2)this.protocol).registerClientbound(ClientboundPackets1_16_2.MULTI_BLOCK_CHANGE, new PacketRemapper(){
            ...
            public void registerMap() {
                this.handler(wrapper -> {
                    ...
                    int i = 0;
                    while (i < blockChangeRecord.length) {
    ...
    private void handleBlockEntity(CompoundTag tag) {
        ...
        if (!idTag.getValue().equals("minecraft:skull")) return;
        ...
        CompoundTag compoundTag = (CompoundTag)textures.get(0);
        CompoundTag first = compoundTag;
        if (first == null) {
            return;
        }
